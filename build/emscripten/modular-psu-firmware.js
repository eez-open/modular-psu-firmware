...
var ASM_CONSTS = {
  595852: function($0) {freeComponentExecutionState($0);},  
 595889: function() {FS.mkdir("/eez_modular_firmware"); FS.mount(IDBFS, {}, "/eez_modular_firmware"); Module.syncdone = 0; FS.syncfs(true, function(err) { assert(!err); Module.syncdone = 1; });},  
 596062: function() {if (Module.syncdone) { Module.syncdone = 0; FS.syncfs(false, function(err) { assert(!err); Module.syncdone = 1; }); }},  
 596180: function() {let jsArray = readScpiInputBuffer(); if (!jsArray) { return null; } let cppBuffer = _malloc(jsArray.length); writeArrayToMemory(jsArray, cppBuffer); return cppBuffer;},  
 596351: function() {let jsArray = readDebuggerInputBuffer(); if (!jsArray) { return null; } let cppBuffer = _malloc(jsArray.length); writeArrayToMemory(jsArray, cppBuffer); return cppBuffer;},  
 596526: function($0, $1) {writeScpiOutputBuffer(new Uint8Array(Module.HEAPU8.buffer, $0, $1));},  
 596599: function($0, $1) {writeDebuggerOutputBuffer(new Uint8Array(Module.HEAPU8.buffer, $0, $1));}
};
