...
var wasmBinaryFile;
  wasmBinaryFile = 'modular-psu-firmware.wasm';
...
var ASM_CONSTS = {
  585068: ($0, $1) => { freeComponentExecutionState($0, $1); },  
 585109: () => { FS.mkdir("/eez_modular_firmware"); FS.mount(IDBFS, {}, "/eez_modular_firmware"); Module.syncdone = 0; FS.syncfs(true, function(err) { assert(!err); Module.syncdone = 1; }); },  
 585282: () => { if (Module.syncdone) { Module.syncdone = 0; FS.syncfs(false, function(err) { assert(!err); Module.syncdone = 1; }); } },  
 585400: () => { let jsArray = readScpiInputBuffer(); if (!jsArray) { return null; } let cppBuffer = _malloc(jsArray.length); writeArrayToMemory(jsArray, cppBuffer); return cppBuffer; },  
 585571: () => { let jsArray = readDebuggerInputBuffer(); if (!jsArray) { return null; } let cppBuffer = _malloc(jsArray.length); writeArrayToMemory(jsArray, cppBuffer); return cppBuffer; },  
 585746: ($0, $1) => { writeScpiOutputBuffer(new Uint8Array(Module.HEAPU8.buffer, $0, $1)); },  
 585819: ($0, $1) => { writeDebuggerOutputBuffer(new Uint8Array(Module.HEAPU8.buffer, $0, $1)); }
};
...
/** @type {function(...*):?} */
var _createDateValue = Module["_createDateValue"] = function() {
  return (_createDateValue = Module["_createDateValue"] = Module["asm"]["createDateValue"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _getUint32Param = Module["_getUint32Param"] = function() {
  return (_getUint32Param = Module["_getUint32Param"] = Module["asm"]["getUint32Param"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _getListParamSize = Module["_getListParamSize"] = function() {
  return (_getListParamSize = Module["_getListParamSize"] = Module["asm"]["getListParamSize"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _evalListParamElementExpression = Module["_evalListParamElementExpression"] = function() {
  return (_evalListParamElementExpression = Module["_evalListParamElementExpression"] = Module["asm"]["evalListParamElementExpression"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _getInputValue = Module["_getInputValue"] = function() {
  return (_getInputValue = Module["_getInputValue"] = Module["asm"]["getInputValue"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _clearInputValue = Module["_clearInputValue"] = function() {
  return (_clearInputValue = Module["_clearInputValue"] = Module["asm"]["clearInputValue"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _logInfo = Module["_logInfo"] = function() {
  return (_logInfo = Module["_logInfo"] = Module["asm"]["logInfo"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _getFirstRootFlowState = Module["_getFirstRootFlowState"] = function() {
  return (_getFirstRootFlowState = Module["_getFirstRootFlowState"] = Module["asm"]["getFirstRootFlowState"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _getFirstChildFlowState = Module["_getFirstChildFlowState"] = function() {
  return (_getFirstChildFlowState = Module["_getFirstChildFlowState"] = Module["asm"]["getFirstChildFlowState"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _getNextSiblingFlowState = Module["_getNextSiblingFlowState"] = function() {
  return (_getNextSiblingFlowState = Module["_getNextSiblingFlowState"] = Module["asm"]["getNextSiblingFlowState"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _getFlowStateFlowIndex = Module["_getFlowStateFlowIndex"] = function() {
  return (_getFlowStateFlowIndex = Module["_getFlowStateFlowIndex"] = Module["asm"]["getFlowStateFlowIndex"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _isRTL = Module["_isRTL"] = function() {
  return (_isRTL = Module["_isRTL"] = Module["asm"]["isRTL"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _getSyncedBuffer = Module["_getSyncedBuffer"] = function() {
  return (_getSyncedBuffer = Module["_getSyncedBuffer"] = Module["asm"]["getSyncedBuffer"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _onPointerEvent = Module["_onPointerEvent"] = function() {
  return (_onPointerEvent = Module["_onPointerEvent"] = Module["asm"]["onPointerEvent"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _onMouseWheelEvent = Module["_onMouseWheelEvent"] = function() {
  return (_onMouseWheelEvent = Module["_onMouseWheelEvent"] = Module["asm"]["onMouseWheelEvent"]).apply(null, arguments);
};
...
var _mainLoop = Module["_mainLoop"] = function() {
  return (_mainLoop = Module["_mainLoop"] = Module["asm"]["mainLoop"]).apply(null, arguments);
};
