...
enum SystemStructures {
    SYSTEM_STRUCTURE_ACTION_PARAMS = 22,
    SYSTEM_STRUCTURE_CHECKBOX_ACTION_PARAMS = 23,
    SYSTEM_STRUCTURE_TEXT_INPUT_ACTION_PARAMS = 24,
    SYSTEM_STRUCTURE_DROP_DOWN_LIST_ACTION_PARAMS = 25,
