...
enum Component_DISPLAY_DATA_WIDGET_Properties {
    ...
    DISPLAY_DATA_WIDGET_PROPERTY_REFRESH_RATE = 2
};
...
enum Component_BUTTON_GROUP_WIDGET_Properties {
    ...
    BUTTON_GROUP_WIDGET_PROPERTY_SELECTED_BUTTON = 2
};
...
enum Component_BAR_GRAPH_WIDGET_Properties {
    ...
    BAR_GRAPH_WIDGET_PROPERTY_MIN = 4,
    BAR_GRAPH_WIDGET_PROPERTY_MAX = 5,
    BAR_GRAPH_WIDGET_PROPERTY_REFRESH_RATE = 6
};
...
enum Component_UP_DOWN_WIDGET_Properties {
    ...
    UP_DOWN_WIDGET_PROPERTY_MIN = 2,
    UP_DOWN_WIDGET_PROPERTY_MAX = 3
};
...
enum SystemStructures {
    ...
    SYSTEM_STRUCTURE_REG_EXP_RESULT = 8200,
    SYSTEM_STRUCTURE_SERIAL_PORT = 8201,
    SYSTEM_STRUCTURE_MQTT_MESSAGE = 8202,
    SYSTEM_STRUCTURE_TERMINAL_WIDGET_ON_DATA_PARAMS = 8203
};
...
enum ArrayTypes {
    ...
    ARRAY_TYPE_DATE = 65556,
    ARRAY_TYPE_BLOB = 65554,
    ARRAY_TYPE_STREAM = 65555,
    ARRAY_TYPE_ANY = 15
};
