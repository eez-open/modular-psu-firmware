...
enum ComponentTypes {
    ...
    COMPONENT_TYPE_QRCODE_WIDGET = 30,
...
enum Component_USER_WIDGET_WIDGET_Properties {
    ...
    USER_WIDGET_WIDGET_PROPERTY_CONTEXT = 2
};
...
enum Component_LINE_CHART_EMBEDDED_WIDGET_Properties {
    ...
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_X_VALUE = 2,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_SHOW_TITLE = 3,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_SHOW_LEGEND = 4,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_SHOW_XAXIS = 5,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_SHOW_YAXIS = 6,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_SHOW_GRID = 7,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_TITLE = 8,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_Y_AXIS_RANGE_FROM = 9,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_Y_AXIS_RANGE_TO = 10,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_MARKER = 11
};

enum Component_QRCODE_WIDGET_Properties {
    QRCODE_WIDGET_PROPERTY_DATA = 0,
    QRCODE_WIDGET_PROPERTY_VISIBLE = 1
};
...
enum Component_LVGLUSER_WIDGET_WIDGET_Properties {
    LVGLUSER_WIDGET_WIDGET_PROPERTY_DATA = 0,
    LVGLUSER_WIDGET_WIDGET_PROPERTY_VISIBLE = 1,
    LVGLUSER_WIDGET_WIDGET_PROPERTY_HIDDEN_FLAG = 2,
    LVGLUSER_WIDGET_WIDGET_PROPERTY_CLICKABLE_FLAG = 3,
    LVGLUSER_WIDGET_WIDGET_PROPERTY_CHECKED_STATE = 4,
    LVGLUSER_WIDGET_WIDGET_PROPERTY_DISABLED_STATE = 5
};
...
enum SystemStructures {
    SYSTEM_STRUCTURE_CLICK_EVENT = 22,
    SYSTEM_STRUCTURE_CHECKBOX_CHANGE_EVENT = 23,
    SYSTEM_STRUCTURE_TEXT_INPUT_CHANGE_EVENT = 24,
    SYSTEM_STRUCTURE_DROP_DOWN_LIST_CHANGE_EVENT = 25,
    SYSTEM_STRUCTURE_SCROLLBAR_STATE = 26,
    SYSTEM_STRUCTURE_REG_EXP_RESULT = 27,
    SYSTEM_STRUCTURE_SERIAL_PORT = 28,
    SYSTEM_STRUCTURE_TERMINAL_WIDGET_ON_DATA_PARAMS = 29
};
...
enum ArrayTypes {
    ARRAY_TYPE_INTEGER = 30,
    ARRAY_TYPE_FLOAT = 31,
    ARRAY_TYPE_DOUBLE = 32,
    ARRAY_TYPE_BOOLEAN = 33,
    ARRAY_TYPE_STRING = 34,
    ARRAY_TYPE_DATE = 35,
    ARRAY_TYPE_BLOB = 36,
    ARRAY_TYPE_STREAM = 37,
    ARRAY_TYPE_ANY = 15
};
