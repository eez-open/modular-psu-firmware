...
enum Component_YT_GRAPH_WIDGET_Properties {
    ...
    YT_GRAPH_WIDGET_PROPERTY_Y2_DATA = 2
};
...
enum Component_LVGL_USER_WIDGET_WIDGET_Properties {
    ...
    LVGL_USER_WIDGET_WIDGET_PROPERTY_HIDDEN_FLAG = 2,
    LVGL_USER_WIDGET_WIDGET_PROPERTY_CLICKABLE_FLAG = 3,
    LVGL_USER_WIDGET_WIDGET_PROPERTY_CHECKED_STATE = 4,
    LVGL_USER_WIDGET_WIDGET_PROPERTY_DISABLED_STATE = 5
};
...
enum SystemStructures {
    ...
    SYSTEM_STRUCTURE_OBJECT_VARIABLE_STATUS = 27,
    SYSTEM_STRUCTURE_REG_EXP_RESULT = 28,
    SYSTEM_STRUCTURE_SERIAL_PORT = 29,
    SYSTEM_STRUCTURE_MQTT_MESSAGE = 30,
    SYSTEM_STRUCTURE_TERMINAL_WIDGET_ON_DATA_PARAMS = 31
};
...
enum ObjectTypes {
    OBJECT_TYPE_INSTRUMENT = 41,
    OBJECT_TYPE_SERIAL_CONNECTION = 44,
    OBJECT_TYPE_MQTT_CONNECTION = 47
};
...
enum ArrayTypes {
    ARRAY_TYPE_INTEGER = 32,
    ARRAY_TYPE_FLOAT = 33,
    ARRAY_TYPE_DOUBLE = 34,
    ARRAY_TYPE_BOOLEAN = 35,
    ARRAY_TYPE_STRING = 36,
    ARRAY_TYPE_DATE = 37,
    ARRAY_TYPE_BLOB = 38,
    ARRAY_TYPE_STREAM = 39,
    ARRAY_TYPE_ANY = 15
};
