...
#define LIST_OF_EVENTS                                                                             \
    ...
    EVENT_SCPI_ERROR(SCPI_ERROR_CH1_DOWN_PROGRAMMER_SWITCHED_OFF, "Sink power limit exceeded on CH1") \
    EVENT_SCPI_ERROR(SCPI_ERROR_CH2_DOWN_PROGRAMMER_SWITCHED_OFF, "Sink power limit exceeded on CH2") \
    EVENT_SCPI_ERROR(SCPI_ERROR_CH3_DOWN_PROGRAMMER_SWITCHED_OFF, "Sink power limit exceeded on CH3") \
    EVENT_SCPI_ERROR(SCPI_ERROR_CH4_DOWN_PROGRAMMER_SWITCHED_OFF, "Sink power limit exceeded on CH4") \
    EVENT_SCPI_ERROR(SCPI_ERROR_CH5_DOWN_PROGRAMMER_SWITCHED_OFF, "Sink power limit exceeded on CH5") \
    EVENT_SCPI_ERROR(SCPI_ERROR_CH6_DOWN_PROGRAMMER_SWITCHED_OFF, "Sink power limit exceeded on CH6") \
