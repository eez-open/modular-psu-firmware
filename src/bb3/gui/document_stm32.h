...
enum StylesEnum {
    ...
    STYLE_ID_BAR_GRAPH_TEXT = 306,
    STYLE_ID_BAR_GRAPH_SET_LINE = 307,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 308,
...
extern const uint8_t assets[314447];
