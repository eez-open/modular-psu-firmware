...
#if defined(EEZ_PLATFORM_STM32)
static const uint32_t MAX_DECOMPRESSED_ASSETS_SIZE = (3 * 512 + 96) * 1024;
#endif
#if defined(EEZ_PLATFORM_SIMULATOR)
...
static const uint32_t ALLOC_BUFFER_SIZE = (1024 - 32 - 256) * 1024;
...
static uint8_t * const GUI_STATE_BUFFER = FLOW_TO_DEBUGGER_MESSAGE_BUFFER + FLOW_TO_DEBUGGER_MESSAGE_BUFFER_SIZE;
static const uint32_t GUI_STATE_BUFFER_SIZE = 256 * 1024;

static uint8_t * const SOUND_TUNES_MEMORY = GUI_STATE_BUFFER + GUI_STATE_BUFFER_SIZE;
...
static uint8_t * const DLOG_RECORD_SAVE_BUFFER = VRAM_AUX_BUFFER7_START_ADDRESS + VRAM_BUFFER_SIZE;
static const uint32_t DLOG_RECORD_SAVE_BUFFER_SIZE = 64 * 1024;

static uint8_t * const FUNCTION_GENERATOR_MEMORY = DLOG_RECORD_SAVE_BUFFER + DLOG_RECORD_SAVE_BUFFER_SIZE;
static const uint32_t FUNCTION_GENERATOR_MEMORY_SIZE = (256 - 64) * 1024;

static uint8_t * const MEMORY_END = FUNCTION_GENERATOR_MEMORY + FUNCTION_GENERATOR_MEMORY_SIZE;
