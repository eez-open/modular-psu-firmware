...
static uint8_t * const FUNCTION_GENERATOR_MEMORY = VRAM_AUX_BUFFER7_START_ADDRESS + VRAM_BUFFER_SIZE;
static const uint32_t FUNCTION_GENERATOR_MEMORY_SIZE = 256 * 1024;
