...
enum Component_ANIMATE_ACTION_COMPONENT_Properties {
    ANIMATE_ACTION_COMPONENT_PROPERTY_TIME = 0,
    ANIMATE_ACTION_COMPONENT_PROPERTY_SPEED = 1
};
...
enum OperationTypes {
    ...
    OPERATION_TYPE_DATE_NOW = 31,
    OPERATION_TYPE_DATE_TO_STRING = 32,
    OPERATION_TYPE_DATE_FROM_STRING = 33,
    OPERATION_TYPE_MATH_SIN = 34,
    OPERATION_TYPE_MATH_COS = 35,
    OPERATION_TYPE_MATH_LOG = 36,
    OPERATION_TYPE_MATH_LOG10 = 37,
    OPERATION_TYPE_MATH_ABS = 38,
    OPERATION_TYPE_MATH_FLOOR = 39,
    OPERATION_TYPE_MATH_CEIL = 40,
    OPERATION_TYPE_MATH_ROUND = 41,
    OPERATION_TYPE_MATH_MIN = 42,
    OPERATION_TYPE_MATH_MAX = 43,
    OPERATION_TYPE_STRING_FIND = 44,
    OPERATION_TYPE_STRING_PAD_START = 45,
    OPERATION_TYPE_STRING_SPLIT = 46,
    OPERATION_TYPE_ARRAY_LENGTH = 47,
    OPERATION_TYPE_ARRAY_SLICE = 48
};
