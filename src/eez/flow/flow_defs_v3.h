...
enum Component_CONTAINER_WIDGET_Properties {
    ...
    CONTAINER_WIDGET_PROPERTY_OVERLAY = 1,
    CONTAINER_WIDGET_PROPERTY_VISIBLE = 2
};
...
enum Component_BUTTON_WIDGET_Properties {
    ...
    BUTTON_WIDGET_PROPERTY_ENABLED = 1
};
...
enum Component_BAR_GRAPH_WIDGET_Properties {
    ...
    BAR_GRAPH_WIDGET_PROPERTY_LINE1_DATA = 1,
    BAR_GRAPH_WIDGET_PROPERTY_LINE2_DATA = 2
};

enum Component_LAYOUT_VIEW_WIDGET_Properties {
    LAYOUT_VIEW_WIDGET_PROPERTY_DATA = 0,
    LAYOUT_VIEW_WIDGET_PROPERTY_CONTEXT = 1,
    LAYOUT_VIEW_WIDGET_PROPERTY_VISIBLE = 2
};

enum Component_YTGRAPH_WIDGET_Properties {
    YTGRAPH_WIDGET_PROPERTY_DATA = 0,
    YTGRAPH_WIDGET_PROPERTY_Y2_DATA = 1
};
...
enum Component_LIST_GRAPH_WIDGET_Properties {
    ...
    LIST_GRAPH_WIDGET_PROPERTY_DWELL_DATA = 1,
    LIST_GRAPH_WIDGET_PROPERTY_Y1_DATA = 2,
    LIST_GRAPH_WIDGET_PROPERTY_Y2_DATA = 3,
    LIST_GRAPH_WIDGET_PROPERTY_CURSOR_DATA = 4
};
...
enum Component_GAUGE_EMBEDDED_WIDGET_Properties {
    ...
    GAUGE_EMBEDDED_WIDGET_PROPERTY_MIN = 1,
    GAUGE_EMBEDDED_WIDGET_PROPERTY_MAX = 2,
    GAUGE_EMBEDDED_WIDGET_PROPERTY_THRESHOLD = 3,
    GAUGE_EMBEDDED_WIDGET_PROPERTY_UNIT = 4
};

enum Component_INPUT_EMBEDDED_WIDGET_Properties {
    INPUT_EMBEDDED_WIDGET_PROPERTY_DATA = 0,
    INPUT_EMBEDDED_WIDGET_PROPERTY_MIN = 1,
    INPUT_EMBEDDED_WIDGET_PROPERTY_MAX = 2,
    INPUT_EMBEDDED_WIDGET_PROPERTY_PRECISION = 3,
    INPUT_EMBEDDED_WIDGET_PROPERTY_UNIT = 4
};

enum Component_ROLLER_WIDGET_Properties {
    ROLLER_WIDGET_PROPERTY_DATA = 0,
    ROLLER_WIDGET_PROPERTY_MIN = 1,
    ROLLER_WIDGET_PROPERTY_MAX = 2,
    ROLLER_WIDGET_PROPERTY_TEXT = 3
};
...
enum Component_SLIDER_WIDGET_Properties {
    ...
    SLIDER_WIDGET_PROPERTY_MIN = 1,
    SLIDER_WIDGET_PROPERTY_MAX = 2
};

enum Component_DROP_DOWN_LIST_WIDGET_Properties {
    DROP_DOWN_LIST_WIDGET_PROPERTY_DATA = 0,
    DROP_DOWN_LIST_WIDGET_PROPERTY_OPTIONS = 1
};
...
enum Component_SET_VARIABLE_ACTION_COMPONENT_Properties {
    SET_VARIABLE_ACTION_COMPONENT_PROPERTY_VARIABLE = 0,
    SET_VARIABLE_ACTION_COMPONENT_PROPERTY_VALUE = 1
};
...
enum OperationTypes {
    ...
    OPERATION_TYPE_FLOW_MAKE_VALUE = 26,
    OPERATION_TYPE_FLOW_MAKE_ARRAY_VALUE = 27,
    OPERATION_TYPE_MATH_SIN = 28,
    OPERATION_TYPE_MATH_COS = 29,
    OPERATION_TYPE_MATH_LOG = 30,
    OPERATION_TYPE_MATH_LOG10 = 31,
    OPERATION_TYPE_MATH_ABS = 32,
    OPERATION_TYPE_MATH_FLOOR = 33,
    OPERATION_TYPE_MATH_CEIL = 34,
    OPERATION_TYPE_MATH_ROUND = 35,
    OPERATION_TYPE_STRING_FIND = 36,
    OPERATION_TYPE_STRING_PAD_START = 37,
    OPERATION_TYPE_STRING_SPLIT = 38,
    OPERATION_TYPE_ARRAY_LENGTH = 39,
    OPERATION_TYPE_ARRAY_SLICE = 40
};

enum SystemStructures {
    SYSTEM_STRUCTURE_ACTION_PARAMS = 0,
    SYSTEM_STRUCTURE_CHECKBOX_ACTION_PARAMS = 1,
    SYSTEM_STRUCTURE_TEXT_INPUT_ACTION_PARAMS = 2,
    SYSTEM_STRUCTURE_SERIAL_PORT = 3,
    SYSTEM_STRUCTURE_TERMINAL_WIDGET_ON_DATA_PARAMS = 4
};
...
enum ArrayTypes {
    ARRAY_TYPE_INTEGER = 6,
    ARRAY_TYPE_FLOAT = 8,
    ARRAY_TYPE_DOUBLE = 10,
    ARRAY_TYPE_BOOLEAN = 12,
    ARRAY_TYPE_STRING = 14,
    ARRAY_TYPE_DATE = 16,
    ARRAY_TYPE_BLOB = 18,
    ARRAY_TYPE_ANY = 20
};
