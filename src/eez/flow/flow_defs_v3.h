...
enum OperationTypes {
    ...
    OPERATION_TYPE_STRING_FIND = 31,
    OPERATION_TYPE_STRING_PAD_START = 32,
    OPERATION_TYPE_STRING_SPLIT = 33,
    OPERATION_TYPE_ARRAY_LENGTH = 34,
    OPERATION_TYPE_ARRAY_SLICE = 35
};
