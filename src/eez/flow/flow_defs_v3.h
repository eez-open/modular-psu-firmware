...
enum OperationTypes {
    ...
    OPERATION_TYPE_FLOW_LANGUAGES = 28,
    OPERATION_TYPE_FLOW_TRANSLATE = 29,
    OPERATION_TYPE_DATE_NOW = 30,
    OPERATION_TYPE_DATE_TO_STRING = 31,
    OPERATION_TYPE_DATE_FROM_STRING = 32,
    OPERATION_TYPE_MATH_SIN = 33,
    OPERATION_TYPE_MATH_COS = 34,
    OPERATION_TYPE_MATH_LOG = 35,
    OPERATION_TYPE_MATH_LOG10 = 36,
    OPERATION_TYPE_MATH_ABS = 37,
    OPERATION_TYPE_MATH_FLOOR = 38,
    OPERATION_TYPE_MATH_CEIL = 39,
    OPERATION_TYPE_MATH_ROUND = 40,
    OPERATION_TYPE_MATH_MIN = 41,
    OPERATION_TYPE_MATH_MAX = 42,
    OPERATION_TYPE_STRING_FIND = 43,
    OPERATION_TYPE_STRING_PAD_START = 44,
    OPERATION_TYPE_STRING_SPLIT = 45,
    OPERATION_TYPE_ARRAY_LENGTH = 46,
    OPERATION_TYPE_ARRAY_SLICE = 47
};
