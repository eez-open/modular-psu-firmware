...
enum SystemStructures {
    ...
    SYSTEM_STRUCTURE_REG_EXP_RESULT = 24,
    SYSTEM_STRUCTURE_SERIAL_PORT = 25,
    SYSTEM_STRUCTURE_TERMINAL_WIDGET_ON_DATA_PARAMS = 26
};
...
enum ArrayTypes {
    ARRAY_TYPE_INTEGER = 27,
    ARRAY_TYPE_FLOAT = 28,
    ARRAY_TYPE_DOUBLE = 29,
    ARRAY_TYPE_BOOLEAN = 30,
    ARRAY_TYPE_STRING = 31,
    ARRAY_TYPE_DATE = 32,
    ARRAY_TYPE_BLOB = 33,
    ARRAY_TYPE_STREAM = 34,
    ARRAY_TYPE_ANY = 14
};
