...
enum OperationTypes {
    ...
    OPERATION_TYPE_MATH_SIN = 25,
    OPERATION_TYPE_MATH_COS = 26,
    OPERATION_TYPE_MATH_LOG = 27,
    OPERATION_TYPE_MATH_LOG10 = 28,
    OPERATION_TYPE_MATH_ABS = 29,
    OPERATION_TYPE_STRING_FIND = 30,
    OPERATION_TYPE_STRING_PAD_START = 31,
    OPERATION_TYPE_STRING_SPLIT = 32,
    OPERATION_TYPE_ARRAY_LENGTH = 33,
    OPERATION_TYPE_ARRAY_SLICE = 34
};
