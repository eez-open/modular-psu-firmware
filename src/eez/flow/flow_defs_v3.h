...
enum ComponentTypes {
    ...
    COMPONENT_TYPE_STOP_ACTION = 1024,
...
enum Component_LOOP_ACTION_COMPONENT_Properties {
    ...
    LOOP_ACTION_COMPONENT_PROPERTY_STEP = 2
};
...
enum OperationTypes {
    ...
    OPERATION_TYPE_MATH_SIN = 26,
    OPERATION_TYPE_MATH_COS = 27,
    OPERATION_TYPE_MATH_LOG = 28,
    OPERATION_TYPE_MATH_LOG10 = 29,
    OPERATION_TYPE_MATH_ABS = 30,
    OPERATION_TYPE_MATH_FLOOR = 31,
    OPERATION_TYPE_MATH_CEIL = 32,
    OPERATION_TYPE_MATH_ROUND = 33,
    OPERATION_TYPE_STRING_FIND = 34,
    OPERATION_TYPE_STRING_PAD_START = 35,
    OPERATION_TYPE_STRING_SPLIT = 36,
    OPERATION_TYPE_ARRAY_LENGTH = 37,
    OPERATION_TYPE_ARRAY_SLICE = 38
};
