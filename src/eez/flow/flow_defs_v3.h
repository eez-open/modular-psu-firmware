...
enum OperationTypes {
    ...
    OPERATION_TYPE_FLOW_INDEX = 23,
    OPERATION_TYPE_MATH_SIN = 24,
    OPERATION_TYPE_MATH_COS = 25,
    OPERATION_TYPE_MATH_LOG = 26,
    OPERATION_TYPE_MATH_LOG10 = 27,
    OPERATION_TYPE_MATH_ABS = 28,
    OPERATION_TYPE_STRING_FIND = 29,
    OPERATION_TYPE_STRING_PAD_START = 30,
    OPERATION_TYPE_STRING_SPLIT = 31,
    OPERATION_TYPE_ARRAY_LENGTH = 32,
    OPERATION_TYPE_ARRAY_SLICE = 33
};
