...
enum ComponentTypes {
    ...
    COMPONENT_TYPE_OVERRIDE_STYLE = 1031,
...
enum Component_LINE_CHART_EMBEDDED_WIDGET_Properties {
    ...
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_TITLE = 3,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_SHOW_LEGEND = 4,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_Y_AXIS_RANGE_FROM = 5,
    LINE_CHART_EMBEDDED_WIDGET_PROPERTY_Y_AXIS_RANGE_TO = 6
};
