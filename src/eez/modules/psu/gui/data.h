...
#define ENUM_DEFINITIONS \
    ...
    ENUM_DEFINITION(CHANNEL_DISPLAY_VALUE_SCALE) \
    ...
    ENUM_DEFINITION(IO_PINS_INPUT1_FUNCTION) \
    ENUM_DEFINITION(IO_PINS_INPUT1_FUNCTION_WITH_DLOG_TRIGGER) \
    ENUM_DEFINITION(IO_PINS_INPUT2_FUNCTION) \
    ENUM_DEFINITION(IO_PINS_INPUT2_FUNCTION_WITH_DLOG_TRIGGER) \
    ENUM_DEFINITION(IO_PINS_OUTPUT1_FUNCTION) \
