...
int getNumSignificantDecimalDigits(Unit unit, int channelIndex, bool extendedPrecision) {
    static int g_numSignificantDecimalDigits[] = { 2,
                                                   ...
                                                   CURRENT_NUM_SIGNIFICANT_DECIMAL_DIGITS - 6,
    ...
    int numSignificantDecimalDigits = g_numSignificantDecimalDigits[unit];
    if (extendedPrecision) {
        ++numSignificantDecimalDigits;
    }
    return numSignificantDecimalDigits;
}
