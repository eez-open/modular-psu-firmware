...
#define LIST_OF_EVENTS                                                                             \
    ...
    EVENT_ERROR(CH1_REMOTE_SENSE_REVERSE_POLARITY_DETECTED, 50,                                    \
                "CH1 rsense reverse polarity detected")                                            \
    EVENT_ERROR(CH2_REMOTE_SENSE_REVERSE_POLARITY_DETECTED, 51,                                    \
                "CH2 rsense reverse polarity detected")                                            \
    ...
    EVENT_INFO(FORCE_DISABLING_ALL_OUTPUTS_ON_POWERUP_ENABLED, 100,                                \
               "Force disabling outputs enabled")                                                  \
    EVENT_INFO(FORCE_DISABLING_ALL_OUTPUTS_ON_POWERUP_DISABLED, 101,                               \
               "Force disabling outputs disabled")                                                 \
    ...
    EVENT_INFO(COUPLED_IN_COMMON_GROUND, 107, "Coupled in common ground")                          \
    EVENT_INFO(COUPLED_IN_SPLIT_RAIL, 108, "Coupled in split rail")
