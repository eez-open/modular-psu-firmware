...
#define VRAM_BUFFER1_START_ADDRESS            (SDRAM_START_ADDRESS        + 1 * 1024 * 1024)
#define VRAM_BUFFER2_START_ADDRESS            (VRAM_BUFFER1_START_ADDRESS + VRAM_BUFFER_SIZE)
#define VRAM_SCREENSHOOT_BUFFER_START_ADDRESS (VRAM_BUFFER2_START_ADDRESS + VRAM_BUFFER_SIZE)

#define VRAM_BUFFER3_START_ADDRESS            (SDRAM_START_ADDRESS        + 2 * 1024 * 1024)
#define VRAM_BUFFER4_START_ADDRESS            (VRAM_BUFFER1_START_ADDRESS + VRAM_BUFFER_SIZE)
