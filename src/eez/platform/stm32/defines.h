...
#define DLOG_RECORD_BUFFER (SDRAM_START_ADDRESS + 3 * 512 * 1024)
#define DLOG_RECORD_BUFFER_SIZE (128 * 1024)

#define DLOG_VIEW_BUFFER (DLOG_RECORD_BUFFER + DLOG_RECORD_BUFFER_SIZE)
#define DLOG_VIEW_BUFFER_SIZE (896 * 1024)

#define SOUND_TUNES_MEMORY (DLOG_VIEW_BUFFER + DLOG_VIEW_BUFFER_SIZE)
#define SOUND_TUNES_MEMORY_SIZE (32 * 1024)

#define FILE_MANAGER_MEMORY (SOUND_TUNES_MEMORY + SOUND_TUNES_MEMORY_SIZE)
#define FILE_MANAGER_MEMORY_SIZE (256 * 1024)

#define VRAM_SCREENSHOOT_JPEG_OUT_BUFFER (FILE_MANAGER_MEMORY + FILE_MANAGER_MEMORY_SIZE)
