...
#define DECOMPRESSED_ASSETS_SIZE 3 * 512 * 1024

#define DLOG_RECORD_BUFFER (DECOMPRESSED_ASSETS_START_ADDRESS + DECOMPRESSED_ASSETS_SIZE)
#define DLOG_RECORD_BUFFER_SIZE (128 * 1024)

#define FILE_VIEW_BUFFER (DLOG_RECORD_BUFFER + DLOG_RECORD_BUFFER_SIZE)
#define FILE_VIEW_BUFFER_SIZE (1408 * 1024)

#define SOUND_TUNES_MEMORY (FILE_VIEW_BUFFER + FILE_VIEW_BUFFER_SIZE)
