...
enum Component_APP_VIEW_WIDGET_Properties {
    APP_VIEW_WIDGET_PROPERTY_DATA = 1
};

enum Component_SCROLL_BAR_WIDGET_Properties {
    SCROLL_BAR_WIDGET_PROPERTY_DATA = 1
};

enum Component_PROGRESS_WIDGET_Properties {
    PROGRESS_WIDGET_PROPERTY_DATA = 1
};

enum Component_CANVAS_WIDGET_Properties {
    CANVAS_WIDGET_PROPERTY_DATA = 1
};
...
enum Component_COMPARE_ACTION_COMPONENT_Properties {
    COMPARE_ACTION_COMPONENT_PROPERTY_A = 1,
    COMPARE_ACTION_COMPONENT_PROPERTY_B = 2,
    COMPARE_ACTION_COMPONENT_PROPERTY_C = 3
};

enum Component_IS_TRUE_ACTION_COMPONENT_Properties {
    IS_TRUE_ACTION_COMPONENT_PROPERTY_VALUE = 1
};

enum Component_READ_SETTING_ACTION_COMPONENT_Properties {
    READ_SETTING_ACTION_COMPONENT_PROPERTY_KEY = 1
};

enum Component_WRITE_SETTINGS_ACTION_COMPONENT_Properties {
    WRITE_SETTINGS_ACTION_COMPONENT_PROPERTY_KEY = 1
};

enum Component_CALL_ACTION_ACTION_COMPONENT_Properties {
    CALL_ACTION_ACTION_COMPONENT_PROPERTY_ACTION = 1
};

enum Component_DELAY_ACTION_COMPONENT_Properties {
    DELAY_ACTION_COMPONENT_PROPERTY_MILLISECONDS = 1
};

enum Component_ERROR_ACTION_COMPONENT_Properties {
    ERROR_ACTION_COMPONENT_PROPERTY_MESSAGE = 1
};

enum Component_SCPI_ACTION_COMPONENT_Properties {
    SCPI_ACTION_COMPONENT_PROPERTY_INSTRUMENT = 1
};
...
enum OperationTypes {
    ...
    OPERATION_TYPE_MATH_SIN = 23,
    OPERATION_TYPE_MATH_COS = 24,
    OPERATION_TYPE_MATH_LOG = 25
};
