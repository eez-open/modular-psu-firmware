enum DataEnum {
    ...
    DATA_ID_SERIAL_BAUD = 225,
    DATA_ID_SERIAL_PARITY = 226,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 227,
    DATA_ID_IO_PINS = 228,
    DATA_ID_IO_PINS_INHIBIT_STATE = 229,
    DATA_ID_IO_PIN_NUMBER = 230,
    DATA_ID_IO_PIN_POLARITY = 231,
    DATA_ID_IO_PIN_FUNCTION = 232,
    DATA_ID_NTP_ENABLED = 233,
    DATA_ID_NTP_SERVER = 234,
    DATA_ID_ASYNC_OPERATION_THROBBER = 235,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 236,
    DATA_ID_PROGRESS = 237,
    DATA_ID_MAIN_APP_VIEW = 238,
    DATA_ID_TOUCH_CALIBRATION_POINT = 239,
    DATA_ID_SIMULATOR_LOAD_STATE = 240,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 241,
    DATA_ID_SIMULATOR_LOAD = 242,
    DATA_ID_SIMULATOR_LOAD2 = 243,
    DATA_ID_SELECTED_THEME = 244,
    DATA_ID_CHANNEL_TITLE = 245,
    DATA_ID_CHANNEL_SHORT_TITLE = 246,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 247,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 248,
    DATA_ID_CHANNEL_LONG_TITLE = 249,
    DATA_ID_ANIMATIONS_DURATION = 250,
    DATA_ID_SLOT1_INFO = 251,
    DATA_ID_SLOT2_INFO = 252,
    DATA_ID_SLOT3_INFO = 253,
    DATA_ID_SLOT1_TEST_RESULT = 254,
    DATA_ID_SLOT2_TEST_RESULT = 255,
    DATA_ID_SLOT3_TEST_RESULT = 256,
    DATA_ID_SLOT_DEFAULT1_VIEW = 257,
    DATA_ID_SLOT_DEFAULT2_VIEW = 258,
    DATA_ID_SLOT_DEFAULT3_VIEW = 259,
    DATA_ID_SLOT1_CHANNEL_INDEX = 260,
    DATA_ID_SLOT2_CHANNEL_INDEX = 261,
    DATA_ID_SLOT3_CHANNEL_INDEX = 262,
    DATA_ID_SLOT_DEF_2CH_VIEW = 263,
    DATA_ID_SLOT_MAX_2CH_VIEW = 264,
    DATA_ID_SLOT_MIN_2CH_VIEW = 265,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 266,
    DATA_ID_SLOT_2CH_CH1_INDEX = 267,
    DATA_ID_SLOT_2CH_CH2_INDEX = 268,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 269,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 270,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 271,
    DATA_ID_BATTERY = 272,
    DATA_ID_IO_PIN_STATE = 273,
    DATA_ID_CHANNEL_DPROG = 274,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 275,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 276,
    DATA_ID_SYS_INFO_HAS_ERROR = 277,
    ...
    DATA_ID_DLOG_STATE = 294,
    DATA_ID_DLOG_TOGGLE_STATE = 295,
    DATA_ID_RECORDING = 296,
    DATA_ID_CHANNEL_HISTORY_VALUES = 297,
    DATA_ID_RECORDING_READY = 298,
    DATA_ID_NONDRAG_OVERLAY = 299,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 300,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 301,
    DATA_ID_DLOG_VISIBLE_VALUES = 302,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 303,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 304,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 305,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 306,
    DATA_ID_DLOG_ALL_VALUES = 307,
    DATA_ID_DLOG_VALUE_LABEL = 308,
    ...
    DATA_ID_DEBUG_TRACE_LOG = 345,
    DATA_ID_DEBUG_TRACE_LOG_LINE = 346,
    DATA_ID_KEYPAD_OK_ENABLED = 347,
    DATA_ID_ETHERNET_HOST_NAME = 348,
    DATA_ID_MQTT_HOST = 349,
    DATA_ID_MQTT_PORT = 350,
    DATA_ID_MQTT_USERNAME = 351,
    DATA_ID_MQTT_PASSWORD = 352,
    DATA_ID_MQTT_PERIOD = 353,
    DATA_ID_DEBUG_TRACE_LOG_IS_STOPPED = 354,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 355,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 356,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 357,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 358,
    DATA_ID_LIST_COUNTER_LABEL = 359,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 360,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 361,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 362,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 363,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 364,
    DATA_ID_IS_RESET_BY_IWDG = 365,
    DATA_ID_DLOG_ENABLED = 366,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 367,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 368,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 369,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 370,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 371
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SIMULATOR_LOAD = 158,
    ACTION_ID_SELECT_THEME = 159,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 160,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 161,
    ACTION_ID_RESTART = 162,
    ACTION_ID_USER_SWITCH_CLICKED = 163,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 164,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 165,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 166,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 167,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 168,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 169,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 170,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 171,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 172,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 173,
    ACTION_ID_SET_COUPLING_PARALLEL = 174,
    ACTION_ID_SET_COUPLING_SERIES = 175,
    ACTION_ID_SET_COUPLING_COMMON_GND = 176,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 177,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 178,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 179,
    ACTION_ID_DRAG_OVERLAY = 180,
    ACTION_ID_DLOG_TOGGLE = 181,
    ACTION_ID_SHOW_DLOG_VIEW = 182,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 183,
    ACTION_ID_SHOW_FILE_MANAGER = 184,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 185,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT_DIRECTORY = 186,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 187,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 188,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 189,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 190,
    ACTION_ID_SHOW_DLOG_PARAMS = 191,
    ACTION_ID_DLOG_VOLTAGE_TOGGLE = 192,
    ACTION_ID_DLOG_CURRENT_TOGGLE = 193,
    ACTION_ID_DLOG_POWER_TOGGLE = 194,
    ACTION_ID_DLOG_VALUE_TOGGLE = 195,
    ACTION_ID_DLOG_EDIT_PERIOD = 196,
    ACTION_ID_DLOG_EDIT_DURATION = 197,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 198,
    ACTION_ID_DLOG_START_RECORDING = 199,
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 200,
    ACTION_ID_FILE_MANAGER_SORT_BY = 201,
    ACTION_ID_DLOG_AUTO_SCALE = 202,
    ACTION_ID_SHOW_DEBUG_TRACE_LOG = 203,
    ACTION_ID_DLOG_UPLOAD = 204,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 205,
    ACTION_ID_MQTT_EDIT_HOST = 206,
    ACTION_ID_MQTT_EDIT_PORT = 207,
    ACTION_ID_MQTT_EDIT_USERNAME = 208,
    ACTION_ID_MQTT_EDIT_PASSWORD = 209,
    ACTION_ID_MQTT_EDIT_PERIOD = 210,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 211,
    ACTION_ID_DEBUG_TRACE_LOG_TOGGLE = 212,
    ACTION_ID_DLOG_SCALE_TO_FIT = 213,
    ACTION_ID_DLOG_VIEW_TOGGLE_LEGEND = 214,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 215,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 216,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 217,
    ACTION_ID_SHUTDOWN = 218,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 219,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 220,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 221,
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[393571];
#else
