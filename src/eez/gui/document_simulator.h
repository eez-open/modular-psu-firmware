enum DataEnum {
    ...
    DATA_ID_EVENT_QUEUE_MULTIPLE_PAGES = 108,
    DATA_ID_EVENT_QUEUE_PREVIOUS_PAGE_ENABLED = 109,
    DATA_ID_EVENT_QUEUE_NEXT_PAGE_ENABLED = 110,
    DATA_ID_EVENT_QUEUE_PAGE_INFO = 111,
    DATA_ID_CHANNEL_RSENSE_STATUS = 112,
    DATA_ID_CHANNEL_RPROG_INSTALLED = 113,
    DATA_ID_CHANNEL_RPROG_STATUS = 114,
    DATA_ID_CHANNEL_TRACKING_IS_ENABLED = 115,
    DATA_ID_CHANNEL_TRACKING_IS_ALLOWED = 116,
    DATA_ID_CHANNEL_IS_PAR_SER_COUPLED_OR_TRACKED = 117,
    DATA_ID_COUPLING_TYPE = 118,
    DATA_ID_CHANNEL_COUPLING_IS_SERIES = 119,
    DATA_ID_SYS_ON_TIME_TOTAL = 120,
    DATA_ID_SYS_ON_TIME_LAST = 121,
    DATA_ID_SYS_TEMP_AUX_STATUS = 122,
    DATA_ID_SYS_TEMP_AUX_OTP_STATE = 123,
    DATA_ID_SYS_TEMP_AUX_OTP_LEVEL = 124,
    DATA_ID_SYS_TEMP_AUX_OTP_DELAY = 125,
    DATA_ID_SYS_TEMP_AUX_OTP_IS_TRIPPED = 126,
    DATA_ID_SYS_TEMP_AUX = 127,
    DATA_ID_SYS_INFO_FIRMWARE_VER = 128,
    DATA_ID_SYS_INFO_SERIAL_NO = 129,
    DATA_ID_SYS_INFO_SCPI_VER = 130,
    DATA_ID_SYS_INFO_CPU = 131,
    DATA_ID_SYS_INFO_FAN_STATUS = 132,
    DATA_ID_SYS_INFO_FAN_SPEED = 133,
    DATA_ID_CHANNEL_BOARD_INFO_LABEL = 134,
    DATA_ID_CHANNEL_BOARD_INFO_REVISION = 135,
    DATA_ID_DATE_TIME_DATE = 136,
    DATA_ID_DATE_TIME_YEAR = 137,
    DATA_ID_DATE_TIME_MONTH = 138,
    DATA_ID_DATE_TIME_DAY = 139,
    DATA_ID_DATE_TIME_TIME = 140,
    DATA_ID_DATE_TIME_HOUR = 141,
    DATA_ID_DATE_TIME_MINUTE = 142,
    DATA_ID_DATE_TIME_SECOND = 143,
    DATA_ID_DATE_TIME_TIME_ZONE = 144,
    DATA_ID_DATE_TIME_DST = 145,
    DATA_ID_SET_PAGE_DIRTY = 146,
    DATA_ID_PROFILES_LIST = 147,
    ...
    DATA_ID_MQTT_ENABLED = 159,
    DATA_ID_ETHERNET_STATUS = 160,
    ...
    DATA_ID_CHANNEL_LIST_INDEX = 195,
    DATA_ID_CHANNEL_LIST_DWELL = 196,
    DATA_ID_CHANNEL_LIST_DWELL_ENABLED = 197,
    DATA_ID_CHANNEL_LIST_VOLTAGE = 198,
    DATA_ID_CHANNEL_LIST_VOLTAGE_ENABLED = 199,
    DATA_ID_CHANNEL_LIST_CURRENT = 200,
    DATA_ID_CHANNEL_LIST_CURRENT_ENABLED = 201,
    DATA_ID_CHANNEL_LISTS_PREVIOUS_PAGE_ENABLED = 202,
    DATA_ID_CHANNEL_LISTS_NEXT_PAGE_ENABLED = 203,
    DATA_ID_CHANNEL_LISTS_CURSOR = 204,
    DATA_ID_CHANNEL_LISTS_INSERT_MENU_ENABLED = 205,
    DATA_ID_CHANNEL_LISTS_DELETE_MENU_ENABLED = 206,
    DATA_ID_CHANNEL_LISTS_DELETE_ROW_ENABLED = 207,
    DATA_ID_CHANNEL_LISTS_CLEAR_COLUMN_ENABLED = 208,
    DATA_ID_CHANNEL_LISTS_DELETE_ROWS_ENABLED = 209,
    DATA_ID_TRIGGER_SOURCE = 210,
    DATA_ID_TRIGGER_DELAY = 211,
    DATA_ID_TRIGGER_INITIATE_CONTINUOUSLY = 212,
    DATA_ID_TRIGGER_IS_INITIATED = 213,
    DATA_ID_TRIGGER_IS_MANUAL = 214,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 215,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 216,
    DATA_ID_CHANNEL_RANGES_MODE = 217,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 218,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 219,
    DATA_ID_TEXT_MESSAGE = 220,
    DATA_ID_SERIAL_STATUS = 221,
    DATA_ID_SERIAL_ENABLED = 222,
    DATA_ID_SERIAL_IS_CONNECTED = 223,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 224,
    DATA_ID_IO_PINS = 225,
    DATA_ID_IO_PINS_INHIBIT_STATE = 226,
    DATA_ID_IO_PIN_NUMBER = 227,
    DATA_ID_IO_PIN_POLARITY = 228,
    DATA_ID_IO_PIN_FUNCTION = 229,
    DATA_ID_NTP_ENABLED = 230,
    DATA_ID_NTP_SERVER = 231,
    DATA_ID_ASYNC_OPERATION_THROBBER = 232,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 233,
    DATA_ID_PROGRESS = 234,
    DATA_ID_MAIN_APP_VIEW = 235,
    DATA_ID_TOUCH_CALIBRATION_POINT = 236,
    DATA_ID_SIMULATOR_LOAD_STATE = 237,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 238,
    DATA_ID_SIMULATOR_LOAD = 239,
    DATA_ID_SIMULATOR_LOAD2 = 240,
    DATA_ID_SELECTED_THEME = 241,
    DATA_ID_CHANNEL_TITLE = 242,
    DATA_ID_CHANNEL_SHORT_TITLE = 243,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 244,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 245,
    DATA_ID_CHANNEL_LONG_TITLE = 246,
    DATA_ID_ANIMATIONS_DURATION = 247,
    DATA_ID_SLOT1_INFO = 248,
    DATA_ID_SLOT2_INFO = 249,
    DATA_ID_SLOT3_INFO = 250,
    DATA_ID_SLOT1_TEST_RESULT = 251,
    DATA_ID_SLOT2_TEST_RESULT = 252,
    DATA_ID_SLOT3_TEST_RESULT = 253,
    DATA_ID_SLOT_DEFAULT1_VIEW = 254,
    DATA_ID_SLOT_DEFAULT2_VIEW = 255,
    DATA_ID_SLOT_DEFAULT3_VIEW = 256,
    DATA_ID_SLOT1_CHANNEL_INDEX = 257,
    DATA_ID_SLOT2_CHANNEL_INDEX = 258,
    DATA_ID_SLOT3_CHANNEL_INDEX = 259,
    DATA_ID_SLOT_DEF_2CH_VIEW = 260,
    DATA_ID_SLOT_MAX_2CH_VIEW = 261,
    DATA_ID_SLOT_MIN_2CH_VIEW = 262,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 263,
    DATA_ID_SLOT_2CH_CH1_INDEX = 264,
    DATA_ID_SLOT_2CH_CH2_INDEX = 265,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 266,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 267,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 268,
    DATA_ID_BATTERY = 269,
    DATA_ID_IO_PIN_STATE = 270,
    DATA_ID_CHANNEL_DPROG = 271,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 272,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 273,
    DATA_ID_SYS_INFO_HAS_ERROR = 274,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 275,
    DATA_ID_SYS_FAN_MODE = 276,
    DATA_ID_SYS_FAN_SPEED = 277,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 278,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 279,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 280,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 281,
    DATA_ID_IS_TRACKING_ALLOWED = 282,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 283,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 284,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 285,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 286,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 287,
    DATA_ID_IS_COUPLED_OR_TRACKED = 288,
    DATA_ID_OVERLAY = 289,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 290,
    DATA_ID_DLOG_STATE = 291,
    DATA_ID_DLOG_TOGGLE_STATE = 292,
    DATA_ID_RECORDING = 293,
    DATA_ID_CHANNEL_HISTORY_VALUES = 294,
    DATA_ID_RECORDING_READY = 295,
    DATA_ID_NONDRAG_OVERLAY = 296,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 297,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 298,
    DATA_ID_DLOG_VISIBLE_VALUES = 299,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 300,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 301,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 302,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 303,
    DATA_ID_DLOG_ALL_VALUES = 304,
    DATA_ID_DLOG_VALUE_LABEL = 305,
    DATA_ID_DLOG_CURRENT_TIME = 306,
    DATA_ID_DLOG_FILE_LENGTH = 307,
    DATA_ID_DLOG_X_AXIS_OFFSET = 308,
    DATA_ID_DLOG_X_AXIS_DIV = 309,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 310,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 311,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 312,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 313,
    DATA_ID_DLOG_VIEW_STATE = 314,
    DATA_ID_DLOG_PERIOD = 315,
    DATA_ID_DLOG_DURATION = 316,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 317,
    DATA_ID_DLOG_CURRENT_ENABLED = 318,
    DATA_ID_DLOG_POWER_ENABLED = 319,
    DATA_ID_DLOG_START_ENABLED = 320,
    DATA_ID_DLOG_FILE_NAME = 321,
    DATA_ID_DLOG_VALUE_STATE = 322,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 323,
    DATA_ID_CHANNEL_OFF_LABEL = 324,
    DATA_ID_FILE_MANAGER_FILES = 325,
    DATA_ID_FILE_MANAGER_FILE_NAME = 326,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 327,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 328,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 329,
    DATA_ID_FILE_MANAGER_STATE = 330,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 331,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 332,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 333,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 334,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 335,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 336,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 337,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 338,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 339,
    DATA_ID_SCRIPT_INFO = 340,
    DATA_ID_SCRIPT_IS_STARTED = 341,
    ...
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 349,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 350,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 351,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 352,
    DATA_ID_LIST_COUNTER_LABEL = 353,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 354,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 355,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 356,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 357,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 358,
    DATA_ID_IS_RESET_BY_IWDG = 359,
    DATA_ID_DLOG_ENABLED = 360,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 361,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 362,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 363,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 364,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 365
};
...
enum StylesEnum {
    ...
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 67,
    STYLE_ID_BOTTOM_BUTTON_DISABLED = 68,
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[392928];
#else
extern const uint8_t assets[3862696];
#endif
