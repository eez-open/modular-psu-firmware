enum DataEnum {
    ...
    DATA_ID_TRIGGER_IS_MANUAL = 203,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 204,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 205,
    DATA_ID_CHANNEL_RANGES_MODE = 206,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 207,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 208,
    DATA_ID_TEXT_MESSAGE = 209,
    DATA_ID_SERIAL_STATUS = 210,
    DATA_ID_SERIAL_IS_CONNECTED = 211,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 212,
    DATA_ID_CHANNEL_RAMP_COUNTDOWN = 213,
    DATA_ID_IO_PINS = 214,
    DATA_ID_IO_PINS_INHIBIT_STATE = 215,
    DATA_ID_IO_PIN_NUMBER = 216,
    DATA_ID_IO_PIN_POLARITY = 217,
    DATA_ID_IO_PIN_FUNCTION_NAME = 218,
    DATA_ID_NTP_ENABLED = 219,
    DATA_ID_NTP_SERVER = 220,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 221,
    DATA_ID_PROGRESS = 222,
    DATA_ID_TOUCH_CALIBRATION_POINT = 223,
    DATA_ID_SELECTED_THEME = 224,
    DATA_ID_CHANNEL_TITLE = 225,
    DATA_ID_CHANNEL_SHORT_TITLE = 226,
    ...
    DATA_ID_DLOG_CURRENT_TIME = 273,
    DATA_ID_DLOG_FILE_LENGTH = 274,
    DATA_ID_DLOG_X_AXIS_OFFSET = 275,
    DATA_ID_DLOG_X_AXIS_DIV = 276,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 277,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 278,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 279,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 280,
    DATA_ID_DLOG_VIEW_STATE = 281,
    DATA_ID_DLOG_PERIOD = 282,
    DATA_ID_DLOG_DURATION = 283,
    DATA_ID_DLOG_FILE_NAME = 284,
    DATA_ID_CHANNEL_OFF_LABEL = 285,
    DATA_ID_FILE_MANAGER_FILES = 286,
    DATA_ID_FILE_MANAGER_FILE_NAME = 287,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 288,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 289,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 290,
    DATA_ID_FILE_MANAGER_STATE = 291,
    DATA_ID_FILE_MANAGER_HAS_PARENT = 292,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 293,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 294,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 295,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 296,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 297,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 298,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 299,
    DATA_ID_SCRIPT_INFO = 300,
    DATA_ID_SCRIPT_IS_STARTED = 301,
    DATA_ID_KEYPAD_OK_ENABLED = 302,
    DATA_ID_ETHERNET_HOST_NAME = 303,
    DATA_ID_MQTT_HOST = 304,
    DATA_ID_MQTT_PORT = 305,
    DATA_ID_MQTT_USERNAME = 306,
    DATA_ID_MQTT_PASSWORD = 307,
    DATA_ID_MQTT_PERIOD = 308,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 309,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 310,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 311,
    DATA_ID_LIST_COUNTER_LABEL = 312,
    DATA_ID_RAMP_COUNTER_LABEL = 313,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 314,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 315,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 316,
    DATA_ID_IS_RESET_BY_IWDG = 317,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 318,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 319,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 320,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 321,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 322,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 323,
    DATA_ID_DATE_TIME_FORMAT = 324,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 325,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 326,
    DATA_ID_DATE_TIME_AM_PM = 327,
    DATA_ID_IS_MULTI_TRACKING = 328,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 329,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 330,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 331,
    DATA_ID_CHANNEL_INFO_BRAND = 332,
    DATA_ID_CHANNEL_INFO_SERIAL = 333,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 334,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 335,
    DATA_ID_FILE_MANAGER_FILE_ICON = 336,
    DATA_ID_FILE_MANAGER_LAYOUT = 337,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 338,
    DATA_ID_TOUCH_RAW_X = 339,
    DATA_ID_TOUCH_RAW_Y = 340,
    DATA_ID_TOUCH_RAW_Z1 = 341,
    DATA_ID_TOUCH_RAW_PRESSED = 342,
    DATA_ID_TOUCH_CALIBRATED_X = 343,
    DATA_ID_TOUCH_CALIBRATED_Y = 344,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 345,
    DATA_ID_TOUCH_FILTERED_X = 346,
    DATA_ID_TOUCH_FILTERED_Y = 347,
    DATA_ID_TOUCH_FILTERED_PRESSED = 348,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 349,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 350,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 351,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 352,
    DATA_ID_ALERT_MESSAGE_IS_SET = 353,
    DATA_ID_ASYNC_PROGRESS = 354,
    DATA_ID_IO_PIN_FUNCTION = 355,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 356,
    DATA_ID_IO_PIN_PWM_DUTY = 357,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 358,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 359,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 360,
    DATA_ID_CHANNEL_RAMP_STATE = 361,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 362,
    DATA_ID_MQTT_IN_ERROR = 363,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 364,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 365,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 366,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 367,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 368,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 369,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 370,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 371,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 372,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 373,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 374,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 375,
    DATA_ID_SLOTS = 376,
    DATA_ID_SLOT_INDEX = 377,
    DATA_ID_SLOT_TITLE_DEF = 378,
    DATA_ID_SLOT_TITLE_MAX = 379,
    DATA_ID_SLOT_TITLE_MIN = 380,
    DATA_ID_SLOT_TITLE_MICRO = 381,
    DATA_ID_SLOT_TITLE_SETTINGS = 382,
    DATA_ID_SLOT_ERROR_MESSAGE = 383,
    DATA_ID_USB_MODE = 384,
    DATA_ID_USB_CURRENT_MODE = 385,
    DATA_ID_USB_DEVICE_CLASS = 386,
    DATA_ID_USB_KEYBOARD_STATE = 387,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 388,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 389,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 390,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 391,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 392,
    DATA_ID_SLOT_SERIAL_INFO = 393,
    DATA_ID_SLOT_IS_ENABLED = 394,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 395,
    DATA_ID_USER_SWITCH_ACTION = 396,
    DATA_ID_NTP_REFRESH_FREQUENCY = 397,
    DATA_ID_CHANNEL_CALIBRATION_IS_POWER_CHANNEL = 398,
    DATA_ID_HAS_CUSTOM_BITMAP = 399,
    DATA_ID_CUSTOM_BITMAP = 400,
    DATA_ID_SLOT_INFO_WITH_FW_VER = 401,
    DATA_ID_MASTER_INFO_WITH_FW_VER = 402,
    DATA_ID_SLOT1_LABELS_AND_COLORS_VIEW = 403,
    DATA_ID_SLOT2_LABELS_AND_COLORS_VIEW = 404,
    DATA_ID_SLOT3_LABELS_AND_COLORS_VIEW = 405,
    DATA_ID_COLORS = 406,
    DATA_ID_KEYPAD_CAN_SET_DEFAULT = 407,
    DATA_ID_LABELS_AND_COLORS_PAGE_SLOT_TITLE = 408,
    DATA_ID_LABELS_AND_COLORS_PAGE_CHANNEL_TITLE = 409,
    DATA_ID_LABELS_AND_COLORS_IS_COLOR_MODIFIED = 410,
    DATA_ID_DLOG_ITEMS = 411,
    DATA_ID_DLOG_ITEM_IS_CHECKED = 412,
    DATA_ID_DLOG_ITEM_CHANNEL = 413,
    DATA_ID_DLOG_ITEM_LABEL = 414,
    DATA_ID_DLOG_ITEMS_SCROLLBAR_ENABLED = 415,
    DATA_ID_DLOG_ITEMS_NUM_SELECTED = 416,
    DATA_ID_DLOG_START_ENABLED = 417,
    DATA_ID_HAS_MULTIPLE_DISK_DRIVES = 418,
    DATA_ID_SELECTED_MASS_STORAGE_DEVICE = 419,
    DATA_ID_FILE_MANAGER_IS_SORT_FILES_OPTION_AVAILABLE = 420,
    DATA_ID_DLOG_PREVIEW_OVERLAY = 421,
    DATA_ID_DLOG_ITEM_IS_AVAILABLE = 422,
    DATA_ID_MODULE_IS_RESYNC_SUPPORTED = 423,
    DATA_ID_CHANNEL_IS_CALIBRATION_VALUE_SOURCE = 424,
    DATA_ID_CALIBRATION_POINT_CAN_EDIT_SET_VALUE = 425,
    DATA_ID_CALIBRATION_POINT_LIVE_MEASURED_VALUE = 426,
    DATA_ID_AC_MAINS = 427,
    DATA_ID_SELECTED_MCU_REVISION = 428,
    DATA_ID_IS_MCU_REVISION_SELECTED = 429,
    DATA_ID_SLOT_IS_2CH_VIEW = 430,
...
enum ActionsEnum {
    ...
    ACTION_ID_DIB_PREL6_TOGGLE_RELAY = 260,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 261,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 262,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 263,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 264,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 265,
    ACTION_ID_DIB_SMX46_SHOW_DAC1_CALIBRATION = 266,
    ACTION_ID_DIB_SMX46_SHOW_DAC2_CALIBRATION = 267,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 268,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 269,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 270,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 271,
    ACTION_ID_DIB_SMX46_CHANGE_SUBCHANNEL_LABEL = 272,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 273,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 274,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 275,
    ACTION_ID_SIMULATOR_LOAD = 276,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 277,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 278
};
...
enum StylesEnum {
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 209,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 210,
    STYLE_ID_SCROLLBAR_TRACK = 211,
    ...
    STYLE_ID_LABELS_AND_COLORS_SLOT = 260,
    STYLE_ID_INLINE261 = 261,
    STYLE_ID_INLINE262 = 262,
    STYLE_ID_FRONT_PANEL_MODULE = 263,
    ...
    STYLE_ID_MON_VALUE_38_RIGHT = 320,
    STYLE_ID_INLINE321 = 321,
    STYLE_ID_CH_PROT_OFF = 322,
    STYLE_ID_CH_PROT_ON = 323,
    STYLE_ID_CH_PROT_TRIPPED = 324,
    STYLE_ID_INLINE325 = 325,
    STYLE_ID_MON_VALUE_20_RIGHT = 326,
    STYLE_ID_MON_VALUE_14_LEFT = 327,
    STYLE_ID_MON_VALUE_14_CENTER = 328,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 329,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 330,
    STYLE_ID_MON_VALUE_14_RIGHT = 331,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 332,
    STYLE_ID_MON_VALUE_24_RIGHT = 333,
...
enum PagesEnum {
    ...
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 144,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 145,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL = 146,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 147,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 148,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 149,
    ...
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 155,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON = 156,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON_2COL = 157,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON = 158,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON_2COL = 159,
    PAGE_ID_DIB_DCP405_LABELS_AND_COLORS = 160,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF = 161,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF_2COL = 162,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 163,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES_2COL = 164,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 165,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL_2COL = 166,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON = 167,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON_2COL = 168,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON = 169,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON_2COL = 170,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF = 171,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF_2COL = 172,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 173,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES_2COL = 174,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 175,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL_2COL = 176,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_TITLE = 177,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_ON = 178,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_OFF = 179,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_ON = 180,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_OFF = 181,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_ON = 182,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_OFF = 183,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_TITLE = 184,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_ON = 185,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_OFF = 186,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_SERIES = 187,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_PARALLEL = 188,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_TITLE = 189,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_ON = 190,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_OFF = 191,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_COUPLED_SERIES = 192,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_COUPLED_PARALLEL = 193,
    ...
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH = 230,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_WITH_BORDER = 231,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_TITLE = 232,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_ON = 233,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_OFF = 234,
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS = 235,
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS_CH = 236,
    PAGE_ID_FRONT_PANEL = 237,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 238,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 239,
    PAGE_ID_DIB_DCM224_SIMULATOR_FRONT_PANEL_MASK = 240,
    PAGE_ID_DIB_DCM224_FRONT_PANEL_LED = 241,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ADV_OPTIONS = 242,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT = 243,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_WITH_BORDER = 244,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON = 245,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF = 246,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_2COL = 247,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_WITH_BORDER_2COL = 248,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON_2COL = 249,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF_2COL = 250,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ = 251,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_WITH_BORDER = 252,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON = 253,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF = 254,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_2COL = 255,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_WITH_BORDER_2COL = 256,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON_2COL = 257,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF_2COL = 258,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH = 259,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_WITH_BORDER = 260,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_WITH_BORDER_MIN = 261,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_TITLE = 262,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_ON = 263,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_OFF = 264,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_ON = 265,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_OFF = 266,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_TITLE = 267,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_ON = 268,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_OFF = 269,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_ON = 270,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_OFF = 271,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH = 272,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_WITH_BORDER = 273,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_TITLE = 274,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_ON = 275,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_OFF = 276,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH = 277,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_WITH_BORDER = 278,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_TITLE = 279,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_ON = 280,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_OFF = 281,
    PAGE_ID_DIB_DCM224_LABELS_AND_COLORS = 282,
    PAGE_ID_DIB_DCM224_LABELS_AND_COLORS_CH = 283
};

extern const uint8_t assets[546995];
