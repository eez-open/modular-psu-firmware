enum DataEnum {
    ...
    DATA_ID_DIB_MIO168_SIMULATOR_AFE_VERSION = 583,
    DATA_ID_DIB_MIO168_IS_SETTINGS_PAGE_SELECTED = 584,
    DATA_ID_DIB_PREL6_RELAYS = 585,
    DATA_ID_DIB_PREL6_RELAY_IS_ON = 586,
    DATA_ID_DIB_PREL6_RELAY_LABEL = 587,
    DATA_ID_DIB_PREL6_RELAY_CYCLES = 588,
    DATA_ID_DIB_PREL6_RELAY_LABEL_LABEL = 589,
    DATA_ID_DIB_PREL6_IS_RELAY_1_OR_6 = 590,
    DATA_ID_DIB_SMX46_ROUTES = 591,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 592,
    DATA_ID_DIB_SMX46_X_LABELS = 593,
    DATA_ID_DIB_SMX46_X_LABEL = 594,
    DATA_ID_DIB_SMX46_Y_LABELS = 595,
    DATA_ID_DIB_SMX46_Y_LABEL = 596,
    DATA_ID_DIB_SMX46_AOUT_CHANNELS = 597,
    DATA_ID_DIB_SMX46_AOUT_VALUE = 598,
    DATA_ID_DIB_SMX46_AOUT_LABEL = 599,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_MODE = 600,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_IS_INITIATED = 601,
    DATA_ID_DIB_SMX46_AOUT_FUNCTION_LABEL = 602,
    DATA_ID_DIB_SMX46_RELAY_ON = 603,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 604,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 605,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 606,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 607,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 608,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 609,
    DATA_ID_SIMULATOR_LOAD_STATE = 610,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 611,
    DATA_ID_SIMULATOR_LOAD = 612,
    DATA_ID_SIMULATOR_LOAD2 = 613,
    DATA_ID_MAIN_APP_VIEW = 614,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 615,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 616,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 617,
    DATA_ID_DIB_DCM224_PWM_DUTY = 618,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 619,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 620,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 621,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 622,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 623,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 624,
...
enum ActionsEnum {
    ...
    ACTION_ID_DIB_MIO168_SELECT_SIMULATOR_AFE_VERSION = 312,
    ACTION_ID_DIB_MIO168_SHOW_SLOT_SETTINGS_IN_MAX_VIEW = 313,
    ACTION_ID_DIB_MIO168_SELECT_PAGE_IN_DEFAULT_VIEW = 314,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_AC_ANALYSIS = 315,
    ACTION_ID_DIB_PREL6_TOGGLE_RELAY = 316,
    ACTION_ID_DIB_PREL6_SHOW_RELAY_LABELS = 317,
    ACTION_ID_DIB_PREL6_CHANGE_RELAY_LABEL = 318,
    ACTION_ID_DIB_PREL6_SHOW_INFO = 319,
    ...
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 334,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 335,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 336,
    ACTION_ID_SIMULATOR_LOAD = 337,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 338,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 339,
...
enum StylesEnum {
    ...
    STYLE_ID_FRONT_PANEL_MODULE = 298,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 386,
    STYLE_ID_INLINE387 = 387,
    STYLE_ID_MON_VALUE_20_LEFT = 388,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 389,
    STYLE_ID_BAR_GRAPH_TEXT = 390,
    STYLE_ID_BAR_GRAPH_SET_LINE = 391,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 392,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 393,
    STYLE_ID_LABELS_AND_COLORS_CHANNEL = 394,
    STYLE_ID_INLINE395 = 395,
    STYLE_ID_TRIGGER_BUTTON_24 = 396,
    STYLE_ID_INLINE397 = 397,
    STYLE_ID_INLINE398 = 398,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 399,
    STYLE_ID_INLINE400 = 400,
    STYLE_ID_CH_PROT_OFF = 401,
    STYLE_ID_CH_PROT_ON = 402,
    STYLE_ID_CH_PROT_TRIPPED = 403,
    STYLE_ID_INLINE404 = 404,
    STYLE_ID_INLINE405 = 405,
    STYLE_ID_MON_VALUE_38_RIGHT = 406,
    STYLE_ID_MON_VALUE_14_RIGHT = 407,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 408,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 409,
...
extern const uint8_t assets[628794];
