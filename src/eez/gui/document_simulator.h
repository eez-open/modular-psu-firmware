enum DataEnum {
    ...
    DATA_ID_KEYPAD_OPTION3_TEXT = 59,
    DATA_ID_KEYPAD_OPTION3_ENABLED = 60,
    DATA_ID_KEYPAD_SIGN_ENABLED = 61,
    DATA_ID_KEYPAD_DOT_ENABLED = 62,
    DATA_ID_KEYPAD_UNIT_ENABLED = 63,
    DATA_ID_CHANNEL_LABEL = 64,
    DATA_ID_CHANNEL_SHORT_LABEL = 65,
    DATA_ID_CHANNEL_TEMP_STATUS = 66,
    DATA_ID_CHANNEL_TEMP = 67,
    DATA_ID_CHANNEL_ON_TIME_TOTAL = 68,
    DATA_ID_CHANNEL_ON_TIME_LAST = 69,
    DATA_ID_CHANNEL_CALIBRATION_STATUS = 70,
    DATA_ID_CHANNEL_CALIBRATION_STATE = 71,
    DATA_ID_CHANNEL_CALIBRATION_DATE = 72,
    DATA_ID_CHANNEL_CALIBRATION_REMARK = 73,
    DATA_ID_CHANNEL_PROTECTION_STATUS = 74,
    DATA_ID_CHANNEL_PROTECTION_OVP_STATE = 75,
    DATA_ID_CHANNEL_PROTECTION_OVP_TYPE = 76,
    ...
    DATA_ID_EVENT_QUEUE_EVENTS = 93,
    DATA_ID_EVENT_QUEUE_EVENT_TYPE = 94,
    DATA_ID_EVENT_QUEUE_EVENT_MESSAGE = 95,
    DATA_ID_EVENT_QUEUE_SELECTED_EVENT_MESSAGE = 96,
    DATA_ID_CHANNEL_RSENSE_STATUS = 97,
    DATA_ID_CHANNEL_RPROG_INSTALLED = 98,
    DATA_ID_CHANNEL_RPROG_STATUS = 99,
    DATA_ID_CHANNEL_TRACKING_IS_ENABLED = 100,
    DATA_ID_CHANNEL_TRACKING_IS_ALLOWED = 101,
    DATA_ID_CHANNEL_IS_PAR_SER_COUPLED_OR_TRACKED = 102,
    DATA_ID_COUPLING_TYPE = 103,
    DATA_ID_CHANNEL_COUPLING_IS_SERIES = 104,
    DATA_ID_SYS_ON_TIME_TOTAL = 105,
    DATA_ID_SYS_ON_TIME_LAST = 106,
    DATA_ID_SYS_TEMP_AUX_STATUS = 107,
    DATA_ID_SYS_TEMP_AUX_OTP_STATE = 108,
    DATA_ID_SYS_TEMP_AUX_OTP_LEVEL = 109,
    DATA_ID_SYS_TEMP_AUX_OTP_DELAY = 110,
    DATA_ID_SYS_TEMP_AUX_OTP_IS_TRIPPED = 111,
    DATA_ID_SYS_TEMP_AUX = 112,
    DATA_ID_SYS_INFO_FIRMWARE_VER = 113,
    DATA_ID_SYS_INFO_SERIAL_NO = 114,
    DATA_ID_SYS_INFO_SCPI_VER = 115,
    DATA_ID_SYS_INFO_CPU = 116,
    DATA_ID_SYS_INFO_FAN_STATUS = 117,
    DATA_ID_SYS_INFO_FAN_SPEED = 118,
    DATA_ID_CHANNEL_BOARD_INFO_LABEL = 119,
    DATA_ID_CHANNEL_BOARD_INFO_REVISION = 120,
    DATA_ID_DATE_TIME_DATE = 121,
    DATA_ID_DATE_TIME_YEAR = 122,
    DATA_ID_DATE_TIME_MONTH = 123,
    DATA_ID_DATE_TIME_DAY = 124,
    DATA_ID_DATE_TIME_TIME = 125,
    DATA_ID_DATE_TIME_HOUR = 126,
    DATA_ID_DATE_TIME_MINUTE = 127,
    DATA_ID_DATE_TIME_SECOND = 128,
    DATA_ID_DATE_TIME_TIME_ZONE = 129,
    DATA_ID_DATE_TIME_DST = 130,
    DATA_ID_SET_PAGE_DIRTY = 131,
    DATA_ID_PROFILES_LIST = 132,
    DATA_ID_PROFILES_AUTO_RECALL_STATUS = 133,
    DATA_ID_PROFILES_AUTO_RECALL_LOCATION = 134,
    DATA_ID_PROFILE_STATUS = 135,
    DATA_ID_PROFILE_LABEL = 136,
    DATA_ID_PROFILE_REMARK = 137,
    DATA_ID_PROFILE_IS_AUTO_RECALL_LOCATION = 138,
    DATA_ID_PROFILE_CHANNEL_U_SET = 139,
    DATA_ID_PROFILE_CHANNEL_I_SET = 140,
    DATA_ID_PROFILE_CHANNEL_OUTPUT_STATE = 141,
    DATA_ID_ETHERNET_INSTALLED = 142,
    DATA_ID_ETHERNET_ENABLED = 143,
    DATA_ID_MQTT_ENABLED = 144,
    DATA_ID_ETHERNET_STATUS = 145,
    DATA_ID_ETHERNET_AND_MQTT_STATUS = 146,
    DATA_ID_MQTT_CONNECTION_STATE = 147,
    DATA_ID_ETHERNET_IP_ADDRESS = 148,
    DATA_ID_ETHERNET_DNS = 149,
    DATA_ID_ETHERNET_GATEWAY = 150,
    DATA_ID_ETHERNET_SUBNET_MASK = 151,
    DATA_ID_ETHERNET_SCPI_PORT = 152,
    DATA_ID_ETHERNET_IS_CONNECTED = 153,
    DATA_ID_ETHERNET_DHCP = 154,
    DATA_ID_ETHERNET_MAC = 155,
    DATA_ID_CHANNEL_IS_VOLTAGE_BALANCED = 156,
    DATA_ID_CHANNEL_IS_CURRENT_BALANCED = 157,
    ...
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE1 = 166,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE2 = 167,
    ...
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 226,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 227,
    DATA_ID_CHANNEL_LONG_TITLE = 228,
    DATA_ID_ANIMATIONS_DURATION = 229,
    DATA_ID_SLOT_INFO = 230,
    DATA_ID_SLOT_TEST_RESULT = 231,
    DATA_ID_SLOT1_DEFAULT_VIEW = 232,
    DATA_ID_SLOT2_DEFAULT_VIEW = 233,
    DATA_ID_SLOT3_DEFAULT_VIEW = 234,
    DATA_ID_SLOT1_CHANNEL_INDEX = 235,
    DATA_ID_SLOT2_CHANNEL_INDEX = 236,
    DATA_ID_SLOT3_CHANNEL_INDEX = 237,
    DATA_ID_BATTERY = 238,
    DATA_ID_IO_PIN_STATE = 239,
    DATA_ID_CHANNEL_DPROG = 240,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 241,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 242,
    DATA_ID_SYS_INFO_HAS_ERROR = 243,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 244,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 245,
    DATA_ID_SYS_FAN_MODE = 246,
    DATA_ID_SYS_FAN_SPEED = 247,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 248,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 249,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 250,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 251,
    DATA_ID_IS_TRACKING_ALLOWED = 252,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 253,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 254,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 255,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 256,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 257,
    DATA_ID_IS_COUPLED_OR_TRACKED = 258,
    DATA_ID_OVERLAY = 259,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 260,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 261,
    DATA_ID_DLOG_STATE = 262,
    DATA_ID_DLOG_TOGGLE_STATE = 263,
    DATA_ID_RECORDING = 264,
    DATA_ID_CHANNEL_HISTORY_VALUES = 265,
    DATA_ID_RECORDING_READY = 266,
    DATA_ID_NONDRAG_OVERLAY = 267,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 268,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 269,
    DATA_ID_DLOG_VISIBLE_VALUES = 270,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 271,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 272,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 273,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 274,
    DATA_ID_DLOG_ALL_VALUES = 275,
    ...
    DATA_ID_DLOG_VOLTAGE_ENABLED = 287,
    DATA_ID_DLOG_CURRENT_ENABLED = 288,
    DATA_ID_DLOG_POWER_ENABLED = 289,
    DATA_ID_DLOG_START_ENABLED = 290,
    DATA_ID_DLOG_FILE_NAME = 291,
    DATA_ID_DLOG_VALUE_STATE = 292,
    ...
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 300,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 301,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 302,
    ...
    DATA_ID_CHANNEL_SETTINGS_PAGE = 326,
    DATA_ID_IS_RESET_BY_IWDG = 327,
    DATA_ID_DLOG_ENABLED = 328,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 329,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 330,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 331,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 332,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 333,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 334,
    DATA_ID_DATE_TIME_FORMAT = 335,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 336,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 337,
    DATA_ID_DATE_TIME_AM_PM = 338,
    DATA_ID_IS_MULTI_TRACKING = 339,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 340,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 341,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 342,
    DATA_ID_CHANNEL_INFO_BRAND = 343,
    DATA_ID_CHANNEL_INFO_SERIAL = 344,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 345,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 346,
    DATA_ID_FILE_MANAGER_FILE_ICON = 347,
    DATA_ID_FILE_MANAGER_LAYOUT = 348,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 349,
    DATA_ID_TOUCH_RAW_X = 350,
    DATA_ID_TOUCH_RAW_Y = 351,
    DATA_ID_TOUCH_RAW_Z1 = 352,
    DATA_ID_TOUCH_RAW_PRESSED = 353,
    DATA_ID_TOUCH_CALIBRATED_X = 354,
    DATA_ID_TOUCH_CALIBRATED_Y = 355,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 356,
    DATA_ID_TOUCH_FILTERED_X = 357,
    DATA_ID_TOUCH_FILTERED_Y = 358,
    DATA_ID_TOUCH_FILTERED_PRESSED = 359,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 360,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 361,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 362,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 363,
    DATA_ID_ALERT_MESSAGE_IS_SET = 364,
    DATA_ID_ASYNC_PROGRESS = 365,
    DATA_ID_IO_PIN_FUNCTION = 366,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 367,
    DATA_ID_IO_PIN_PWM_DUTY = 368,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 369,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 370,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 371,
    DATA_ID_DEBUG_VARIABLES = 372,
    DATA_ID_DEBUG_VARIABLE_NAME = 373,
    DATA_ID_DEBUG_VARIABLE_VALUE = 374,
    DATA_ID_CHANNEL_RAMP_STATE = 375,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 376,
    DATA_ID_MQTT_IN_ERROR = 377,
    DATA_ID_DEBUG_I_DAC = 378,
    DATA_ID_DEBUG_U_DAC = 379,
    DATA_ID_DEBUG_I_DAC_AMPER = 380,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 381,
    DATA_ID_DEBUG_I_ADC = 382,
    DATA_ID_DEBUG_U_ADC = 383,
    DATA_ID_DEBUG_I_ADC_AMPER = 384,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 385,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 386,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 387,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 388,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 389,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 390,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 391,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 392,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 393,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 394,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 395,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 396,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 397,
    DATA_ID_DUMMY = 398,
    DATA_ID_SLOTS = 399,
    DATA_ID_SLOT_INDEX = 400,
    DATA_ID_SLOT_TITLE_DEF = 401,
    DATA_ID_SLOT_TITLE_MAX = 402,
    DATA_ID_SLOT_TITLE_MIN = 403,
    DATA_ID_SLOT_TITLE_MICRO = 404,
    DATA_ID_SLOT_TITLE_SETTINGS = 405,
    DATA_ID_SLOT_ERROR_MESSAGE = 406,
    DATA_ID_USB_MODE = 407,
    DATA_ID_USB_CURRENT_MODE = 408,
    DATA_ID_USB_DEVICE_CLASS = 409,
    DATA_ID_USB_KEYBOARD_STATE = 410,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 411,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 412,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 413,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 414,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 415,
    DATA_ID_SLOT_SERIAL_INFO = 416,
    DATA_ID_SLOT_IS_ENABLED = 417,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 418,
    DATA_ID_USER_SWITCH_ACTION = 419,
    DATA_ID_NTP_REFRESH_FREQUENCY = 420,
    DATA_ID_DIB_MIO168_DIN_PINS = 421,
    DATA_ID_DIB_MIO168_DIN_PINS_1_4 = 422,
    DATA_ID_DIB_MIO168_DIN_PINS_5_8 = 423,
    DATA_ID_DIB_MIO168_DIN_NO = 424,
    DATA_ID_DIB_MIO168_DIN_STATE = 425,
    DATA_ID_DIB_MIO168_DIN_RANGE = 426,
    DATA_ID_DIB_MIO168_DIN_SPEED = 427,
    DATA_ID_DIB_MIO168_DOUT_PINS = 428,
    DATA_ID_DIB_MIO168_DOUT_NO = 429,
    DATA_ID_DIB_MIO168_DOUT_STATE = 430,
    DATA_ID_DIB_MIO168_AIN_CHANNELS = 431,
    DATA_ID_DIB_MIO168_AIN_LABEL = 432,
    DATA_ID_DIB_MIO168_AIN_VALUE = 433,
    DATA_ID_DIB_MIO168_AIN_MODE = 434,
    DATA_ID_DIB_MIO168_AIN_RANGE = 435,
    DATA_ID_DIB_MIO168_AIN_HAS_TEMP_SENSOR_BIAS_FEATURE = 436,
    DATA_ID_DIB_MIO168_AIN_TEMP_SENSOR_BIAS = 437,
    DATA_ID_DIB_MIO168_AOUT_CHANNELS = 438,
    DATA_ID_DIB_MIO168_AOUT_LABEL = 439,
    DATA_ID_DIB_MIO168_AOUT_VALUE = 440,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_ENABLED = 441,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_MODE = 442,
    DATA_ID_DIB_MIO168_AOUT_VOLTAGE_RANGE = 443,
    DATA_ID_DIB_MIO168_AOUT_CURRENT_RANGE = 444,
    DATA_ID_DIB_MIO168_AOUT_CHANNEL_HAS_SETTINGS = 445,
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 446,
    DATA_ID_DIB_MIO168_PWM_LABEL = 447,
    DATA_ID_DIB_MIO168_PWM_FREQ = 448,
    DATA_ID_DIB_MIO168_PWM_DUTY = 449,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 450,
    DATA_ID_DIB_SMX46_ROUTES = 451,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 452,
    DATA_ID_DIB_SMX46_X_LABELS = 453,
    DATA_ID_DIB_SMX46_X_LABEL = 454,
    DATA_ID_DIB_SMX46_Y_LABELS = 455,
    DATA_ID_DIB_SMX46_Y_LABEL = 456,
    DATA_ID_DIB_SMX46_DAC1 = 457,
    DATA_ID_DIB_SMX46_DAC2 = 458,
    DATA_ID_DIB_SMX46_RELAY_ON = 459,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 460,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 461,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 462,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_VIEW = 463,
    DATA_ID_DIB_DCM220_SLOT_MIN_2CH_VIEW = 464,
    DATA_ID_DIB_DCM220_SLOT_MICRO_2CH_VIEW = 465,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 466,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 467,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_VIEW = 468,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 469,
    DATA_ID_SIMULATOR_LOAD_STATE = 470,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 471,
    DATA_ID_SIMULATOR_LOAD = 472,
    DATA_ID_SIMULATOR_LOAD2 = 473,
    DATA_ID_MAIN_APP_VIEW = 474,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 475,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 476,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 477,
    DATA_ID_DIB_DCM224_PWM_DUTY = 478,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 479,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 480,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 481,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 482,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_VIEW = 483,
    DATA_ID_DIB_DCM224_SLOT_MIN_2CH_VIEW = 484,
    DATA_ID_DIB_DCM224_SLOT_MICRO_2CH_VIEW = 485,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 486,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 487,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_VIEW = 488
};
...
enum ActionsEnum {
    ...
    ACTION_ID_EDIT_NTP_REFRESH_FREQUENCY = 227,
    ACTION_ID_KEYPAD_OPTION3 = 228,
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 229,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 230,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 231,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 232,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_TEMP_SENSOR_BIAS = 233,
    ACTION_ID_DIB_MIO168_AIN_SHOW_CONFIGURATION = 234,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE = 235,
    ACTION_ID_DIB_MIO168_AIN_SELECT_RANGE = 236,
    ACTION_ID_DIB_MIO168_AOUT_TOGGLE_OUTPUT_ENABLED = 237,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_OUTPUT_MODE = 238,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_VOLTAGE_RANGE = 239,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_CURRENT_RANGE = 240,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_CONFIGURATION = 241,
    ACTION_ID_DIB_MIO168_SHOW_INFO = 242,
    ACTION_ID_DIB_MIO168_SHOW_CALIBRATION = 243,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 244,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 245,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 246,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 247,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 248,
    ACTION_ID_DIB_SMX46_SHOW_DAC1_CALIBRATION = 249,
    ACTION_ID_DIB_SMX46_SHOW_DAC2_CALIBRATION = 250,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 251,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 252,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 253,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 254,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 255,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 256,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 257,
    ACTION_ID_SIMULATOR_LOAD = 258,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 259,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 260
};
...
enum StylesEnum {
    ...
    STYLE_ID_ENCODER_CURSOR_14_ENABLED_BALANCED = 39,
    STYLE_ID_ENCODER_CURSOR_14_DISABLED = 40,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED_BALANCED = 41,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_DISABLED = 42,
    STYLE_ID_ENCODER_CURSOR_17_ENABLED_BALANCED = 43,
    ...
    STYLE_ID_CHANNEL2 = 49,
    STYLE_ID_CHANNEL3 = 50,
    STYLE_ID_CHANNEL4 = 51,
    STYLE_ID_CHANNEL5 = 52,
    STYLE_ID_CHANNEL6 = 53,
    STYLE_ID_CHANNEL1_INVERSE = 54,
    STYLE_ID_CHANNEL2_INVERSE = 55,
    STYLE_ID_CHANNEL3_INVERSE = 56,
    STYLE_ID_CHANNEL4_INVERSE = 57,
    STYLE_ID_CHANNEL5_INVERSE = 58,
    STYLE_ID_CHANNEL6_INVERSE = 59,
    STYLE_ID_DEFAULT_M = 60,
    STYLE_ID_DEFAULT_M_WARNING = 61,
    STYLE_ID_VALUE_S = 62,
    STYLE_ID_TOUCH_CALIBRATION = 63,
    STYLE_ID_NOTE_M = 64,
    STYLE_ID_TOUCH_CALIBRATION_POINT = 65,
    STYLE_ID_BUTTON_BGND = 66,
    STYLE_ID_STATUS_ICON_ENABLED_WITH_NEED_ATTENTION = 67,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ERROR = 68,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ACTIVE = 69,
    STYLE_ID_STATUS_ICON_ENABLED_BLINK = 70,
    STYLE_ID_STATUS_ICON_DISABLED = 71,
    STYLE_ID_DLOG_RECORD_BUTTON = 72,
    STYLE_ID_STATUS_ICON_DISABLED_BLINK = 73,
    STYLE_ID_OVERLAY = 74,
    STYLE_ID_OVERLAY_LEFT = 75,
    STYLE_ID_OVERLAY_ICON = 76,
    STYLE_ID_EDIT_VALUE_S_LEFT = 77,
    STYLE_ID_BOTTOM_BUTTON_BACKGROUND = 78,
    STYLE_ID_BOTTOM_BUTTON = 79,
    STYLE_ID_VALUE_S_LEFT = 80,
    STYLE_ID_EDIT_VALUE_M_LEFT = 81,
    STYLE_ID_KEY_ICONS = 82,
    STYLE_ID_KEY = 83,
    STYLE_ID_KEY_DISABLED = 84,
    STYLE_ID_INLINE85 = 85,
    STYLE_ID_TAB_PAGE_SELECTED = 86,
    STYLE_ID_TAB_PAGE = 87,
    STYLE_ID_INLINE88 = 88,
    STYLE_ID_INLINE89 = 89,
    STYLE_ID_INLINE90 = 90,
    STYLE_ID_INLINE91 = 91,
    STYLE_ID_INLINE92 = 92,
    STYLE_ID_BUTTON_S = 93,
    ...
    STYLE_ID_PROGRESS = 108,
    STYLE_ID_ASYNC_OPERATION_ACTION = 109,
    ...
    STYLE_ID_DEFAULT_INVERSE = 117,
    STYLE_ID_SCROLLBAR_THUMB = 118,
    STYLE_ID_SCROLLBAR_BUTTON = 119,
    ...
    STYLE_ID_VALUE_M_LEFT = 138,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 139,
    STYLE_ID_INLINE140 = 140,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 141,
    STYLE_ID_ENCODER_CURSOR_17_ENABLED = 142,
    STYLE_ID_INLINE143 = 143,
    STYLE_ID_YT_GRAPH = 144,
    STYLE_ID_LIST_GRAPH_CURSOR = 145,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 146,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 147,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 148,
    STYLE_ID_INLINE149 = 149,
    STYLE_ID_INLINE150 = 150,
    STYLE_ID_INLINE151 = 151,
    STYLE_ID_EDIT_VALUE_M_CENTERED = 152,
    STYLE_ID_INLINE153 = 153,
    STYLE_ID_INLINE154 = 154,
    STYLE_ID_INLINE155 = 155,
    STYLE_ID_BUTTON_S_DISABLED = 156,
    STYLE_ID_INLINE157 = 157,
    STYLE_ID_INLINE158 = 158,
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 159,
    STYLE_ID_INLINE160 = 160,
    STYLE_ID_EVENT_ERROR = 161,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 162,
    STYLE_ID_INLINE163 = 163,
    STYLE_ID_ICON_AND_TEXT_S = 164,
    STYLE_ID_INLINE165 = 165,
    STYLE_ID_INLINE166 = 166,
    STYLE_ID_VALUE_M = 167,
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 221,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 222,
    STYLE_ID_SCROLLBAR_TRACK = 223,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 300,
    STYLE_ID_INLINE301 = 301,
    STYLE_ID_MON_VALUE_20_LEFT = 302,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 303,
    STYLE_ID_BAR_GRAPH_TEXT = 304,
    STYLE_ID_BAR_GRAPH_SET_LINE = 305,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 306,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 307,
    ...
    STYLE_ID_INST_SELECTED = 314,
    STYLE_ID_MON_VALUE_38_RIGHT = 315,
    STYLE_ID_INLINE316 = 316,
    STYLE_ID_CH_PROT_OFF = 317,
    STYLE_ID_CH_PROT_ON = 318,
    STYLE_ID_CH_PROT_TRIPPED = 319,
    STYLE_ID_INLINE320 = 320,
    STYLE_ID_MON_VALUE_20_RIGHT = 321,
    STYLE_ID_MON_VALUE_14_LEFT = 322,
    STYLE_ID_MON_VALUE_14_CENTER = 323,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 324,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 325,
    STYLE_ID_MON_VALUE_14_RIGHT = 326,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 327,
    STYLE_ID_MON_VALUE_24_RIGHT = 328,
...
enum ColorsEnum {
    ...
    COLOR_ID_TEXT_ENABLED_BALANCED = 3,
    COLOR_ID_TEXT_SELECTED = 4,
    COLOR_ID_TEXT_ENABLE_BACKGROUND = 5,
    COLOR_ID_STATUS_LINE_TEXT = 6,
    COLOR_ID_STATUS_LINE_TEXT_DISABLED = 7,
    COLOR_ID_TEXT_DISABLED_BACKGROUND = 8,
    COLOR_ID_STATUS_LINE_BACKGROUND = 9,
    COLOR_ID_STATUS_OK = 10,
    COLOR_ID_STATUS_WARNING = 11,
    COLOR_ID_INST_MAX_HEADER_BGND = 12,
    COLOR_ID_INST_MIN_HEADER_BGND = 13,
    COLOR_ID_INST_MAX_HEADER_TEXT = 14,
    COLOR_ID_INST_MIN_HEADER_TEXT = 15,
    COLOR_ID_TEXT_SELECTABLE_BACKGROUND = 16,
    COLOR_ID_PROTECTION_TEXT = 17,
    COLOR_ID_TEXT_DISABLED = 18,
    COLOR_ID_BAR_GRAPH_VOLTAGE = 19,
    COLOR_ID_BAR_GRAPH_CURRENT = 20,
    COLOR_ID_BAR_GRAPH_POWER = 21,
    COLOR_ID_BAR_GRAPH_BACKGROUND = 22,
    COLOR_ID_BAR_GRAPH_TEXT = 23,
    COLOR_ID_BAR_GRAPH_TEXT_INSIDE = 24,
    COLOR_ID_BAR_GRAPH_SET_LINE = 25,
    COLOR_ID_ACTION_COLOR = 26,
    COLOR_ID_POPUP_BACKGROUND_REGULAR = 27,
    COLOR_ID_POPUP_TEXT_SELECTED = 28,
    COLOR_ID_POPUP_BACKGROUND_WARNING = 29,
    COLOR_ID_POPUP_BACKGROUND_INFO = 30,
    COLOR_ID_TEXT_EDITED = 31,
    COLOR_ID_TEXT_VALUE = 32,
    COLOR_ID_DATA_LOGGING = 33,
    COLOR_ID_OVERLAY_BACKGROUND = 34,
    COLOR_ID_OVERLAY_DRAG_BACKGROUND = 35,
    COLOR_ID_OVERLAY_TEXT = 36,
    COLOR_ID_CHANNEL1 = 37,
    COLOR_ID_CHANNEL2 = 38,
    COLOR_ID_CHANNEL3 = 39,
    COLOR_ID_CHANNEL4 = 40,
    COLOR_ID_CHANNEL5 = 41,
    COLOR_ID_CHANNEL6 = 42,
    COLOR_ID_SCROLLBAR_TRACK = 43,
    COLOR_ID_SCROLLBAR_THUMB = 44,
    COLOR_ID_SCROLLBAR_BUTTON = 45,
    COLOR_ID_YT_GRAPH_GRID = 46,
    COLOR_ID_YT_GRAPH_BACKGROUND = 47,
    COLOR_ID_YT_GRAPH_CURSOR = 48,
    COLOR_ID_YT_GRAPH_Y1 = 49,
    COLOR_ID_YT_GRAPH_Y2 = 50,
    COLOR_ID_YT_GRAPH_Y3 = 51,
    COLOR_ID_YT_GRAPH_Y4 = 52,
    COLOR_ID_YT_GRAPH_Y5 = 53,
    COLOR_ID_LOADING = 54,
    COLOR_ID_PROGRESS = 55,
    COLOR_ID_PROGRESS_BACKGROUND = 56,
    COLOR_ID_BACKDROP = 57
};
...
enum PagesEnum {
    ...
    PAGE_ID_DIB_MIO168_SETTINGS = 121,
    PAGE_ID_DIB_MIO168_DIN_CONFIGURATION = 122,
    PAGE_ID_DIB_MIO168_AIN_CONFIGURATION = 123,
    PAGE_ID_DIB_MIO168_AOUT_DAC7760_CONFIGURATION = 124,
    PAGE_ID_DIB_MIO168_AOUT_DAC7563_CONFIGURATION = 125,
    PAGE_ID_DIB_MIO168_INFO = 126,
    PAGE_ID_DIB_PREL6_SIMULATOR_FRONT_PANEL_MASK = 127,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF = 128,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_2COL = 129,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 130,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 131,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 132,
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 133,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 134,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL = 135,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 136,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 137,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 138,
    PAGE_ID_DIB_SMX46_SETTINGS = 139,
    PAGE_ID_DIB_SMX46_CONFIGURE_ROUTES = 140,
    PAGE_ID_DIB_SMX46_INFO = 141,
    PAGE_ID_DIB_SMX46_RELAY_CYCLES = 142,
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 143,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON = 144,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON_2COL = 145,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON = 146,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON_2COL = 147,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF = 148,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF_2COL = 149,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 150,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES_2COL = 151,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 152,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL_2COL = 153,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON = 154,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON_2COL = 155,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON = 156,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON_2COL = 157,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF = 158,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF_2COL = 159,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 160,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES_2COL = 161,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 162,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL_2COL = 163,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_TITLE = 164,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_ON = 165,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_OFF = 166,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_OFF = 167,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_ON = 168,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_ON = 169,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_OFF = 170,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_TITLE = 171,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_ON = 172,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_OFF = 173,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_SERIES = 174,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_PARALLEL = 175,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_TITLE = 176,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_ON = 177,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_OFF = 178,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_COUPLED_SERIES = 179,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_COUPLED_PARALLEL = 180,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK = 181,
    PAGE_ID_DIB_DCM220_FRONT_PANEL_LED = 182,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_ERROR = 183,
    ...
    PAGE_ID_FRONT_PANEL = 215,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 216,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 217,
    PAGE_ID_DIB_DCM224_SIMULATOR_FRONT_PANEL_MASK = 218,
    PAGE_ID_DIB_DCM224_FRONT_PANEL_LED = 219,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ERROR = 220,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ADV_OPTIONS = 221,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT = 222,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_2COL = 223,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON = 224,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON_2COL = 225,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF = 226,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF_2COL = 227,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ = 228,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_2COL = 229,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON = 230,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON_2COL = 231,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF = 232,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF_2COL = 233,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH = 234,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_TITLE = 235,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_ON = 236,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_OFF = 237,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_OFF = 238,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_ON = 239,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_OFF = 240,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_ON = 241,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_ON = 242,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_OFF = 243,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_TITLE = 244,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_TITLE = 245,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH = 246,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_ON = 247,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_OFF = 248,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH = 249,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_TITLE = 250,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_ON = 251,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_OFF = 252
};

extern const uint8_t assets[537659];
