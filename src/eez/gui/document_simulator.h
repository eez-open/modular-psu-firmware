enum DataEnum {
    ...
    DATA_ID_MAIN_APP_VIEW = 221,
    DATA_ID_TOUCH_CALIBRATION_POINT = 222,
    DATA_ID_SIMULATOR_LOAD_STATE = 223,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 224,
    DATA_ID_SIMULATOR_LOAD = 225,
    DATA_ID_SIMULATOR_LOAD2 = 226,
    DATA_ID_SELECTED_THEME = 227,
    DATA_ID_CHANNEL_TITLE = 228,
    DATA_ID_CHANNEL_SHORT_TITLE = 229,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 230,
    ...
    DATA_ID_SLOT1_DEFAULT_VIEW = 236,
    DATA_ID_SLOT2_DEFAULT_VIEW = 237,
    DATA_ID_SLOT3_DEFAULT_VIEW = 238,
    DATA_ID_SLOT1_CHANNEL_INDEX = 239,
    DATA_ID_SLOT2_CHANNEL_INDEX = 240,
    DATA_ID_SLOT3_CHANNEL_INDEX = 241,
    DATA_ID_SLOT_DEF_2CH_VIEW = 242,
    DATA_ID_SLOT_MAX_2CH_VIEW = 243,
    DATA_ID_SLOT_MIN_2CH_VIEW = 244,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 245,
    DATA_ID_SLOT_2CH_CH1_INDEX = 246,
    DATA_ID_SLOT_2CH_CH2_INDEX = 247,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 248,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 249,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 250,
    DATA_ID_BATTERY = 251,
    DATA_ID_IO_PIN_STATE = 252,
    DATA_ID_CHANNEL_DPROG = 253,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 254,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 255,
    DATA_ID_SYS_INFO_HAS_ERROR = 256,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 257,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 258,
    DATA_ID_SYS_FAN_MODE = 259,
    DATA_ID_SYS_FAN_SPEED = 260,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 261,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 262,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 263,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 264,
    DATA_ID_IS_TRACKING_ALLOWED = 265,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 266,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 267,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 268,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 269,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 270,
    DATA_ID_IS_COUPLED_OR_TRACKED = 271,
    DATA_ID_OVERLAY = 272,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 273,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 274,
    DATA_ID_DLOG_STATE = 275,
    DATA_ID_DLOG_TOGGLE_STATE = 276,
    DATA_ID_RECORDING = 277,
    DATA_ID_CHANNEL_HISTORY_VALUES = 278,
    DATA_ID_RECORDING_READY = 279,
    DATA_ID_NONDRAG_OVERLAY = 280,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 281,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 282,
    DATA_ID_DLOG_VISIBLE_VALUES = 283,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 284,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 285,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 286,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 287,
    DATA_ID_DLOG_ALL_VALUES = 288,
    DATA_ID_DLOG_CURRENT_TIME = 289,
    DATA_ID_DLOG_FILE_LENGTH = 290,
    DATA_ID_DLOG_X_AXIS_OFFSET = 291,
    DATA_ID_DLOG_X_AXIS_DIV = 292,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 293,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 294,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 295,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 296,
    DATA_ID_DLOG_VIEW_STATE = 297,
    DATA_ID_DLOG_PERIOD = 298,
    DATA_ID_DLOG_DURATION = 299,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 300,
    DATA_ID_DLOG_CURRENT_ENABLED = 301,
    DATA_ID_DLOG_POWER_ENABLED = 302,
    DATA_ID_DLOG_START_ENABLED = 303,
    DATA_ID_DLOG_FILE_NAME = 304,
    DATA_ID_DLOG_VALUE_STATE = 305,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 306,
    DATA_ID_CHANNEL_OFF_LABEL = 307,
    DATA_ID_FILE_MANAGER_FILES = 308,
    DATA_ID_FILE_MANAGER_FILE_NAME = 309,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 310,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 311,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 312,
    DATA_ID_FILE_MANAGER_STATE = 313,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 314,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 315,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 316,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 317,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 318,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 319,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 320,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 321,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 322,
    DATA_ID_SCRIPT_INFO = 323,
    DATA_ID_SCRIPT_IS_STARTED = 324,
    DATA_ID_KEYPAD_OK_ENABLED = 325,
    DATA_ID_ETHERNET_HOST_NAME = 326,
    DATA_ID_MQTT_HOST = 327,
    DATA_ID_MQTT_PORT = 328,
    DATA_ID_MQTT_USERNAME = 329,
    DATA_ID_MQTT_PASSWORD = 330,
    DATA_ID_MQTT_PERIOD = 331,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 332,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 333,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 334,
    DATA_ID_LIST_COUNTER_LABEL = 335,
    DATA_ID_RAMP_COUNTER_LABEL = 336,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 337,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 338,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 339,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 340,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 341,
    DATA_ID_IS_RESET_BY_IWDG = 342,
    DATA_ID_DLOG_ENABLED = 343,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 344,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 345,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 346,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 347,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 348,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 349,
    DATA_ID_DATE_TIME_FORMAT = 350,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 351,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 352,
    DATA_ID_DATE_TIME_AM_PM = 353,
    DATA_ID_IS_MULTI_TRACKING = 354,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 355,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 356,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 357,
    DATA_ID_CHANNEL_INFO_BRAND = 358,
    DATA_ID_CHANNEL_INFO_SERIAL = 359,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 360,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 361,
    DATA_ID_FILE_MANAGER_FILE_ICON = 362,
    DATA_ID_FILE_MANAGER_LAYOUT = 363,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 364,
    DATA_ID_TOUCH_RAW_X = 365,
    DATA_ID_TOUCH_RAW_Y = 366,
    DATA_ID_TOUCH_RAW_Z1 = 367,
    DATA_ID_TOUCH_RAW_PRESSED = 368,
    DATA_ID_TOUCH_CALIBRATED_X = 369,
    DATA_ID_TOUCH_CALIBRATED_Y = 370,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 371,
    DATA_ID_TOUCH_FILTERED_X = 372,
    DATA_ID_TOUCH_FILTERED_Y = 373,
    DATA_ID_TOUCH_FILTERED_PRESSED = 374,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 375,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 376,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 377,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 378,
    DATA_ID_ALERT_MESSAGE_IS_SET = 379,
    DATA_ID_ASYNC_PROGRESS = 380,
    DATA_ID_IO_PIN_FUNCTION = 381,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 382,
    DATA_ID_IO_PIN_PWM_DUTY = 383,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 384,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 385,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 386,
    DATA_ID_DEBUG_VARIABLES = 387,
    DATA_ID_DEBUG_VARIABLE_NAME = 388,
    DATA_ID_DEBUG_VARIABLE_VALUE = 389,
    DATA_ID_CHANNEL_RAMP_STATE = 390,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 391,
    DATA_ID_MQTT_IN_ERROR = 392,
    DATA_ID_DEBUG_I_DAC = 393,
    DATA_ID_DEBUG_U_DAC = 394,
    DATA_ID_DEBUG_I_DAC_AMPER = 395,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 396,
    DATA_ID_DEBUG_I_ADC = 397,
    DATA_ID_DEBUG_U_ADC = 398,
    DATA_ID_DEBUG_I_ADC_AMPER = 399,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 400,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 401,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 402,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 403,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 404,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 405,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 406,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 407,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 408,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 409,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 410,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 411,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 412,
    DATA_ID_DUMMY = 413,
    DATA_ID_SLOTS = 414,
    DATA_ID_SLOT_INDEX = 415,
    DATA_ID_SLOT_TITLE_DEF = 416,
    DATA_ID_SLOT_TITLE_MAX = 417,
    DATA_ID_SLOT_TITLE_MIN = 418,
    DATA_ID_SLOT_TITLE_MICRO = 419,
    DATA_ID_MIO168_INPUTS = 420,
    DATA_ID_MIO168_INPUT_NO = 421,
    DATA_ID_MIO168_INPUT_STATE = 422,
    DATA_ID_MIO168_OUTPUTS = 423,
    DATA_ID_MIO168_OUTPUT_NO = 424,
    DATA_ID_MIO168_OUTPUT_STATE = 425
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SIMULATOR_LOAD = 141,
    ACTION_ID_SELECT_THEME = 142,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 143,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 144,
    ACTION_ID_RESTART = 145,
    ACTION_ID_USER_SWITCH_CLICKED = 146,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 147,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 148,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 149,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 150,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 151,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 152,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 153,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 154,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 155,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 156,
    ACTION_ID_SET_COUPLING_PARALLEL = 157,
    ACTION_ID_SET_COUPLING_SERIES = 158,
    ACTION_ID_SET_COUPLING_COMMON_GND = 159,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 160,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 161,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 162,
    ACTION_ID_DRAG_OVERLAY = 163,
    ACTION_ID_DLOG_TOGGLE = 164,
    ACTION_ID_SHOW_DLOG_VIEW = 165,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 166,
    ACTION_ID_SHOW_FILE_MANAGER = 167,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 168,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT_DIRECTORY = 169,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 170,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 171,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 172,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 173,
    ACTION_ID_SHOW_DLOG_PARAMS = 174,
    ACTION_ID_DLOG_VOLTAGE_TOGGLE = 175,
    ACTION_ID_DLOG_CURRENT_TOGGLE = 176,
    ACTION_ID_DLOG_POWER_TOGGLE = 177,
    ACTION_ID_DLOG_VALUE_TOGGLE = 178,
    ACTION_ID_DLOG_EDIT_PERIOD = 179,
    ACTION_ID_DLOG_EDIT_DURATION = 180,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 181,
    ACTION_ID_DLOG_START_RECORDING = 182,
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 183,
    ACTION_ID_FILE_MANAGER_SORT_BY = 184,
    ACTION_ID_DLOG_AUTO_SCALE = 185,
    ACTION_ID_DLOG_UPLOAD = 186,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 187,
    ACTION_ID_MQTT_EDIT_HOST = 188,
    ACTION_ID_MQTT_EDIT_PORT = 189,
    ACTION_ID_MQTT_EDIT_USERNAME = 190,
    ACTION_ID_MQTT_EDIT_PASSWORD = 191,
    ACTION_ID_MQTT_EDIT_PERIOD = 192,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 193,
    ACTION_ID_DLOG_SCALE_TO_FIT = 194,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 195,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 196,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 197,
    ACTION_ID_SHUTDOWN = 198,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 199,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 200,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 201,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 202,
    ACTION_ID_PROFILE_IMPORT = 203,
    ACTION_ID_PROFILE_EXPORT = 204,
    ACTION_ID_EVENT_QUEUE_FILTER = 205,
    ACTION_ID_EVENT_QUEUE_SELECT_EVENT = 206,
    ACTION_ID_DATE_TIME_SELECT_FORMAT = 207,
    ACTION_ID_DATE_TIME_TOGGLE_AM_PM = 208,
    ACTION_ID_EDIT_NO_FOCUS = 209,
    ACTION_ID_UNTRACK_ALL = 210,
    ACTION_ID_CH_SETTINGS_COPY = 211,
    ACTION_ID_SHOW_SYS_SETTINGS_ETHERNET_ERROR = 212,
    ACTION_ID_FILE_MANAGER_SELECT_LIST_VIEW = 213,
    ACTION_ID_SHOW_SYS_SETTINGS_RAMP_AND_DELAY = 214,
    ACTION_ID_CHANNEL_TOGGLE_RAMP_STATE = 215,
    ACTION_ID_DLOG_VIEW_SELECT_LEGEND_VIEW_OPTION = 216,
    ACTION_ID_SET_FOCUS = 217,
    ACTION_ID_SELECT_CHANNEL_CALIBRATION_VALUE_TYPE = 218,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_NEXT = 219,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_PREVIOUS = 220,
    ...
    ACTION_ID_SHOW_SLOT_SETTINGS = 227,
    ACTION_ID_MIO168_TOGGLE_OUTPUT_STATE = 228
};
...
enum StylesEnum {
    ...
    STYLE_ID_INLINE62 = 62,
    STYLE_ID_INLINE63 = 63,
    STYLE_ID_VALUE_S = 64,
    STYLE_ID_TOUCH_CALIBRATION = 65,
    STYLE_ID_NOTE_M = 66,
    STYLE_ID_TOUCH_CALIBRATION_POINT = 67,
    STYLE_ID_BUTTON_BGND = 68,
    STYLE_ID_STATUS_ICON_ENABLED_WITH_NEED_ATTENTION = 69,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ERROR = 70,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ACTIVE = 71,
    STYLE_ID_STATUS_ICON_ENABLED_BLINK = 72,
    STYLE_ID_STATUS_ICON_DISABLED = 73,
    STYLE_ID_DLOG_RECORD_BUTTON = 74,
    STYLE_ID_STATUS_ICON_DISABLED_BLINK = 75,
    STYLE_ID_OVERLAY = 76,
    STYLE_ID_OVERLAY_LEFT = 77,
    STYLE_ID_OVERLAY_ICON = 78,
    STYLE_ID_EDIT_VALUE_S_LEFT = 79,
    STYLE_ID_BOTTOM_BUTTON_BACKGROUND = 80,
    STYLE_ID_BOTTOM_BUTTON = 81,
    STYLE_ID_VALUE_S_LEFT = 82,
    STYLE_ID_EDIT_VALUE_M_LEFT = 83,
    STYLE_ID_KEY_ICONS = 84,
    STYLE_ID_KEY = 85,
    STYLE_ID_KEY_DISABLED = 86,
    STYLE_ID_INLINE87 = 87,
    STYLE_ID_TAB_PAGE_SELECTED = 88,
    STYLE_ID_TAB_PAGE = 89,
    ...
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 135,
    STYLE_ID_INLINE136 = 136,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 137,
    STYLE_ID_ENCODER_CURSOR_17_ENABLED = 138,
    STYLE_ID_INLINE139 = 139,
    STYLE_ID_YT_GRAPH = 140,
    STYLE_ID_LIST_GRAPH_CURSOR = 141,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 142,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 143,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 144,
    ...
    STYLE_ID_BUTTON_S_DISABLED = 151,
    ...
    STYLE_ID_EDIT_VALUE_M_CENTERED = 167,
    STYLE_ID_EDIT_S = 168,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 196,
    STYLE_ID_INLINE197 = 197,
    STYLE_ID_MON_VALUE_20_LEFT = 198,
    STYLE_ID_INLINE199 = 199,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 200,
    STYLE_ID_BAR_GRAPH_TEXT = 201,
    STYLE_ID_BAR_GRAPH_SET_LINE = 202,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 203,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 204,
    STYLE_ID_INLINE205 = 205,
    STYLE_ID_INLINE206 = 206,
    STYLE_ID_TRIGGER_BUTTON_24 = 207,
    STYLE_ID_INLINE208 = 208,
    STYLE_ID_INLINE209 = 209,
    STYLE_ID_MON_VALUE_14_RIGHT = 210,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 211,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 212,
    STYLE_ID_TRIGGER_BUTTON_14 = 213,
    STYLE_ID_INLINE214 = 214,
    STYLE_ID_INLINE215 = 215,
    STYLE_ID_INLINE216 = 216,
    STYLE_ID_INLINE217 = 217,
    STYLE_ID_INLINE218 = 218,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 219,
    STYLE_ID_INST_SELECTED = 220,
    STYLE_ID_MON_VALUE_38_RIGHT = 221,
    STYLE_ID_INLINE222 = 222,
    STYLE_ID_CH_PROT_OFF = 223,
    STYLE_ID_CH_PROT_ON = 224,
    STYLE_ID_CH_PROT_TRIPPED = 225,
    STYLE_ID_INLINE226 = 226,
    STYLE_ID_MON_VALUE_24_RIGHT = 227,
    STYLE_ID_MON_VALUE_14_CENTER = 228,
    STYLE_ID_INLINE229 = 229,
    STYLE_ID_INLINE230 = 230,
    STYLE_ID_INLINE231 = 231,
    STYLE_ID_INLINE232 = 232,
    STYLE_ID_MON_VALUE_20_RIGHT = 233,
    STYLE_ID_MON_VALUE_14_LEFT = 234,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 235,
    STYLE_ID_INLINE236 = 236,
    STYLE_ID_INLINE237 = 237,
    STYLE_ID_INLINE238 = 238,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 239,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 240,
    STYLE_ID_SCROLLBAR_TRACK = 241,
...
enum PagesEnum {
    ...
    PAGE_ID_CH_SETTINGS_CALIBRATION_EDIT = 45,
    PAGE_ID_CH_SETTINGS_CALIBRATION_VIEW = 46,
    PAGE_ID_CH_SETTINGS_ADV_OPTIONS = 47,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 48,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 49,
    PAGE_ID_CH_SETTINGS_INFO = 50,
    PAGE_ID_SYS_SETTINGS = 51,
    PAGE_ID_SYS_SETTINGS_TEMPERATURE = 52,
    PAGE_ID_SYS_SETTINGS_PROTECTIONS = 53,
    PAGE_ID_SYS_SETTINGS_TRIGGER = 54,
    PAGE_ID_SYS_SETTINGS_IO = 55,
    PAGE_ID_SYS_SETTINGS_DATE_TIME = 56,
    PAGE_ID_SYS_SETTINGS_ENCODER = 57,
    PAGE_ID_SYS_SETTINGS_SERIAL = 58,
    PAGE_ID_SYS_SETTINGS_ETHERNET = 59,
    PAGE_ID_SYS_SETTINGS_MQTT = 60,
    PAGE_ID_SYS_SETTINGS_ETHERNET_STATIC = 61,
    PAGE_ID_SYS_SETTINGS_SCREEN_CALIBRATION = 62,
    PAGE_ID_SYS_SETTINGS_DISPLAY = 63,
    PAGE_ID_SYS_SETTINGS_SOUND = 64,
    PAGE_ID_SYS_SETTINGS_TRACKING = 65,
    PAGE_ID_SYS_SETTINGS_COUPLING = 66,
    PAGE_ID_SYS_SETTINGS_RAMP_AND_DELAY = 67,
    ...
    PAGE_ID_MINIMIZED_CHANNELS = 79,
    PAGE_ID_SLOT_DEF_VERT = 80,
    PAGE_ID_SLOT_DEF_VERT_TITLE = 81,
    PAGE_ID_SLOT_DEF_1CH_NUM_ON = 82,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF = 83,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 84,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 85,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 86,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 87,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 88,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 89,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 90,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON = 91,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF = 92,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 93,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 94,
    PAGE_ID_SLOT_DEF_2CH_VERT = 95,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON = 96,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF = 97,
    PAGE_ID_SLOT_DEF_VERT_ERROR = 98,
    PAGE_ID_SLOT_DEF_VERT_NOT_INSTALLED = 99,
    PAGE_ID_SLOT_DEF_HORZ = 100,
    PAGE_ID_SLOT_DEF_HORZ_TITLE = 101,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON = 102,
    PAGE_ID_SLOT_DEF_1CH_YT_ON = 103,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF = 104,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 105,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 106,
    PAGE_ID_SLOT_DEF_2CH_HORZ = 107,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON = 108,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF = 109,
    PAGE_ID_SLOT_DEF_HORZ_ERROR = 110,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED = 111,
    PAGE_ID_SLOT_MAX_1CH_TITLE = 112,
    PAGE_ID_SLOT_MAX_1CH_NUM_ON = 113,
    PAGE_ID_SLOT_MAX_1CH_NUM_OFF = 114,
    PAGE_ID_SLOT_MAX_1CH_HBAR_ON = 115,
    PAGE_ID_SLOT_MAX_1CH_HBAR_OFF = 116,
    PAGE_ID_SLOT_MAX_1CH_YT_ON = 117,
    PAGE_ID_SLOT_MAX_1CH_YT_OFF = 118,
    PAGE_ID_SLOT_MAX_2CH = 119,
    PAGE_ID_SLOT_MAX_2CH_TITLE = 120,
    PAGE_ID_SLOT_MAX_2CH_NUM_ON = 121,
    PAGE_ID_SLOT_MAX_2CH_NUM_OFF = 122,
    PAGE_ID_SLOT_MAX_2CH_HBAR_ON = 123,
    PAGE_ID_SLOT_MAX_2CH_HBAR_OFF = 124,
    PAGE_ID_SLOT_MAX_2CH_YT_ON = 125,
    PAGE_ID_SLOT_MAX_2CH_YT_OFF = 126,
    PAGE_ID_SLOT_MAX_2CH_MIN_TITLE = 127,
    PAGE_ID_SLOT_MAX_2CH_MIN_ON = 128,
    PAGE_ID_SLOT_MAX_2CH_MIN_OFF = 129,
    PAGE_ID_SLOT_MAX_ERROR = 130,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 131,
    PAGE_ID_SLOT_MIN_1CH_TITLE = 132,
    PAGE_ID_SLOT_MIN_1CH_ON = 133,
    PAGE_ID_SLOT_MIN_1CH_OFF = 134,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_SERIES = 135,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_PARALLEL = 136,
    PAGE_ID_SLOT_MIN_2CH_TITLE = 137,
    PAGE_ID_SLOT_MIN_2CH = 138,
    PAGE_ID_SLOT_MIN_2CH_ON = 139,
    PAGE_ID_SLOT_MIN_2CH_OFF = 140,
    PAGE_ID_SLOT_MIN_ERROR = 141,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 142,
    PAGE_ID_SLOT_MICRO_1CH_TITLE = 143,
    PAGE_ID_SLOT_MICRO_1CH_ON = 144,
    PAGE_ID_SLOT_MICRO_1CH_OFF = 145,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_SERIES = 146,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_PARALLEL = 147,
    PAGE_ID_SLOT_MICRO_2CH = 148,
    PAGE_ID_SLOT_MICRO_2CH_TITLE = 149,
    PAGE_ID_SLOT_MICRO_2CH_ON = 150,
    PAGE_ID_SLOT_MICRO_2CH_OFF = 151,
    PAGE_ID_SLOT_MICRO_ERROR = 152,
    PAGE_ID_SLOT_MICRO_NOT_INSTALLED = 153,
    PAGE_ID_DLOG_VIEW = 154,
    PAGE_ID_IMAGE_VIEW = 155,
    PAGE_ID_DLOG_PARAMS = 156,
    PAGE_ID_DLOG_VIEW_OVERLAY_OPTIONS = 157,
    PAGE_ID_FILE_MANAGER = 158,
    PAGE_ID_FILE_BROWSER = 159,
    PAGE_ID_FILE_MENU = 160,
    PAGE_ID_FRONT_PANEL = 161,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 162,
    PAGE_ID_DCP405_FRONT_PANEL = 163,
    PAGE_ID_DCM220_FRONT_PANEL = 164,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 165,
    PAGE_ID_DCM224_FRONT_PANEL = 166,
    PAGE_ID_PREL6_FRONT_PANEL = 167,
    PAGE_ID_SMX46_FRONT_PANEL = 168,
    ...
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 179,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 180,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 181,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 182,
    PAGE_ID_MIO168_FRONT_PANEL = 183
};

extern const uint8_t assets[523990];
