...
enum ActionsEnum {
    ...
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 287,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 288,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 289,
    ACTION_ID_SIMULATOR_LOAD = 290,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 291,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 292
};
...
enum StylesEnum {
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 322,
    STYLE_ID_INLINE323 = 323,
    STYLE_ID_MON_VALUE_20_LEFT = 324,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 325,
    STYLE_ID_BAR_GRAPH_TEXT = 326,
    STYLE_ID_BAR_GRAPH_SET_LINE = 327,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 328,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 329,
    STYLE_ID_LABELS_AND_COLORS_CHANNEL = 330,
    STYLE_ID_INLINE331 = 331,
    STYLE_ID_TRIGGER_BUTTON_24 = 332,
    STYLE_ID_INLINE333 = 333,
    STYLE_ID_INLINE334 = 334,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 335,
    STYLE_ID_TRIGGER_BUTTON_14 = 336,
    STYLE_ID_MON_VALUE_38_RIGHT = 337,
    STYLE_ID_INLINE338 = 338,
    STYLE_ID_CH_PROT_OFF = 339,
    STYLE_ID_CH_PROT_ON = 340,
    STYLE_ID_CH_PROT_TRIPPED = 341,
    STYLE_ID_INLINE342 = 342,
    STYLE_ID_MON_VALUE_20_RIGHT = 343,
    STYLE_ID_MON_VALUE_14_LEFT = 344,
    STYLE_ID_MON_VALUE_14_CENTER = 345,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 346,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 347,
    STYLE_ID_MON_VALUE_14_RIGHT = 348,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 349,
...
extern const uint8_t assets[551431];
