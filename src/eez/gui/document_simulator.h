enum DataEnum {
    ...
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUES = 165,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE_LABEL = 166,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE = 167,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_SCALE = 168,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_IS_CUSTOM_SCALE = 169,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_RANGE = 170,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_YT_VIEW_RATE = 171,
    DATA_ID_SYS_ENCODER_CONFIRMATION_MODE = 172,
    DATA_ID_SYS_ENCODER_MOVING_UP_SPEED = 173,
    DATA_ID_SYS_ENCODER_MOVING_DOWN_SPEED = 174,
    DATA_ID_SYS_ENCODER_INSTALLED = 175,
    DATA_ID_SYS_DISPLAY_STATE = 176,
    DATA_ID_SYS_DISPLAY_BRIGHTNESS = 177,
    DATA_ID_CHANNEL_TRIGGER_MODE = 178,
    DATA_ID_CHANNEL_TRIGGER_ON_LIST_STOP = 179,
    DATA_ID_CHANNEL_U_TRIGGER_VALUE = 180,
    DATA_ID_CHANNEL_I_TRIGGER_VALUE = 181,
    DATA_ID_CHANNEL_LIST_COUNT = 182,
    DATA_ID_CHANNEL_LISTS = 183,
    DATA_ID_RAMP_AND_DELAY_LIST = 184,
    DATA_ID_CHANNEL_LIST_INDEX = 185,
    DATA_ID_CHANNEL_LIST_DWELL = 186,
    DATA_ID_CHANNEL_LIST_DWELL_ENABLED = 187,
    DATA_ID_CHANNEL_LIST_VOLTAGE = 188,
    DATA_ID_CHANNEL_LIST_VOLTAGE_ENABLED = 189,
    DATA_ID_CHANNEL_LIST_CURRENT = 190,
    DATA_ID_CHANNEL_LIST_CURRENT_ENABLED = 191,
    DATA_ID_CHANNEL_LISTS_PREVIOUS_PAGE_ENABLED = 192,
    DATA_ID_CHANNEL_LISTS_NEXT_PAGE_ENABLED = 193,
    DATA_ID_CHANNEL_LISTS_CURSOR = 194,
    DATA_ID_CHANNEL_LISTS_INSERT_MENU_ENABLED = 195,
    DATA_ID_CHANNEL_LISTS_DELETE_MENU_ENABLED = 196,
    DATA_ID_CHANNEL_LISTS_DELETE_ROW_ENABLED = 197,
    DATA_ID_CHANNEL_LISTS_CLEAR_COLUMN_ENABLED = 198,
    DATA_ID_CHANNEL_LISTS_DELETE_ROWS_ENABLED = 199,
    DATA_ID_CHANNEL_COUPLING_STATE = 200,
    DATA_ID_TRIGGER_SOURCE = 201,
    DATA_ID_DLOG_TRIGGER_SOURCE = 202,
    DATA_ID_TRIGGER_DELAY = 203,
    DATA_ID_TRIGGER_INITIATE_CONTINUOUSLY = 204,
    DATA_ID_TRIGGER_IS_INITIATED = 205,
    DATA_ID_TRIGGER_IS_MANUAL = 206,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 207,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 208,
    DATA_ID_CHANNEL_RANGES_MODE = 209,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 210,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 211,
    DATA_ID_TEXT_MESSAGE = 212,
    DATA_ID_SERIAL_STATUS = 213,
    DATA_ID_SERIAL_IS_CONNECTED = 214,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 215,
    DATA_ID_CHANNEL_RAMP_COUNTDOWN = 216,
    DATA_ID_IO_PINS = 217,
    DATA_ID_IO_PINS_INHIBIT_STATE = 218,
    DATA_ID_IO_PIN_NUMBER = 219,
    DATA_ID_IO_PIN_POLARITY = 220,
    DATA_ID_IO_PIN_FUNCTION_NAME = 221,
    DATA_ID_NTP_ENABLED = 222,
    DATA_ID_NTP_SERVER = 223,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 224,
    DATA_ID_PROGRESS = 225,
    DATA_ID_TOUCH_CALIBRATION_POINT = 226,
    DATA_ID_SELECTED_THEME = 227,
    DATA_ID_CHANNEL_TITLE = 228,
    DATA_ID_CHANNEL_SHORT_TITLE = 229,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 230,
    DATA_ID_CHANNEL_LONG_TITLE = 231,
    DATA_ID_ANIMATIONS_DURATION = 232,
    DATA_ID_SLOT_INFO = 233,
    DATA_ID_SLOT_TEST_RESULT = 234,
    DATA_ID_SLOT_DEFAULT_VIEW = 235,
    DATA_ID_SLOT1_CHANNEL_INDEX = 236,
    DATA_ID_SLOT2_CHANNEL_INDEX = 237,
    DATA_ID_SLOT3_CHANNEL_INDEX = 238,
    DATA_ID_BATTERY = 239,
    DATA_ID_IO_PIN_STATE = 240,
    DATA_ID_CHANNEL_DPROG = 241,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 242,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 243,
    DATA_ID_SYS_INFO_HAS_ERROR = 244,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 245,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 246,
    DATA_ID_SYS_FAN_MODE = 247,
    DATA_ID_SYS_FAN_SPEED = 248,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 249,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 250,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 251,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 252,
    DATA_ID_IS_TRACKING_ALLOWED = 253,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 254,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 255,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 256,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 257,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 258,
    DATA_ID_IS_COUPLED_OR_TRACKED = 259,
    DATA_ID_OVERLAY = 260,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 261,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 262,
    DATA_ID_DLOG_STATE = 263,
    DATA_ID_DLOG_TOGGLE_STATE = 264,
    DATA_ID_RECORDING = 265,
    DATA_ID_CHANNEL_HISTORY_VALUES = 266,
    DATA_ID_RECORDING_READY = 267,
    DATA_ID_NONDRAG_OVERLAY = 268,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 269,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 270,
    DATA_ID_DLOG_VISIBLE_VALUES = 271,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 272,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 273,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 274,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 275,
    DATA_ID_DLOG_CURRENT_TIME = 276,
    DATA_ID_DLOG_FILE_LENGTH = 277,
    DATA_ID_DLOG_X_AXIS_OFFSET = 278,
    DATA_ID_DLOG_X_AXIS_DIV = 279,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 280,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 281,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 282,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 283,
    DATA_ID_DLOG_VIEW_STATE = 284,
    DATA_ID_DLOG_PERIOD = 285,
    DATA_ID_DLOG_DURATION = 286,
    DATA_ID_DLOG_FILE_NAME = 287,
    DATA_ID_CHANNEL_OFF_LABEL = 288,
    DATA_ID_FILE_MANAGER_FILES = 289,
    DATA_ID_FILE_MANAGER_FILE_NAME = 290,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 291,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 292,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 293,
    DATA_ID_FILE_MANAGER_STATE = 294,
    DATA_ID_FILE_MANAGER_HAS_PARENT = 295,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 296,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 297,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 298,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 299,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 300,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 301,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 302,
    DATA_ID_SCRIPT_INFO = 303,
    DATA_ID_SCRIPT_IS_STARTED = 304,
    DATA_ID_KEYPAD_OK_ENABLED = 305,
    DATA_ID_ETHERNET_HOST_NAME = 306,
    DATA_ID_MQTT_HOST = 307,
    DATA_ID_MQTT_PORT = 308,
    DATA_ID_MQTT_USERNAME = 309,
    DATA_ID_MQTT_PASSWORD = 310,
    DATA_ID_MQTT_PERIOD = 311,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 312,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 313,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 314,
    DATA_ID_LIST_COUNTER_LABEL = 315,
    DATA_ID_RAMP_COUNTER_LABEL = 316,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 317,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 318,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 319,
    DATA_ID_IS_RESET_BY_IWDG = 320,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 321,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 322,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 323,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 324,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 325,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 326,
    DATA_ID_DATE_TIME_FORMAT = 327,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 328,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 329,
    DATA_ID_DATE_TIME_AM_PM = 330,
    DATA_ID_IS_MULTI_TRACKING = 331,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 332,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 333,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 334,
    DATA_ID_CHANNEL_INFO_BRAND = 335,
    DATA_ID_CHANNEL_INFO_SERIAL = 336,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 337,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 338,
    DATA_ID_FILE_MANAGER_FILE_ICON = 339,
    DATA_ID_FILE_MANAGER_LAYOUT = 340,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 341,
    DATA_ID_TOUCH_RAW_X = 342,
    DATA_ID_TOUCH_RAW_Y = 343,
    DATA_ID_TOUCH_RAW_Z1 = 344,
    DATA_ID_TOUCH_RAW_PRESSED = 345,
    DATA_ID_TOUCH_CALIBRATED_X = 346,
    DATA_ID_TOUCH_CALIBRATED_Y = 347,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 348,
    DATA_ID_TOUCH_FILTERED_X = 349,
    DATA_ID_TOUCH_FILTERED_Y = 350,
    DATA_ID_TOUCH_FILTERED_PRESSED = 351,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 352,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 353,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 354,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 355,
    DATA_ID_ALERT_MESSAGE_IS_SET = 356,
    DATA_ID_ASYNC_PROGRESS = 357,
    DATA_ID_IO_PIN_FUNCTION = 358,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 359,
    DATA_ID_IO_PIN_PWM_DUTY = 360,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 361,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 362,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 363,
    DATA_ID_CHANNEL_RAMP_STATE = 364,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 365,
    DATA_ID_MQTT_IN_ERROR = 366,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 367,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 368,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 369,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 370,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 371,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 372,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 373,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 374,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 375,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 376,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 377,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 378,
    DATA_ID_SLOTS = 379,
    DATA_ID_SLOT_INDEX = 380,
    DATA_ID_SLOT_TITLE_DEF = 381,
    DATA_ID_SLOT_TITLE_MAX = 382,
    DATA_ID_SLOT_TITLE_MIN = 383,
    DATA_ID_SLOT_TITLE_MICRO = 384,
    DATA_ID_SLOT_TITLE_SETTINGS = 385,
    DATA_ID_SLOT_ERROR_MESSAGE = 386,
    DATA_ID_USB_MODE = 387,
    DATA_ID_USB_CURRENT_MODE = 388,
    DATA_ID_USB_DEVICE_CLASS = 389,
    DATA_ID_USB_KEYBOARD_STATE = 390,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 391,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 392,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 393,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 394,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 395,
    DATA_ID_SLOT_SERIAL_INFO = 396,
    DATA_ID_SLOT_IS_ENABLED = 397,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 398,
    DATA_ID_USER_SWITCH_ACTION = 399,
    DATA_ID_NTP_REFRESH_FREQUENCY = 400,
    DATA_ID_CHANNEL_CALIBRATION_IS_POWER_CHANNEL = 401,
    DATA_ID_HAS_CUSTOM_BITMAP = 402,
    DATA_ID_CUSTOM_BITMAP = 403,
    DATA_ID_SLOT_INFO_WITH_FW_VER = 404,
    DATA_ID_MASTER_INFO_WITH_FW_VER = 405,
    DATA_ID_SLOT1_LABELS_AND_COLORS_VIEW = 406,
    DATA_ID_SLOT2_LABELS_AND_COLORS_VIEW = 407,
    DATA_ID_SLOT3_LABELS_AND_COLORS_VIEW = 408,
    DATA_ID_COLORS = 409,
    DATA_ID_KEYPAD_CAN_SET_DEFAULT = 410,
    DATA_ID_LABELS_AND_COLORS_PAGE_SLOT_TITLE = 411,
    DATA_ID_LABELS_AND_COLORS_PAGE_CHANNEL_TITLE = 412,
    DATA_ID_LABELS_AND_COLORS_IS_COLOR_MODIFIED = 413,
    DATA_ID_DLOG_ITEMS = 414,
    DATA_ID_DLOG_ITEM_IS_CHECKED = 415,
    DATA_ID_DLOG_ITEM_CHANNEL = 416,
    DATA_ID_DLOG_ITEM_LABEL = 417,
    DATA_ID_DLOG_ITEMS_SCROLLBAR_ENABLED = 418,
    DATA_ID_DLOG_ITEMS_NUM_SELECTED = 419,
    DATA_ID_DLOG_START_ENABLED = 420,
    DATA_ID_HAS_MULTIPLE_DISK_DRIVES = 421,
    DATA_ID_SELECTED_MASS_STORAGE_DEVICE = 422,
    DATA_ID_FILE_MANAGER_IS_SORT_FILES_OPTION_AVAILABLE = 423,
    DATA_ID_DLOG_PREVIEW_OVERLAY = 424,
    DATA_ID_DLOG_ITEM_IS_AVAILABLE = 425,
    DATA_ID_MODULE_IS_RESYNC_SUPPORTED = 426,
    DATA_ID_CHANNEL_IS_CALIBRATION_VALUE_SOURCE = 427,
    DATA_ID_CALIBRATION_POINT_CAN_EDIT_SET_VALUE = 428,
    DATA_ID_CALIBRATION_POINT_LIVE_MEASURED_VALUE = 429,
    DATA_ID_AC_MAINS = 430,
    DATA_ID_SELECTED_MCU_REVISION = 431,
    DATA_ID_IS_MCU_REVISION_SELECTED = 432,
    DATA_ID_DIB_MIO168_DIN_PINS = 433,
    DATA_ID_DIB_MIO168_DIN_PINS_1_4 = 434,
    DATA_ID_DIB_MIO168_DIN_PINS_5_8 = 435,
    DATA_ID_DIB_MIO168_DIN_NO = 436,
    DATA_ID_DIB_MIO168_DIN_STATE = 437,
    DATA_ID_DIB_MIO168_DIN_RANGE = 438,
    DATA_ID_DIB_MIO168_DIN_LABEL = 439,
    DATA_ID_DIB_MIO168_DIN_LABEL_LABEL = 440,
    DATA_ID_DIB_MIO168_DIN_SPEED = 441,
    DATA_ID_DIB_MIO168_DOUT_PINS = 442,
    DATA_ID_DIB_MIO168_DOUT_PINS_1_4 = 443,
    DATA_ID_DIB_MIO168_DOUT_PINS_5_8 = 444,
    DATA_ID_DIB_MIO168_DOUT_NO = 445,
    DATA_ID_DIB_MIO168_DOUT_STATE = 446,
    DATA_ID_DIB_MIO168_DOUT_LABEL = 447,
    DATA_ID_DIB_MIO168_DOUT_LABEL_LABEL = 448,
    DATA_ID_DIB_MIO168_AIN_CHANNELS = 449,
    DATA_ID_DIB_MIO168_AIN_LABEL = 450,
    DATA_ID_DIB_MIO168_AIN_LABEL_LABEL = 451,
    DATA_ID_DIB_MIO168_AIN_VALUE = 452,
    DATA_ID_DIB_MIO168_AIN_MODE = 453,
    DATA_ID_DIB_MIO168_AIN_RANGE = 454,
    DATA_ID_DIB_MIO168_AIN_RANGE_IS_AVAILABLE = 455,
    DATA_ID_DIB_MIO168_AIN_MODE_AND_RANGE = 456,
    DATA_ID_DIB_MIO168_AIN_RANGE_IS_MULTIPLE_SELECTION_AVAILABLE = 457,
    DATA_ID_DIB_MIO168_AIN_FAULT_STATUS = 458,
    DATA_ID_DIB_MIO168_AIN_NPLC = 459,
    DATA_ID_DIB_MIO168_AIN_APERTURE = 460,
    ...
    DATA_ID_DIB_MIO168_AOUT_MODE_AND_RANGE = 470,
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 471,
    DATA_ID_DIB_MIO168_PWM_LABEL = 472,
    DATA_ID_DIB_MIO168_PWM_LABEL_LABEL = 473,
    DATA_ID_DIB_MIO168_PWM_FREQ = 474,
    DATA_ID_DIB_MIO168_PWM_DUTY = 475,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 476,
    DATA_ID_DIB_MIO168_AFE_VERSION = 477,
    DATA_ID_DIB_MIO168_PAGER_LIST = 478,
    DATA_ID_DIB_MIO168_PAGER_IS_SELECTED = 479,
    DATA_ID_DIB_MIO168_PAGER_SELECTED_PAGE = 480,
    DATA_ID_DIB_PREL6_RELAYS = 481,
    DATA_ID_DIB_PREL6_RELAY_IS_ON = 482,
    DATA_ID_DIB_PREL6_RELAY_LABEL = 483,
    DATA_ID_DIB_SMX46_ROUTES = 484,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 485,
    DATA_ID_DIB_SMX46_X_LABELS = 486,
    DATA_ID_DIB_SMX46_X_LABEL = 487,
    DATA_ID_DIB_SMX46_Y_LABELS = 488,
    DATA_ID_DIB_SMX46_Y_LABEL = 489,
    DATA_ID_DIB_SMX46_DAC1 = 490,
    DATA_ID_DIB_SMX46_DAC2 = 491,
    DATA_ID_DIB_SMX46_RELAY_ON = 492,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 493,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 494,
    DATA_ID_DIB_SMX46_ANALOG_OUTPUTS = 495,
    DATA_ID_DIB_SMX46_AO_LABEL = 496,
    DATA_ID_DIB_SMX46_AO1_LABEL = 497,
    DATA_ID_DIB_SMX46_AO2_LABEL = 498,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 499,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_VIEW = 500,
    DATA_ID_DIB_DCM220_SLOT_MIN_2CH_VIEW = 501,
    DATA_ID_DIB_DCM220_SLOT_MICRO_2CH_VIEW = 502,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 503,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 504,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_VIEW = 505,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 506,
    DATA_ID_SIMULATOR_LOAD_STATE = 507,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 508,
    DATA_ID_SIMULATOR_LOAD = 509,
    DATA_ID_SIMULATOR_LOAD2 = 510,
    DATA_ID_MAIN_APP_VIEW = 511,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 512,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 513,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 514,
    DATA_ID_DIB_DCM224_PWM_DUTY = 515,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 516,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 517,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 518,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 519,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_VIEW = 520,
    DATA_ID_DIB_DCM224_SLOT_MIN_2CH_VIEW = 521,
    DATA_ID_DIB_DCM224_SLOT_MICRO_2CH_VIEW = 522,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 523,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 524,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_VIEW = 525
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_CH_SETTINGS_PROT_CLEAR = 47,
    ACTION_ID_SHOW_CH_SETTINGS_PROT_OCP = 48,
    ACTION_ID_SHOW_CH_SETTINGS_PROT_OVP = 49,
    ACTION_ID_SHOW_CH_SETTINGS_PROT_OPP = 50,
    ACTION_ID_SHOW_CH_SETTINGS_PROT_OTP = 51,
    ACTION_ID_SHOW_CH_SETTINGS_TRIGGER = 52,
    ACTION_ID_SHOW_CH_SETTINGS_LISTS = 53,
    ACTION_ID_SHOW_CH_SETTINGS_ADV_OPTIONS = 54,
    ACTION_ID_SHOW_CH_SETTINGS_ADV_RANGES = 55,
    ACTION_ID_SHOW_CH_SETTINGS_ADV_VIEW = 56,
    ACTION_ID_SHOW_CH_SETTINGS_INFO = 57,
    ACTION_ID_SHOW_CH_SETTINGS_CAL = 58,
    ACTION_ID_EDIT_CALIBRATION_PASSWORD = 59,
    ACTION_ID_CH_SETTINGS_CALIBRATION_START_CALIBRATION = 60,
    ACTION_ID_CH_SETTINGS_CALIBRATION_TOGGLE_ENABLE = 61,
    ACTION_ID_CH_SETTINGS_PROT_CLEAR = 62,
    ACTION_ID_CH_SETTINGS_PROT_CLEAR_AND_DISABLE = 63,
    ACTION_ID_CH_SETTINGS_PROT_TOGGLE_STATE = 64,
    ACTION_ID_CH_SETTINGS_PROT_TOGGLE_TYPE = 65,
    ACTION_ID_CH_SETTINGS_PROT_EDIT_LIMIT = 66,
    ACTION_ID_CH_SETTINGS_PROT_EDIT_LEVEL = 67,
    ACTION_ID_CH_SETTINGS_PROT_EDIT_DELAY = 68,
    ACTION_ID_SET = 69,
    ACTION_ID_DISCARD = 70,
    ACTION_ID_EDIT_FIELD = 71,
    ACTION_ID_CH_SETTINGS_ADV_REMOTE_TOGGLE_SENSE = 72,
    ACTION_ID_CH_SETTINGS_ADV_REMOTE_TOGGLE_PROGRAMMING = 73,
    ACTION_ID_DATE_TIME_SELECT_DST_RULE = 74,
    ACTION_ID_SHOW_USER_PROFILES = 75,
    ACTION_ID_SHOW_USER_PROFILE_SETTINGS = 76,
    ACTION_ID_PROFILES_TOGGLE_AUTO_RECALL = 77,
    ACTION_ID_PROFILE_TOGGLE_IS_AUTO_RECALL_LOCATION = 78,
    ACTION_ID_PROFILE_RECALL = 79,
    ACTION_ID_PROFILE_SAVE = 80,
    ACTION_ID_PROFILE_DELETE = 81,
    ACTION_ID_PROFILE_EDIT_REMARK = 82,
    ACTION_ID_TOGGLE_CHANNELS_VIEW_MODE = 83,
    ACTION_ID_ETHERNET_TOGGLE = 84,
    ACTION_ID_MQTT_TOGGLE = 85,
    ACTION_ID_ETHERNET_TOGGLE_DHCP = 86,
    ACTION_ID_ETHERNET_EDIT_MAC_ADDRESS = 87,
    ACTION_ID_ETHERNET_EDIT_STATIC_ADDRESS = 88,
    ACTION_ID_ETHERNET_EDIT_IP_ADDRESS = 89,
    ACTION_ID_ETHERNET_EDIT_DNS = 90,
    ACTION_ID_ETHERNET_EDIT_GATEWAY = 91,
    ACTION_ID_ETHERNET_EDIT_SUBNET_MASK = 92,
    ACTION_ID_ETHERNET_EDIT_SCPI_PORT = 93,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_OUTPUT_PROTECTION_COUPLE = 94,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_SHUTDOWN_WHEN_PROTECTION_TRIPPED = 95,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_FORCE_DISABLING_ALL_OUTPUTS_ON_POWER_UP = 96,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_TOGGLE_STATE = 97,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_EDIT_LEVEL = 98,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_EDIT_DELAY = 99,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_CLEAR = 100,
    ACTION_ID_EDIT_SYSTEM_PASSWORD = 101,
    ACTION_ID_SYS_FRONT_PANEL_LOCK = 102,
    ACTION_ID_SYS_FRONT_PANEL_UNLOCK = 103,
    ACTION_ID_SYS_SETTINGS_SOUND_TOGGLE = 104,
    ACTION_ID_SYS_SETTINGS_SOUND_TOGGLE_CLICK = 105,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT = 106,
    ACTION_ID_SYS_SETTINGS_ENCODER_TOGGLE_CONFIRMATION_MODE = 107,
    ACTION_ID_TURN_DISPLAY_OFF = 108,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_TRIGGER_MODE = 109,
    ACTION_ID_CH_SETTINGS_LISTS_EDIT_LIST_COUNT = 110,
    ACTION_ID_CH_SETTINGS_LISTS_EDIT_ON_LIST_STOP = 111,
    ACTION_ID_CHANNEL_LISTS_PREVIOUS_PAGE = 112,
    ACTION_ID_CHANNEL_LISTS_NEXT_PAGE = 113,
    ACTION_ID_CHANNEL_LISTS_EDIT = 114,
    ACTION_ID_SHOW_CHANNEL_LISTS_INSERT_MENU = 115,
    ACTION_ID_SHOW_CHANNEL_LISTS_DELETE_MENU = 116,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_ABOVE = 117,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_BELOW = 118,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROW = 119,
    ACTION_ID_CHANNEL_LISTS_CLEAR_COLUMN = 120,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROWS = 121,
    ACTION_ID_CHANNEL_LISTS_DELETE_ALL = 122,
    ACTION_ID_TRIGGER_SELECT_SOURCE = 123,
    ACTION_ID_TRIGGER_EDIT_DELAY = 124,
    ACTION_ID_TRIGGER_TOGGLE_INITIATE_CONTINUOUSLY = 125,
    ACTION_ID_TRIGGER_GENERATE_MANUAL = 126,
    ACTION_ID_TRIGGER_SHOW_GENERAL_SETTINGS = 127,
    ACTION_ID_SHOW_STAND_BY_MENU = 128,
    ACTION_ID_RESET = 129,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_SELECT_MODE = 130,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_TOGGLE_AUTO_RANGING = 131,
    ACTION_ID_IO_PIN_TOGGLE_POLARITY = 132,
    ACTION_ID_IO_PIN_SELECT_FUNCTION = 133,
    ACTION_ID_NTP_TOGGLE = 134,
    ACTION_ID_NTP_EDIT_SERVER = 135,
    ACTION_ID_SELECT_THEME = 136,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 137,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 138,
    ACTION_ID_RESTART = 139,
    ACTION_ID_USER_SWITCH_CLICKED = 140,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 141,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 142,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 143,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 144,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 145,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 146,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 147,
    ACTION_ID_SET_COUPLING_PARALLEL = 148,
    ACTION_ID_SET_COUPLING_SERIES = 149,
    ACTION_ID_SET_COUPLING_COMMON_GND = 150,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 151,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 152,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 153,
    ACTION_ID_DRAG_OVERLAY = 154,
    ACTION_ID_DLOG_TOGGLE = 155,
    ACTION_ID_SHOW_DLOG_VIEW = 156,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 157,
    ACTION_ID_SHOW_FILE_MANAGER = 158,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 159,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT = 160,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 161,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 162,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 163,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 164,
    ACTION_ID_SHOW_DLOG_PARAMS = 165,
    ACTION_ID_DLOG_EDIT_PERIOD = 166,
    ACTION_ID_DLOG_EDIT_DURATION = 167,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 168,
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 169,
    ACTION_ID_FILE_MANAGER_SORT_BY = 170,
    ACTION_ID_DLOG_AUTO_SCALE = 171,
    ACTION_ID_DLOG_UPLOAD = 172,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 173,
    ACTION_ID_MQTT_EDIT_HOST = 174,
    ACTION_ID_MQTT_EDIT_PORT = 175,
    ACTION_ID_MQTT_EDIT_USERNAME = 176,
    ACTION_ID_MQTT_EDIT_PASSWORD = 177,
    ACTION_ID_MQTT_EDIT_PERIOD = 178,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 179,
    ACTION_ID_DLOG_SCALE_TO_FIT = 180,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 181,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 182,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 183,
    ACTION_ID_SHUTDOWN = 184,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 185,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 186,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 187,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 188,
    ACTION_ID_PROFILE_IMPORT = 189,
    ACTION_ID_PROFILE_EXPORT = 190,
    ACTION_ID_EVENT_QUEUE_FILTER = 191,
    ACTION_ID_EVENT_QUEUE_SELECT_EVENT = 192,
    ACTION_ID_DATE_TIME_SELECT_FORMAT = 193,
    ACTION_ID_DATE_TIME_TOGGLE_AM_PM = 194,
    ACTION_ID_EDIT_NO_FOCUS = 195,
    ACTION_ID_UNTRACK_ALL = 196,
    ACTION_ID_CH_SETTINGS_COPY = 197,
    ACTION_ID_SHOW_SYS_SETTINGS_ETHERNET_ERROR = 198,
    ACTION_ID_FILE_MANAGER_SELECT_LIST_VIEW = 199,
    ACTION_ID_SHOW_SYS_SETTINGS_RAMP_AND_DELAY = 200,
    ACTION_ID_CHANNEL_TOGGLE_RAMP_STATE = 201,
    ACTION_ID_DLOG_VIEW_SELECT_LEGEND_VIEW_OPTION = 202,
    ACTION_ID_SET_FOCUS = 203,
    ACTION_ID_SELECT_CHANNEL_CALIBRATION_VALUE_TYPE = 204,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_NEXT = 205,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_PREVIOUS = 206,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_DELETE = 207,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_SAVE = 208,
    ACTION_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 209,
    ACTION_ID_CH_SETTINGS_CALIBRATION_VIEW_POINTS = 210,
    ACTION_ID_SHOW_TOUCH_CALIBRATION_INTRO = 211,
    ACTION_ID_TOGGLE_SLOT_MAX_VIEW = 212,
    ACTION_ID_SHOW_SLOT_SETTINGS = 213,
    ACTION_ID_SELECT_USB_MODE = 214,
    ACTION_ID_SELECT_USB_DEVICE_CLASS = 215,
    ACTION_ID_TOGGLE_DISPLAY_TEST_COLOR_INDEX = 216,
    ACTION_ID_SHOW_DISPLAY_TEST_PAGE = 217,
    ACTION_ID_EDIT_NTP_REFRESH_FREQUENCY = 218,
    ACTION_ID_KEYPAD_OPTION3 = 219,
    ACTION_ID_SHOW_LABELS_AND_COLORS = 220,
    ACTION_ID_CHANGE_SLOT_LABEL = 221,
    ACTION_ID_CHANGE_CHANNEL_LABEL = 222,
    ACTION_ID_SHOW_CHANNEL_COLOR_PICKER = 223,
    ACTION_ID_PICK_COLOR = 224,
    ACTION_ID_KEYPAD_SET_DEFAULT = 225,
    ACTION_ID_SHOW_SLOT_COLOR_PICKER = 226,
    ACTION_ID_PICK_DEFAULT_COLOR = 227,
    ACTION_ID_DLOG_ITEM_TOGGLE = 228,
    ACTION_ID_DLOG_TRIGGER_SELECT_SOURCE = 229,
    ACTION_ID_SELECT_MASS_STORAGE_DEVICE = 230,
    ACTION_ID_MODULE_RESYNC = 231,
    ACTION_ID_SELECT_AC_MAINS = 232,
    ACTION_ID_SHOW_SELECT_MCU_REVISION_PAGE = 233,
    ACTION_ID_SELECT_R2B4_REVISION = 234,
    ACTION_ID_SELECT_R3B3_REVISION = 235,
    ACTION_ID_SELECT_MCU_REVISION = 236,
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 237,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 238,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 239,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 240,
    ACTION_ID_DIB_MIO168_AIN_SHOW_CONFIGURATION = 241,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE = 242,
    ACTION_ID_DIB_MIO168_AIN_SELECT_RANGE = 243,
    ACTION_ID_DIB_MIO168_AIN_CHANGE_LABEL = 244,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE_AND_RANGE = 245,
    ACTION_ID_DIB_MIO168_AOUT_TOGGLE_OUTPUT_ENABLED = 246,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_OUTPUT_MODE = 247,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_VOLTAGE_RANGE = 248,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_CURRENT_RANGE = 249,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_MODE_AND_RANGE = 250,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_CONFIGURATION = 251,
    ACTION_ID_DIB_MIO168_AOUT_CHANGE_LABEL = 252,
    ACTION_ID_DIB_MIO168_SHOW_INFO = 253,
    ACTION_ID_DIB_MIO168_SHOW_CALIBRATION = 254,
    ACTION_ID_DIB_MIO168_SHOW_CHANNEL_LABELS = 255,
    ACTION_ID_DIB_MIO168_SHOW_DIN_CHANNEL_LABELS = 256,
    ACTION_ID_DIB_MIO168_SHOW_DOUT_CHANNEL_LABELS = 257,
    ACTION_ID_DIB_MIO168_CHANGE_DIN_LABEL = 258,
    ACTION_ID_DIB_MIO168_CHANGE_DOUT_LABEL = 259,
    ACTION_ID_DIB_MIO168_PWM_CHANGE_LABEL = 260,
    ACTION_ID_DIB_MIO168_PAGER_SELECT_PAGE = 261,
    ACTION_ID_DIB_PREL6_TOGGLE_RELAY = 262,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 263,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 264,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 265,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 266,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 267,
    ACTION_ID_DIB_SMX46_SHOW_DAC1_CALIBRATION = 268,
    ACTION_ID_DIB_SMX46_SHOW_DAC2_CALIBRATION = 269,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 270,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 271,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 272,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 273,
    ACTION_ID_DIB_SMX46_CHANGE_SUBCHANNEL_LABEL = 274,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 275,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 276,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 277,
    ACTION_ID_SIMULATOR_LOAD = 278,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 279,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 280
};
...
enum StylesEnum {
    ...
    STYLE_ID_VALUE_S = 52,
    STYLE_ID_TOUCH_CALIBRATION = 53,
    STYLE_ID_NOTE_M = 54,
    STYLE_ID_TOUCH_CALIBRATION_POINT = 55,
    STYLE_ID_BUTTON_BGND = 56,
    STYLE_ID_STATUS_ICON_ENABLED_WITH_NEED_ATTENTION = 57,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ERROR = 58,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ACTIVE = 59,
    STYLE_ID_STATUS_ICON_ENABLED_BLINK = 60,
    STYLE_ID_STATUS_ICON_DISABLED = 61,
    STYLE_ID_DLOG_RECORD_BUTTON = 62,
    STYLE_ID_STATUS_ICON_DISABLED_BLINK = 63,
    STYLE_ID_OVERLAY = 64,
    STYLE_ID_OVERLAY_LEFT = 65,
    STYLE_ID_OVERLAY_ICON = 66,
    STYLE_ID_VALUE_S_LEFT = 67,
    STYLE_ID_EDIT_VALUE_M_LEFT = 68,
    STYLE_ID_KEY_ICONS = 69,
    STYLE_ID_KEY = 70,
    STYLE_ID_KEY_DISABLED = 71,
    STYLE_ID_INLINE72 = 72,
    STYLE_ID_TAB_PAGE_SELECTED = 73,
    STYLE_ID_TAB_PAGE = 74,
    ...
    STYLE_ID_EDIT_VALUE_S_LEFT = 84,
    STYLE_ID_SLIDER_SHADE_1 = 85,
    STYLE_ID_SLIDER_SHADE_2 = 86,
    STYLE_ID_SLIDER_SHADE_3 = 87,
    STYLE_ID_SLIDER_SHADE_4 = 88,
    STYLE_ID_SLIDER_SHADE_5 = 89,
    STYLE_ID_YES_NO = 90,
    STYLE_ID_YES_NO_BUTTON = 91,
    STYLE_ID_YES_NO_MESSAGE = 92,
    STYLE_ID_INLINE93 = 93,
    STYLE_ID_TEXT_MESSAGE = 94,
    STYLE_ID_INLINE95 = 95,
    STYLE_ID_INLINE96 = 96,
    STYLE_ID_ASYNC_OPERATION = 97,
    STYLE_ID_PROGRESS = 98,
    ...
    STYLE_ID_DEFAULT_INVERSE = 107,
    STYLE_ID_SCROLLBAR_THUMB = 108,
    STYLE_ID_SCROLLBAR_BUTTON = 109,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 110,
    STYLE_ID_INLINE111 = 111,
    STYLE_ID_KEY_SPEC_ICONS = 112,
    STYLE_ID_INLINE113 = 113,
    STYLE_ID_KEY_SPEC_ICONS_DISABLED = 114,
    STYLE_ID_INLINE115 = 115,
    STYLE_ID_INLINE116 = 116,
    STYLE_ID_INLINE117 = 117,
    STYLE_ID_INLINE118 = 118,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 119,
    ...
    STYLE_ID_VALUE_M_LEFT = 128,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 129,
    STYLE_ID_INLINE130 = 130,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 131,
    STYLE_ID_ENCODER_CURSOR_17_ENABLED = 132,
    STYLE_ID_INLINE133 = 133,
    STYLE_ID_YT_GRAPH = 134,
    STYLE_ID_LIST_GRAPH_CURSOR = 135,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 136,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 137,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 138,
    STYLE_ID_INLINE139 = 139,
    STYLE_ID_INLINE140 = 140,
    STYLE_ID_INLINE141 = 141,
    STYLE_ID_EDIT_VALUE_M_CENTERED = 142,
    STYLE_ID_INLINE143 = 143,
    STYLE_ID_INLINE144 = 144,
    STYLE_ID_INLINE145 = 145,
    STYLE_ID_BUTTON_S_DISABLED = 146,
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 213,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 214,
    STYLE_ID_SCROLLBAR_TRACK = 215,
    ...
    STYLE_ID_LABELS_AND_COLORS_SLOT = 264,
    STYLE_ID_INLINE265 = 265,
    STYLE_ID_INLINE266 = 266,
    STYLE_ID_INLINE267 = 267,
    STYLE_ID_FRONT_PANEL_MODULE = 268,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 311,
    STYLE_ID_INLINE312 = 312,
    STYLE_ID_MON_VALUE_20_LEFT = 313,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 314,
    STYLE_ID_BAR_GRAPH_TEXT = 315,
    STYLE_ID_BAR_GRAPH_SET_LINE = 316,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 317,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 318,
    STYLE_ID_LABELS_AND_COLORS_CHANNEL = 319,
    STYLE_ID_INLINE320 = 320,
    STYLE_ID_INLINE321 = 321,
    STYLE_ID_TRIGGER_BUTTON_24 = 322,
    STYLE_ID_INLINE323 = 323,
    STYLE_ID_INLINE324 = 324,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 325,
    STYLE_ID_TRIGGER_BUTTON_14 = 326,
    STYLE_ID_INLINE327 = 327,
    STYLE_ID_INST_SELECTED = 328,
    STYLE_ID_MON_VALUE_38_RIGHT = 329,
    STYLE_ID_INLINE330 = 330,
    STYLE_ID_CH_PROT_OFF = 331,
    STYLE_ID_CH_PROT_ON = 332,
    STYLE_ID_CH_PROT_TRIPPED = 333,
    STYLE_ID_INLINE334 = 334,
    STYLE_ID_MON_VALUE_20_RIGHT = 335,
    STYLE_ID_MON_VALUE_14_LEFT = 336,
    STYLE_ID_MON_VALUE_14_CENTER = 337,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 338,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 339,
    STYLE_ID_MON_VALUE_14_RIGHT = 340,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 341,
    STYLE_ID_MON_VALUE_24_RIGHT = 342,
...
enum PagesEnum {
    ...
    PAGE_ID_CH_SETTINGS_PROT_CLEAR = 29,
    PAGE_ID_CH_SETTINGS_PROT_OVP = 30,
    PAGE_ID_CH_SETTINGS_PROT_OCP = 31,
    PAGE_ID_CH_SETTINGS_PROT_OPP = 32,
    PAGE_ID_CH_SETTINGS_PROT_OTP = 33,
    PAGE_ID_CH_SETTINGS_TRIGGER = 34,
    PAGE_ID_CH_SETTINGS_LISTS = 35,
    PAGE_ID_CH_SETTINGS_LISTS_INSERT_MENU = 36,
    PAGE_ID_CH_SETTINGS_LISTS_FILE_MENU = 37,
    PAGE_ID_CH_SETTINGS_LISTS_DELETE_MENU = 38,
    PAGE_ID_CH_SETTINGS_CALIBRATION = 39,
    PAGE_ID_CH_SETTINGS_CALIBRATION_EDIT = 40,
    PAGE_ID_CH_SETTINGS_CALIBRATION_VIEW = 41,
    PAGE_ID_CH_SETTINGS_ADV_OPTIONS = 42,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 43,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 44,
    PAGE_ID_CH_SETTINGS_INFO = 45,
    PAGE_ID_SYS_SETTINGS = 46,
    PAGE_ID_SYS_SETTINGS_TEMPERATURE = 47,
    PAGE_ID_SYS_SETTINGS_PROTECTIONS = 48,
    PAGE_ID_SYS_SETTINGS_TRIGGER = 49,
    PAGE_ID_SYS_SETTINGS_IO = 50,
    PAGE_ID_SYS_SETTINGS_DATE_TIME = 51,
    PAGE_ID_SYS_SETTINGS_ENCODER = 52,
    PAGE_ID_SYS_SETTINGS_USB = 53,
    PAGE_ID_SYS_SETTINGS_ETHERNET = 54,
    PAGE_ID_SYS_SETTINGS_MQTT = 55,
    PAGE_ID_SYS_SETTINGS_ETHERNET_STATIC = 56,
    PAGE_ID_SYS_SETTINGS_SCREEN_CALIBRATION = 57,
    PAGE_ID_SYS_SETTINGS_DISPLAY = 58,
    PAGE_ID_SYS_SETTINGS_DISPLAY_TEST = 59,
    PAGE_ID_SYS_SETTINGS_SOUND = 60,
    PAGE_ID_SYS_SETTINGS_TRACKING = 61,
    PAGE_ID_SYS_SETTINGS_COUPLING = 62,
    PAGE_ID_SYS_SETTINGS_RAMP_AND_DELAY = 63,
    PAGE_ID_SYS_INFO = 64,
    PAGE_ID_SYS_SETTINGS_LABELS_AND_COLORS = 65,
    PAGE_ID_USER_PROFILES = 66,
    PAGE_ID_USER_PROFILE_SETTINGS = 67,
    PAGE_ID_USER_PROFILE_0_SETTINGS = 68,
    PAGE_ID_PROFILE_BASIC_INFO = 69,
    ...
    PAGE_ID_FOCUS_VALUE_OVERLAY = 111,
    PAGE_ID_OVP_TYPE = 112,
    PAGE_ID_SLOT_LABELS_AND_COLORS = 113,
    PAGE_ID_COLOR_PICKER = 114,
    PAGE_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 115,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 116,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF_2COL = 117,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 118,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 119,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 120,
    ...
    PAGE_ID_DIB_MIO168_AIN_CONFIGURATION = 127,
    PAGE_ID_DIB_MIO168_AOUT_DAC7760_CONFIGURATION = 128,
    PAGE_ID_DIB_MIO168_AOUT_DAC7563_CONFIGURATION = 129,
    PAGE_ID_DIB_MIO168_INFO = 130,
    PAGE_ID_DIB_PREL6_SIMULATOR_FRONT_PANEL_MASK = 131,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF = 132,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_2COL = 133,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 134,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 135,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 136,
    PAGE_ID_DIB_PREL6_SETTINGS = 137,
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 138,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 139,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL = 140,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 141,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 142,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 143,
    PAGE_ID_DIB_SMX46_SETTINGS = 144,
    PAGE_ID_DIB_SMX46_CONFIGURE_ROUTES = 145,
    PAGE_ID_DIB_SMX46_INFO = 146,
    PAGE_ID_DIB_SMX46_RELAY_CYCLES = 147,
    PAGE_ID_DIB_SMX46_LABELS_AND_COLORS = 148,
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 149,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON = 150,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON_2COL = 151,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON = 152,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON_2COL = 153,
    PAGE_ID_DIB_DCP405_LABELS_AND_COLORS = 154,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF = 155,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF_2COL = 156,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 157,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES_2COL = 158,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 159,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL_2COL = 160,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON = 161,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON_2COL = 162,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON = 163,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON_2COL = 164,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF = 165,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF_2COL = 166,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 167,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES_2COL = 168,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 169,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL_2COL = 170,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_TITLE = 171,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_ON = 172,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_OFF = 173,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_OFF = 174,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_ON = 175,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_ON = 176,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_OFF = 177,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_TITLE = 178,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_ON = 179,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_OFF = 180,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_SERIES = 181,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_PARALLEL = 182,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_TITLE = 183,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_ON = 184,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_OFF = 185,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_COUPLED_SERIES = 186,
    PAGE_ID_DIB_DCP405_SLOT_MICRO_1CH_COUPLED_PARALLEL = 187,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK = 188,
    PAGE_ID_DIB_DCM220_FRONT_PANEL_LED = 189,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT = 190,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT_2COL = 191,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT_ON = 192,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT_ON_2COL = 193,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT_OFF = 194,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT_OFF_2COL = 195,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ = 196,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_2COL = 197,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_ON = 198,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_ON_2COL = 199,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_OFF = 200,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_OFF_2COL = 201,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH = 202,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_TITLE = 203,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_NUM_ON = 204,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_OFF = 205,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_NUM_OFF = 206,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_HBAR_ON = 207,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_HBAR_OFF = 208,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_ON = 209,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_YT_ON = 210,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_YT_OFF = 211,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_TITLE = 212,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH_TITLE = 213,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH = 214,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH_ON = 215,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH_OFF = 216,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH = 217,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_TITLE = 218,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_ON = 219,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_OFF = 220,
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS = 221,
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS_CH = 222,
    PAGE_ID_FRONT_PANEL = 223,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 224,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 225,
    PAGE_ID_DIB_DCM224_SIMULATOR_FRONT_PANEL_MASK = 226,
    PAGE_ID_DIB_DCM224_FRONT_PANEL_LED = 227,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ADV_OPTIONS = 228,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT = 229,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_2COL = 230,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON = 231,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON_2COL = 232,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF = 233,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF_2COL = 234,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ = 235,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_2COL = 236,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON = 237,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON_2COL = 238,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF = 239,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF_2COL = 240,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH = 241,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_TITLE = 242,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_ON = 243,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_OFF = 244,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_OFF = 245,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_ON = 246,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_OFF = 247,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_ON = 248,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_ON = 249,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_OFF = 250,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_TITLE = 251,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_TITLE = 252,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH = 253,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_ON = 254,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_OFF = 255,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH = 256,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_TITLE = 257,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_ON = 258,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_OFF = 259,
    PAGE_ID_DIB_DCM224_LABELS_AND_COLORS = 260,
    PAGE_ID_DIB_DCM224_LABELS_AND_COLORS_CH = 261
};

extern const uint8_t assets[545202];
