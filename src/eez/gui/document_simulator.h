...
enum StylesEnum {
    ...
    STYLE_ID_EDIT_VALUE_M_CENTERED = 166,
    STYLE_ID_EDIT_S = 167,
    ...
    STYLE_ID_DISPLAY_OFF = 190,
    STYLE_ID_DISPLAY_OFF_S = 191,
    STYLE_ID_INLINE192 = 192,
    STYLE_ID_INLINE193 = 193,
    STYLE_ID_MON_VALUE_48_RIGHT = 194,
    STYLE_ID_INLINE195 = 195,
    STYLE_ID_MON_VALUE_20_LEFT = 196,
    ...
    STYLE_ID_BUTTON_S_DISABLED = 251,
...
extern const uint8_t assets[413666];
