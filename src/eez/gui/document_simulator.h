...
enum StylesEnum {
    ...
    STYLE_ID_STATUS_BGND = 90,
    STYLE_ID_EDIT_VALUE_ACTIVE = 91,
    STYLE_ID_DEFAULT_DISABLED = 92,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S = 93,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_DISABLED = 94,
    STYLE_ID_DARK_LINE = 95,
    STYLE_ID_DISPLAY_OFF = 96,
    STYLE_ID_DISPLAY_OFF_S = 97,
    STYLE_ID_SET_VALUE_S_RIGHT_BALANCED = 98,
    STYLE_ID_SET_VALUE_BALANCED = 99,
    STYLE_ID_SET_VALUE_FOCUS_BALANCED = 100,
    STYLE_ID_PROT_INDICATOR_S = 101,
    STYLE_ID_PROT_INDICATOR_SET_S = 102,
    STYLE_ID_PROT_INDICATOR_TRIP_S = 103,
    STYLE_ID_FRONT_PANEL_DEFAULT = 104,
...
enum PagesEnum {
    ...
    PAGE_ID_CHANNELS = 77,
    PAGE_ID_PROFILE = 78,
    PAGE_ID_PROFILE_BASIC_INFO = 79,
    PAGE_ID_COUPLED_CHANNELS_DEFAULT_VIEW = 80,
    PAGE_ID_COUPLED_CHANNELS_HORIZONTAL_BAR_VIEW = 81,
    PAGE_ID_COUPLED_CHANNELS_VERTICAL_BAR_VIEW = 82,
    PAGE_ID_COUPLED_CHANNELS_YTBAR_VIEW = 83,
    PAGE_ID_OCP = 84,
    PAGE_ID_OVP = 85,
    PAGE_ID_OTP = 86,
    PAGE_ID_OPP = 87,
    PAGE_ID_FRONT_PANEL = 88,
    PAGE_ID_NUMERIC_KEYPAD2 = 89,
    PAGE_ID_OLD_STATUS_BAR = 90,
    PAGE_ID_OLD_TASK_BAR = 91,
    PAGE_ID_MINIMIZED_APP_VIEW = 92,
    PAGE_ID_TEST = 93
};

extern const uint8_t assets[201341];
