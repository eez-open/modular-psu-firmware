enum DataEnum {
    ...
    DATA_ID_CALIBRATION_POINTS = 415,
    DATA_ID_CALIBRATION_POINT_IS_SET = 416,
    DATA_ID_CALIBRATION_POINT_DAC = 417,
    DATA_ID_CALIBRATION_POINT_VALUE = 418,
    DATA_ID_CALIBRATION_POINT_ADC = 419,
    DATA_ID_CHANNEL_CALIBRATION_VALUE = 420,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 421,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_OTHER = 422
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SELECT_CHANNEL_CALIBRATION_VALUE = 218,
    ACTION_ID_DELETE_CALIBRATION_POINT = 219
};
...
extern const uint8_t assets[443819];
