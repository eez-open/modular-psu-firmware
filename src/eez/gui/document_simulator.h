...
enum StylesEnum {
    ...
    STYLE_ID_VALUE_M = 164,
    STYLE_ID_INLINE165 = 165,
    STYLE_ID_INLINE166 = 166,
    STYLE_ID_DEFAULT_DISABLED = 167,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 297,
    STYLE_ID_INLINE298 = 298,
    STYLE_ID_MON_VALUE_20_LEFT = 299,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 300,
    STYLE_ID_BAR_GRAPH_TEXT = 301,
    STYLE_ID_BAR_GRAPH_SET_LINE = 302,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 303,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 304,
...
extern const uint8_t assets[537561];
