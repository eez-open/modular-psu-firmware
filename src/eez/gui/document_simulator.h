enum DataEnum {
    ...
    DATA_ID_IO_PIN_UART_BAUD = 224,
    DATA_ID_IO_PIN_UART_PARITY = 225,
    DATA_ID_IO_PIN_UART_DATA_BITS = 226,
    DATA_ID_IO_PIN_UART_STOP_BITS = 227,
    ...
    DATA_ID_SELECTED_THEME = 233,
    DATA_ID_CHANNEL_TITLE = 234,
    DATA_ID_CHANNEL_SHORT_TITLE = 235,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 236,
    DATA_ID_CHANNEL_LONG_TITLE = 237,
    DATA_ID_ANIMATIONS_DURATION = 238,
    DATA_ID_SLOT_INFO = 239,
    DATA_ID_SLOT_TEST_RESULT = 240,
    DATA_ID_SLOT_DEFAULT_VIEW = 241,
    DATA_ID_SLOT1_CHANNEL_INDEX = 242,
    DATA_ID_SLOT2_CHANNEL_INDEX = 243,
    DATA_ID_SLOT3_CHANNEL_INDEX = 244,
    DATA_ID_SLOT1_NON_MAPPED_CHANNEL_INDEX = 245,
    DATA_ID_SLOT2_NON_MAPPED_CHANNEL_INDEX = 246,
    DATA_ID_SLOT3_NON_MAPPED_CHANNEL_INDEX = 247,
    DATA_ID_BATTERY = 248,
    DATA_ID_IO_PIN_STATE = 249,
    DATA_ID_CHANNEL_DPROG = 250,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 251,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 252,
    DATA_ID_SYS_INFO_HAS_ERROR = 253,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 254,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 255,
    DATA_ID_SYS_FAN_MODE = 256,
    DATA_ID_SYS_FAN_SPEED = 257,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 258,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 259,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 260,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 261,
    DATA_ID_IS_TRACKING_ALLOWED = 262,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 263,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 264,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 265,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 266,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 267,
    DATA_ID_IS_COUPLED_OR_TRACKED = 268,
    DATA_ID_OVERLAY = 269,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 270,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 271,
    DATA_ID_DLOG_STATE = 272,
    DATA_ID_DLOG_TOGGLE_STATE = 273,
    DATA_ID_RECORDING = 274,
    DATA_ID_CHANNEL_HISTORY_VALUES = 275,
    DATA_ID_RECORDING_READY = 276,
    DATA_ID_NONDRAG_OVERLAY = 277,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 278,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 279,
    DATA_ID_DLOG_VISIBLE_VALUES = 280,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 281,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 282,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 283,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 284,
    DATA_ID_DLOG_CURRENT_TIME = 285,
    DATA_ID_DLOG_FILE_LENGTH = 286,
    DATA_ID_DLOG_X_AXIS_OFFSET = 287,
    DATA_ID_DLOG_X_AXIS_DIV = 288,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 289,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 290,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 291,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 292,
    DATA_ID_DLOG_VIEW_STATE = 293,
    DATA_ID_DLOG_PERIOD = 294,
    DATA_ID_DLOG_PERIOD_SPEC = 295,
    DATA_ID_DLOG_DURATION = 296,
    DATA_ID_DLOG_FILE_NAME = 297,
    DATA_ID_CHANNEL_OFF_LABEL = 298,
    DATA_ID_FILE_MANAGER_FILES = 299,
    DATA_ID_FILE_MANAGER_FILE_NAME = 300,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 301,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 302,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 303,
    DATA_ID_FILE_MANAGER_STATE = 304,
    DATA_ID_FILE_MANAGER_HAS_PARENT = 305,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 306,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 307,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 308,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 309,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 310,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 311,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 312,
    DATA_ID_SCRIPT_INFO = 313,
    DATA_ID_SCRIPT_IS_STARTED = 314,
    DATA_ID_KEYPAD_OK_ENABLED = 315,
    DATA_ID_ETHERNET_HOST_NAME = 316,
    DATA_ID_MQTT_HOST = 317,
    DATA_ID_MQTT_PORT = 318,
    DATA_ID_MQTT_USERNAME = 319,
    DATA_ID_MQTT_PASSWORD = 320,
    DATA_ID_MQTT_PERIOD = 321,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 322,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 323,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 324,
    DATA_ID_LIST_COUNTER_LABEL = 325,
    DATA_ID_RAMP_COUNTER_LABEL = 326,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 327,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 328,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 329,
    DATA_ID_IS_RESET_BY_IWDG = 330,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 331,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 332,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 333,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 334,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 335,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 336,
    DATA_ID_DATE_TIME_FORMAT = 337,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 338,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 339,
    DATA_ID_DATE_TIME_AM_PM = 340,
    DATA_ID_IS_MULTI_TRACKING = 341,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 342,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 343,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 344,
    DATA_ID_CHANNEL_INFO_BRAND = 345,
    DATA_ID_CHANNEL_INFO_SERIAL = 346,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 347,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 348,
    DATA_ID_FILE_MANAGER_FILE_ICON = 349,
    DATA_ID_FILE_MANAGER_LAYOUT = 350,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 351,
    DATA_ID_TOUCH_RAW_X = 352,
    DATA_ID_TOUCH_RAW_Y = 353,
    DATA_ID_TOUCH_RAW_Z1 = 354,
    DATA_ID_TOUCH_RAW_PRESSED = 355,
    DATA_ID_TOUCH_CALIBRATED_X = 356,
    DATA_ID_TOUCH_CALIBRATED_Y = 357,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 358,
    DATA_ID_TOUCH_FILTERED_X = 359,
    DATA_ID_TOUCH_FILTERED_Y = 360,
    DATA_ID_TOUCH_FILTERED_PRESSED = 361,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 362,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 363,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 364,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 365,
    DATA_ID_ALERT_MESSAGE_IS_SET = 366,
    DATA_ID_ASYNC_PROGRESS = 367,
    DATA_ID_IO_PIN_FUNCTION = 368,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 369,
    DATA_ID_IO_PIN_PWM_DUTY = 370,
    DATA_ID_IO_PIN_IS_UART_ENABLED = 371,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 372,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 373,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 374,
    DATA_ID_CHANNEL_RAMP_STATE = 375,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 376,
    DATA_ID_MQTT_IN_ERROR = 377,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 378,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 379,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 380,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 381,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 382,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 383,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 384,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 385,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 386,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 387,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 388,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 389,
    DATA_ID_SLOTS = 390,
    DATA_ID_SLOT_INDEX = 391,
    DATA_ID_SLOT_TITLE_DEF = 392,
    DATA_ID_SLOT_TITLE_MAX = 393,
    DATA_ID_SLOT_TITLE_MIN = 394,
    DATA_ID_SLOT_TITLE_SETTINGS = 395,
    DATA_ID_SLOT_SHORT_TITLE = 396,
    ...
    DATA_ID_DLOG_ITEMS_NUM_SELECTED = 426,
    DATA_ID_DLOG_ITEM_IS_CHECKED = 427,
    DATA_ID_DLOG_ITEM_CHANNEL = 428,
    DATA_ID_DLOG_ITEM_LABEL = 429,
    DATA_ID_DLOG_ITEMS_SCROLLBAR_ENABLED = 430,
    ...
    DATA_ID_MODULE_IS_RESYNC_SUPPORTED = 437,
    DATA_ID_CHANNEL_IS_CALIBRATION_VALUE_SOURCE = 438,
    DATA_ID_CALIBRATION_POINT_CAN_EDIT_SET_VALUE = 439,
    DATA_ID_CALIBRATION_POINT_LIVE_MEASURED_VALUE = 440,
    DATA_ID_AC_MAINS = 441,
    DATA_ID_SELECTED_MCU_REVISION = 442,
    DATA_ID_IS_MCU_REVISION_SELECTED = 443,
    DATA_ID_SLOT_IS_2CH_VIEW = 444,
    DATA_ID_COLOR_IS_SELECTED = 445,
    DATA_ID_MASTER_ERROR_MESSAGE = 446,
    DATA_ID_DLOG_PERIOD_HAS_PREDEFINED_VALUES = 447,
    DATA_ID_DLOG_VIEW_SELECTED_TAB = 448,
    DATA_ID_DLOG_BOOKMARKS = 449,
    DATA_ID_DLOG_BOOKMARK_X_VALUE = 450,
    DATA_ID_DLOG_BOOKMARK_TEXT = 451,
    DATA_ID_DLOG_BOOKMARK_IS_SELECTED = 452,
    DATA_ID_DLOG_VIEW_IS_DRAWER_OPEN = 453,
    DATA_ID_DLOG_VIEW_IS_ZOOM_IN_ENABLED = 454,
    DATA_ID_DLOG_VIEW_IS_ZOOM_OUT_ENABLED = 455,
    DATA_ID_DLOG_BOOKMARKS_IS_SCROLLBAR_VISIBLE = 456,
    DATA_ID_DLOG_Y_VALUES_IS_SCROLLBAR_VISIBLE = 457,
    DATA_ID_DLOG_Y_VALUES = 458,
    DATA_ID_DLOG_Y_VALUE_LABEL = 459,
    DATA_ID_DLOG_Y_VALUE_IS_CHECKED = 460,
    DATA_ID_DLOG_Y_VALUE_IS_SELECTED = 461,
    DATA_ID_DLOG_Y_VALUE_IS_ENABLED = 462,
    DATA_ID_DLOG_Y_VALUE_OFFSET = 463,
    DATA_ID_DLOG_Y_VALUE_DIV = 464,
    DATA_ID_DLOG_Y_VALUE_CURSOR = 465,
    DATA_ID_FUNCTION_GENERATOR_CHANNELS = 466,
    DATA_ID_FUNCTION_GENERATOR_ANY_CHANNEL_SELECTED = 467,
    DATA_ID_FUNCTION_GENERATOR_CHANNEL = 468,
    DATA_ID_FUNCTION_GENERATOR_ITEM_LABEL = 469,
    DATA_ID_FUNCTION_GENERATOR_SELECTED_ITEM_LABEL = 470,
    DATA_ID_FUNCTION_GENERATOR_ITEM_IS_CHECKED = 471,
    DATA_ID_FUNCTION_GENERATOR_IS_MAX_SELECTED = 472,
    DATA_ID_FUNCTION_GENERATOR_NUM_SELECTED = 473,
    DATA_ID_FUNCTION_GENERATOR_ITEM_IS_SELECTED = 474,
    DATA_ID_FUNCTION_GENERATOR_WAVEFORM = 475,
    DATA_ID_FUNCTION_GENERATOR_WAVEFORM_LABEL = 476,
    DATA_ID_FUNCTION_GENERATOR_FREQUENCY = 477,
    DATA_ID_FUNCTION_GENERATOR_MODE = 478,
    DATA_ID_FUNCTION_GENERATOR_PHASE_SHIFT = 479,
    DATA_ID_FUNCTION_GENERATOR_AMPLITUDE = 480,
    DATA_ID_FUNCTION_GENERATOR_OFFSET = 481,
    DATA_ID_FUNCTION_GENERATOR_DUTY_CYCLE = 482,
    DATA_ID_FUNCTION_GENERATOR_CANVAS = 483,
    DATA_ID_FUNCTION_GENERATOR_HAS_MODE_SELECT = 484,
    DATA_ID_FUNCTION_GENERATOR_HAS_AMPLITUDE_AND_OFFSET = 485,
    DATA_ID_FUNCTION_GENERATOR_HAS_DUTY_CYCLE = 486,
    DATA_ID_FUNCTION_GENERATOR_IS_FREQ = 487,
    DATA_ID_FUNCTION_GENERATOR_IS_AMPL = 488,
    DATA_ID_FUNCTION_GENERATOR_IS_DC = 489,
    DATA_ID_FUNCTION_GENERATOR_ANY_SELECTED = 490,
    DATA_ID_OVERLAY_MINIMIZED = 491,
    DATA_ID_OVERLAY_HIDDEN = 492,
    DATA_ID_DIB_MIO168_DIN_PINS = 493,
    DATA_ID_DIB_MIO168_DIN_PINS_1_4 = 494,
    DATA_ID_DIB_MIO168_DIN_PINS_5_8 = 495,
    DATA_ID_DIB_MIO168_DIN_NO = 496,
    DATA_ID_DIB_MIO168_DIN_STATE = 497,
    DATA_ID_DIB_MIO168_DIN_RANGE = 498,
    DATA_ID_DIB_MIO168_DIN_LABEL = 499,
    DATA_ID_DIB_MIO168_DIN_LABEL_LABEL = 500,
    DATA_ID_DIB_MIO168_DIN_SPEED = 501,
    DATA_ID_DIB_MIO168_DOUT_PINS = 502,
    DATA_ID_DIB_MIO168_DOUT_PINS_1_4 = 503,
    DATA_ID_DIB_MIO168_DOUT_PINS_5_8 = 504,
    DATA_ID_DIB_MIO168_DOUT_NO = 505,
    DATA_ID_DIB_MIO168_DOUT_STATE = 506,
    DATA_ID_DIB_MIO168_DOUT_LABEL = 507,
    DATA_ID_DIB_MIO168_DOUT_LABEL_LABEL = 508,
    DATA_ID_DIB_MIO168_DOUT_TRIGGER_MODE = 509,
    DATA_ID_DIB_MIO168_DOUT_TRIGGER_IS_INITIATED = 510,
    DATA_ID_DIB_MIO168_DOUT_FUNCTION_LABEL = 511,
    DATA_ID_DIB_MIO168_AIN_CHANNELS = 512,
    DATA_ID_DIB_MIO168_AIN_LABEL = 513,
    DATA_ID_DIB_MIO168_AIN_LABEL_SHORT = 514,
    DATA_ID_DIB_MIO168_AIN_LABEL_LABEL = 515,
    DATA_ID_DIB_MIO168_AIN_VALUE = 516,
    DATA_ID_DIB_MIO168_AIN_MODE = 517,
    DATA_ID_DIB_MIO168_AIN_RANGE = 518,
    DATA_ID_DIB_MIO168_AIN_IS_DLOG_ACTIVE = 519,
    DATA_ID_DIB_MIO168_AIN_MODE_AND_RANGE = 520,
    DATA_ID_DIB_MIO168_AIN_MODE_IS_MULTIPLE_SELECTION_AVAILABLE = 521,
    DATA_ID_DIB_MIO168_AIN_RANGE_IS_MULTIPLE_SELECTION_AVAILABLE = 522,
    DATA_ID_DIB_MIO168_AIN_IS_OVERFLOW = 523,
    DATA_ID_DIB_MIO168_AIN_HAS_POWER_COLUMN = 524,
    DATA_ID_DIB_MIO168_AIN_HAS_P1 = 525,
    DATA_ID_DIB_MIO168_AIN_P1 = 526,
    DATA_ID_DIB_MIO168_AIN_HAS_P2 = 527,
    DATA_ID_DIB_MIO168_AIN_P2 = 528,
    DATA_ID_DIB_MIO168_AIN_HAS_EFFICIENCY = 529,
    DATA_ID_DIB_MIO168_AIN_CALC_EFFICIENCY = 530,
    DATA_ID_DIB_MIO168_AIN_EFFICIENCY = 531,
    DATA_ID_DIB_MIO168_AIN_ACTIVE_POWER = 532,
    DATA_ID_DIB_MIO168_AIN_REACTIVE_POWER = 533,
    DATA_ID_DIB_MIO168_AIN_VOLT_RMS = 534,
    DATA_ID_DIB_MIO168_AIN_CURR_RMS = 535,
    DATA_ID_DIB_MIO168_AIN_APPARENT_POWER = 536,
    DATA_ID_DIB_MIO168_AIN_POWER_FACTOR = 537,
    DATA_ID_DIB_MIO168_AIN_NPLC = 538,
    DATA_ID_DIB_MIO168_AIN_APERTURE = 539,
    DATA_ID_DIB_MIO168_AIN_EFFICIENCY_FORMULA = 540,
    DATA_ID_DIB_MIO168_IS_NO_AFE = 541,
    DATA_ID_DIB_MIO168_AC_ANALYSIS_ENABLED = 542,
    DATA_ID_DIB_MIO168_AOUT_CHANNELS = 543,
    DATA_ID_DIB_MIO168_AOUT_LABEL = 544,
    DATA_ID_DIB_MIO168_AOUT_LABEL_SHORT = 545,
    DATA_ID_DIB_MIO168_AOUT_LABEL_LABEL = 546,
    DATA_ID_DIB_MIO168_AOUT_VALUE = 547,
    DATA_ID_DIB_MIO168_AOUT_VALUE_IS_OFF = 548,
    DATA_ID_DIB_MIO168_AC_ANALYSIS_ALLOWED = 549,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_ENABLED = 550,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_MODE = 551,
    DATA_ID_DIB_MIO168_AOUT_VOLTAGE_RANGE = 552,
    DATA_ID_DIB_MIO168_AOUT_CURRENT_RANGE = 553,
    DATA_ID_DIB_MIO168_AOUT_CHANNEL_HAS_SETTINGS = 554,
    DATA_ID_DIB_MIO168_AOUT_MODE_AND_RANGE = 555,
    DATA_ID_DIB_MIO168_AOUT_TRIGGER_MODE = 556,
    DATA_ID_DIB_MIO168_AOUT_TRIGGER_IS_INITIATED = 557,
    DATA_ID_DIB_MIO168_AOUT_FUNCTION_LABEL = 558,
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 559,
    DATA_ID_DIB_MIO168_PWM_LABEL = 560,
    DATA_ID_DIB_MIO168_PWM_LABEL_SHORT = 561,
    DATA_ID_DIB_MIO168_PWM_LABEL_LABEL = 562,
    DATA_ID_DIB_MIO168_PWM_FREQ = 563,
    DATA_ID_DIB_MIO168_PWM_DUTY = 564,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 565,
    DATA_ID_DIB_MIO168_AFE_VERSION = 566,
    DATA_ID_DIB_MIO168_PAGER_LIST = 567,
    DATA_ID_DIB_MIO168_PAGER_IS_SELECTED = 568,
    DATA_ID_DIB_MIO168_PAGER_SELECTED_PAGE = 569,
    DATA_ID_DIB_MIO168_SELECTED_PAGE_IN_DEFAULT_VIEW = 570,
    DATA_ID_DIB_MIO168_SIMULATOR_AFE_VERSION = 571,
    DATA_ID_DIB_MIO168_IS_SETTINGS_PAGE_SELECTED = 572,
    DATA_ID_DIB_PREL6_RELAYS = 573,
    DATA_ID_DIB_PREL6_RELAY_IS_ON = 574,
    DATA_ID_DIB_PREL6_RELAY_LABEL = 575,
    DATA_ID_DIB_PREL6_RELAY_CYCLES = 576,
    DATA_ID_DIB_PREL6_RELAY_LABEL_LABEL = 577,
    DATA_ID_DIB_PREL6_IS_RELAY_1_OR_6 = 578,
    DATA_ID_DIB_SMX46_ROUTES = 579,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 580,
    DATA_ID_DIB_SMX46_X_LABELS = 581,
    DATA_ID_DIB_SMX46_X_LABEL = 582,
    DATA_ID_DIB_SMX46_Y_LABELS = 583,
    DATA_ID_DIB_SMX46_Y_LABEL = 584,
    DATA_ID_DIB_SMX46_AOUT_CHANNELS = 585,
    DATA_ID_DIB_SMX46_AOUT_VALUE = 586,
    DATA_ID_DIB_SMX46_AOUT_LABEL = 587,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_MODE = 588,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_IS_INITIATED = 589,
    DATA_ID_DIB_SMX46_AOUT_FUNCTION_LABEL = 590,
    DATA_ID_DIB_SMX46_RELAY_ON = 591,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 592,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 593,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 594,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_VIEW = 595,
    DATA_ID_DIB_DCM220_SLOT_MIN_2CH_VIEW = 596,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 597,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 598,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_VIEW = 599,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 600,
    DATA_ID_SIMULATOR_LOAD_STATE = 601,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 602,
    DATA_ID_SIMULATOR_LOAD = 603,
    DATA_ID_SIMULATOR_LOAD2 = 604,
    DATA_ID_MAIN_APP_VIEW = 605,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 606,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 607,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 608,
    DATA_ID_DIB_DCM224_PWM_DUTY = 609,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 610,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 611,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 612,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 613,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_VIEW = 614,
    DATA_ID_DIB_DCM224_SLOT_MIN_2CH_VIEW = 615,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 616,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 617,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_VIEW = 618,
    DATA_ID_DIB_MUX14D_P1_RELAYS = 619,
    DATA_ID_DIB_MUX14D_P1_RELAY_LABEL = 620,
    DATA_ID_DIB_MUX14D_P1_RELAY_IS_FIRST = 621,
    DATA_ID_DIB_MUX14D_P1_RELAY_IS_ON = 622,
    DATA_ID_DIB_MUX14D_P1_RELAY_CYCLES = 623,
    DATA_ID_DIB_MUX14D_P1_RELAY_LABEL_LABEL = 624,
    DATA_ID_DIB_MUX14D_P2_RELAYS = 625,
    DATA_ID_DIB_MUX14D_P2_RELAY_LABEL = 626,
    DATA_ID_DIB_MUX14D_P2_RELAY_IS_FIRST = 627,
    DATA_ID_DIB_MUX14D_P2_RELAY_IS_ON = 628,
    DATA_ID_DIB_MUX14D_P2_RELAY_CYCLES = 629,
    DATA_ID_DIB_MUX14D_P2_RELAY_LABEL_LABEL = 630,
    DATA_ID_DIB_MUX14D_EXT_RELAY_IS_ON = 631,
    DATA_ID_DIB_MUX14D_EXT_RELAY_CYCLES = 632,
    DATA_ID_DIB_MUX14D_ADIB1_RELAY_IS_ON = 633,
    DATA_ID_DIB_MUX14D_ADIB1_RELAY_CYCLES = 634,
    DATA_ID_DIB_MUX14D_ADIB2_RELAY_IS_ON = 635,
    DATA_ID_DIB_MUX14D_ADIB2_RELAY_CYCLES = 636,
    DATA_ID_DIB_MUX14D_CJ_TEMP = 637,
    DATA_ID_DIB_MUX14D_MULTIPLE_CONNECTIONS = 638
};
...
enum ActionsEnum {
    ...
    ACTION_ID_FUNCTION_GENERATOR_TOGGLE_FREQ = 262,
    ACTION_ID_FUNCTION_GENERATOR_TOGGLE_AMPL = 263,
    ACTION_ID_FUNCTION_GENERATOR_DESELECT_ALL = 264,
    ACTION_ID_TOGGLE_OVERLAY_MINIMIZED = 265,
    ACTION_ID_HIDE_OVERLAY = 266,
    ACTION_ID_SHOW_OVERLAY = 267,
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 268,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 269,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 270,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 271,
    ACTION_ID_DIB_MIO168_DOUT_SELECT_TRIGGER_MODE = 272,
    ACTION_ID_DIB_MIO168_DOUT_SHOW_CONFIGURATION = 273,
    ACTION_ID_DIB_MIO168_DOUT_SHOW_FUNCTION = 274,
    ACTION_ID_DIB_MIO168_AIN_SHOW_CONFIGURATION = 275,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE = 276,
    ACTION_ID_DIB_MIO168_AIN_SELECT_RANGE = 277,
    ACTION_ID_DIB_MIO168_AIN_CHANGE_LABEL = 278,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE_AND_RANGE = 279,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_EFFICIENCY_FORMULA = 280,
    ACTION_ID_DIB_MIO168_AOUT_TOGGLE_OUTPUT_ENABLED = 281,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_OUTPUT_MODE = 282,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_VOLTAGE_RANGE = 283,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_CURRENT_RANGE = 284,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_MODE_AND_RANGE = 285,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_CONFIGURATION = 286,
    ACTION_ID_DIB_MIO168_AOUT_CHANGE_LABEL = 287,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_TRIGGER_MODE = 288,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_FUNCTION = 289,
    ACTION_ID_DIB_MIO168_SHOW_INFO = 290,
    ACTION_ID_DIB_MIO168_SHOW_CALIBRATION = 291,
    ACTION_ID_DIB_MIO168_SHOW_CHANNEL_LABELS = 292,
    ACTION_ID_DIB_MIO168_SHOW_DIN_CHANNEL_LABELS = 293,
    ACTION_ID_DIB_MIO168_SHOW_DOUT_CHANNEL_LABELS = 294,
    ACTION_ID_DIB_MIO168_CHANGE_DIN_LABEL = 295,
    ACTION_ID_DIB_MIO168_CHANGE_DOUT_LABEL = 296,
    ACTION_ID_DIB_MIO168_PWM_CHANGE_LABEL = 297,
    ACTION_ID_DIB_MIO168_PAGER_SELECT_PAGE = 298,
    ACTION_ID_DIB_MIO168_SELECT_SIMULATOR_AFE_VERSION = 299,
    ACTION_ID_DIB_MIO168_SHOW_SLOT_SETTINGS_IN_MAX_VIEW = 300,
    ACTION_ID_DIB_MIO168_SELECT_PAGE_IN_DEFAULT_VIEW = 301,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_AC_ANALYSIS = 302,
    ACTION_ID_DIB_PREL6_TOGGLE_RELAY = 303,
    ACTION_ID_DIB_PREL6_SHOW_RELAY_LABELS = 304,
    ACTION_ID_DIB_PREL6_CHANGE_RELAY_LABEL = 305,
    ACTION_ID_DIB_PREL6_SHOW_INFO = 306,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 307,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 308,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 309,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 310,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 311,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 312,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 313,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 314,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 315,
    ACTION_ID_DIB_SMX46_CHANGE_SUBCHANNEL_LABEL = 316,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_CONFIGURATION = 317,
    ACTION_ID_DIB_SMX46_AOUT_SELECT_TRIGGER_MODE = 318,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_FUNCTION = 319,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_CALIBRATION = 320,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 321,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 322,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 323,
    ACTION_ID_SIMULATOR_LOAD = 324,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 325,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 326,
    ACTION_ID_DIB_MUX14D_TOGGLE_P1_RELAY = 327,
    ACTION_ID_DIB_MUX14D_CHANGE_P1_RELAY_LABEL = 328,
    ACTION_ID_DIB_MUX14D_TOGGLE_P2_RELAY = 329,
    ACTION_ID_DIB_MUX14D_CHANGE_P2_RELAY_LABEL = 330,
    ACTION_ID_DIB_MUX14D_TOGGLE_EXT_RELAY = 331,
    ACTION_ID_DIB_MUX14D_TOGGLE_ADIB1_RELAY = 332,
    ACTION_ID_DIB_MUX14D_TOGGLE_ADIB2_RELAY = 333,
    ACTION_ID_DIB_MUX14D_SHOW_RELAY_LABELS = 334,
    ACTION_ID_DIB_MUX14D_SHOW_INFO = 335,
    ACTION_ID_DIB_MUX14D_SHOW_RELAY_CYCLES = 336,
    ACTION_ID_DIB_MUX14D_TOGGLE_MULTIPLE_CONNECTIONS = 337
};
...
enum StylesEnum {
    ...
    STYLE_ID_VALUE_S_LEFT = 72,
    STYLE_ID_EDIT_VALUE_M_LEFT = 73,
    STYLE_ID_KEY_ICONS = 74,
    STYLE_ID_KEY = 75,
    STYLE_ID_KEY_DISABLED = 76,
    STYLE_ID_INLINE77 = 77,
    STYLE_ID_TAB_PAGE_SELECTED = 78,
    STYLE_ID_TAB_PAGE = 79,
    STYLE_ID_BOTTOM_BUTTON_BACKGROUND = 80,
    STYLE_ID_BOTTOM_BUTTON = 81,
    ...
    STYLE_ID_BUTTON_S = 88,
    STYLE_ID_EDIT_VALUE_S_LEFT = 89,
    STYLE_ID_SLIDER_SHADE_1 = 90,
    STYLE_ID_SLIDER_SHADE_2 = 91,
    STYLE_ID_SLIDER_SHADE_3 = 92,
    STYLE_ID_SLIDER_SHADE_4 = 93,
    STYLE_ID_SLIDER_SHADE_5 = 94,
    STYLE_ID_YES_NO = 95,
    STYLE_ID_YES_NO_BUTTON = 96,
    STYLE_ID_YES_NO_MESSAGE = 97,
    STYLE_ID_INLINE98 = 98,
    STYLE_ID_TEXT_MESSAGE = 99,
    STYLE_ID_INLINE100 = 100,
    STYLE_ID_INLINE101 = 101,
    STYLE_ID_ASYNC_OPERATION = 102,
    ...
    STYLE_ID_DEFAULT_INVERSE = 111,
    STYLE_ID_SCROLLBAR_THUMB = 112,
    STYLE_ID_SCROLLBAR_BUTTON = 113,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 114,
    STYLE_ID_INLINE115 = 115,
    STYLE_ID_KEY_SPEC_ICONS = 116,
    STYLE_ID_INLINE117 = 117,
    STYLE_ID_KEY_SPEC_ICONS_DISABLED = 118,
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 223,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 224,
    STYLE_ID_SCROLLBAR_TRACK = 225,
    ...
    STYLE_ID_DEFAULT_M_WARNING = 262,
    ...
    STYLE_ID_LABELS_AND_COLORS_SLOT = 288,
    STYLE_ID_INLINE289 = 289,
    STYLE_ID_INLINE290 = 290,
    STYLE_ID_INLINE291 = 291,
    STYLE_ID_FRONT_PANEL_MODULE = 292,
    ...
    STYLE_ID_TRIGGER_BUTTON_14 = 302,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 370,
    STYLE_ID_INLINE371 = 371,
    STYLE_ID_MON_VALUE_20_LEFT = 372,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 373,
    STYLE_ID_BAR_GRAPH_TEXT = 374,
    STYLE_ID_BAR_GRAPH_SET_LINE = 375,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 376,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 377,
    STYLE_ID_LABELS_AND_COLORS_CHANNEL = 378,
    STYLE_ID_INLINE379 = 379,
    STYLE_ID_TRIGGER_BUTTON_24 = 380,
    STYLE_ID_INLINE381 = 381,
    STYLE_ID_INLINE382 = 382,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 383,
    STYLE_ID_MON_VALUE_38_RIGHT = 384,
    STYLE_ID_INLINE385 = 385,
    STYLE_ID_CH_PROT_OFF = 386,
    STYLE_ID_CH_PROT_ON = 387,
    STYLE_ID_CH_PROT_TRIPPED = 388,
    STYLE_ID_INLINE389 = 389,
    STYLE_ID_MON_VALUE_20_RIGHT = 390,
    STYLE_ID_MON_VALUE_14_LEFT = 391,
    STYLE_ID_MON_VALUE_14_CENTER = 392,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 393,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 394,
    STYLE_ID_MON_VALUE_14_RIGHT = 395,
    STYLE_ID_MON_VALUE_24_RIGHT = 396,
    STYLE_ID_INLINE397 = 397,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 398,
...
extern const uint8_t assets[630670];
