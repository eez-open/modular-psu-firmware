...
enum ActionsEnum {
    ...
    ACTION_ID_DIB_SMX46_SHOW_INFO = 234,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 235,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 236,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 237,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 238,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 239,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 240,
    ACTION_ID_SIMULATOR_LOAD = 241,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 242,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 243
};
...
enum StylesEnum {
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 279,
    STYLE_ID_INLINE280 = 280,
    STYLE_ID_MON_VALUE_20_LEFT = 281,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 282,
    STYLE_ID_BAR_GRAPH_TEXT = 283,
    STYLE_ID_BAR_GRAPH_SET_LINE = 284,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 285,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 286,
    STYLE_ID_INLINE287 = 287,
    STYLE_ID_INLINE288 = 288,
    STYLE_ID_TRIGGER_BUTTON_24 = 289,
    STYLE_ID_INLINE290 = 290,
    STYLE_ID_INLINE291 = 291,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 292,
    STYLE_ID_TRIGGER_BUTTON_14 = 293,
    STYLE_ID_INST_SELECTED = 294,
    STYLE_ID_MON_VALUE_38_RIGHT = 295,
    STYLE_ID_INLINE296 = 296,
    STYLE_ID_CH_PROT_OFF = 297,
    STYLE_ID_CH_PROT_ON = 298,
    STYLE_ID_CH_PROT_TRIPPED = 299,
    STYLE_ID_INLINE300 = 300,
    STYLE_ID_MON_VALUE_20_RIGHT = 301,
    STYLE_ID_MON_VALUE_14_LEFT = 302,
    STYLE_ID_MON_VALUE_14_CENTER = 303,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 304,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 305,
    STYLE_ID_MON_VALUE_14_RIGHT = 306,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 307,
    STYLE_ID_MON_VALUE_24_RIGHT = 308,
...
extern const uint8_t assets[532223];
