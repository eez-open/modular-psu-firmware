...
enum StylesEnum {
    ...
    STYLE_ID_ICON_AND_TEXT_S_DISABLED = 159,
    ...
    STYLE_ID_DISPLAY_OFF = 191,
    STYLE_ID_DISPLAY_OFF_S = 192,
    STYLE_ID_INLINE193 = 193,
    STYLE_ID_INLINE194 = 194,
    STYLE_ID_MON_VALUE_48_RIGHT = 195,
    STYLE_ID_INLINE196 = 196,
    STYLE_ID_MON_VALUE_20_LEFT = 197,
    ...
    STYLE_ID_BUTTON_S_DISABLED = 252,
...
extern const uint8_t assets[413632];
