enum DataEnum {
    ...
    DATA_ID_MAIN_APP_VIEW = 236,
    DATA_ID_TOUCH_CALIBRATION_POINT = 237,
    DATA_ID_SIMULATOR_LOAD_STATE = 238,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 239,
    DATA_ID_SIMULATOR_LOAD = 240,
    DATA_ID_SIMULATOR_LOAD2 = 241,
    ...
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 267,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 268,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 269,
    DATA_ID_BATTERY = 270,
    DATA_ID_IO_PIN_STATE = 271,
    DATA_ID_CHANNEL_DPROG = 272,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 273,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 274,
    DATA_ID_SYS_INFO_HAS_ERROR = 275,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 276,
    DATA_ID_SYS_FAN_MODE = 277,
    DATA_ID_SYS_FAN_SPEED = 278,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 279,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 280,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 281,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 282,
    DATA_ID_IS_TRACKING_ALLOWED = 283,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 284,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 285,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 286,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 287,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 288,
    DATA_ID_IS_COUPLED_OR_TRACKED = 289,
    DATA_ID_OVERLAY = 290,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 291,
    DATA_ID_DLOG_STATE = 292,
    DATA_ID_DLOG_TOGGLE_STATE = 293,
    DATA_ID_RECORDING = 294,
    DATA_ID_CHANNEL_HISTORY_VALUES = 295,
    DATA_ID_RECORDING_READY = 296,
    DATA_ID_NONDRAG_OVERLAY = 297,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 298,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 299,
    DATA_ID_DLOG_VISIBLE_VALUES = 300,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 301,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 302,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 303,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 304,
    DATA_ID_DLOG_ALL_VALUES = 305,
    DATA_ID_DLOG_VALUE_LABEL = 306,
    DATA_ID_DLOG_CURRENT_TIME = 307,
    DATA_ID_DLOG_FILE_LENGTH = 308,
    DATA_ID_DLOG_X_AXIS_OFFSET = 309,
    DATA_ID_DLOG_X_AXIS_DIV = 310,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 311,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 312,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 313,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 314,
    DATA_ID_DLOG_VIEW_STATE = 315,
    DATA_ID_DLOG_PERIOD = 316,
    DATA_ID_DLOG_DURATION = 317,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 318,
    DATA_ID_DLOG_CURRENT_ENABLED = 319,
    DATA_ID_DLOG_POWER_ENABLED = 320,
    DATA_ID_DLOG_START_ENABLED = 321,
    DATA_ID_DLOG_FILE_NAME = 322,
    DATA_ID_DLOG_VALUE_STATE = 323,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 324,
    DATA_ID_CHANNEL_OFF_LABEL = 325,
    DATA_ID_FILE_MANAGER_FILES = 326,
    DATA_ID_FILE_MANAGER_FILE_NAME = 327,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 328,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 329,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 330,
    DATA_ID_FILE_MANAGER_STATE = 331,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 332,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 333,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 334,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 335,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 336,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 337,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 338,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 339,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 340,
    DATA_ID_SCRIPT_INFO = 341,
    DATA_ID_SCRIPT_IS_STARTED = 342,
    DATA_ID_KEYPAD_OK_ENABLED = 343,
    DATA_ID_ETHERNET_HOST_NAME = 344,
    DATA_ID_MQTT_HOST = 345,
    DATA_ID_MQTT_PORT = 346,
    DATA_ID_MQTT_USERNAME = 347,
    DATA_ID_MQTT_PASSWORD = 348,
    DATA_ID_MQTT_PERIOD = 349,
    ...
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 367,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 368,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 369
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SIMULATOR_LOAD = 155,
    ACTION_ID_SELECT_THEME = 156,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 157,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 158,
    ACTION_ID_RESTART = 159,
    ACTION_ID_USER_SWITCH_CLICKED = 160,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 161,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 162,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 163,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 164,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 165,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 166,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 167,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 168,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 169,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 170,
    ACTION_ID_SET_COUPLING_PARALLEL = 171,
    ACTION_ID_SET_COUPLING_SERIES = 172,
    ACTION_ID_SET_COUPLING_COMMON_GND = 173,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 174,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 175,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 176,
    ACTION_ID_DRAG_OVERLAY = 177,
    ACTION_ID_DLOG_TOGGLE = 178,
    ACTION_ID_SHOW_DLOG_VIEW = 179,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 180,
    ACTION_ID_SHOW_FILE_MANAGER = 181,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 182,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT_DIRECTORY = 183,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 184,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 185,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 186,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 187,
    ACTION_ID_SHOW_DLOG_PARAMS = 188,
    ACTION_ID_DLOG_VOLTAGE_TOGGLE = 189,
    ACTION_ID_DLOG_CURRENT_TOGGLE = 190,
    ACTION_ID_DLOG_POWER_TOGGLE = 191,
    ACTION_ID_DLOG_VALUE_TOGGLE = 192,
    ACTION_ID_DLOG_EDIT_PERIOD = 193,
    ACTION_ID_DLOG_EDIT_DURATION = 194,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 195,
    ACTION_ID_DLOG_START_RECORDING = 196,
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 197,
    ACTION_ID_FILE_MANAGER_SORT_BY = 198,
    ACTION_ID_DLOG_AUTO_SCALE = 199,
    ...
    ACTION_ID_DLOG_SCALE_TO_FIT = 208,
    ACTION_ID_DLOG_VIEW_TOGGLE_LEGEND = 209,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 210,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 211,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 212,
    ACTION_ID_SHUTDOWN = 213,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 214,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 215,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 216,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 217,
    ACTION_ID_PROFILE_IMPORT = 218,
    ACTION_ID_PROFILE_EXPORT = 219,
    ACTION_ID_EVENT_QUEUE_FILTER = 220,
    ACTION_ID_EVENT_QUEUE_SELECT_EVENT = 221
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[393859];
#else
extern const uint8_t assets[3864384];
#endif
