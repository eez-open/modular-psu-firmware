...
enum ActionsEnum {
    ...
    ACTION_ID_NTP_TOGGLE = 155,
    ACTION_ID_NTP_EDIT_SERVER = 156,
    ACTION_ID_SIMULATOR_LOAD = 157,
    ...
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 163,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 164,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 165,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 166,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 167,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 168,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 169,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 170,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 171,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 172,
    ACTION_ID_SET_COUPLING_PARALLEL = 173,
    ACTION_ID_SET_COUPLING_SERIES = 174,
    ACTION_ID_SET_COUPLING_COMMON_GND = 175,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 176,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 177,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 178,
    ACTION_ID_DRAG_OVERLAY = 179,
    ACTION_ID_DLOG_TOGGLE = 180,
    ACTION_ID_SHOW_DLOG_VIEW = 181,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 182,
    ACTION_ID_SHOW_FILE_MANAGER = 183,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 184,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT_DIRECTORY = 185,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 186,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 187,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 188,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 189,
    ACTION_ID_SHOW_DLOG_PARAMS = 190,
    ACTION_ID_DLOG_VOLTAGE_TOGGLE = 191,
    ACTION_ID_DLOG_CURRENT_TOGGLE = 192,
    ACTION_ID_DLOG_POWER_TOGGLE = 193,
    ACTION_ID_DLOG_VALUE_TOGGLE = 194,
    ACTION_ID_DLOG_EDIT_PERIOD = 195,
    ACTION_ID_DLOG_EDIT_DURATION = 196,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 197,
    ACTION_ID_DLOG_START_RECORDING = 198,
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 199,
    ACTION_ID_FILE_MANAGER_SORT_BY = 200,
    ACTION_ID_DLOG_AUTO_SCALE = 201,
    ACTION_ID_SHOW_DEBUG_TRACE_LOG = 202,
    ACTION_ID_DLOG_UPLOAD = 203,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 204,
    ACTION_ID_MQTT_EDIT_HOST = 205,
    ACTION_ID_MQTT_EDIT_PORT = 206,
    ACTION_ID_MQTT_EDIT_USERNAME = 207,
    ACTION_ID_MQTT_EDIT_PASSWORD = 208,
    ACTION_ID_MQTT_EDIT_PERIOD = 209,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 210,
    ACTION_ID_DEBUG_TRACE_LOG_TOGGLE = 211,
    ACTION_ID_DLOG_SCALE_TO_FIT = 212,
    ACTION_ID_DLOG_VIEW_TOGGLE_LEGEND = 213,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 214,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 215,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 216,
    ACTION_ID_SHUTDOWN = 217,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 218,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 219,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 220,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 221,
    ACTION_ID_PROFILE_IMPORT = 222,
    ACTION_ID_PROFILE_EXPORT = 223
};
...
enum PagesEnum {
    ...
    PAGE_ID_SYS_SETTINGS_CAL = 62,
    PAGE_ID_SYS_SETTINGS_CAL_CH = 63,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP = 64,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_FINISH = 65,
    PAGE_ID_SYS_SETTINGS_SCREEN_CALIBRATION = 66,
    PAGE_ID_SYS_SETTINGS_DISPLAY = 67,
    PAGE_ID_SYS_SETTINGS_SOUND = 68,
    PAGE_ID_SYS_SETTINGS_TRACKING = 69,
    PAGE_ID_SYS_SETTINGS_COUPLING = 70,
    PAGE_ID_USER_PROFILES = 71,
    PAGE_ID_USER_PROFILE_SETTINGS = 72,
    PAGE_ID_USER_PROFILE_0_SETTINGS = 73,
    PAGE_ID_PROFILE_BASIC_INFO = 74,
    PAGE_ID_SYS_INFO = 75,
    PAGE_ID_STAND_BY_MENU = 76,
    PAGE_ID_ENTERING_STANDBY = 77,
    PAGE_ID_STANDBY = 78,
    PAGE_ID_SAVING = 79,
    PAGE_ID_SHUTDOWN = 80,
    PAGE_ID_DISPLAY_OFF = 81,
    PAGE_ID_MINIMIZED_CHANNELS = 82,
    PAGE_ID_SLOT_DEF_VERT = 83,
    PAGE_ID_SLOT_DEF_VERT_TITLE = 84,
    PAGE_ID_SLOT_DEF_1CH_NUM_ON = 85,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON = 86,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF = 87,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 88,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 89,
    PAGE_ID_SLOT_DEF_2CH_VERT = 90,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON = 91,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF = 92,
    PAGE_ID_SLOT_DEF_VERT_ERROR = 93,
    PAGE_ID_SLOT_DEF_VERT_NOT_INSTALLED = 94,
    PAGE_ID_SLOT_DEF_HORZ = 95,
    PAGE_ID_SLOT_DEF_HORZ_TITLE = 96,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON = 97,
    PAGE_ID_SLOT_DEF_1CH_YT_ON = 98,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF = 99,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 100,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 101,
    PAGE_ID_SLOT_DEF_2CH_HORZ = 102,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON = 103,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF = 104,
    PAGE_ID_SLOT_DEF_HORZ_ERROR = 105,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED = 106,
    PAGE_ID_SLOT_MAX_1CH_TITLE = 107,
    PAGE_ID_SLOT_MAX_1CH_NUM_ON = 108,
    PAGE_ID_SLOT_MAX_1CH_NUM_OFF = 109,
    PAGE_ID_SLOT_MAX_1CH_HBAR_ON = 110,
    PAGE_ID_SLOT_MAX_1CH_HBAR_OFF = 111,
    PAGE_ID_SLOT_MAX_1CH_YT_ON = 112,
    PAGE_ID_SLOT_MAX_1CH_YT_OFF = 113,
    PAGE_ID_SLOT_MAX_2CH = 114,
    PAGE_ID_SLOT_MAX_2CH_TITLE = 115,
    PAGE_ID_SLOT_MAX_2CH_NUM_ON = 116,
    PAGE_ID_SLOT_MAX_2CH_NUM_OFF = 117,
    PAGE_ID_SLOT_MAX_2CH_HBAR_ON = 118,
    PAGE_ID_SLOT_MAX_2CH_HBAR_OFF = 119,
    PAGE_ID_SLOT_MAX_2CH_YT_ON = 120,
    PAGE_ID_SLOT_MAX_2CH_YT_OFF = 121,
    PAGE_ID_SLOT_MAX_2CH_MIN_TITLE = 122,
    PAGE_ID_SLOT_MAX_2CH_MIN_ON = 123,
    PAGE_ID_SLOT_MAX_2CH_MIN_OFF = 124,
    PAGE_ID_SLOT_MAX_ERROR = 125,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 126,
    PAGE_ID_SLOT_MIN_1CH_TITLE = 127,
    PAGE_ID_SLOT_MIN_1CH_ON = 128,
    PAGE_ID_SLOT_MIN_1CH_OFF = 129,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_SERIES = 130,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_PARALLEL = 131,
    PAGE_ID_SLOT_MIN_2CH_TITLE = 132,
    PAGE_ID_SLOT_MIN_2CH = 133,
    PAGE_ID_SLOT_MIN_2CH_ON = 134,
    PAGE_ID_SLOT_MIN_2CH_OFF = 135,
    PAGE_ID_SLOT_MIN_ERROR = 136,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 137,
    PAGE_ID_SLOT_MICRO_1CH_TITLE = 138,
    PAGE_ID_SLOT_MICRO_1CH_ON = 139,
    PAGE_ID_SLOT_MICRO_1CH_OFF = 140,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_SERIES = 141,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_PARALLEL = 142,
    PAGE_ID_SLOT_MICRO_2CH = 143,
    PAGE_ID_SLOT_MICRO_2CH_TITLE = 144,
    PAGE_ID_SLOT_MICRO_2CH_ON = 145,
    PAGE_ID_SLOT_MICRO_2CH_OFF = 146,
    PAGE_ID_SLOT_MICRO_ERROR = 147,
    PAGE_ID_SLOT_MICRO_NOT_INSTALLED = 148,
    PAGE_ID_DLOG_VIEW = 149,
    PAGE_ID_IMAGE_VIEW = 150,
    PAGE_ID_DLOG_PARAMS = 151,
    PAGE_ID_DLOG_VIEW_OVERLAY_OPTIONS = 152,
    PAGE_ID_FILE_MANAGER = 153,
    PAGE_ID_FILE_BROWSER = 154,
    PAGE_ID_DEBUG_TRACE_LOG = 155,
    PAGE_ID_FILE_MENU = 156,
    PAGE_ID_FRONT_PANEL = 157,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 158,
    PAGE_ID_DCP405_FRONT_PANEL = 159,
    PAGE_ID_DCP405B_FRONT_PANEL = 160,
    PAGE_ID_DCM220_FRONT_PANEL = 161,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 162,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 163
};

#ifdef OPTION_SDRAM
extern const uint8_t assets[393565];
#else
extern const uint8_t assets[3864328];
#endif
