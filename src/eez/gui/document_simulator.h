...
enum PagesEnum {
    ...
    PAGE_ID_FRONT_PANEL = 156,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 157,
    PAGE_ID_DCP405_FRONT_PANEL = 158,
    PAGE_ID_DCP405B_FRONT_PANEL = 159,
    PAGE_ID_DCM220_FRONT_PANEL = 160,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 161,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 162
};

#ifdef OPTION_SDRAM
extern const uint8_t assets[392814];
#else
extern const uint8_t assets[3864748];
#endif
