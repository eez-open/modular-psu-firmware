enum DataEnum {
    ...
    DATA_ID_DIB_MIO168_SIMULATOR_AFE_VERSION = 577,
    DATA_ID_DIB_MIO168_IS_SETTINGS_PAGE_SELECTED = 578,
    DATA_ID_DIB_PREL6_RELAYS = 579,
    DATA_ID_DIB_PREL6_RELAY_IS_ON = 580,
    DATA_ID_DIB_PREL6_RELAY_LABEL = 581,
    DATA_ID_DIB_PREL6_RELAY_CYCLES = 582,
    DATA_ID_DIB_PREL6_RELAY_LABEL_LABEL = 583,
    DATA_ID_DIB_PREL6_IS_RELAY_1_OR_6 = 584,
    DATA_ID_DIB_SMX46_ROUTES = 585,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 586,
    DATA_ID_DIB_SMX46_X_LABELS = 587,
    DATA_ID_DIB_SMX46_X_LABEL = 588,
    DATA_ID_DIB_SMX46_Y_LABELS = 589,
    DATA_ID_DIB_SMX46_Y_LABEL = 590,
    DATA_ID_DIB_SMX46_AOUT_CHANNELS = 591,
    DATA_ID_DIB_SMX46_AOUT_VALUE = 592,
    DATA_ID_DIB_SMX46_AOUT_LABEL = 593,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_MODE = 594,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_IS_INITIATED = 595,
    DATA_ID_DIB_SMX46_AOUT_FUNCTION_LABEL = 596,
    DATA_ID_DIB_SMX46_RELAY_ON = 597,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 598,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 599,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 600,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 601,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 602,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 603,
    DATA_ID_SIMULATOR_LOAD_STATE = 604,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 605,
    DATA_ID_SIMULATOR_LOAD = 606,
    DATA_ID_SIMULATOR_LOAD2 = 607,
    DATA_ID_MAIN_APP_VIEW = 608,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 609,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 610,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 611,
    DATA_ID_DIB_DCM224_PWM_DUTY = 612,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 613,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 614,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 615,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 616,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 617,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 618,
...
enum StylesEnum {
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 381,
    STYLE_ID_INLINE382 = 382,
    STYLE_ID_MON_VALUE_20_LEFT = 383,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 384,
    STYLE_ID_BAR_GRAPH_TEXT = 385,
    STYLE_ID_BAR_GRAPH_SET_LINE = 386,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 387,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 388,
    STYLE_ID_LABELS_AND_COLORS_CHANNEL = 389,
    STYLE_ID_INLINE390 = 390,
    STYLE_ID_TRIGGER_BUTTON_24 = 391,
    STYLE_ID_INLINE392 = 392,
    STYLE_ID_INLINE393 = 393,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 394,
    STYLE_ID_INLINE395 = 395,
    STYLE_ID_CH_PROT_OFF = 396,
    STYLE_ID_CH_PROT_ON = 397,
    STYLE_ID_CH_PROT_TRIPPED = 398,
    STYLE_ID_INLINE399 = 399,
    STYLE_ID_INLINE400 = 400,
    STYLE_ID_MON_VALUE_38_RIGHT = 401,
    STYLE_ID_MON_VALUE_14_RIGHT = 402,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 403,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 404,
...
extern const uint8_t assets[625916];
