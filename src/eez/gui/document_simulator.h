enum DataEnum {
    ...
    DATA_ID_SLOT1_NON_MAPPED_CHANNEL_INDEX = 240,
    DATA_ID_SLOT2_NON_MAPPED_CHANNEL_INDEX = 241,
    DATA_ID_SLOT3_NON_MAPPED_CHANNEL_INDEX = 242,
    DATA_ID_BATTERY = 243,
    ...
    DATA_ID_DLOG_CURRENT_TIME = 280,
    DATA_ID_DLOG_FILE_LENGTH = 281,
    DATA_ID_DLOG_X_AXIS_OFFSET = 282,
    DATA_ID_DLOG_X_AXIS_DIV = 283,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 284,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 285,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 286,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 287,
    DATA_ID_DLOG_VIEW_STATE = 288,
    DATA_ID_DLOG_PERIOD = 289,
    DATA_ID_DLOG_PERIOD_SPEC = 290,
    DATA_ID_DLOG_DURATION = 291,
    DATA_ID_DLOG_FILE_NAME = 292,
    DATA_ID_CHANNEL_OFF_LABEL = 293,
    DATA_ID_FILE_MANAGER_FILES = 294,
    DATA_ID_FILE_MANAGER_FILE_NAME = 295,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 296,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 297,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 298,
    DATA_ID_FILE_MANAGER_STATE = 299,
    DATA_ID_FILE_MANAGER_HAS_PARENT = 300,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 301,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 302,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 303,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 304,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 305,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 306,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 307,
    DATA_ID_SCRIPT_INFO = 308,
    DATA_ID_SCRIPT_IS_STARTED = 309,
    DATA_ID_KEYPAD_OK_ENABLED = 310,
    DATA_ID_ETHERNET_HOST_NAME = 311,
    DATA_ID_MQTT_HOST = 312,
    DATA_ID_MQTT_PORT = 313,
    DATA_ID_MQTT_USERNAME = 314,
    DATA_ID_MQTT_PASSWORD = 315,
    DATA_ID_MQTT_PERIOD = 316,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 317,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 318,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 319,
    DATA_ID_LIST_COUNTER_LABEL = 320,
    DATA_ID_RAMP_COUNTER_LABEL = 321,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 322,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 323,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 324,
    DATA_ID_IS_RESET_BY_IWDG = 325,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 326,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 327,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 328,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 329,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 330,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 331,
    DATA_ID_DATE_TIME_FORMAT = 332,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 333,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 334,
    DATA_ID_DATE_TIME_AM_PM = 335,
    DATA_ID_IS_MULTI_TRACKING = 336,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 337,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 338,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 339,
    DATA_ID_CHANNEL_INFO_BRAND = 340,
    DATA_ID_CHANNEL_INFO_SERIAL = 341,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 342,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 343,
    DATA_ID_FILE_MANAGER_FILE_ICON = 344,
    DATA_ID_FILE_MANAGER_LAYOUT = 345,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 346,
    DATA_ID_TOUCH_RAW_X = 347,
    DATA_ID_TOUCH_RAW_Y = 348,
    DATA_ID_TOUCH_RAW_Z1 = 349,
    DATA_ID_TOUCH_RAW_PRESSED = 350,
    DATA_ID_TOUCH_CALIBRATED_X = 351,
    DATA_ID_TOUCH_CALIBRATED_Y = 352,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 353,
    DATA_ID_TOUCH_FILTERED_X = 354,
    DATA_ID_TOUCH_FILTERED_Y = 355,
    DATA_ID_TOUCH_FILTERED_PRESSED = 356,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 357,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 358,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 359,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 360,
    DATA_ID_ALERT_MESSAGE_IS_SET = 361,
    DATA_ID_ASYNC_PROGRESS = 362,
    DATA_ID_IO_PIN_FUNCTION = 363,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 364,
    DATA_ID_IO_PIN_PWM_DUTY = 365,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 366,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 367,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 368,
    DATA_ID_CHANNEL_RAMP_STATE = 369,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 370,
    DATA_ID_MQTT_IN_ERROR = 371,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 372,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 373,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 374,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 375,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 376,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 377,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 378,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 379,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 380,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 381,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 382,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 383,
    DATA_ID_SLOTS = 384,
    DATA_ID_SLOT_INDEX = 385,
    DATA_ID_SLOT_TITLE_DEF = 386,
    DATA_ID_SLOT_TITLE_MAX = 387,
    DATA_ID_SLOT_TITLE_MIN = 388,
    DATA_ID_SLOT_TITLE_SETTINGS = 389,
    DATA_ID_SLOT_SHORT_TITLE = 390,
    DATA_ID_SLOT_ERROR_MESSAGE = 391,
    DATA_ID_USB_MODE = 392,
    DATA_ID_USB_CURRENT_MODE = 393,
    DATA_ID_USB_DEVICE_CLASS = 394,
    DATA_ID_USB_KEYBOARD_STATE = 395,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 396,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 397,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 398,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 399,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 400,
    DATA_ID_SLOT_SERIAL_INFO = 401,
    DATA_ID_SLOT_IS_ENABLED = 402,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 403,
    DATA_ID_USER_SWITCH_ACTION = 404,
    DATA_ID_NTP_REFRESH_FREQUENCY = 405,
    DATA_ID_CHANNEL_CALIBRATION_IS_POWER_CHANNEL = 406,
    DATA_ID_HAS_CUSTOM_BITMAP = 407,
    DATA_ID_CUSTOM_BITMAP = 408,
    DATA_ID_SLOT_INFO_WITH_FW_VER = 409,
    DATA_ID_MASTER_INFO_WITH_FW_VER = 410,
    DATA_ID_SLOT1_LABELS_AND_COLORS_VIEW = 411,
    DATA_ID_SLOT2_LABELS_AND_COLORS_VIEW = 412,
    DATA_ID_SLOT3_LABELS_AND_COLORS_VIEW = 413,
    DATA_ID_COLORS = 414,
    DATA_ID_KEYPAD_CAN_SET_DEFAULT = 415,
    DATA_ID_LABELS_AND_COLORS_PAGE_SLOT_TITLE = 416,
    DATA_ID_LABELS_AND_COLORS_PAGE_CHANNEL_TITLE = 417,
    DATA_ID_LABELS_AND_COLORS_IS_COLOR_MODIFIED = 418,
    DATA_ID_DLOG_ITEMS = 419,
    DATA_ID_DLOG_ITEMS_NUM_SELECTED = 420,
    DATA_ID_DLOG_ITEM_IS_CHECKED = 421,
    DATA_ID_DLOG_ITEM_CHANNEL = 422,
    DATA_ID_DLOG_ITEM_LABEL = 423,
    DATA_ID_DLOG_ITEMS_SCROLLBAR_ENABLED = 424,
    DATA_ID_DLOG_START_ENABLED = 425,
    DATA_ID_HAS_MULTIPLE_DISK_DRIVES = 426,
    DATA_ID_SELECTED_MASS_STORAGE_DEVICE = 427,
    DATA_ID_FILE_MANAGER_IS_SORT_FILES_OPTION_AVAILABLE = 428,
    DATA_ID_DLOG_PREVIEW_OVERLAY = 429,
    DATA_ID_DLOG_ITEM_IS_AVAILABLE = 430,
    DATA_ID_MODULE_IS_RESYNC_SUPPORTED = 431,
    DATA_ID_CHANNEL_IS_CALIBRATION_VALUE_SOURCE = 432,
    DATA_ID_CALIBRATION_POINT_CAN_EDIT_SET_VALUE = 433,
    DATA_ID_CALIBRATION_POINT_LIVE_MEASURED_VALUE = 434,
    DATA_ID_AC_MAINS = 435,
    DATA_ID_SELECTED_MCU_REVISION = 436,
    DATA_ID_IS_MCU_REVISION_SELECTED = 437,
    DATA_ID_SLOT_IS_2CH_VIEW = 438,
    DATA_ID_COLOR_IS_SELECTED = 439,
    DATA_ID_MASTER_ERROR_MESSAGE = 440,
    DATA_ID_DLOG_PERIOD_HAS_PREDEFINED_VALUES = 441,
    DATA_ID_DLOG_VIEW_SELECTED_TAB = 442,
    DATA_ID_DLOG_BOOKMARKS = 443,
    DATA_ID_DLOG_BOOKMARK_X_VALUE = 444,
    DATA_ID_DLOG_BOOKMARK_TEXT = 445,
    DATA_ID_DLOG_BOOKMARK_IS_SELECTED = 446,
    DATA_ID_DLOG_VIEW_IS_DRAWER_OPEN = 447,
    DATA_ID_DLOG_VIEW_IS_ZOOM_IN_ENABLED = 448,
    DATA_ID_DLOG_VIEW_IS_ZOOM_OUT_ENABLED = 449,
    DATA_ID_DLOG_BOOKMARKS_IS_SCROLLBAR_VISIBLE = 450,
    DATA_ID_DLOG_Y_VALUES_IS_SCROLLBAR_VISIBLE = 451,
    DATA_ID_DLOG_Y_VALUES = 452,
    DATA_ID_DLOG_Y_VALUE_LABEL = 453,
    DATA_ID_DLOG_Y_VALUE_IS_CHECKED = 454,
    DATA_ID_DLOG_Y_VALUE_IS_SELECTED = 455,
    DATA_ID_DLOG_Y_VALUE_IS_ENABLED = 456,
    DATA_ID_DLOG_Y_VALUE_OFFSET = 457,
    DATA_ID_DLOG_Y_VALUE_DIV = 458,
    DATA_ID_DLOG_Y_VALUE_CURSOR = 459,
    DATA_ID_FUNCTION_GENERATOR_CHANNELS = 460,
    DATA_ID_FUNCTION_GENERATOR_ANY_CHANNEL_SELECTED = 461,
    DATA_ID_FUNCTION_GENERATOR_CHANNEL = 462,
    DATA_ID_FUNCTION_GENERATOR_ITEM_LABEL = 463,
    DATA_ID_FUNCTION_GENERATOR_ITEM_IS_CHECKED = 464,
    DATA_ID_FUNCTION_GENERATOR_IS_MAX_SELECTED = 465,
    DATA_ID_FUNCTION_GENERATOR_NUM_SELECTED = 466,
    DATA_ID_FUNCTION_GENERATOR_ITEM_IS_SELECTED = 467,
    DATA_ID_FUNCTION_GENERATOR_WAVEFORM = 468,
    DATA_ID_FUNCTION_GENERATOR_WAVEFORM_LABEL = 469,
    DATA_ID_FUNCTION_GENERATOR_FREQUENCY = 470,
    DATA_ID_FUNCTION_GENERATOR_MODE = 471,
    DATA_ID_FUNCTION_GENERATOR_PHASE_SHIFT = 472,
    DATA_ID_FUNCTION_GENERATOR_AMPLITUDE = 473,
    DATA_ID_FUNCTION_GENERATOR_OFFSET = 474,
    DATA_ID_FUNCTION_GENERATOR_DUTY_CYCLE = 475,
    DATA_ID_FUNCTION_GENERATOR_CANVAS = 476,
    DATA_ID_FUNCTION_GENERATOR_HAS_MODE_SELECT = 477,
    DATA_ID_FUNCTION_GENERATOR_HAS_AMPLITUDE_AND_OFFSET = 478,
    DATA_ID_FUNCTION_GENERATOR_HAS_DUTY_CYCLE = 479,
    DATA_ID_FUNCTION_GENERATOR_IS_FREQ = 480,
    DATA_ID_FUNCTION_GENERATOR_IS_AMPL = 481,
    DATA_ID_FUNCTION_GENERATOR_IS_DC = 482,
    DATA_ID_FUNCTION_GENERATOR_ANY_SELECTED = 483,
    DATA_ID_DIB_MIO168_DIN_PINS = 484,
    DATA_ID_DIB_MIO168_DIN_PINS_1_4 = 485,
    DATA_ID_DIB_MIO168_DIN_PINS_5_8 = 486,
    DATA_ID_DIB_MIO168_DIN_NO = 487,
    DATA_ID_DIB_MIO168_DIN_STATE = 488,
    DATA_ID_DIB_MIO168_DIN_RANGE = 489,
    DATA_ID_DIB_MIO168_DIN_LABEL = 490,
    DATA_ID_DIB_MIO168_DIN_LABEL_LABEL = 491,
    DATA_ID_DIB_MIO168_DIN_SPEED = 492,
    DATA_ID_DIB_MIO168_DOUT_PINS = 493,
    DATA_ID_DIB_MIO168_DOUT_PINS_1_4 = 494,
    DATA_ID_DIB_MIO168_DOUT_PINS_5_8 = 495,
    DATA_ID_DIB_MIO168_DOUT_NO = 496,
    DATA_ID_DIB_MIO168_DOUT_STATE = 497,
    DATA_ID_DIB_MIO168_DOUT_LABEL = 498,
    DATA_ID_DIB_MIO168_DOUT_LABEL_LABEL = 499,
    DATA_ID_DIB_MIO168_DOUT_TRIGGER_MODE = 500,
    DATA_ID_DIB_MIO168_DOUT_TRIGGER_IS_INITIATED = 501,
    DATA_ID_DIB_MIO168_DOUT_FUNCTION_LABEL = 502,
    DATA_ID_DIB_MIO168_AIN_CHANNELS = 503,
    DATA_ID_DIB_MIO168_AIN_LABEL = 504,
    DATA_ID_DIB_MIO168_AIN_LABEL_SHORT = 505,
    DATA_ID_DIB_MIO168_AIN_LABEL_LABEL = 506,
    DATA_ID_DIB_MIO168_AIN_VALUE = 507,
    DATA_ID_DIB_MIO168_AIN_MODE = 508,
    DATA_ID_DIB_MIO168_AIN_RANGE = 509,
    DATA_ID_DIB_MIO168_AIN_IS_DLOG_ACTIVE = 510,
    DATA_ID_DIB_MIO168_AIN_MODE_AND_RANGE = 511,
    DATA_ID_DIB_MIO168_AIN_MODE_IS_MULTIPLE_SELECTION_AVAILABLE = 512,
    DATA_ID_DIB_MIO168_AIN_RANGE_IS_MULTIPLE_SELECTION_AVAILABLE = 513,
    DATA_ID_DIB_MIO168_AIN_IS_OVERFLOW = 514,
    DATA_ID_DIB_MIO168_AIN_HAS_POWER_COLUMN = 515,
    DATA_ID_DIB_MIO168_AIN_HAS_P1 = 516,
    DATA_ID_DIB_MIO168_AIN_P1 = 517,
    DATA_ID_DIB_MIO168_AIN_HAS_P2 = 518,
    DATA_ID_DIB_MIO168_AIN_P2 = 519,
    DATA_ID_DIB_MIO168_AIN_HAS_EFFICIENCY = 520,
    DATA_ID_DIB_MIO168_AIN_CALC_EFFICIENCY = 521,
    DATA_ID_DIB_MIO168_AIN_EFFICIENCY = 522,
    DATA_ID_DIB_MIO168_AIN_ACTIVE_POWER = 523,
    DATA_ID_DIB_MIO168_AIN_REACTIVE_POWER = 524,
    DATA_ID_DIB_MIO168_AIN_VOLT_RMS = 525,
    DATA_ID_DIB_MIO168_AIN_CURR_RMS = 526,
    DATA_ID_DIB_MIO168_AIN_APPARENT_POWER = 527,
    DATA_ID_DIB_MIO168_AIN_POWER_FACTOR = 528,
    DATA_ID_DIB_MIO168_AIN_NPLC = 529,
    DATA_ID_DIB_MIO168_AIN_APERTURE = 530,
    DATA_ID_DIB_MIO168_AOUT_CHANNELS = 531,
    DATA_ID_DIB_MIO168_AOUT_LABEL = 532,
    DATA_ID_DIB_MIO168_AOUT_LABEL_SHORT = 533,
    DATA_ID_DIB_MIO168_AOUT_LABEL_LABEL = 534,
    DATA_ID_DIB_MIO168_AOUT_VALUE = 535,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_ENABLED = 536,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_MODE = 537,
    DATA_ID_DIB_MIO168_AOUT_VOLTAGE_RANGE = 538,
    DATA_ID_DIB_MIO168_AOUT_CURRENT_RANGE = 539,
    DATA_ID_DIB_MIO168_AOUT_CHANNEL_HAS_SETTINGS = 540,
    DATA_ID_DIB_MIO168_AOUT_MODE_AND_RANGE = 541,
    DATA_ID_DIB_MIO168_AOUT_TRIGGER_MODE = 542,
    DATA_ID_DIB_MIO168_AOUT_TRIGGER_IS_INITIATED = 543,
    DATA_ID_DIB_MIO168_AOUT_FUNCTION_LABEL = 544,
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 545,
    DATA_ID_DIB_MIO168_PWM_LABEL = 546,
    DATA_ID_DIB_MIO168_PWM_LABEL_SHORT = 547,
    DATA_ID_DIB_MIO168_PWM_LABEL_LABEL = 548,
    DATA_ID_DIB_MIO168_PWM_FREQ = 549,
    DATA_ID_DIB_MIO168_PWM_DUTY = 550,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 551,
    DATA_ID_DIB_MIO168_AFE_VERSION = 552,
    DATA_ID_DIB_MIO168_PAGER_LIST = 553,
    DATA_ID_DIB_MIO168_PAGER_IS_SELECTED = 554,
    DATA_ID_DIB_MIO168_PAGER_SELECTED_PAGE = 555,
    DATA_ID_DIB_MIO168_SELECTED_PAGE_IN_DEFAULT_VIEW = 556,
    DATA_ID_DIB_MIO168_SIMULATOR_AFE_VERSION = 557,
    DATA_ID_DIB_MIO168_IS_NO_AFE = 558,
    DATA_ID_DIB_MIO168_AIN_EFFICIENCY_FORMULA = 559,
    DATA_ID_DIB_MIO168_IS_SETTINGS_PAGE_SELECTED = 560,
    DATA_ID_DIB_PREL6_RELAYS = 561,
    DATA_ID_DIB_PREL6_RELAY_IS_ON = 562,
    DATA_ID_DIB_PREL6_RELAY_LABEL = 563,
    DATA_ID_DIB_PREL6_RELAY_CYCLES = 564,
    DATA_ID_DIB_PREL6_RELAY_LABEL_LABEL = 565,
    DATA_ID_DIB_PREL6_IS_RELAY_1_OR_6 = 566,
    DATA_ID_DIB_SMX46_ROUTES = 567,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 568,
    DATA_ID_DIB_SMX46_X_LABELS = 569,
    DATA_ID_DIB_SMX46_X_LABEL = 570,
    DATA_ID_DIB_SMX46_Y_LABELS = 571,
    DATA_ID_DIB_SMX46_Y_LABEL = 572,
    DATA_ID_DIB_SMX46_AOUT_CHANNELS = 573,
    DATA_ID_DIB_SMX46_AOUT_VALUE = 574,
    DATA_ID_DIB_SMX46_AOUT_LABEL = 575,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_MODE = 576,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_IS_INITIATED = 577,
    DATA_ID_DIB_SMX46_AOUT_FUNCTION_LABEL = 578,
    DATA_ID_DIB_SMX46_RELAY_ON = 579,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 580,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 581,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 582,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_VIEW = 583,
    DATA_ID_DIB_DCM220_SLOT_MIN_2CH_VIEW = 584,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 585,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 586,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_VIEW = 587,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 588,
    DATA_ID_SIMULATOR_LOAD_STATE = 589,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 590,
    DATA_ID_SIMULATOR_LOAD = 591,
    DATA_ID_SIMULATOR_LOAD2 = 592,
    DATA_ID_MAIN_APP_VIEW = 593,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 594,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 595,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 596,
    DATA_ID_DIB_DCM224_PWM_DUTY = 597,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 598,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 599,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 600,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 601,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_VIEW = 602,
    DATA_ID_DIB_DCM224_SLOT_MIN_2CH_VIEW = 603,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 604,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 605,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_VIEW = 606,
    DATA_ID_DIB_MUX14D_P1_RELAYS = 607,
    DATA_ID_DIB_MUX14D_P1_RELAY_LABEL = 608,
    DATA_ID_DIB_MUX14D_P1_RELAY_IS_FIRST = 609,
    DATA_ID_DIB_MUX14D_P1_RELAY_IS_ON = 610,
    DATA_ID_DIB_MUX14D_P1_RELAY_CYCLES = 611,
    DATA_ID_DIB_MUX14D_P1_RELAY_LABEL_LABEL = 612,
    DATA_ID_DIB_MUX14D_P2_RELAYS = 613,
    DATA_ID_DIB_MUX14D_P2_RELAY_LABEL = 614,
    DATA_ID_DIB_MUX14D_P2_RELAY_IS_FIRST = 615,
    DATA_ID_DIB_MUX14D_P2_RELAY_IS_ON = 616,
    DATA_ID_DIB_MUX14D_P2_RELAY_CYCLES = 617,
    DATA_ID_DIB_MUX14D_P2_RELAY_LABEL_LABEL = 618,
    DATA_ID_DIB_MUX14D_EXT_RELAY_IS_ON = 619,
    DATA_ID_DIB_MUX14D_EXT_RELAY_CYCLES = 620,
    DATA_ID_DIB_MUX14D_ADIB1_RELAY_IS_ON = 621,
    DATA_ID_DIB_MUX14D_ADIB1_RELAY_CYCLES = 622,
    DATA_ID_DIB_MUX14D_ADIB2_RELAY_IS_ON = 623,
    DATA_ID_DIB_MUX14D_ADIB2_RELAY_CYCLES = 624,
    DATA_ID_DIB_MUX14D_CJ_TEMP = 625,
    DATA_ID_DIB_MUX14D_MULTIPLE_CONNECTIONS = 626
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_SYS_SETTINGS_FUNCTION_GENERATOR = 249,
    ACTION_ID_FUNCTION_GENERATOR_SELECT_WAVEFORM = 250,
    ACTION_ID_FUNCTION_GENERATOR_ITEM_TOGGLE_SELECTED = 251,
    ACTION_ID_FUNCTION_GENERATOR_ITEM_TOGGLE_CHECKED = 252,
    ACTION_ID_FUNCTION_GENERATOR_SELECT_CHANNELS = 253,
    ACTION_ID_FUNCTION_GENERATOR_MODE_SELECT_MODE = 254,
    ACTION_ID_SHOW_SYS_SETTINGS_FUNCTION_GENERATOR_SELECT_CHANNEL = 255,
    ACTION_ID_TRIGGER_MANUALLY = 256,
    ACTION_ID_FUNCTION_GENERATOR_TOGGLE_FREQ = 257,
    ACTION_ID_FUNCTION_GENERATOR_TOGGLE_AMPL = 258,
    ACTION_ID_FUNCTION_GENERATOR_DESELECT_ALL = 259,
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 260,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 261,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 262,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 263,
    ACTION_ID_DIB_MIO168_DOUT_SELECT_TRIGGER_MODE = 264,
    ACTION_ID_DIB_MIO168_DOUT_SHOW_CONFIGURATION = 265,
    ACTION_ID_DIB_MIO168_DOUT_SHOW_FUNCTION = 266,
    ACTION_ID_DIB_MIO168_AIN_SHOW_CONFIGURATION = 267,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE = 268,
    ACTION_ID_DIB_MIO168_AIN_SELECT_RANGE = 269,
    ACTION_ID_DIB_MIO168_AIN_CHANGE_LABEL = 270,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE_AND_RANGE = 271,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_EFFICIENCY_FORMULA = 272,
    ACTION_ID_DIB_MIO168_AOUT_TOGGLE_OUTPUT_ENABLED = 273,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_OUTPUT_MODE = 274,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_VOLTAGE_RANGE = 275,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_CURRENT_RANGE = 276,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_MODE_AND_RANGE = 277,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_CONFIGURATION = 278,
    ACTION_ID_DIB_MIO168_AOUT_CHANGE_LABEL = 279,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_TRIGGER_MODE = 280,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_FUNCTION = 281,
    ACTION_ID_DIB_MIO168_SHOW_INFO = 282,
    ACTION_ID_DIB_MIO168_SHOW_CALIBRATION = 283,
    ACTION_ID_DIB_MIO168_SHOW_CHANNEL_LABELS = 284,
    ACTION_ID_DIB_MIO168_SHOW_DIN_CHANNEL_LABELS = 285,
    ACTION_ID_DIB_MIO168_SHOW_DOUT_CHANNEL_LABELS = 286,
    ACTION_ID_DIB_MIO168_CHANGE_DIN_LABEL = 287,
    ACTION_ID_DIB_MIO168_CHANGE_DOUT_LABEL = 288,
    ACTION_ID_DIB_MIO168_PWM_CHANGE_LABEL = 289,
    ACTION_ID_DIB_MIO168_PAGER_SELECT_PAGE = 290,
    ACTION_ID_DIB_MIO168_SELECT_SIMULATOR_AFE_VERSION = 291,
    ACTION_ID_DIB_MIO168_SHOW_SLOT_SETTINGS_IN_MAX_VIEW = 292,
    ACTION_ID_DIB_MIO168_SELECT_PAGE_IN_DEFAULT_VIEW = 293,
    ACTION_ID_DIB_PREL6_TOGGLE_RELAY = 294,
    ACTION_ID_DIB_PREL6_SHOW_RELAY_LABELS = 295,
    ACTION_ID_DIB_PREL6_CHANGE_RELAY_LABEL = 296,
    ACTION_ID_DIB_PREL6_SHOW_INFO = 297,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 298,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 299,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 300,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 301,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 302,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 303,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 304,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 305,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 306,
    ACTION_ID_DIB_SMX46_CHANGE_SUBCHANNEL_LABEL = 307,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_CONFIGURATION = 308,
    ACTION_ID_DIB_SMX46_AOUT_SELECT_TRIGGER_MODE = 309,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_FUNCTION = 310,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_CALIBRATION = 311,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 312,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 313,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 314,
    ACTION_ID_SIMULATOR_LOAD = 315,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 316,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 317,
    ACTION_ID_DIB_MUX14D_TOGGLE_P1_RELAY = 318,
    ACTION_ID_DIB_MUX14D_CHANGE_P1_RELAY_LABEL = 319,
    ACTION_ID_DIB_MUX14D_TOGGLE_P2_RELAY = 320,
    ACTION_ID_DIB_MUX14D_CHANGE_P2_RELAY_LABEL = 321,
    ACTION_ID_DIB_MUX14D_TOGGLE_EXT_RELAY = 322,
    ACTION_ID_DIB_MUX14D_TOGGLE_ADIB1_RELAY = 323,
    ACTION_ID_DIB_MUX14D_TOGGLE_ADIB2_RELAY = 324,
    ACTION_ID_DIB_MUX14D_SHOW_RELAY_LABELS = 325,
    ACTION_ID_DIB_MUX14D_SHOW_INFO = 326,
    ACTION_ID_DIB_MUX14D_SHOW_RELAY_CYCLES = 327,
    ACTION_ID_DIB_MUX14D_TOGGLE_MULTIPLE_CONNECTIONS = 328
};
...
enum StylesEnum {
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 218,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 219,
    STYLE_ID_SCROLLBAR_TRACK = 220,
    ...
    STYLE_ID_DEFAULT_M_WARNING = 257,
    ...
    STYLE_ID_LABELS_AND_COLORS_SLOT = 283,
    STYLE_ID_INLINE284 = 284,
    STYLE_ID_INLINE285 = 285,
    STYLE_ID_INLINE286 = 286,
    STYLE_ID_FRONT_PANEL_MODULE = 287,
    ...
    STYLE_ID_TRIGGER_BUTTON_14 = 296,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 363,
    STYLE_ID_INLINE364 = 364,
    STYLE_ID_MON_VALUE_20_LEFT = 365,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 366,
    STYLE_ID_BAR_GRAPH_TEXT = 367,
    STYLE_ID_BAR_GRAPH_SET_LINE = 368,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 369,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 370,
    STYLE_ID_LABELS_AND_COLORS_CHANNEL = 371,
    STYLE_ID_INLINE372 = 372,
    STYLE_ID_TRIGGER_BUTTON_24 = 373,
    STYLE_ID_INLINE374 = 374,
    STYLE_ID_INLINE375 = 375,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 376,
    STYLE_ID_MON_VALUE_38_RIGHT = 377,
    STYLE_ID_INLINE378 = 378,
    STYLE_ID_CH_PROT_OFF = 379,
    STYLE_ID_CH_PROT_ON = 380,
    STYLE_ID_CH_PROT_TRIPPED = 381,
    STYLE_ID_INLINE382 = 382,
    STYLE_ID_MON_VALUE_20_RIGHT = 383,
    STYLE_ID_MON_VALUE_14_LEFT = 384,
    STYLE_ID_MON_VALUE_14_CENTER = 385,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 386,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 387,
    STYLE_ID_MON_VALUE_14_RIGHT = 388,
    STYLE_ID_MON_VALUE_24_RIGHT = 389,
    STYLE_ID_INLINE390 = 390,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 391,
...
extern const uint8_t assets[608562];
