...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_CH_SETTINGS_ADV_REMOTE = 61,
    ACTION_ID_SHOW_CH_SETTINGS_ADV_RANGES = 62,
    ACTION_ID_SHOW_CH_SETTINGS_ADV_TRACKING = 63,
    ACTION_ID_SHOW_CH_SETTINGS_ADV_COUPLING = 64,
    ACTION_ID_SHOW_CH_SETTINGS_ADV_VIEW = 65,
    ACTION_ID_SHOW_CH_SETTINGS_INFO = 66,
    ACTION_ID_SHOW_CH_SETTINGS_INFO_CAL = 67,
    ACTION_ID_SYS_SETTINGS_CAL_EDIT_PASSWORD = 68,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_START = 69,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP_PREVIOUS = 70,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP_NEXT = 71,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_STOP_AND_SHOW_PREVIOUS_PAGE = 72,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_STOP_AND_SHOW_MAIN_PAGE = 73,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP_SET = 74,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP_SET_LEVEL_VALUE = 75,
    ACTION_ID_SYS_SETTINGS_CAL_CH_WIZ_SAVE = 76,
    ACTION_ID_SYS_SETTINGS_CAL_TOGGLE_ENABLE = 77,
    ACTION_ID_CH_SETTINGS_PROT_CLEAR = 78,
    ACTION_ID_CH_SETTINGS_PROT_CLEAR_AND_DISABLE = 79,
    ACTION_ID_CH_SETTINGS_PROT_TOGGLE_STATE = 80,
    ACTION_ID_CH_SETTINGS_PROT_EDIT_LIMIT = 81,
    ACTION_ID_CH_SETTINGS_PROT_EDIT_LEVEL = 82,
    ACTION_ID_CH_SETTINGS_PROT_EDIT_DELAY = 83,
    ACTION_ID_SET = 84,
    ACTION_ID_DISCARD = 85,
    ACTION_ID_EDIT_FIELD = 86,
    ACTION_ID_EVENT_QUEUE_PREVIOUS_PAGE = 87,
    ACTION_ID_EVENT_QUEUE_NEXT_PAGE = 88,
    ACTION_ID_CH_SETTINGS_ADV_REMOTE_TOGGLE_SENSE = 89,
    ACTION_ID_CH_SETTINGS_ADV_REMOTE_TOGGLE_PROGRAMMING = 90,
    ACTION_ID_DATE_TIME_SELECT_DST_RULE = 91,
    ACTION_ID_SHOW_USER_PROFILES = 92,
    ACTION_ID_SHOW_USER_PROFILES2 = 93,
    ACTION_ID_SHOW_USER_PROFILE_SETTINGS = 94,
    ACTION_ID_PROFILES_TOGGLE_AUTO_RECALL = 95,
    ACTION_ID_PROFILE_TOGGLE_IS_AUTO_RECALL_LOCATION = 96,
    ACTION_ID_PROFILE_RECALL = 97,
    ACTION_ID_PROFILE_SAVE = 98,
    ACTION_ID_PROFILE_DELETE = 99,
    ACTION_ID_PROFILE_EDIT_REMARK = 100,
    ACTION_ID_TOGGLE_CHANNELS_VIEW_MODE = 101,
    ACTION_ID_ETHERNET_TOGGLE = 102,
    ACTION_ID_ETHERNET_TOGGLE_DHCP = 103,
    ACTION_ID_ETHERNET_EDIT_MAC_ADDRESS = 104,
    ACTION_ID_ETHERNET_EDIT_STATIC_ADDRESS = 105,
    ACTION_ID_ETHERNET_EDIT_IP_ADDRESS = 106,
    ACTION_ID_ETHERNET_EDIT_DNS = 107,
    ACTION_ID_ETHERNET_EDIT_GATEWAY = 108,
    ACTION_ID_ETHERNET_EDIT_SUBNET_MASK = 109,
    ACTION_ID_ETHERNET_EDIT_SCPI_PORT = 110,
    ACTION_ID_CH_SETTINGS_ADV_COUPLING_UNCOUPLE = 111,
    ACTION_ID_CH_SETTINGS_ADV_COUPLING_SET_PARALLEL_INFO = 112,
    ACTION_ID_CH_SETTINGS_ADV_COUPLING_SET_SERIES_INFO = 113,
    ACTION_ID_CH_SETTINGS_ADV_COUPLING_SET_PARALLEL = 114,
    ACTION_ID_CH_SETTINGS_ADV_COUPLING_SET_SERIES = 115,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_TRACKING_MODE = 116,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_OUTPUT_PROTECTION_COUPLE = 117,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_SHUTDOWN_WHEN_PROTECTION_TRIPPED = 118,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_FORCE_DISABLING_ALL_OUTPUTS_ON_POWER_UP = 119,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_TOGGLE_STATE = 120,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_EDIT_LEVEL = 121,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_EDIT_DELAY = 122,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_CLEAR = 123,
    ACTION_ID_ON_LAST_ERROR_EVENT_ACTION = 124,
    ACTION_ID_EDIT_SYSTEM_PASSWORD = 125,
    ACTION_ID_SYS_FRONT_PANEL_LOCK = 126,
    ACTION_ID_SYS_FRONT_PANEL_UNLOCK = 127,
    ACTION_ID_SYS_SETTINGS_SOUND_TOGGLE = 128,
    ACTION_ID_SYS_SETTINGS_SOUND_TOGGLE_CLICK = 129,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_DISPLAY_VALUE1 = 130,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_DISPLAY_VALUE2 = 131,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_SWAP_DISPLAY_VALUES = 132,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_YTVIEW_RATE = 133,
    ACTION_ID_ERROR_ALERT_ACTION = 134,
    ACTION_ID_SYS_SETTINGS_ENCODER_TOGGLE_CONFIRMATION_MODE = 135,
    ACTION_ID_TURN_DISPLAY_OFF = 136,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_TRIGGER_MODE = 137,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_VOLTAGE_TRIGGER_VALUE = 138,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_CURRENT_TRIGGER_VALUE = 139,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_LIST_COUNT = 140,
    ACTION_ID_CH_SETTINGS_TRIGGER_TOGGLE_OUTPUT_STATE = 141,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_ON_LIST_STOP = 142,
    ACTION_ID_CHANNEL_LISTS_PREVIOUS_PAGE = 143,
    ACTION_ID_CHANNEL_LISTS_NEXT_PAGE = 144,
    ACTION_ID_CHANNEL_LISTS_EDIT = 145,
    ACTION_ID_SHOW_CHANNEL_LISTS_INSERT_MENU = 146,
    ACTION_ID_SHOW_CHANNEL_LISTS_DELETE_MENU = 147,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_ABOVE = 148,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_BELOW = 149,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROW = 150,
    ACTION_ID_CHANNEL_LISTS_CLEAR_COLUMN = 151,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROWS = 152,
    ACTION_ID_CHANNEL_LISTS_DELETE_ALL = 153,
    ACTION_ID_CHANNEL_INITIATE_TRIGGER = 154,
    ACTION_ID_CHANNEL_SET_TO_FIXED = 155,
    ACTION_ID_CHANNEL_ENABLE_OUTPUT = 156,
    ACTION_ID_TRIGGER_SELECT_SOURCE = 157,
    ACTION_ID_TRIGGER_EDIT_DELAY = 158,
    ACTION_ID_TRIGGER_TOGGLE_INITIATE_CONTINUOUSLY = 159,
    ACTION_ID_TRIGGER_GENERATE_MANUAL = 160,
    ACTION_ID_TRIGGER_SHOW_GENERAL_SETTINGS = 161,
    ACTION_ID_SHOW_STAND_BY_MENU = 162,
    ACTION_ID_RESET = 163,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_SELECT_MODE = 164,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_TOGGLE_AUTO_RANGING = 165,
    ACTION_ID_IO_PIN_TOGGLE_POLARITY = 166,
    ACTION_ID_IO_PIN_SELECT_FUNCTION = 167,
    ACTION_ID_SERIAL_TOGGLE = 168,
    ACTION_ID_SERIAL_SELECT_PARITY = 169,
    ACTION_ID_NTP_TOGGLE = 170,
    ACTION_ID_NTP_EDIT_SERVER = 171,
    ACTION_ID_OPEN_APPLICATION = 172,
    ACTION_ID_SHOW_HOME = 173,
    ACTION_ID_SIMULATOR_LOAD = 174,
    ACTION_ID_SELECT_THEME = 175
};
...
enum StylesEnum {
    ...
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_CONTAINER = 2,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_ITEM = 3,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_DISABLED_ITEM = 4,
    STYLE_ID_DEFAULT = 5,
    STYLE_ID_DEFAULT_S = 6,
    STYLE_ID_EDIT_INFO_S = 7,
    STYLE_ID_TOUCH_CALIBRATION = 8,
    STYLE_ID_TOUCH_CALIBRATION_ACTIVE = 9,
    STYLE_ID_MENU_S = 10,
    STYLE_ID_BOTTOM_BUTTON_BACKGROUND = 11,
    STYLE_ID_BOTTOM_BUTTON = 12,
    STYLE_ID_HOME = 13,
    STYLE_ID_HOME_ICON = 14,
    STYLE_ID_HOME_ICON_ACTIVE = 15,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_CENTER = 16,
    STYLE_ID_EVENT_INFO_ICON = 17,
    STYLE_ID_EVENT_WARNING_ICON = 18,
    STYLE_ID_EVENT_ERROR_ICON = 19,
    STYLE_ID_PROT_INDICATOR_INVALID_S = 20,
    STYLE_ID_PROT_INDICATOR_S = 21,
    STYLE_ID_PROT_INDICATOR_SET_S = 22,
    STYLE_ID_PROT_INDICATOR_TRIP_S = 23,
    STYLE_ID_DEFAULT_INVERSE = 24,
    STYLE_ID_BUTTON_INDICATOR_ON = 25,
    STYLE_ID_BUTTON_INDICATOR_ERROR = 26,
    STYLE_ID_BUTTON_INDICATOR_OFF = 27,
    STYLE_ID_PROT_INDICATOR_BLINK_S = 28,
    STYLE_ID_DEFAULT_S_LEFT = 29,
    STYLE_ID_EDIT_S = 30,
    STYLE_ID_CHANNEL_OFF = 31,
    STYLE_ID_MON_VALUE_L_RIGHT = 32,
    STYLE_ID_MON_VALUE_UR_L_RIGHT = 33,
    STYLE_ID_MON_VALUE_FOCUS = 34,
    STYLE_ID_MON_VALUE = 35,
    STYLE_ID_MON_DAC = 36,
    STYLE_ID_CHANNEL_ERROR = 37,
    STYLE_ID_BAR_GRAPH_U_DEFUALT = 38,
    STYLE_ID_BAR_GRAPH_TEXT = 39,
    STYLE_ID_BAR_GRAPH_SET_LINE = 40,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 41,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 42,
    STYLE_ID_BAR_GRAPH_UNREGULATED = 43,
    STYLE_ID_EDIT_VALUE_S_RIGHT = 44,
    STYLE_ID_EDIT_VALUE_FOCUS_S_RIGHT = 45,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_RIGHT = 46,
    STYLE_ID_MON_DAC_S = 47,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 48,
    STYLE_ID_BAR_GRAPH_TEXT_VERTICAL = 49,
    STYLE_ID_EDIT_S_FOCUS = 50,
    STYLE_ID_YT_GRAPH = 51,
    STYLE_ID_YT_GRAPH_U_DEFUALT = 52,
    STYLE_ID_YT_GRAPH_I_DEFAULT = 53,
    STYLE_ID_YT_GRAPH_UNREGULATED = 54,
    STYLE_ID_COUPLED_INFO_S = 55,
    STYLE_ID_EDIT_VALUE = 56,
    STYLE_ID_BOTTOM_BUTTON_DISABLED = 57,
    STYLE_ID_EDIT_VALUE_S_LEFT = 58,
    STYLE_ID_KEY = 59,
    STYLE_ID_KEY_ICONS = 60,
    STYLE_ID_KEY_DISABLED = 61,
    STYLE_ID_TAB_PAGE_SELECTED = 62,
    STYLE_ID_TAB_PAGE = 63,
    STYLE_ID_EDIT_VALUE_L = 64,
    STYLE_ID_VALUE = 65,
    STYLE_ID_VALUE_S = 66,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 67,
    STYLE_ID_YELLOW_1 = 68,
    STYLE_ID_YELLOW_2 = 69,
    STYLE_ID_YELLOW_3 = 70,
    STYLE_ID_YELLOW_4 = 71,
    STYLE_ID_YELLOW_5 = 72,
    STYLE_ID_YELLOW_6 = 73,
    STYLE_ID_INFO_ALERT = 74,
    STYLE_ID_INFO_ALERT_BUTTON = 75,
    STYLE_ID_TOAST_ALERT = 76,
    STYLE_ID_ERROR_ALERT = 77,
    STYLE_ID_ERROR_ALERT_BUTTON = 78,
    STYLE_ID_YES_NO = 79,
...
enum PagesEnum {
    ...
    PAGE_ID_INFO_ALERT = 15,
    PAGE_ID_INFO_LONG_ALERT = 16,
    PAGE_ID_TOAST3_ALERT = 17,
    PAGE_ID_ERROR_ALERT = 18,
    PAGE_ID_ERROR_LONG_ALERT = 19,
    PAGE_ID_ERROR_ALERT_WITH_ACTION = 20,
    PAGE_ID_ERROR_TOAST_ALERT = 21,
    PAGE_ID_YES_NO = 22,
    PAGE_ID_ARE_YOU_SURE_WITH_MESSAGE = 23,
    PAGE_ID_YES_NO_LATER = 24,
    PAGE_ID_TEXT_MESSAGE = 25,
    PAGE_ID_ASYNC_OPERATION_IN_PROGRESS = 26,
    PAGE_ID_PROGRESS = 27,
    PAGE_ID_EVENT_QUEUE = 28,
    PAGE_ID_KEYPAD = 29,
    PAGE_ID_NUMERIC_KEYPAD = 30,
    PAGE_ID_CH_SETTINGS_PROT = 31,
    ...
    PAGE_ID_CH_START_LIST = 41,
    PAGE_ID_CH_SETTINGS_ADV = 42,
    PAGE_ID_CH_SETTINGS_ADV_REMOTE = 43,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 44,
    PAGE_ID_CH_SETTINGS_ADV_TRACKING = 45,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING = 46,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING_INFO = 47,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 48,
    PAGE_ID_CH_SETTINGS_INFO = 49,
    PAGE_ID_SYS_SETTINGS1 = 50,
    PAGE_ID_SYS_SETTINGS2 = 51,
    PAGE_ID_SYS_SETTINGS_AUX_OTP = 52,
    ...
    PAGE_ID_CHANNELS = 79,
    PAGE_ID_PROFILE = 80,
    PAGE_ID_PROFILE_BASIC_INFO = 81,
    PAGE_ID_COUPLED_CHANNELS_DEFAULT_VIEW = 82,
    PAGE_ID_COUPLED_CHANNELS_HORIZONTAL_BAR_VIEW = 83,
    PAGE_ID_COUPLED_CHANNELS_VERTICAL_BAR_VIEW = 84,
    PAGE_ID_COUPLED_CHANNELS_YTBAR_VIEW = 85,
    PAGE_ID_OCP = 86,
    PAGE_ID_OVP = 87,
    PAGE_ID_OTP = 88,
    PAGE_ID_OPP = 89,
    PAGE_ID_FRONT_PANEL = 90,
    PAGE_ID_NUMERIC_KEYPAD2 = 91,
    PAGE_ID_SYS_SETTINGS = 92
};

extern const uint8_t assets[187483];
