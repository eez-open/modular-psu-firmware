enum DataEnum {
    ...
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 288,
    ...
    DATA_ID_KEYPAD_OK_ENABLED = 340,
    DATA_ID_ETHERNET_HOST_NAME = 341,
    DATA_ID_MQTT_HOST = 342,
    DATA_ID_MQTT_PORT = 343,
    DATA_ID_MQTT_USERNAME = 344,
    DATA_ID_MQTT_PASSWORD = 345,
    DATA_ID_MQTT_PERIOD = 346,
    ...
    DATA_ID_RAMP_COUNTER_LABEL = 352,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 353,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 354,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 355,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 356,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 357,
    DATA_ID_IS_RESET_BY_IWDG = 358,
    DATA_ID_DLOG_ENABLED = 359,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 360,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 361,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 362,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 363,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 364,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 365,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 366,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 367,
    DATA_ID_DATE_TIME_FORMAT = 368,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 369,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 370,
    DATA_ID_DATE_TIME_AM_PM = 371,
    DATA_ID_IS_MULTI_TRACKING = 372,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 373,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 374,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 375,
    DATA_ID_CHANNEL_INFO_BRAND = 376,
    DATA_ID_CHANNEL_INFO_SERIAL = 377,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 378,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 379,
    DATA_ID_FILE_MANAGER_FILE_ICON = 380,
    DATA_ID_FILE_MANAGER_LAYOUT = 381,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 382,
    DATA_ID_TOUCH_RAW_X = 383,
    DATA_ID_TOUCH_RAW_Y = 384,
    DATA_ID_TOUCH_RAW_Z1 = 385,
    DATA_ID_TOUCH_RAW_PRESSED = 386,
    DATA_ID_TOUCH_CALIBRATED_X = 387,
    DATA_ID_TOUCH_CALIBRATED_Y = 388,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 389,
    DATA_ID_TOUCH_FILTERED_X = 390,
    DATA_ID_TOUCH_FILTERED_Y = 391,
    DATA_ID_TOUCH_FILTERED_PRESSED = 392,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 393,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 394,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 395,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 396,
    DATA_ID_ALERT_MESSAGE_IS_SET = 397,
    DATA_ID_ASYNC_PROGRESS = 398,
    DATA_ID_IO_PIN_FUNCTION = 399,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 400,
    DATA_ID_IO_PIN_PWM_DUTY = 401,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 402,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 403,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 404,
    DATA_ID_DEBUG_VARIABLES = 405,
    DATA_ID_DEBUG_VARIABLE_NAME = 406,
    DATA_ID_DEBUG_VARIABLE_VALUE = 407,
    DATA_ID_CHANNEL_RAMP_STATE = 408,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 409
};
...
extern const uint8_t assets[413518];
