enum DataEnum {
    ...
    DATA_ID_EVENT_QUEUE_LAST_EVENT_MESSAGE = 105,
    DATA_ID_EVENT_QUEUE_EVENTS = 106,
    DATA_ID_EVENT_QUEUE_EVENTS_TYPE = 107,
    DATA_ID_EVENT_QUEUE_EVENTS_MESSAGE = 108,
    ...
    DATA_ID_DEBUG_TRACE_LOG = 343,
    DATA_ID_DEBUG_TRACE_LOG_LINE = 344,
    ...
    DATA_ID_DEBUG_TRACE_LOG_IS_STOPPED = 352,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 353,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 354,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 355,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 356,
    DATA_ID_LIST_COUNTER_LABEL = 357,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 358,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 359,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 360,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 361,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 362,
    DATA_ID_IS_RESET_BY_IWDG = 363,
    DATA_ID_DLOG_ENABLED = 364,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 365,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 366,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 367,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 368,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 369
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_DEBUG_TRACE_LOG = 200,
    ACTION_ID_DLOG_UPLOAD = 201,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 202,
    ACTION_ID_MQTT_EDIT_HOST = 203,
    ACTION_ID_MQTT_EDIT_PORT = 204,
    ACTION_ID_MQTT_EDIT_USERNAME = 205,
    ACTION_ID_MQTT_EDIT_PASSWORD = 206,
    ACTION_ID_MQTT_EDIT_PERIOD = 207,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 208,
    ACTION_ID_DEBUG_TRACE_LOG_TOGGLE = 209,
    ACTION_ID_DLOG_SCALE_TO_FIT = 210,
    ACTION_ID_DLOG_VIEW_TOGGLE_LEGEND = 211,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 212,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 213,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 214,
    ACTION_ID_SHUTDOWN = 215,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 216,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 217,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 218,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 219,
    ACTION_ID_PROFILE_IMPORT = 220,
    ACTION_ID_PROFILE_EXPORT = 221
};
...
enum PagesEnum {
    ...
    PAGE_ID_CH_SETTINGS_CALIBRATION_WIZ_STEP = 62,
    PAGE_ID_CH_SETTINGS_CALIBRATION_WIZ_FINISH = 63,
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[392772];
#else
extern const uint8_t assets[3862776];
#endif
