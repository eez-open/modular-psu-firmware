enum DataEnum {
    ...
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 328,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 329,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 330,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 331,
    DATA_ID_IS_RESET_BY_IWDG = 332,
    DATA_ID_DLOG_ENABLED = 333,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 334,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 335,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 336,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 337,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 338,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 339,
    DATA_ID_DATE_TIME_FORMAT = 340,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 341,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 342,
    DATA_ID_DATE_TIME_AM_PM = 343,
    DATA_ID_IS_MULTI_TRACKING = 344,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 345,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 346,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 347,
    DATA_ID_CHANNEL_INFO_BRAND = 348,
    DATA_ID_CHANNEL_INFO_SERIAL = 349,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 350,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 351,
    DATA_ID_FILE_MANAGER_FILE_ICON = 352,
    DATA_ID_FILE_MANAGER_LAYOUT = 353,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 354,
    DATA_ID_TOUCH_RAW_X = 355,
    DATA_ID_TOUCH_RAW_Y = 356,
    DATA_ID_TOUCH_RAW_Z1 = 357,
    DATA_ID_TOUCH_RAW_PRESSED = 358,
    DATA_ID_TOUCH_CALIBRATED_X = 359,
    DATA_ID_TOUCH_CALIBRATED_Y = 360,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 361,
    DATA_ID_TOUCH_FILTERED_X = 362,
    DATA_ID_TOUCH_FILTERED_Y = 363,
    DATA_ID_TOUCH_FILTERED_PRESSED = 364,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 365,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 366,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 367,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 368,
    DATA_ID_ALERT_MESSAGE_IS_SET = 369,
    DATA_ID_ASYNC_PROGRESS = 370,
    DATA_ID_IO_PIN_FUNCTION = 371,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 372,
    DATA_ID_IO_PIN_PWM_DUTY = 373,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 374,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 375,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 376,
    DATA_ID_DEBUG_VARIABLES = 377,
    DATA_ID_DEBUG_VARIABLE_NAME = 378,
    DATA_ID_DEBUG_VARIABLE_VALUE = 379,
    DATA_ID_CHANNEL_RAMP_STATE = 380,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 381,
    DATA_ID_MQTT_IN_ERROR = 382,
    DATA_ID_DEBUG_I_DAC = 383,
    DATA_ID_DEBUG_U_DAC = 384,
    DATA_ID_DEBUG_I_DAC_AMPER = 385,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 386,
    DATA_ID_DEBUG_I_ADC = 387,
    DATA_ID_DEBUG_U_ADC = 388,
    DATA_ID_DEBUG_I_ADC_AMPER = 389,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 390,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 391,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 392,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 393,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 394,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 395,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 396,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 397,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 398,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 399,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 400,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 401,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 402,
    DATA_ID_DUMMY = 403,
    DATA_ID_SLOTS = 404,
    DATA_ID_SLOT_INDEX = 405,
    DATA_ID_SLOT_TITLE_DEF = 406,
    DATA_ID_SLOT_TITLE_MAX = 407,
    DATA_ID_SLOT_TITLE_MIN = 408,
    DATA_ID_SLOT_TITLE_MICRO = 409,
    DATA_ID_SLOT_ERROR_MESSAGE = 410,
    DATA_ID_USB_MODE = 411,
    DATA_ID_USB_CURRENT_MODE = 412,
    DATA_ID_USB_DEVICE_CLASS = 413,
    DATA_ID_USB_KEYBOARD_STATE = 414,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 415,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 416,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 417,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 418,
    DATA_ID_DIB_MIO168_INPUTS = 419,
    DATA_ID_DIB_MIO168_INPUT_NO = 420,
    DATA_ID_DIB_MIO168_INPUT_STATE = 421,
    DATA_ID_DIB_MIO168_OUTPUTS = 422,
    DATA_ID_DIB_MIO168_OUTPUT_NO = 423,
    DATA_ID_DIB_MIO168_OUTPUT_STATE = 424,
    DATA_ID_DIB_MIO168_ANALOG_INPUTS = 425,
    DATA_ID_DIB_MIO168_ANALOG_INPUT_VALUE = 426,
    DATA_ID_DIB_SMX46_OUTPUTS = 427,
...
enum StylesEnum {
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 202,
    STYLE_ID_INLINE203 = 203,
    STYLE_ID_MON_VALUE_20_LEFT = 204,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 205,
    STYLE_ID_BAR_GRAPH_TEXT = 206,
    STYLE_ID_BAR_GRAPH_SET_LINE = 207,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 208,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 209,
    STYLE_ID_INLINE210 = 210,
    STYLE_ID_INLINE211 = 211,
    STYLE_ID_TRIGGER_BUTTON_24 = 212,
    STYLE_ID_INLINE213 = 213,
    STYLE_ID_INLINE214 = 214,
    STYLE_ID_MON_VALUE_14_RIGHT = 215,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 216,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 217,
    STYLE_ID_TRIGGER_BUTTON_14 = 218,
    STYLE_ID_INLINE219 = 219,
    STYLE_ID_INLINE220 = 220,
    STYLE_ID_INLINE221 = 221,
    STYLE_ID_INLINE222 = 222,
    STYLE_ID_INLINE223 = 223,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 224,
    STYLE_ID_INST_SELECTED = 225,
    STYLE_ID_MON_VALUE_38_RIGHT = 226,
    STYLE_ID_INLINE227 = 227,
    STYLE_ID_CH_PROT_OFF = 228,
    STYLE_ID_CH_PROT_ON = 229,
    STYLE_ID_CH_PROT_TRIPPED = 230,
    STYLE_ID_INLINE231 = 231,
    STYLE_ID_MON_VALUE_24_RIGHT = 232,
    STYLE_ID_MON_VALUE_14_CENTER = 233,
    STYLE_ID_INLINE234 = 234,
    STYLE_ID_INLINE235 = 235,
    STYLE_ID_INLINE236 = 236,
    STYLE_ID_INLINE237 = 237,
    STYLE_ID_INLINE238 = 238,
    STYLE_ID_MON_VALUE_20_RIGHT = 239,
    STYLE_ID_MON_VALUE_14_LEFT = 240,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 241,
    STYLE_ID_INLINE242 = 242,
    STYLE_ID_INLINE243 = 243,
    STYLE_ID_INLINE244 = 244,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 245,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 246,
    STYLE_ID_SCROLLBAR_TRACK = 247,
...
enum PagesEnum {
    ...
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK = 202,
    PAGE_ID_DIB_DCM220_FRONT_PANEL_LED = 203,
    ...
    PAGE_ID_DIB_DCM224_SIMULATOR_FRONT_PANEL_MASK = 208,
    PAGE_ID_DIB_DCM224_FRONT_PANEL_LED = 209,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ERROR = 210,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ADV_OPTIONS = 211
};

extern const uint8_t assets[524272];
