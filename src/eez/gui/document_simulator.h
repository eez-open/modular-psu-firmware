...
enum ActionsEnum {
    ...
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 268,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 269,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 270,
    ACTION_ID_SIMULATOR_LOAD = 271,
...
extern const uint8_t assets[540992];
