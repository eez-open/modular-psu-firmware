enum DataEnum {
    ...
    DATA_ID_CHANNEL_DISPLAY_VALUE3 = 33,
    DATA_ID_OVP = 34,
    DATA_ID_OCP = 35,
    DATA_ID_OPP = 36,
    DATA_ID_OTP_CH = 37,
    ...
    DATA_ID_KEYPAD_OPTION3_TEXT = 56,
    DATA_ID_KEYPAD_OPTION3_ENABLED = 57,
    DATA_ID_KEYPAD_SIGN_ENABLED = 58,
    DATA_ID_KEYPAD_DOT_ENABLED = 59,
    DATA_ID_KEYPAD_UNIT_ENABLED = 60,
    DATA_ID_CHANNEL_LABEL = 61,
    DATA_ID_CHANNEL_SHORT_LABEL = 62,
    DATA_ID_CHANNEL_TEMP_STATUS = 63,
    DATA_ID_CHANNEL_TEMP = 64,
    DATA_ID_CHANNEL_ON_TIME_TOTAL = 65,
    DATA_ID_CHANNEL_ON_TIME_LAST = 66,
    DATA_ID_CHANNEL_CALIBRATION_STATUS = 67,
    DATA_ID_CHANNEL_CALIBRATION_STATE = 68,
    DATA_ID_CHANNEL_CALIBRATION_DATE = 69,
    DATA_ID_CHANNEL_CALIBRATION_REMARK = 70,
    DATA_ID_CHANNEL_PROTECTION_STATUS = 71,
    DATA_ID_CHANNEL_PROTECTION_STATUS_OVP = 72,
    DATA_ID_CHANNEL_PROTECTION_STATUS_OCP = 73,
    DATA_ID_CHANNEL_PROTECTION_STATUS_OPP = 74,
    DATA_ID_CHANNEL_PROTECTION_STATUS_OTP = 75,
    ...
    DATA_ID_IO_PIN_LABEL = 220,
    DATA_ID_IO_PIN_POLARITY = 221,
    DATA_ID_IO_PIN_FUNCTION_NAME = 222,
    DATA_ID_IO_PIN_UART_MODE = 223,
    DATA_ID_NTP_ENABLED = 224,
    DATA_ID_NTP_SERVER = 225,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 226,
    DATA_ID_PROGRESS = 227,
    DATA_ID_TOUCH_CALIBRATION_POINT = 228,
    DATA_ID_SELECTED_THEME = 229,
    DATA_ID_CHANNEL_TITLE = 230,
    DATA_ID_CHANNEL_SHORT_TITLE = 231,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 232,
    DATA_ID_CHANNEL_LONG_TITLE = 233,
    DATA_ID_ANIMATIONS_DURATION = 234,
    DATA_ID_SLOT_INFO = 235,
    DATA_ID_SLOT_TEST_RESULT = 236,
    DATA_ID_SLOT_DEFAULT_VIEW = 237,
    DATA_ID_SLOT1_CHANNEL_INDEX = 238,
    DATA_ID_SLOT2_CHANNEL_INDEX = 239,
    DATA_ID_SLOT3_CHANNEL_INDEX = 240,
    DATA_ID_SLOT1_NON_MAPPED_CHANNEL_INDEX = 241,
    DATA_ID_SLOT2_NON_MAPPED_CHANNEL_INDEX = 242,
    DATA_ID_SLOT3_NON_MAPPED_CHANNEL_INDEX = 243,
    DATA_ID_BATTERY = 244,
    DATA_ID_IO_PIN_STATE = 245,
    DATA_ID_CHANNEL_DPROG = 246,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 247,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 248,
    DATA_ID_SYS_INFO_HAS_ERROR = 249,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 250,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 251,
    DATA_ID_SYS_FAN_MODE = 252,
    DATA_ID_SYS_FAN_SPEED = 253,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 254,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 255,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 256,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 257,
    DATA_ID_IS_TRACKING_ALLOWED = 258,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 259,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 260,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 261,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 262,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 263,
    DATA_ID_IS_COUPLED_OR_TRACKED = 264,
    DATA_ID_OVERLAY = 265,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 266,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 267,
    DATA_ID_DLOG_STATE = 268,
    DATA_ID_DLOG_TOGGLE_STATE = 269,
    DATA_ID_RECORDING = 270,
    DATA_ID_CHANNEL_HISTORY_VALUES = 271,
    DATA_ID_RECORDING_READY = 272,
    DATA_ID_NONDRAG_OVERLAY = 273,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 274,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 275,
    DATA_ID_DLOG_VISIBLE_VALUES = 276,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 277,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 278,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 279,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 280,
    ...
    DATA_ID_DLOG_PERIOD_SPEC = 291,
    DATA_ID_DLOG_DURATION = 292,
    DATA_ID_DLOG_FILE_NAME = 293,
    DATA_ID_CHANNEL_OFF_LABEL = 294,
    DATA_ID_FILE_MANAGER_FILES = 295,
    DATA_ID_FILE_MANAGER_FILE_NAME = 296,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 297,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 298,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 299,
    DATA_ID_FILE_MANAGER_STATE = 300,
    DATA_ID_FILE_MANAGER_HAS_PARENT = 301,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 302,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 303,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 304,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 305,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 306,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 307,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 308,
    DATA_ID_SCRIPT_INFO = 309,
    DATA_ID_SCRIPT_IS_STARTED = 310,
    DATA_ID_KEYPAD_OK_ENABLED = 311,
    DATA_ID_ETHERNET_HOST_NAME = 312,
    DATA_ID_MQTT_HOST = 313,
    DATA_ID_MQTT_PORT = 314,
    DATA_ID_MQTT_USERNAME = 315,
    DATA_ID_MQTT_PASSWORD = 316,
    DATA_ID_MQTT_PERIOD = 317,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 318,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 319,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 320,
    DATA_ID_LIST_COUNTER_LABEL = 321,
    DATA_ID_RAMP_COUNTER_LABEL = 322,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 323,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 324,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 325,
    DATA_ID_IS_RESET_BY_IWDG = 326,
    ...
    DATA_ID_CHANNEL_RAMP_STATE = 370,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 371,
    DATA_ID_MQTT_IN_ERROR = 372,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 373,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 374,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 375,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 376,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 377,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 378,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 379,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 380,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 381,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 382,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 383,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 384,
    DATA_ID_SLOTS = 385,
    DATA_ID_SLOT_INDEX = 386,
    DATA_ID_SLOT_TITLE_DEF = 387,
    DATA_ID_SLOT_TITLE_MAX = 388,
    DATA_ID_SLOT_TITLE_MIN = 389,
    DATA_ID_SLOT_TITLE_SETTINGS = 390,
    DATA_ID_SLOT_SHORT_TITLE = 391,
    DATA_ID_SLOT_ERROR_MESSAGE = 392,
    DATA_ID_USB_MODE = 393,
    DATA_ID_USB_CURRENT_MODE = 394,
    DATA_ID_USB_DEVICE_CLASS = 395,
    DATA_ID_USB_KEYBOARD_STATE = 396,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 397,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 398,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 399,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 400,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 401,
    DATA_ID_SLOT_SERIAL_INFO = 402,
    DATA_ID_SLOT_IS_ENABLED = 403,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 404,
    DATA_ID_USER_SWITCH_ACTION = 405,
    DATA_ID_NTP_REFRESH_FREQUENCY = 406,
    DATA_ID_CHANNEL_CALIBRATION_IS_POWER_CHANNEL = 407,
    DATA_ID_HAS_CUSTOM_BITMAP = 408,
    DATA_ID_CUSTOM_BITMAP = 409,
    DATA_ID_SLOT_INFO_WITH_FW_VER = 410,
    DATA_ID_MASTER_INFO_WITH_FW_VER = 411,
    DATA_ID_SLOT1_LABELS_AND_COLORS_VIEW = 412,
    DATA_ID_SLOT2_LABELS_AND_COLORS_VIEW = 413,
    DATA_ID_SLOT3_LABELS_AND_COLORS_VIEW = 414,
    DATA_ID_COLORS = 415,
    DATA_ID_KEYPAD_CAN_SET_DEFAULT = 416,
    DATA_ID_LABELS_AND_COLORS_PAGE_SLOT_TITLE = 417,
    DATA_ID_LABELS_AND_COLORS_PAGE_CHANNEL_TITLE = 418,
    DATA_ID_LABELS_AND_COLORS_IS_COLOR_MODIFIED = 419,
    DATA_ID_DLOG_ITEMS = 420,
    DATA_ID_DLOG_ITEMS_NUM_SELECTED = 421,
    DATA_ID_DLOG_ITEM_IS_CHECKED = 422,
    DATA_ID_DLOG_ITEM_CHANNEL = 423,
    DATA_ID_DLOG_ITEM_LABEL = 424,
    DATA_ID_DLOG_ITEMS_SCROLLBAR_ENABLED = 425,
    DATA_ID_DLOG_START_ENABLED = 426,
    DATA_ID_HAS_MULTIPLE_DISK_DRIVES = 427,
    DATA_ID_SELECTED_MASS_STORAGE_DEVICE = 428,
    DATA_ID_FILE_MANAGER_IS_SORT_FILES_OPTION_AVAILABLE = 429,
    DATA_ID_DLOG_PREVIEW_OVERLAY = 430,
    DATA_ID_DLOG_ITEM_IS_AVAILABLE = 431,
    DATA_ID_MODULE_IS_RESYNC_SUPPORTED = 432,
    DATA_ID_CHANNEL_IS_CALIBRATION_VALUE_SOURCE = 433,
    DATA_ID_CALIBRATION_POINT_CAN_EDIT_SET_VALUE = 434,
    DATA_ID_CALIBRATION_POINT_LIVE_MEASURED_VALUE = 435,
    DATA_ID_AC_MAINS = 436,
    DATA_ID_SELECTED_MCU_REVISION = 437,
    DATA_ID_IS_MCU_REVISION_SELECTED = 438,
    DATA_ID_SLOT_IS_2CH_VIEW = 439,
    DATA_ID_COLOR_IS_SELECTED = 440,
    DATA_ID_MASTER_ERROR_MESSAGE = 441,
    DATA_ID_DLOG_PERIOD_HAS_PREDEFINED_VALUES = 442,
    DATA_ID_DLOG_VIEW_SELECTED_TAB = 443,
    DATA_ID_DLOG_BOOKMARKS = 444,
    DATA_ID_DLOG_BOOKMARK_X_VALUE = 445,
    DATA_ID_DLOG_BOOKMARK_TEXT = 446,
    DATA_ID_DLOG_BOOKMARK_IS_SELECTED = 447,
    DATA_ID_DLOG_VIEW_IS_DRAWER_OPEN = 448,
    DATA_ID_DLOG_VIEW_IS_ZOOM_IN_ENABLED = 449,
    DATA_ID_DLOG_VIEW_IS_ZOOM_OUT_ENABLED = 450,
    DATA_ID_DLOG_BOOKMARKS_IS_SCROLLBAR_VISIBLE = 451,
    DATA_ID_DLOG_Y_VALUES_IS_SCROLLBAR_VISIBLE = 452,
    DATA_ID_DLOG_Y_VALUES = 453,
    DATA_ID_DLOG_Y_VALUE_LABEL = 454,
    DATA_ID_DLOG_Y_VALUE_IS_CHECKED = 455,
    DATA_ID_DLOG_Y_VALUE_IS_SELECTED = 456,
    DATA_ID_DLOG_Y_VALUE_IS_ENABLED = 457,
    DATA_ID_DLOG_Y_VALUE_OFFSET = 458,
    DATA_ID_DLOG_Y_VALUE_DIV = 459,
    DATA_ID_DLOG_Y_VALUE_CURSOR = 460,
    DATA_ID_FUNCTION_GENERATOR_CHANNELS = 461,
    DATA_ID_FUNCTION_GENERATOR_ANY_CHANNEL_SELECTED = 462,
    DATA_ID_FUNCTION_GENERATOR_CHANNEL = 463,
    DATA_ID_FUNCTION_GENERATOR_ITEM_LABEL = 464,
    DATA_ID_FUNCTION_GENERATOR_ITEM_IS_CHECKED = 465,
    DATA_ID_FUNCTION_GENERATOR_IS_MAX_SELECTED = 466,
    DATA_ID_FUNCTION_GENERATOR_NUM_SELECTED = 467,
    DATA_ID_FUNCTION_GENERATOR_ITEM_IS_SELECTED = 468,
    DATA_ID_FUNCTION_GENERATOR_WAVEFORM = 469,
    DATA_ID_FUNCTION_GENERATOR_WAVEFORM_LABEL = 470,
    DATA_ID_FUNCTION_GENERATOR_FREQUENCY = 471,
    DATA_ID_FUNCTION_GENERATOR_MODE = 472,
    DATA_ID_FUNCTION_GENERATOR_PHASE_SHIFT = 473,
    DATA_ID_FUNCTION_GENERATOR_AMPLITUDE = 474,
    DATA_ID_FUNCTION_GENERATOR_OFFSET = 475,
    DATA_ID_FUNCTION_GENERATOR_DUTY_CYCLE = 476,
    DATA_ID_FUNCTION_GENERATOR_CANVAS = 477,
    DATA_ID_FUNCTION_GENERATOR_HAS_MODE_SELECT = 478,
    DATA_ID_FUNCTION_GENERATOR_HAS_AMPLITUDE_AND_OFFSET = 479,
    DATA_ID_FUNCTION_GENERATOR_HAS_DUTY_CYCLE = 480,
    DATA_ID_FUNCTION_GENERATOR_IS_FREQ = 481,
    DATA_ID_FUNCTION_GENERATOR_IS_AMPL = 482,
    DATA_ID_FUNCTION_GENERATOR_IS_DC = 483,
    DATA_ID_FUNCTION_GENERATOR_ANY_SELECTED = 484,
    DATA_ID_DIB_MIO168_DIN_PINS = 485,
    DATA_ID_DIB_MIO168_DIN_PINS_1_4 = 486,
    DATA_ID_DIB_MIO168_DIN_PINS_5_8 = 487,
    DATA_ID_DIB_MIO168_DIN_NO = 488,
    DATA_ID_DIB_MIO168_DIN_STATE = 489,
    DATA_ID_DIB_MIO168_DIN_RANGE = 490,
    DATA_ID_DIB_MIO168_DIN_LABEL = 491,
    DATA_ID_DIB_MIO168_DIN_LABEL_LABEL = 492,
    DATA_ID_DIB_MIO168_DIN_SPEED = 493,
    DATA_ID_DIB_MIO168_DOUT_PINS = 494,
    DATA_ID_DIB_MIO168_DOUT_PINS_1_4 = 495,
    DATA_ID_DIB_MIO168_DOUT_PINS_5_8 = 496,
    DATA_ID_DIB_MIO168_DOUT_NO = 497,
    DATA_ID_DIB_MIO168_DOUT_STATE = 498,
    DATA_ID_DIB_MIO168_DOUT_LABEL = 499,
    DATA_ID_DIB_MIO168_DOUT_LABEL_LABEL = 500,
    DATA_ID_DIB_MIO168_DOUT_TRIGGER_MODE = 501,
    DATA_ID_DIB_MIO168_DOUT_TRIGGER_IS_INITIATED = 502,
    DATA_ID_DIB_MIO168_DOUT_FUNCTION_LABEL = 503,
    DATA_ID_DIB_MIO168_AIN_CHANNELS = 504,
    DATA_ID_DIB_MIO168_AIN_LABEL = 505,
    DATA_ID_DIB_MIO168_AIN_LABEL_SHORT = 506,
    DATA_ID_DIB_MIO168_AIN_LABEL_LABEL = 507,
    DATA_ID_DIB_MIO168_AIN_VALUE = 508,
    DATA_ID_DIB_MIO168_AIN_MODE = 509,
    DATA_ID_DIB_MIO168_AIN_RANGE = 510,
    DATA_ID_DIB_MIO168_AIN_IS_DLOG_ACTIVE = 511,
    DATA_ID_DIB_MIO168_AIN_MODE_AND_RANGE = 512,
    DATA_ID_DIB_MIO168_AIN_MODE_IS_MULTIPLE_SELECTION_AVAILABLE = 513,
    DATA_ID_DIB_MIO168_AIN_RANGE_IS_MULTIPLE_SELECTION_AVAILABLE = 514,
    DATA_ID_DIB_MIO168_AIN_IS_OVERFLOW = 515,
    DATA_ID_DIB_MIO168_AIN_HAS_POWER_COLUMN = 516,
    DATA_ID_DIB_MIO168_AIN_HAS_P1 = 517,
    DATA_ID_DIB_MIO168_AIN_P1 = 518,
    DATA_ID_DIB_MIO168_AIN_HAS_P2 = 519,
    DATA_ID_DIB_MIO168_AIN_P2 = 520,
    DATA_ID_DIB_MIO168_AIN_HAS_EFFICIENCY = 521,
    DATA_ID_DIB_MIO168_AIN_CALC_EFFICIENCY = 522,
    DATA_ID_DIB_MIO168_AIN_EFFICIENCY = 523,
    DATA_ID_DIB_MIO168_AIN_ACTIVE_POWER = 524,
    DATA_ID_DIB_MIO168_AIN_REACTIVE_POWER = 525,
    DATA_ID_DIB_MIO168_AIN_VOLT_RMS = 526,
    DATA_ID_DIB_MIO168_AIN_CURR_RMS = 527,
    DATA_ID_DIB_MIO168_AIN_APPARENT_POWER = 528,
    DATA_ID_DIB_MIO168_AIN_POWER_FACTOR = 529,
    DATA_ID_DIB_MIO168_AIN_NPLC = 530,
    DATA_ID_DIB_MIO168_AIN_APERTURE = 531,
    DATA_ID_DIB_MIO168_AIN_EFFICIENCY_FORMULA = 532,
    DATA_ID_DIB_MIO168_IS_NO_AFE = 533,
    DATA_ID_DIB_MIO168_AC_ANALYSIS_ENABLED = 534,
    DATA_ID_DIB_MIO168_AOUT_CHANNELS = 535,
    DATA_ID_DIB_MIO168_AOUT_LABEL = 536,
    DATA_ID_DIB_MIO168_AOUT_LABEL_SHORT = 537,
    DATA_ID_DIB_MIO168_AOUT_LABEL_LABEL = 538,
    DATA_ID_DIB_MIO168_AOUT_VALUE = 539,
    DATA_ID_DIB_MIO168_AOUT_VALUE_IS_OFF = 540,
    DATA_ID_DIB_MIO168_AC_ANALYSIS_ALLOWED = 541,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_ENABLED = 542,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_MODE = 543,
    DATA_ID_DIB_MIO168_AOUT_VOLTAGE_RANGE = 544,
    DATA_ID_DIB_MIO168_AOUT_CURRENT_RANGE = 545,
    DATA_ID_DIB_MIO168_AOUT_CHANNEL_HAS_SETTINGS = 546,
    DATA_ID_DIB_MIO168_AOUT_MODE_AND_RANGE = 547,
    DATA_ID_DIB_MIO168_AOUT_TRIGGER_MODE = 548,
    DATA_ID_DIB_MIO168_AOUT_TRIGGER_IS_INITIATED = 549,
    DATA_ID_DIB_MIO168_AOUT_FUNCTION_LABEL = 550,
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 551,
    DATA_ID_DIB_MIO168_PWM_LABEL = 552,
    DATA_ID_DIB_MIO168_PWM_LABEL_SHORT = 553,
    DATA_ID_DIB_MIO168_PWM_LABEL_LABEL = 554,
    DATA_ID_DIB_MIO168_PWM_FREQ = 555,
    DATA_ID_DIB_MIO168_PWM_DUTY = 556,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 557,
    DATA_ID_DIB_MIO168_AFE_VERSION = 558,
    DATA_ID_DIB_MIO168_PAGER_LIST = 559,
    DATA_ID_DIB_MIO168_PAGER_IS_SELECTED = 560,
    DATA_ID_DIB_MIO168_PAGER_SELECTED_PAGE = 561,
    DATA_ID_DIB_MIO168_SELECTED_PAGE_IN_DEFAULT_VIEW = 562,
    DATA_ID_DIB_MIO168_SIMULATOR_AFE_VERSION = 563,
    DATA_ID_DIB_MIO168_IS_SETTINGS_PAGE_SELECTED = 564,
    DATA_ID_DIB_PREL6_RELAYS = 565,
    DATA_ID_DIB_PREL6_RELAY_IS_ON = 566,
    DATA_ID_DIB_PREL6_RELAY_LABEL = 567,
    DATA_ID_DIB_PREL6_RELAY_CYCLES = 568,
    DATA_ID_DIB_PREL6_RELAY_LABEL_LABEL = 569,
    DATA_ID_DIB_PREL6_IS_RELAY_1_OR_6 = 570,
    DATA_ID_DIB_SMX46_ROUTES = 571,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 572,
    DATA_ID_DIB_SMX46_X_LABELS = 573,
    DATA_ID_DIB_SMX46_X_LABEL = 574,
    DATA_ID_DIB_SMX46_Y_LABELS = 575,
    DATA_ID_DIB_SMX46_Y_LABEL = 576,
    DATA_ID_DIB_SMX46_AOUT_CHANNELS = 577,
    DATA_ID_DIB_SMX46_AOUT_VALUE = 578,
    DATA_ID_DIB_SMX46_AOUT_LABEL = 579,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_MODE = 580,
    DATA_ID_DIB_SMX46_AOUT_TRIGGER_IS_INITIATED = 581,
    DATA_ID_DIB_SMX46_AOUT_FUNCTION_LABEL = 582,
    DATA_ID_DIB_SMX46_RELAY_ON = 583,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 584,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 585,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 586,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_VIEW = 587,
    DATA_ID_DIB_DCM220_SLOT_MIN_2CH_VIEW = 588,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 589,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 590,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_VIEW = 591,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 592,
    DATA_ID_SIMULATOR_LOAD_STATE = 593,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 594,
    DATA_ID_SIMULATOR_LOAD = 595,
    DATA_ID_SIMULATOR_LOAD2 = 596,
    DATA_ID_MAIN_APP_VIEW = 597,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 598,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 599,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 600,
    DATA_ID_DIB_DCM224_PWM_DUTY = 601,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 602,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 603,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 604,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 605,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_VIEW = 606,
    DATA_ID_DIB_DCM224_SLOT_MIN_2CH_VIEW = 607,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 608,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 609,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_VIEW = 610,
    DATA_ID_DIB_MUX14D_P1_RELAYS = 611,
    DATA_ID_DIB_MUX14D_P1_RELAY_LABEL = 612,
    DATA_ID_DIB_MUX14D_P1_RELAY_IS_FIRST = 613,
    DATA_ID_DIB_MUX14D_P1_RELAY_IS_ON = 614,
    DATA_ID_DIB_MUX14D_P1_RELAY_CYCLES = 615,
    DATA_ID_DIB_MUX14D_P1_RELAY_LABEL_LABEL = 616,
    DATA_ID_DIB_MUX14D_P2_RELAYS = 617,
    DATA_ID_DIB_MUX14D_P2_RELAY_LABEL = 618,
    DATA_ID_DIB_MUX14D_P2_RELAY_IS_FIRST = 619,
    DATA_ID_DIB_MUX14D_P2_RELAY_IS_ON = 620,
    DATA_ID_DIB_MUX14D_P2_RELAY_CYCLES = 621,
    DATA_ID_DIB_MUX14D_P2_RELAY_LABEL_LABEL = 622,
    DATA_ID_DIB_MUX14D_EXT_RELAY_IS_ON = 623,
    DATA_ID_DIB_MUX14D_EXT_RELAY_CYCLES = 624,
    DATA_ID_DIB_MUX14D_ADIB1_RELAY_IS_ON = 625,
    DATA_ID_DIB_MUX14D_ADIB1_RELAY_CYCLES = 626,
    DATA_ID_DIB_MUX14D_ADIB2_RELAY_IS_ON = 627,
    DATA_ID_DIB_MUX14D_ADIB2_RELAY_CYCLES = 628,
    DATA_ID_DIB_MUX14D_CJ_TEMP = 629,
    DATA_ID_DIB_MUX14D_MULTIPLE_CONNECTIONS = 630
};
...
enum ActionsEnum {
    ...
    ACTION_ID_NTP_TOGGLE = 133,
    ACTION_ID_NTP_EDIT_SERVER = 134,
    ACTION_ID_SELECT_THEME = 135,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 136,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 137,
    ACTION_ID_RESTART = 138,
    ACTION_ID_USER_SWITCH_CLICKED = 139,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 140,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 141,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 142,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 143,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 144,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 145,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 146,
    ACTION_ID_SET_COUPLING_PARALLEL = 147,
    ACTION_ID_SET_COUPLING_SERIES = 148,
    ACTION_ID_SET_COUPLING_COMMON_GND = 149,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 150,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 151,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 152,
    ACTION_ID_DRAG_OVERLAY = 153,
    ACTION_ID_DLOG_TOGGLE = 154,
    ACTION_ID_SHOW_DLOG_VIEW = 155,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 156,
    ACTION_ID_SHOW_FILE_MANAGER = 157,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 158,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT = 159,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 160,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 161,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 162,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 163,
    ACTION_ID_SHOW_DLOG_PARAMS = 164,
    ACTION_ID_DLOG_EDIT_PERIOD = 165,
    ACTION_ID_DLOG_EDIT_DURATION = 166,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 167,
    ACTION_ID_DLOG_VIEW_TOGGLE_DRAWER = 168,
    ACTION_ID_FILE_MANAGER_SORT_BY = 169,
    ACTION_ID_DLOG_AUTO_SCALE = 170,
    ACTION_ID_DLOG_UPLOAD = 171,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 172,
    ACTION_ID_MQTT_EDIT_HOST = 173,
    ACTION_ID_MQTT_EDIT_PORT = 174,
    ACTION_ID_MQTT_EDIT_USERNAME = 175,
    ACTION_ID_MQTT_EDIT_PASSWORD = 176,
    ACTION_ID_MQTT_EDIT_PERIOD = 177,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 178,
    ACTION_ID_DLOG_SCALE_TO_FIT = 179,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 180,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 181,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 182,
    ACTION_ID_SHUTDOWN = 183,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 184,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 185,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 186,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 187,
    ACTION_ID_PROFILE_IMPORT = 188,
    ACTION_ID_PROFILE_EXPORT = 189,
    ACTION_ID_EVENT_QUEUE_FILTER = 190,
    ACTION_ID_EVENT_QUEUE_SELECT_EVENT = 191,
    ACTION_ID_DATE_TIME_SELECT_FORMAT = 192,
    ACTION_ID_DATE_TIME_TOGGLE_AM_PM = 193,
    ACTION_ID_EDIT_NO_FOCUS = 194,
    ACTION_ID_UNTRACK_ALL = 195,
    ACTION_ID_CH_SETTINGS_COPY = 196,
    ACTION_ID_SHOW_SYS_SETTINGS_ETHERNET_ERROR = 197,
    ACTION_ID_FILE_MANAGER_SELECT_LIST_VIEW = 198,
    ACTION_ID_SHOW_SYS_SETTINGS_RAMP_AND_DELAY = 199,
    ACTION_ID_CHANNEL_TOGGLE_RAMP_STATE = 200,
    ACTION_ID_DLOG_VIEW_SELECT_LEGEND_VIEW_OPTION = 201,
    ...
    ACTION_ID_DLOG_PERIOD_SELECT_PREDEFINED_VALUE = 239,
    ACTION_ID_DLOG_VIEW_SELECT_BOOKMARKS_TAB = 240,
    ACTION_ID_DLOG_VIEW_SELECT_OPTIONS_TAB = 241,
    ACTION_ID_DLOG_VIEW_SELECT_BOOKMARK = 242,
    ACTION_ID_DLOG_VIEW_ZOOM_IN = 243,
    ACTION_ID_DLOG_VIEW_ZOOM_OUT = 244,
    ACTION_ID_DLOG_VIEW_SELECT_Y_VALUES_TAB = 245,
    ACTION_ID_DLOG_VIEW_SELECT_Y_VALUE = 246,
    ACTION_ID_DLOG_VIEW_TOGGLE_Y_VALUE_VISIBLE = 247,
    ACTION_ID_SCROLL = 248,
    ACTION_ID_SHOW_PINOUT = 249,
    ACTION_ID_SHOW_SYS_SETTINGS_FUNCTION_GENERATOR = 250,
    ACTION_ID_FUNCTION_GENERATOR_SELECT_WAVEFORM = 251,
    ACTION_ID_FUNCTION_GENERATOR_ITEM_TOGGLE_SELECTED = 252,
    ACTION_ID_FUNCTION_GENERATOR_ITEM_TOGGLE_CHECKED = 253,
    ACTION_ID_FUNCTION_GENERATOR_SELECT_CHANNELS = 254,
    ACTION_ID_FUNCTION_GENERATOR_MODE_SELECT_MODE = 255,
    ACTION_ID_SHOW_SYS_SETTINGS_FUNCTION_GENERATOR_SELECT_CHANNEL = 256,
    ACTION_ID_TRIGGER_MANUALLY = 257,
    ACTION_ID_FUNCTION_GENERATOR_TOGGLE_FREQ = 258,
    ACTION_ID_FUNCTION_GENERATOR_TOGGLE_AMPL = 259,
    ACTION_ID_FUNCTION_GENERATOR_DESELECT_ALL = 260,
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 261,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 262,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 263,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 264,
    ACTION_ID_DIB_MIO168_DOUT_SELECT_TRIGGER_MODE = 265,
    ACTION_ID_DIB_MIO168_DOUT_SHOW_CONFIGURATION = 266,
    ACTION_ID_DIB_MIO168_DOUT_SHOW_FUNCTION = 267,
    ACTION_ID_DIB_MIO168_AIN_SHOW_CONFIGURATION = 268,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE = 269,
    ACTION_ID_DIB_MIO168_AIN_SELECT_RANGE = 270,
    ACTION_ID_DIB_MIO168_AIN_CHANGE_LABEL = 271,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE_AND_RANGE = 272,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_EFFICIENCY_FORMULA = 273,
    ACTION_ID_DIB_MIO168_AOUT_TOGGLE_OUTPUT_ENABLED = 274,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_OUTPUT_MODE = 275,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_VOLTAGE_RANGE = 276,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_CURRENT_RANGE = 277,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_MODE_AND_RANGE = 278,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_CONFIGURATION = 279,
    ACTION_ID_DIB_MIO168_AOUT_CHANGE_LABEL = 280,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_TRIGGER_MODE = 281,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_FUNCTION = 282,
    ACTION_ID_DIB_MIO168_SHOW_INFO = 283,
    ACTION_ID_DIB_MIO168_SHOW_CALIBRATION = 284,
    ACTION_ID_DIB_MIO168_SHOW_CHANNEL_LABELS = 285,
    ACTION_ID_DIB_MIO168_SHOW_DIN_CHANNEL_LABELS = 286,
    ACTION_ID_DIB_MIO168_SHOW_DOUT_CHANNEL_LABELS = 287,
    ACTION_ID_DIB_MIO168_CHANGE_DIN_LABEL = 288,
    ACTION_ID_DIB_MIO168_CHANGE_DOUT_LABEL = 289,
    ACTION_ID_DIB_MIO168_PWM_CHANGE_LABEL = 290,
    ACTION_ID_DIB_MIO168_PAGER_SELECT_PAGE = 291,
    ACTION_ID_DIB_MIO168_SELECT_SIMULATOR_AFE_VERSION = 292,
    ACTION_ID_DIB_MIO168_SHOW_SLOT_SETTINGS_IN_MAX_VIEW = 293,
    ACTION_ID_DIB_MIO168_SELECT_PAGE_IN_DEFAULT_VIEW = 294,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_AC_ANALYSIS = 295,
    ACTION_ID_DIB_PREL6_TOGGLE_RELAY = 296,
    ACTION_ID_DIB_PREL6_SHOW_RELAY_LABELS = 297,
    ACTION_ID_DIB_PREL6_CHANGE_RELAY_LABEL = 298,
    ACTION_ID_DIB_PREL6_SHOW_INFO = 299,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 300,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 301,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 302,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 303,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 304,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 305,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 306,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 307,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 308,
    ACTION_ID_DIB_SMX46_CHANGE_SUBCHANNEL_LABEL = 309,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_CONFIGURATION = 310,
    ACTION_ID_DIB_SMX46_AOUT_SELECT_TRIGGER_MODE = 311,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_FUNCTION = 312,
    ACTION_ID_DIB_SMX46_AOUT_SHOW_CALIBRATION = 313,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 314,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 315,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 316,
    ACTION_ID_SIMULATOR_LOAD = 317,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 318,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 319,
    ACTION_ID_DIB_MUX14D_TOGGLE_P1_RELAY = 320,
    ACTION_ID_DIB_MUX14D_CHANGE_P1_RELAY_LABEL = 321,
    ACTION_ID_DIB_MUX14D_TOGGLE_P2_RELAY = 322,
    ACTION_ID_DIB_MUX14D_CHANGE_P2_RELAY_LABEL = 323,
    ACTION_ID_DIB_MUX14D_TOGGLE_EXT_RELAY = 324,
    ACTION_ID_DIB_MUX14D_TOGGLE_ADIB1_RELAY = 325,
    ACTION_ID_DIB_MUX14D_TOGGLE_ADIB2_RELAY = 326,
    ACTION_ID_DIB_MUX14D_SHOW_RELAY_LABELS = 327,
    ACTION_ID_DIB_MUX14D_SHOW_INFO = 328,
    ACTION_ID_DIB_MUX14D_SHOW_RELAY_CYCLES = 329,
    ACTION_ID_DIB_MUX14D_TOGGLE_MULTIPLE_CONNECTIONS = 330
};
...
enum StylesEnum {
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 219,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 220,
    STYLE_ID_SCROLLBAR_TRACK = 221,
    ...
    STYLE_ID_DEFAULT_M_WARNING = 258,
    ...
    STYLE_ID_LABELS_AND_COLORS_SLOT = 284,
    STYLE_ID_INLINE285 = 285,
    STYLE_ID_INLINE286 = 286,
    STYLE_ID_INLINE287 = 287,
    STYLE_ID_FRONT_PANEL_MODULE = 288,
    ...
    STYLE_ID_TRIGGER_BUTTON_14 = 298,
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 366,
    STYLE_ID_INLINE367 = 367,
    STYLE_ID_MON_VALUE_20_LEFT = 368,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 369,
    STYLE_ID_BAR_GRAPH_TEXT = 370,
    STYLE_ID_BAR_GRAPH_SET_LINE = 371,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 372,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 373,
    STYLE_ID_LABELS_AND_COLORS_CHANNEL = 374,
    STYLE_ID_INLINE375 = 375,
    STYLE_ID_TRIGGER_BUTTON_24 = 376,
    STYLE_ID_INLINE377 = 377,
    STYLE_ID_INLINE378 = 378,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 379,
    STYLE_ID_MON_VALUE_38_RIGHT = 380,
    STYLE_ID_INLINE381 = 381,
    STYLE_ID_CH_PROT_OFF = 382,
    STYLE_ID_CH_PROT_ON = 383,
    STYLE_ID_CH_PROT_TRIPPED = 384,
    STYLE_ID_INLINE385 = 385,
    STYLE_ID_MON_VALUE_20_RIGHT = 386,
    STYLE_ID_MON_VALUE_14_LEFT = 387,
    STYLE_ID_MON_VALUE_14_CENTER = 388,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 389,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 390,
    STYLE_ID_MON_VALUE_14_RIGHT = 391,
    STYLE_ID_MON_VALUE_24_RIGHT = 392,
    STYLE_ID_INLINE393 = 393,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 394,
...
enum PagesEnum {
    ...
    PAGE_ID_SLOT_MAX_WITH_BORDER = 97,
    PAGE_ID_SLOT_MAX_ERROR = 98,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 99,
    PAGE_ID_SLOT_MIN_WITH_BORDER = 100,
    PAGE_ID_SLOT_MIN_ERROR = 101,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 102,
    PAGE_ID_DLOG_VIEW = 103,
    PAGE_ID_DLOG_VIEW_DRAWER = 104,
    PAGE_ID_DLOG_PARAMS = 105,
    PAGE_ID_IMAGE_VIEW = 106,
    PAGE_ID_PINOUT = 107,
    PAGE_ID_FILE_MANAGER = 108,
    PAGE_ID_FILE_BROWSER = 109,
    PAGE_ID_FILE_MENU = 110,
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 111,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 112,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 113,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 114,
    PAGE_ID_TOUCH_TEST = 115,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 116,
    PAGE_ID_OVP_TYPE = 117,
    PAGE_ID_SLOT_LABELS_AND_COLORS = 118,
    PAGE_ID_COLOR_PICKER = 119,
    PAGE_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 120,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF_VERT = 121,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF_HORZ = 122,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF_2COL_VERT = 123,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF_2COL_HORZ = 124,
    ...
    PAGE_ID_DIB_MIO168_DOUT_CONFIGURATION = 133,
    ...
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_VERT = 139,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_HORZ = 140,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_2COL_VERT = 141,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_2COL_HORZ = 142,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 143,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 144,
    PAGE_ID_DIB_PREL6_SETTINGS = 145,
    PAGE_ID_DIB_PREL6_LABELS_AND_COLORS = 146,
    PAGE_ID_DIB_PREL6_CHANNEL_LABELS = 147,
    PAGE_ID_DIB_PREL6_INFO = 148,
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 149,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_VERT = 150,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_HORZ = 151,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL_VERT = 152,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL_HORZ = 153,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 154,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 155,
    PAGE_ID_DIB_SMX46_SETTINGS = 156,
    PAGE_ID_DIB_SMX46_AOUT_CONFIGURATION = 157,
    PAGE_ID_DIB_SMX46_CONFIGURE_ROUTES = 158,
    PAGE_ID_DIB_SMX46_INFO = 159,
    PAGE_ID_DIB_SMX46_RELAY_CYCLES = 160,
    PAGE_ID_DIB_SMX46_LABELS_AND_COLORS = 161,
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 162,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON = 163,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_NUM_ON_2COL = 164,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON = 165,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VBAR_ON_2COL = 166,
    PAGE_ID_DIB_DCP405_LABELS_AND_COLORS = 167,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF = 168,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_OFF_2COL = 169,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 170,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_SERIES_2COL = 171,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 172,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL_2COL = 173,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON = 174,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HBAR_ON_2COL = 175,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON = 176,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_YT_ON_2COL = 177,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF = 178,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_OFF_2COL = 179,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 180,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_SERIES_2COL = 181,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 182,
    PAGE_ID_DIB_DCP405_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL_2COL = 183,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_TITLE = 184,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_ON = 185,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_NUM_OFF = 186,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_ON = 187,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_HBAR_OFF = 188,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_ON = 189,
    PAGE_ID_DIB_DCP405_SLOT_MAX_1CH_YT_OFF = 190,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_TITLE = 191,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_ON = 192,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_OFF = 193,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_SERIES = 194,
    PAGE_ID_DIB_DCP405_SLOT_MIN_1CH_COUPLED_PARALLEL = 195,
    ...
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS = 232,
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS_CH = 233,
    PAGE_ID_FRONT_PANEL = 234,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 235,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 236,
    PAGE_ID_DIB_DCM224_SIMULATOR_FRONT_PANEL_MASK = 237,
    PAGE_ID_DIB_DCM224_FRONT_PANEL_LED = 238,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ADV_OPTIONS = 239,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT = 240,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_WITH_BORDER = 241,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON = 242,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF = 243,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_2COL = 244,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_WITH_BORDER_2COL = 245,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON_2COL = 246,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF_2COL = 247,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ = 248,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_WITH_BORDER = 249,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON = 250,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF = 251,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_2COL = 252,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_WITH_BORDER_2COL = 253,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON_2COL = 254,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF_2COL = 255,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH = 256,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_WITH_BORDER = 257,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_WITH_BORDER_MIN = 258,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_TITLE = 259,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_ON = 260,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_OFF = 261,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_ON = 262,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_HBAR_OFF = 263,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_TITLE = 264,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_ON = 265,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_OFF = 266,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_ON = 267,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_OFF = 268,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH = 269,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_WITH_BORDER = 270,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_TITLE = 271,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_ON = 272,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_OFF = 273,
    PAGE_ID_DIB_DCM224_LABELS_AND_COLORS = 274,
    PAGE_ID_DIB_DCM224_LABELS_AND_COLORS_CH = 275,
    PAGE_ID_DIB_MUX14D_SIMULATOR_FRONT_PANEL_MASK = 276,
    PAGE_ID_DIB_MUX14D_SLOT_VIEW_DEF_VERT = 277,
    PAGE_ID_DIB_MUX14D_SLOT_VIEW_DEF_HORZ = 278,
    PAGE_ID_DIB_MUX14D_SLOT_VIEW_DEF_2COL_VERT = 279,
    PAGE_ID_DIB_MUX14D_SLOT_VIEW_DEF_2COL_HORZ = 280,
    PAGE_ID_DIB_MUX14D_SLOT_VIEW_MAX = 281,
    PAGE_ID_DIB_MUX14D_SLOT_VIEW_MIN = 282,
    PAGE_ID_DIB_MUX14D_SETTINGS = 283,
    PAGE_ID_DIB_MUX14D_LABELS_AND_COLORS = 284,
    PAGE_ID_DIB_MUX14D_CHANNEL_LABELS = 285,
    PAGE_ID_DIB_MUX14D_INFO = 286,
    PAGE_ID_DIB_MUX14D_RELAY_CYCLES = 287
};

extern const uint8_t assets[626693];
