enum DataEnum {
    ...
    DATA_ID_DLOG_VALUE_LABEL = 309,
    DATA_ID_DLOG_CURRENT_TIME = 310,
    DATA_ID_DLOG_FILE_LENGTH = 311,
    DATA_ID_DLOG_X_AXIS_OFFSET = 312,
    DATA_ID_DLOG_X_AXIS_DIV = 313,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 314,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 315,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 316,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 317,
    DATA_ID_DLOG_VIEW_STATE = 318,
    DATA_ID_DLOG_PERIOD = 319,
    DATA_ID_DLOG_DURATION = 320,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 321,
    DATA_ID_DLOG_CURRENT_ENABLED = 322,
    DATA_ID_DLOG_POWER_ENABLED = 323,
    DATA_ID_DLOG_START_ENABLED = 324,
    DATA_ID_DLOG_FILE_NAME = 325,
    DATA_ID_DLOG_VALUE_STATE = 326,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 327,
    DATA_ID_CHANNEL_OFF_LABEL = 328,
    DATA_ID_FILE_MANAGER_FILES = 329,
    DATA_ID_FILE_MANAGER_FILE_NAME = 330,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 331,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 332,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 333,
    DATA_ID_FILE_MANAGER_STATE = 334,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 335,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 336,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 337,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 338,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 339,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 340,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 341,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 342,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 343,
    DATA_ID_SCRIPT_INFO = 344,
    DATA_ID_SCRIPT_IS_STARTED = 345,
    DATA_ID_KEYPAD_OK_ENABLED = 346,
    DATA_ID_ETHERNET_HOST_NAME = 347,
    DATA_ID_MQTT_HOST = 348,
    DATA_ID_MQTT_PORT = 349,
    DATA_ID_MQTT_USERNAME = 350,
    DATA_ID_MQTT_PASSWORD = 351,
    DATA_ID_MQTT_PERIOD = 352,
    ...
    DATA_ID_RAMP_COUNTER_LABEL = 358,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 359,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 360,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 361,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 362,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 363,
    DATA_ID_IS_RESET_BY_IWDG = 364,
    DATA_ID_DLOG_ENABLED = 365,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 366,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 367,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 368,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 369,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 370,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 371,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 372,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 373,
    DATA_ID_DATE_TIME_FORMAT = 374,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 375,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 376,
    DATA_ID_DATE_TIME_AM_PM = 377,
    DATA_ID_IS_MULTI_TRACKING = 378,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 379,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 380,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 381,
    DATA_ID_CHANNEL_INFO_BRAND = 382,
    DATA_ID_CHANNEL_INFO_SERIAL = 383,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 384,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 385,
    DATA_ID_FILE_MANAGER_FILE_ICON = 386,
    DATA_ID_FILE_MANAGER_LAYOUT = 387,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 388,
    DATA_ID_TOUCH_RAW_X = 389,
    DATA_ID_TOUCH_RAW_Y = 390,
    DATA_ID_TOUCH_RAW_Z1 = 391,
    DATA_ID_TOUCH_RAW_PRESSED = 392,
    DATA_ID_TOUCH_CALIBRATED_X = 393,
    DATA_ID_TOUCH_CALIBRATED_Y = 394,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 395,
    DATA_ID_TOUCH_FILTERED_X = 396,
    DATA_ID_TOUCH_FILTERED_Y = 397,
    DATA_ID_TOUCH_FILTERED_PRESSED = 398,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 399,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 400,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 401,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 402,
    DATA_ID_ALERT_MESSAGE_IS_SET = 403,
    DATA_ID_ASYNC_PROGRESS = 404,
    DATA_ID_IO_PIN_FUNCTION = 405,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 406,
    DATA_ID_IO_PIN_PWM_DUTY = 407,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 408,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 409,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 410,
    DATA_ID_DEBUG_VARIABLES = 411,
    DATA_ID_DEBUG_VARIABLE_NAME = 412,
    DATA_ID_DEBUG_VARIABLE_VALUE = 413,
    DATA_ID_CHANNEL_RAMP_STATE = 414,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 415,
    DATA_ID_MQTT_IN_ERROR = 416
};
...
enum StylesEnum {
    ...
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 194,
    STYLE_ID_BAR_GRAPH_TEXT = 195,
    STYLE_ID_BAR_GRAPH_SET_LINE = 196,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 197,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 198,
    STYLE_ID_INLINE199 = 199,
    STYLE_ID_INLINE200 = 200,
    STYLE_ID_TRIGGER_BUTTON_24 = 201,
    STYLE_ID_INLINE202 = 202,
    STYLE_ID_INLINE203 = 203,
    STYLE_ID_MON_VALUE_14_RIGHT = 204,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 205,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 206,
    STYLE_ID_TRIGGER_BUTTON_14 = 207,
    ...
    STYLE_ID_BUTTON_S_DISABLED = 248,
...
extern const uint8_t assets[435589];
