enum DataEnum {
    ...
    DATA_ID_CHANNEL_U_MON_A = 11,
    DATA_ID_CHANNEL_U_MON_B = 12,
    DATA_ID_CHANNEL_U_MON_DAC = 13,
    DATA_ID_CHANNEL_U_LIMIT = 14,
    DATA_ID_CHANNEL_U_EDIT = 15,
    DATA_ID_CHANNEL_U_EDIT_A = 16,
    DATA_ID_CHANNEL_U_EDIT_B = 17,
    DATA_ID_CHANNEL_I_SET = 18,
    DATA_ID_CHANNEL_I_MON = 19,
    DATA_ID_CHANNEL_I_MON_A = 20,
    DATA_ID_CHANNEL_I_MON_B = 21,
    DATA_ID_CHANNEL_I_MON_DAC = 22,
    DATA_ID_CHANNEL_I_LIMIT = 23,
    DATA_ID_CHANNEL_I_EDIT = 24,
    DATA_ID_CHANNEL_I_EDIT_A = 25,
    DATA_ID_CHANNEL_I_EDIT_B = 26,
    DATA_ID_CHANNEL_P_MON = 27,
    DATA_ID_CHANNEL_P_MON_A = 28,
    DATA_ID_CHANNEL_P_MON_B = 29,
    DATA_ID_CHANNELS_VIEW_MODE = 30,
    ...
    DATA_ID_CHANNEL_PROTECTION_OPP_LIMIT_A = 98,
    DATA_ID_CHANNEL_PROTECTION_OPP_LIMIT_B = 99,
    ...
    DATA_ID_CHANNEL_IS_COUPLED = 116,
    DATA_ID_CHANNEL_IS_TRACKED = 117,
    DATA_ID_CHANNEL_IS_COUPLED_OR_TRACKED = 118,
    DATA_ID_CHANNEL_COUPLING_IS_ALLOWED = 119,
    DATA_ID_CHANNEL_COUPLING_MODE = 120,
    DATA_ID_CHANNEL_COUPLING_SELECTED_MODE = 121,
    DATA_ID_CHANNEL_COUPLING_IS_SERIES = 122,
    DATA_ID_SYS_ON_TIME_TOTAL = 123,
    DATA_ID_SYS_ON_TIME_LAST = 124,
    DATA_ID_SYS_TEMP_AUX_STATUS = 125,
    DATA_ID_SYS_TEMP_AUX_OTP_STATE = 126,
    DATA_ID_SYS_TEMP_AUX_OTP_LEVEL = 127,
    DATA_ID_SYS_TEMP_AUX_OTP_DELAY = 128,
    DATA_ID_SYS_TEMP_AUX_OTP_IS_TRIPPED = 129,
    DATA_ID_SYS_TEMP_AUX = 130,
    DATA_ID_SYS_INFO_FIRMWARE_VER = 131,
    DATA_ID_SYS_INFO_SERIAL_NO = 132,
    DATA_ID_SYS_INFO_SCPI_VER = 133,
    DATA_ID_SYS_INFO_CPU = 134,
    DATA_ID_SYS_INFO_ETHERNET = 135,
    ...
    DATA_ID_PROFILES_LIST1 = 151,
    DATA_ID_PROFILES_LIST2 = 152,
    DATA_ID_PROFILES_AUTO_RECALL_STATUS = 153,
    DATA_ID_PROFILES_AUTO_RECALL_LOCATION = 154,
    DATA_ID_PROFILE_STATUS = 155,
    DATA_ID_PROFILE_LABEL = 156,
    DATA_ID_PROFILE_REMARK = 157,
    DATA_ID_PROFILE_IS_AUTO_RECALL_LOCATION = 158,
    DATA_ID_PROFILE_CHANNEL_U_SET = 159,
    DATA_ID_PROFILE_CHANNEL_I_SET = 160,
    DATA_ID_PROFILE_CHANNEL_OUTPUT_STATE = 161,
    DATA_ID_ETHERNET_INSTALLED = 162,
    DATA_ID_ETHERNET_ENABLED = 163,
    DATA_ID_ETHERNET_STATUS = 164,
    DATA_ID_ETHERNET_IP_ADDRESS = 165,
    DATA_ID_ETHERNET_DNS = 166,
    DATA_ID_ETHERNET_GATEWAY = 167,
    DATA_ID_ETHERNET_SUBNET_MASK = 168,
    DATA_ID_ETHERNET_SCPI_PORT = 169,
    DATA_ID_ETHERNET_IS_CONNECTED = 170,
    DATA_ID_ETHERNET_DHCP = 171,
    DATA_ID_ETHERNET_MAC = 172,
    DATA_ID_CHANNEL_IS_VOLTAGE_BALANCED = 173,
    DATA_ID_CHANNEL_IS_CURRENT_BALANCED = 174,
    DATA_ID_SYS_OUTPUT_PROTECTION_COUPLED = 175,
    DATA_ID_SYS_SHUTDOWN_WHEN_PROTECTION_TRIPPED = 176,
    DATA_ID_SYS_FORCE_DISABLING_ALL_OUTPUTS_ON_POWER_UP = 177,
    DATA_ID_SYS_PASSWORD_IS_SET = 178,
    DATA_ID_SYS_RL_STATE = 179,
    DATA_ID_SYS_SOUND_IS_ENABLED = 180,
    DATA_ID_SYS_SOUND_IS_CLICK_ENABLED = 181,
    DATA_ID_SYS_SOUND_ENABLED = 182,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE1 = 183,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE2 = 184,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_YT_VIEW_RATE = 185,
    DATA_ID_SYS_ENCODER_CONFIRMATION_MODE = 186,
    DATA_ID_SYS_ENCODER_MOVING_UP_SPEED = 187,
    DATA_ID_SYS_ENCODER_MOVING_DOWN_SPEED = 188,
    DATA_ID_SYS_ENCODER_INSTALLED = 189,
    DATA_ID_SYS_DISPLAY_STATE = 190,
    DATA_ID_SYS_DISPLAY_BRIGHTNESS = 191,
    DATA_ID_CHANNEL_TRIGGER_MODE = 192,
    DATA_ID_CHANNEL_TRIGGER_OUTPUT_STATE = 193,
    ...
    DATA_ID_VIEW_STATUS = 241,
    DATA_ID_DLOG_STATUS = 242,
    DATA_ID_MAIN_APP_VIEW = 243,
    DATA_ID_APPLICATIONS = 244,
    DATA_ID_APPLICATION_TITLE = 245,
    DATA_ID_APPLICATION_ICON = 246,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 247,
    DATA_ID_FOREGROUND_APPLICATION = 248,
    DATA_ID_FOREGROUND_APPLICATION_TITLE = 249,
    DATA_ID_TOUCH_CALIBRATION_POINT = 250,
    DATA_ID_SLOTS = 251,
    DATA_ID_SLOT_MODULE_TYPE = 252,
    DATA_ID_SIMULATOR_LOAD_STATE = 253,
    DATA_ID_SIMULATOR_LOAD = 254,
    DATA_ID_SELECTED_THEME = 255,
    DATA_ID_PROFILE_DIRTY = 256,
    DATA_ID_CHANNEL_TITLE = 257,
    DATA_ID_CHANNEL_SHORT_TITLE = 258
};
...
void data_channel_u_mon_a(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_u_mon_b(DataOperationEnum operation, Cursor &cursor, Value &value);
...
void data_channel_u_edit_a(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_u_edit_b(DataOperationEnum operation, Cursor &cursor, Value &value);
...
void data_channel_i_mon_a(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_i_mon_b(DataOperationEnum operation, Cursor &cursor, Value &value);
...
void data_channel_i_edit_a(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_i_edit_b(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_p_mon(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_p_mon_a(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_p_mon_b(DataOperationEnum operation, Cursor &cursor, Value &value);
...
void data_channel_protection_opp_limit_a(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_protection_opp_limit_b(DataOperationEnum operation, Cursor &cursor, Value &value);
...
enum StylesEnum {
    ...
    STYLE_ID_BAR_GRAPH_TEXT_VERTICAL = 21,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 22,
    STYLE_ID_DEFAULT_INVERSE = 23,
    STYLE_ID_CHANNEL_OFF = 24,
    STYLE_ID_MON_VALUE_L_RIGHT = 25,
    STYLE_ID_MON_VALUE_UR_L_RIGHT = 26,
    STYLE_ID_MON_VALUE_FOCUS = 27,
    STYLE_ID_MON_VALUE = 28,
    STYLE_ID_MON_DAC = 29,
    STYLE_ID_EDIT_S = 30,
    STYLE_ID_CHANNEL_ERROR = 31,
    STYLE_ID_BAR_GRAPH_U_DEFUALT = 32,
    STYLE_ID_BAR_GRAPH_TEXT = 33,
    STYLE_ID_BAR_GRAPH_SET_LINE = 34,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 35,
    STYLE_ID_BAR_GRAPH_UNREGULATED = 36,
    STYLE_ID_EDIT_VALUE_S_RIGHT = 37,
    STYLE_ID_EDIT_VALUE_FOCUS_S_RIGHT = 38,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_RIGHT = 39,
    STYLE_ID_MON_DAC_S = 40,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_CENTER = 41,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 42,
    ...
    STYLE_ID_EDIT_VALUE_S_LEFT = 50,
    STYLE_ID_KEY = 51,
    STYLE_ID_KEY_ICONS = 52,
    STYLE_ID_KEY_DISABLED = 53,
    STYLE_ID_TAB_PAGE_SELECTED = 54,
    STYLE_ID_TAB_PAGE = 55,
    STYLE_ID_EDIT_VALUE_L = 56,
    STYLE_ID_VALUE = 57,
    STYLE_ID_VALUE_S = 58,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 59,
    STYLE_ID_YELLOW_1 = 60,
    STYLE_ID_YELLOW_2 = 61,
    STYLE_ID_YELLOW_3 = 62,
    STYLE_ID_YELLOW_4 = 63,
    STYLE_ID_YELLOW_5 = 64,
    STYLE_ID_YELLOW_6 = 65,
    STYLE_ID_YES_NO = 66,
    STYLE_ID_YES_NO_BUTTON = 67,
    STYLE_ID_YES_NO_BACKGROUND = 68,
    STYLE_ID_YES_NO_MESSAGE = 69,
    STYLE_ID_TEXT_MESSAGE = 70,
    STYLE_ID_ASYNC_OPERATION = 71,
    STYLE_ID_ASYNC_OPERATION_ACTION = 72,
    STYLE_ID_EVENT_INFO = 73,
    STYLE_ID_EVENT_WARNING = 74,
    STYLE_ID_EVENT_ERROR = 75,
    STYLE_ID_BOTTOM_BUTTON_DISABLED = 76,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 77,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_LEFT = 78,
    STYLE_ID_KEY_SPEC_ICONS = 79,
    STYLE_ID_KEY_SPEC = 80,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 81,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 82,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 83,
    STYLE_ID_LIST_GRAPH_CURSOR = 84,
    STYLE_ID_YT_GRAPH_U_DEFUALT_LABEL = 85,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 86,
    STYLE_ID_EDIT_VALUE_FOCUS_S_CENTER = 87,
    STYLE_ID_EDIT_VALUE_LEFT = 88,
    STYLE_ID_EDIT_VALUE_ACTIVE_LEFT = 89,
...
enum PagesEnum {
    ...
    PAGE_ID_MAIN_2 = 10,
    PAGE_ID_MAIN_3 = 11,
    PAGE_ID_MAIN_BACKUP = 12,
    PAGE_ID_MAIN_HELP = 13,
    PAGE_ID_EDIT_MODE_KEYPAD = 14,
    PAGE_ID_EDIT_MODE_STEP = 15,
    PAGE_ID_EDIT_MODE_STEP_HELP = 16,
    PAGE_ID_EDIT_MODE_SLIDER = 17,
    PAGE_ID_EDIT_MODE_SLIDER_HELP = 18,
    PAGE_ID_YES_NO = 19,
    PAGE_ID_ARE_YOU_SURE_WITH_MESSAGE = 20,
    PAGE_ID_YES_NO_LATER = 21,
    ...
    PAGE_ID_CH_START_LIST = 38,
    PAGE_ID_CH_SETTINGS_ADV = 39,
    PAGE_ID_CH_SETTINGS_ADV_REMOTE = 40,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 41,
    PAGE_ID_CH_SETTINGS_ADV_TRACKING = 42,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING = 43,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING_INFO = 44,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 45,
    PAGE_ID_CH_SETTINGS_INFO = 46,
    PAGE_ID_SYS_SETTINGS = 47,
    PAGE_ID_SYS_SETTINGS_AUX_OTP = 48,
    ...
    PAGE_ID_SYS_SETTINGS_CAL = 57,
    PAGE_ID_SYS_SETTINGS_CAL_CH = 58,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP = 59,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_FINISH = 60,
    ...
    PAGE_ID_USER_PROFILES2 = 65,
    PAGE_ID_USER_PROFILE_SETTINGS = 66,
    PAGE_ID_USER_PROFILE_0_SETTINGS = 67,
    PAGE_ID_SYS_INFO = 68,
    PAGE_ID_SYS_INFO2 = 69,
    PAGE_ID_STAND_BY_MENU = 70,
    PAGE_ID_ENTERING_STANDBY = 71,
    PAGE_ID_STANDBY = 72,
    PAGE_ID_DISPLAY_OFF = 73,
    PAGE_ID_CHANNELS = 74,
    PAGE_ID_PROFILE = 75,
    PAGE_ID_PROFILE_BASIC_INFO = 76,
    PAGE_ID_COUPLED_CHANNELS_DEFAULT_VIEW = 77,
    PAGE_ID_COUPLED_CHANNELS_HORIZONTAL_BAR_VIEW = 78,
    PAGE_ID_COUPLED_CHANNELS_VERTICAL_BAR_VIEW = 79,
    PAGE_ID_COUPLED_CHANNELS_YTBAR_VIEW = 80,
    PAGE_ID_OCP = 81,
    PAGE_ID_OVP = 82,
    PAGE_ID_OTP = 83,
    PAGE_ID_OPP = 84,
    PAGE_ID_FRONT_PANEL = 85,
    PAGE_ID_NUMERIC_KEYPAD2 = 86,
    PAGE_ID_OLD_STATUS_BAR = 87,
    PAGE_ID_OLD_TASK_BAR = 88,
    PAGE_ID_MINIMIZED_APP_VIEW = 89,
    PAGE_ID_GUI_TMPL_ONE_MAX_STATUS_LINE_BOTTOM = 90,
    PAGE_ID_GUI_TMPL_SYSTEM_SETTINGS_STATUS_LINE_BOTTOM = 91,
    PAGE_ID_GUI_TMPL_DEFAULT_VERTICAL_NUMERIC_ETC = 92,
    PAGE_ID_GUI_TMPL_HORIZONTAL_GRAPH_BAR = 93,
    PAGE_ID_GUI_TMPL_OUTPUT_COUPLINGS = 94,
    PAGE_ID_DCP405_DEFAULT_NUMERIC = 95,
    PAGE_ID_DCP405_DEFAULT_VERT_BAR = 96,
    PAGE_ID_DCP405_DEFAULT_HORZ_BAR = 97,
    PAGE_ID_DCP405_DEFAULT_VERT_OFF = 98,
    PAGE_ID_DCP405_DEFAULT_HORZ_OFF = 99,
    PAGE_ID_CHANNELS_DEFAULT_NUMERIC = 100,
    PAGE_ID_CHANNELS_DEFAULT_VERT_BAR = 101,
    PAGE_ID_CHANNELS_DEFAULT_HORZ_BAR = 102
};

extern const uint8_t assets[271500];
