enum DataEnum {
    ...
    DATA_ID_RAMP_COUNTER_LABEL = 351,
    ...
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 364,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 365,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 366,
    DATA_ID_DATE_TIME_FORMAT = 367,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 368,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 369,
    DATA_ID_DATE_TIME_AM_PM = 370,
    DATA_ID_IS_MULTI_TRACKING = 371,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 372,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 373,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 374,
    DATA_ID_CHANNEL_INFO_BRAND = 375,
    DATA_ID_CHANNEL_INFO_SERIAL = 376,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 377,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 378,
    DATA_ID_FILE_MANAGER_FILE_ICON = 379,
    DATA_ID_FILE_MANAGER_LAYOUT = 380,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 381,
    DATA_ID_TOUCH_RAW_X = 382,
    DATA_ID_TOUCH_RAW_Y = 383,
    DATA_ID_TOUCH_RAW_Z1 = 384,
    DATA_ID_TOUCH_RAW_PRESSED = 385,
    DATA_ID_TOUCH_CALIBRATED_X = 386,
    DATA_ID_TOUCH_CALIBRATED_Y = 387,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 388,
    DATA_ID_TOUCH_FILTERED_X = 389,
    DATA_ID_TOUCH_FILTERED_Y = 390,
    DATA_ID_TOUCH_FILTERED_PRESSED = 391,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 392,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 393,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 394,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 395,
    DATA_ID_ALERT_MESSAGE_IS_SET = 396,
    DATA_ID_ASYNC_PROGRESS = 397,
    DATA_ID_IO_PIN_FUNCTION = 398,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 399,
    DATA_ID_IO_PIN_PWM_DUTY = 400,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 401,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 402,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 403,
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_SYS_SETTINGS_RAMP_AND_DELAY = 227
};
...
extern const uint8_t assets[401241];
