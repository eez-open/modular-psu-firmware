enum DataEnum {
    ...
    DATA_ID_CHANNEL_TITLE = 249,
    DATA_ID_CHANNEL_SHORT_TITLE = 250,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 251,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 252,
    DATA_ID_CHANNEL_LONG_TITLE = 253,
    DATA_ID_ANIMATIONS_DURATION = 254,
    DATA_ID_SLOT1_INFO = 255,
    DATA_ID_SLOT2_INFO = 256,
    DATA_ID_SLOT3_INFO = 257,
    DATA_ID_SLOT1_TEST_RESULT = 258,
    DATA_ID_SLOT2_TEST_RESULT = 259,
    DATA_ID_SLOT3_TEST_RESULT = 260,
    DATA_ID_SLOT_DEFAULT1_VIEW = 261,
    DATA_ID_SLOT_DEFAULT2_VIEW = 262,
    DATA_ID_SLOT_DEFAULT3_VIEW = 263,
    DATA_ID_SLOT1_CHANNEL_INDEX = 264,
    DATA_ID_SLOT2_CHANNEL_INDEX = 265,
    DATA_ID_SLOT3_CHANNEL_INDEX = 266,
    DATA_ID_SLOT_DEF_2CH_VIEW = 267,
    DATA_ID_SLOT_MAX_2CH_VIEW = 268,
    DATA_ID_SLOT_MIN_2CH_VIEW = 269,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 270,
    DATA_ID_SLOT_2CH_CH1_INDEX = 271,
    DATA_ID_SLOT_2CH_CH2_INDEX = 272,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 273,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 274,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 275,
    DATA_ID_BATTERY = 276,
    DATA_ID_IO_PIN_STATE = 277,
    DATA_ID_CHANNEL_DPROG = 278,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 279,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 280,
    DATA_ID_SYS_INFO_HAS_ERROR = 281,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 282,
    DATA_ID_SYS_FAN_MODE = 283,
    DATA_ID_SYS_FAN_SPEED = 284,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 285,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 286,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 287,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 288,
    DATA_ID_IS_TRACKING_ALLOWED = 289,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 290,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 291,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 292,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 293,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 294,
    DATA_ID_IS_COUPLED_OR_TRACKED = 295,
    DATA_ID_OVERLAY = 296,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 297,
    DATA_ID_DLOG_STATE = 298,
    DATA_ID_DLOG_TOGGLE_STATE = 299,
    DATA_ID_RECORDING = 300,
    DATA_ID_CHANNEL_HISTORY_VALUES = 301,
    DATA_ID_RECORDING_READY = 302,
    DATA_ID_NONDRAG_OVERLAY = 303,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 304,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 305,
    DATA_ID_DLOG_VISIBLE_VALUES = 306,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 307,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 308,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 309,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 310,
    DATA_ID_DLOG_ALL_VALUES = 311,
    DATA_ID_DLOG_VALUE_LABEL = 312,
    DATA_ID_DLOG_CURRENT_TIME = 313,
    DATA_ID_DLOG_FILE_LENGTH = 314,
    DATA_ID_DLOG_X_AXIS_OFFSET = 315,
    DATA_ID_DLOG_X_AXIS_DIV = 316,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 317,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 318,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 319,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 320,
    DATA_ID_DLOG_VIEW_STATE = 321,
    DATA_ID_DLOG_PERIOD = 322,
    DATA_ID_DLOG_DURATION = 323,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 324,
    DATA_ID_DLOG_CURRENT_ENABLED = 325,
    DATA_ID_DLOG_POWER_ENABLED = 326,
    DATA_ID_DLOG_START_ENABLED = 327,
    DATA_ID_DLOG_FILE_NAME = 328,
    DATA_ID_DLOG_VALUE_STATE = 329,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 330,
    DATA_ID_CHANNEL_OFF_LABEL = 331,
    DATA_ID_FILE_MANAGER_FILES = 332,
    DATA_ID_FILE_MANAGER_FILE_NAME = 333,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 334,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 335,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 336,
    DATA_ID_FILE_MANAGER_STATE = 337,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 338,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 339,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 340,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 341,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 342,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 343,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 344,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 345,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 346,
    DATA_ID_SCRIPT_INFO = 347,
    DATA_ID_SCRIPT_IS_STARTED = 348,
    DATA_ID_DEBUG_TRACE_LOG = 349,
    DATA_ID_DEBUG_TRACE_LOG_LINE = 350,
    DATA_ID_KEYPAD_OK_ENABLED = 351,
    DATA_ID_ETHERNET_HOST_NAME = 352,
    DATA_ID_MQTT_HOST = 353,
    DATA_ID_MQTT_PORT = 354,
    DATA_ID_MQTT_USERNAME = 355,
    DATA_ID_MQTT_PASSWORD = 356,
    DATA_ID_MQTT_PERIOD = 357,
    DATA_ID_DEBUG_TRACE_LOG_IS_STOPPED = 358,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 359,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 360,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 361,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 362,
    DATA_ID_LIST_COUNTER_LABEL = 363,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 364,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 365,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 366,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 367,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 368,
    DATA_ID_IS_RESET_BY_IWDG = 369,
    DATA_ID_DLOG_ENABLED = 370,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 371
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[392996];
#else
extern const uint8_t assets[3864604];
#endif
