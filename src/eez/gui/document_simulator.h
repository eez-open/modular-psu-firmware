...
enum BitmapsEnum {
    ...
    BITMAP_ID_PREL6 = 18,
    BITMAP_ID_SMX46 = 19,
    BITMAP_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 20
};
...
enum StylesEnum {
    ...
    STYLE_ID_FRONT_PANEL_MODULE = 270,
...
enum PagesEnum {
    ...
    PAGE_ID_FRONT_PANEL = 160,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 161,
    PAGE_ID_DCP405_FRONT_PANEL = 162,
    PAGE_ID_DCM220_FRONT_PANEL = 163,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 164,
    PAGE_ID_DCM224_FRONT_PANEL = 165,
    PAGE_ID_PREL6_FRONT_PANEL = 166,
    PAGE_ID_SMX46_FRONT_PANEL = 167,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 168,
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 169,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 170,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 171,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 172,
    PAGE_ID_TOUCH_TEST = 173,
    PAGE_ID_DEBUG_VARIABLES = 174,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 175,
    PAGE_ID_OVP_TYPE = 176,
    PAGE_ID_DEBUG_POWER_CHANNELS = 177,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 178,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 179,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 180,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 181,
    PAGE_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 182
};

extern const uint8_t assets[518008];
