...
enum StylesEnum {
    ...
    STYLE_ID_DEFAULT_INVERSE = 16,
    STYLE_ID_CHANNEL_OFF = 17,
    STYLE_ID_MON_VALUE_L_RIGHT = 18,
    STYLE_ID_MON_VALUE_UR_L_RIGHT = 19,
    STYLE_ID_MON_VALUE_FOCUS = 20,
    STYLE_ID_MON_VALUE = 21,
    STYLE_ID_MON_DAC = 22,
    STYLE_ID_EDIT_S = 23,
    STYLE_ID_CHANNEL_ERROR = 24,
    STYLE_ID_BAR_GRAPH_U_DEFUALT = 25,
    STYLE_ID_BAR_GRAPH_TEXT = 26,
    STYLE_ID_BAR_GRAPH_SET_LINE = 27,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 28,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 29,
    STYLE_ID_BAR_GRAPH_UNREGULATED = 30,
    STYLE_ID_EDIT_VALUE_S_RIGHT = 31,
    STYLE_ID_EDIT_VALUE_FOCUS_S_RIGHT = 32,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_RIGHT = 33,
    STYLE_ID_MON_DAC_S = 34,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_CENTER = 35,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 36,
    STYLE_ID_BAR_GRAPH_TEXT_VERTICAL = 37,
    STYLE_ID_EDIT_S_FOCUS = 38,
    STYLE_ID_YT_GRAPH = 39,
    STYLE_ID_YT_GRAPH_U_DEFUALT = 40,
    STYLE_ID_YT_GRAPH_I_DEFAULT = 41,
    STYLE_ID_YT_GRAPH_UNREGULATED = 42,
    STYLE_ID_COUPLED_INFO_S = 43,
    STYLE_ID_EDIT_VALUE = 44,
    STYLE_ID_EDIT_VALUE_S_LEFT = 45,
    STYLE_ID_KEY = 46,
    STYLE_ID_KEY_ICONS = 47,
    STYLE_ID_KEY_DISABLED = 48,
    STYLE_ID_TAB_PAGE_SELECTED = 49,
    STYLE_ID_TAB_PAGE = 50,
    STYLE_ID_EDIT_VALUE_L = 51,
    STYLE_ID_VALUE = 52,
    STYLE_ID_VALUE_S = 53,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 54,
    STYLE_ID_YELLOW_1 = 55,
    STYLE_ID_YELLOW_2 = 56,
    STYLE_ID_YELLOW_3 = 57,
    STYLE_ID_YELLOW_4 = 58,
    STYLE_ID_YELLOW_5 = 59,
    STYLE_ID_YELLOW_6 = 60,
    STYLE_ID_INFO_ALERT = 61,
    STYLE_ID_INFO_ALERT_BUTTON = 62,
    STYLE_ID_TOAST_ALERT = 63,
    STYLE_ID_ERROR_ALERT = 64,
    STYLE_ID_ERROR_ALERT_BUTTON = 65,
    STYLE_ID_YES_NO = 66,
    ...
    STYLE_ID_DEFAULT_3 = 104,
    STYLE_ID_EVENT_INFO_ICON = 105,
    STYLE_ID_EVENT_WARNING_ICON = 106,
    STYLE_ID_EVENT_ERROR_ICON = 107,
    STYLE_ID_PROT_INDICATOR_INVALID_S = 108,
    STYLE_ID_BUTTON_INDICATOR_ON = 109,
    STYLE_ID_BUTTON_INDICATOR_ERROR = 110,
    STYLE_ID_BUTTON_INDICATOR_OFF = 111,
    STYLE_ID_PROT_INDICATOR_BLINK_S = 112,
    STYLE_ID_DEFAULT_S_LEFT = 113
};
...
enum PagesEnum {
    ...
    PAGE_ID_OLD_STATUS_BAR = 93,
    PAGE_ID_OLD_TASK_BAR = 94,
    PAGE_ID_STATUS_LINE = 95
};

extern const uint8_t assets[201745];
