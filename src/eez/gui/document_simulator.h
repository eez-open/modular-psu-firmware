enum DataEnum {
    ...
    DATA_ID_SLOTS = 245,
    DATA_ID_SLOT_MODULE_TYPE = 246,
    DATA_ID_SIMULATOR_LOAD_STATE = 247,
    DATA_ID_SIMULATOR_LOAD = 248,
    DATA_ID_SELECTED_THEME = 249,
    DATA_ID_PROFILE_DIRTY = 250,
    DATA_ID_CHANNEL_TITLE = 251,
    DATA_ID_CHANNEL_SHORT_TITLE = 252,
    DATA_ID_CHANNEL_LONG_TITLE = 253
};
...
enum StylesEnum {
    ...
    STYLE_ID_FRONT_PANEL_DEFAULT = 112,
    STYLE_ID_DEFAULT_3 = 113,
    STYLE_ID_ENCODER_CURSOR = 114,
    STYLE_ID_BUTTON_BGND = 115
};
...
extern const uint8_t assets[274176];
