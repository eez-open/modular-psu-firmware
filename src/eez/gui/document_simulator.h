enum DataEnum {
    ...
    DATA_ID_DEBUG_I_DAC = 417,
    DATA_ID_DEBUG_U_DAC = 418,
    DATA_ID_DEBUG_I_DAC_AMPER = 419,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 420,
    DATA_ID_DEBUG_I_ADC = 421,
    DATA_ID_DEBUG_U_ADC = 422,
    DATA_ID_DEBUG_I_ADC_AMPER = 423,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 424
};
