...
enum StylesEnum {
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 224,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 225,
    STYLE_ID_SCROLLBAR_TRACK = 226,
    ...
    STYLE_ID_DEFAULT_M_WARNING = 263,
    ...
    STYLE_ID_LABELS_AND_COLORS_SLOT = 289,
    STYLE_ID_INLINE290 = 290,
    STYLE_ID_INLINE291 = 291,
    STYLE_ID_INLINE292 = 292,
    STYLE_ID_FRONT_PANEL_MODULE = 293,
...
extern const uint8_t assets[625007];
