enum DataEnum {
    ...
    DATA_ID_SLOT_DEF_2CH_VIEW = 236,
    DATA_ID_SLOT_MAX_2CH_VIEW = 237,
    DATA_ID_SLOT_MIN_2CH_VIEW = 238,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 239,
    DATA_ID_SLOT_2CH_CH1_INDEX = 240,
    DATA_ID_SLOT_2CH_CH2_INDEX = 241,
    DATA_ID_BATTERY = 242,
    DATA_ID_IO_PIN_STATE = 243,
    DATA_ID_CHANNEL_DPROG = 244,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 245,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 246,
    DATA_ID_SYS_INFO_HAS_ERROR = 247,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 248,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 249,
    DATA_ID_SYS_FAN_MODE = 250,
    DATA_ID_SYS_FAN_SPEED = 251,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 252,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 253,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 254,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 255,
    DATA_ID_IS_TRACKING_ALLOWED = 256,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 257,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 258,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 259,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 260,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 261,
    DATA_ID_IS_COUPLED_OR_TRACKED = 262,
    DATA_ID_OVERLAY = 263,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 264,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 265,
    DATA_ID_DLOG_STATE = 266,
    DATA_ID_DLOG_TOGGLE_STATE = 267,
    DATA_ID_RECORDING = 268,
    DATA_ID_CHANNEL_HISTORY_VALUES = 269,
    DATA_ID_RECORDING_READY = 270,
    DATA_ID_NONDRAG_OVERLAY = 271,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 272,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 273,
    DATA_ID_DLOG_VISIBLE_VALUES = 274,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 275,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 276,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 277,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 278,
    DATA_ID_DLOG_ALL_VALUES = 279,
    ...
    DATA_ID_DLOG_DURATION = 290,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 291,
    DATA_ID_DLOG_CURRENT_ENABLED = 292,
    DATA_ID_DLOG_POWER_ENABLED = 293,
    DATA_ID_DLOG_START_ENABLED = 294,
    DATA_ID_DLOG_FILE_NAME = 295,
    DATA_ID_DLOG_VALUE_STATE = 296,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 297,
    ...
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 305,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 306,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 307,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 308,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 309,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 310,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 311,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 312,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 313,
    DATA_ID_SCRIPT_INFO = 314,
    DATA_ID_SCRIPT_IS_STARTED = 315,
    DATA_ID_KEYPAD_OK_ENABLED = 316,
    DATA_ID_ETHERNET_HOST_NAME = 317,
    DATA_ID_MQTT_HOST = 318,
    DATA_ID_MQTT_PORT = 319,
    DATA_ID_MQTT_USERNAME = 320,
    DATA_ID_MQTT_PASSWORD = 321,
    DATA_ID_MQTT_PERIOD = 322,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 323,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 324,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 325,
    DATA_ID_LIST_COUNTER_LABEL = 326,
    DATA_ID_RAMP_COUNTER_LABEL = 327,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 328,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 329,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 330,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 331,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 332,
    DATA_ID_IS_RESET_BY_IWDG = 333,
    DATA_ID_DLOG_ENABLED = 334,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 335,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 336,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 337,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 338,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 339,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 340,
    DATA_ID_DATE_TIME_FORMAT = 341,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 342,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 343,
    DATA_ID_DATE_TIME_AM_PM = 344,
    DATA_ID_IS_MULTI_TRACKING = 345,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 346,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 347,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 348,
    DATA_ID_CHANNEL_INFO_BRAND = 349,
    DATA_ID_CHANNEL_INFO_SERIAL = 350,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 351,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 352,
    DATA_ID_FILE_MANAGER_FILE_ICON = 353,
    DATA_ID_FILE_MANAGER_LAYOUT = 354,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 355,
    DATA_ID_TOUCH_RAW_X = 356,
    DATA_ID_TOUCH_RAW_Y = 357,
    DATA_ID_TOUCH_RAW_Z1 = 358,
    DATA_ID_TOUCH_RAW_PRESSED = 359,
    DATA_ID_TOUCH_CALIBRATED_X = 360,
    DATA_ID_TOUCH_CALIBRATED_Y = 361,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 362,
    DATA_ID_TOUCH_FILTERED_X = 363,
    DATA_ID_TOUCH_FILTERED_Y = 364,
    DATA_ID_TOUCH_FILTERED_PRESSED = 365,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 366,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 367,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 368,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 369,
    DATA_ID_ALERT_MESSAGE_IS_SET = 370,
    DATA_ID_ASYNC_PROGRESS = 371,
    DATA_ID_IO_PIN_FUNCTION = 372,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 373,
    DATA_ID_IO_PIN_PWM_DUTY = 374,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 375,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 376,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 377,
    DATA_ID_DEBUG_VARIABLES = 378,
    DATA_ID_DEBUG_VARIABLE_NAME = 379,
    DATA_ID_DEBUG_VARIABLE_VALUE = 380,
    DATA_ID_CHANNEL_RAMP_STATE = 381,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 382,
    DATA_ID_MQTT_IN_ERROR = 383,
    DATA_ID_DEBUG_I_DAC = 384,
    DATA_ID_DEBUG_U_DAC = 385,
    DATA_ID_DEBUG_I_DAC_AMPER = 386,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 387,
    DATA_ID_DEBUG_I_ADC = 388,
    DATA_ID_DEBUG_U_ADC = 389,
    DATA_ID_DEBUG_I_ADC_AMPER = 390,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 391,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 392,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 393,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 394,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 395,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 396,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 397,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 398,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 399,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 400,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 401,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 402,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 403,
    DATA_ID_DUMMY = 404,
    DATA_ID_SLOTS = 405,
    DATA_ID_SLOT_INDEX = 406,
    DATA_ID_SLOT_TITLE_DEF = 407,
    DATA_ID_SLOT_TITLE_MAX = 408,
    DATA_ID_SLOT_TITLE_MIN = 409,
    ...
    DATA_ID_CHANNELS_IS_2COL_VIEW = 416,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 417,
    DATA_ID_DIB_MIO168_INPUTS = 418,
    DATA_ID_DIB_MIO168_INPUT_NO = 419,
    DATA_ID_DIB_MIO168_INPUT_STATE = 420,
    DATA_ID_DIB_MIO168_OUTPUTS = 421,
    DATA_ID_DIB_MIO168_OUTPUT_NO = 422,
    DATA_ID_DIB_MIO168_OUTPUT_STATE = 423,
    DATA_ID_DIB_MIO168_ANALOG_INPUTS = 424,
    DATA_ID_DIB_MIO168_ANALOG_INPUT_VALUE = 425,
    DATA_ID_DIB_SMX46_OUTPUTS = 426,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 427,
    DATA_ID_SIMULATOR_LOAD_STATE = 428,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 429,
    DATA_ID_SIMULATOR_LOAD = 430,
    DATA_ID_SIMULATOR_LOAD2 = 431,
    DATA_ID_MAIN_APP_VIEW = 432,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 433,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 434
};
...
enum BitmapsEnum {
    ...
    BITMAP_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM220 = 19,
    BITMAP_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM224 = 20,
    BITMAP_ID_FRONT_PANEL = 21
};
...
enum StylesEnum {
    ...
    STYLE_ID_DISPLAY_OFF = 193,
    STYLE_ID_DISPLAY_OFF_S = 194,
    STYLE_ID_INLINE195 = 195,
    STYLE_ID_INLINE196 = 196,
    STYLE_ID_MON_VALUE_48_RIGHT = 197,
    STYLE_ID_INLINE198 = 198,
    STYLE_ID_MON_VALUE_20_LEFT = 199,
    ...
    STYLE_ID_MON_VALUE_20_RIGHT = 234,
    STYLE_ID_MON_VALUE_14_LEFT = 235,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 236,
    STYLE_ID_INLINE237 = 237,
    STYLE_ID_INLINE238 = 238,
    STYLE_ID_INLINE239 = 239,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 240,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 241,
    STYLE_ID_SCROLLBAR_TRACK = 242,
    ...
    STYLE_ID_FRONT_PANEL_MODULE = 290,
...
enum PagesEnum {
    ...
    PAGE_ID_SLOT_DEF_1CH_NUM_ON_2COL = 81,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON = 82,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON_2COL = 83,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF = 84,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF_2COL = 85,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 86,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES_2COL = 87,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 88,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL_2COL = 89,
    PAGE_ID_SLOT_DEF_2CH_VERT = 90,
    PAGE_ID_SLOT_DEF_2CH_VERT_2COL = 91,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON = 92,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON_2COL = 93,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF = 94,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF_2COL = 95,
    ...
    PAGE_ID_SLOT_DEF_HORZ_TITLE_2COL = 102,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON = 103,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON_2COL = 104,
    PAGE_ID_SLOT_DEF_1CH_YT_ON = 105,
    PAGE_ID_SLOT_DEF_1CH_YT_ON_2COL = 106,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF = 107,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF_2COL = 108,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 109,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES_2COL = 110,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 111,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL_2COL = 112,
    PAGE_ID_SLOT_DEF_2CH_HORZ = 113,
    PAGE_ID_SLOT_DEF_2CH_HORZ_2COL = 114,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON = 115,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON_2COL = 116,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF = 117,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF_2COL = 118,
    PAGE_ID_SLOT_DEF_HORZ_ERROR = 119,
    PAGE_ID_SLOT_DEF_HORZ_ERROR_2COL = 120,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED = 121,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED_2COL = 122,
    PAGE_ID_SLOT_DEF_HORZ_EMPTY = 123,
    PAGE_ID_SLOT_DEF_HORZ_EMPTY_2COL = 124,
    PAGE_ID_SLOT_MAX_1CH_TITLE = 125,
    PAGE_ID_SLOT_MAX_1CH_NUM_ON = 126,
    PAGE_ID_SLOT_MAX_1CH_NUM_OFF = 127,
    PAGE_ID_SLOT_MAX_1CH_HBAR_ON = 128,
    PAGE_ID_SLOT_MAX_1CH_HBAR_OFF = 129,
    PAGE_ID_SLOT_MAX_1CH_YT_ON = 130,
    PAGE_ID_SLOT_MAX_1CH_YT_OFF = 131,
    PAGE_ID_SLOT_MAX_2CH = 132,
    PAGE_ID_SLOT_MAX_2CH_TITLE = 133,
    PAGE_ID_SLOT_MAX_2CH_NUM_ON = 134,
    PAGE_ID_SLOT_MAX_2CH_NUM_OFF = 135,
    PAGE_ID_SLOT_MAX_2CH_HBAR_ON = 136,
    PAGE_ID_SLOT_MAX_2CH_HBAR_OFF = 137,
    PAGE_ID_SLOT_MAX_2CH_YT_ON = 138,
    PAGE_ID_SLOT_MAX_2CH_YT_OFF = 139,
    PAGE_ID_SLOT_MAX_2CH_MIN_TITLE = 140,
    PAGE_ID_SLOT_MAX_2CH_MIN_ON = 141,
    PAGE_ID_SLOT_MAX_2CH_MIN_OFF = 142,
    PAGE_ID_SLOT_MAX_ERROR = 143,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 144,
    PAGE_ID_SLOT_MIN_1CH_TITLE = 145,
    PAGE_ID_SLOT_MIN_1CH_ON = 146,
    PAGE_ID_SLOT_MIN_1CH_OFF = 147,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_SERIES = 148,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_PARALLEL = 149,
    PAGE_ID_SLOT_MIN_2CH_TITLE = 150,
    PAGE_ID_SLOT_MIN_2CH = 151,
    PAGE_ID_SLOT_MIN_2CH_ON = 152,
    PAGE_ID_SLOT_MIN_2CH_OFF = 153,
    PAGE_ID_SLOT_MIN_ERROR = 154,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 155,
    PAGE_ID_SLOT_MICRO_1CH_TITLE = 156,
    PAGE_ID_SLOT_MICRO_1CH_ON = 157,
    PAGE_ID_SLOT_MICRO_1CH_OFF = 158,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_SERIES = 159,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_PARALLEL = 160,
    PAGE_ID_SLOT_MICRO_2CH = 161,
    PAGE_ID_SLOT_MICRO_2CH_TITLE = 162,
    PAGE_ID_SLOT_MICRO_2CH_ON = 163,
    PAGE_ID_SLOT_MICRO_2CH_OFF = 164,
    PAGE_ID_SLOT_MICRO_ERROR = 165,
    PAGE_ID_SLOT_MICRO_NOT_INSTALLED = 166,
    PAGE_ID_DLOG_VIEW = 167,
    PAGE_ID_IMAGE_VIEW = 168,
    PAGE_ID_DLOG_PARAMS = 169,
    PAGE_ID_DLOG_VIEW_OVERLAY_OPTIONS = 170,
    PAGE_ID_FILE_MANAGER = 171,
    PAGE_ID_FILE_BROWSER = 172,
    PAGE_ID_FILE_MENU = 173,
    ...
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 183,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF_2COL = 184,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 185,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 186,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 187,
    PAGE_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 188,
    PAGE_ID_DIB_PREL6_SIMULATOR_FRONT_PANEL_MASK = 189,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF = 190,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_2COL = 191,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 192,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 193,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 194,
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 195,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 196,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL = 197,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 198,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 199,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 200,
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 201,
    PAGE_ID_DIB_DCP405_CH_SETTINGS_SPECIFIC = 202,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM220 = 203,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM224 = 204,
    PAGE_ID_DIB_DCM220_DCM220_FRONT_PANEL_LED = 205,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_ERROR = 206,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_SPECIFIC = 207,
    PAGE_ID_FRONT_PANEL = 208,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 209,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 210
};

extern const uint8_t assets[522555];
