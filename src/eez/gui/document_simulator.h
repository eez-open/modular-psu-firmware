...
enum StylesEnum {
    ...
    STYLE_ID_FRONT_PANEL_DEFAULT = 102,
...
enum PagesEnum {
    ...
    PAGE_ID_OTP = 79,
    PAGE_ID_OPP = 80,
    PAGE_ID_FRONT_PANEL = 81,
    PAGE_ID_NUMERIC_KEYPAD2 = 82,
    PAGE_ID_OLD_STATUS_BAR = 83,
    PAGE_ID_OLD_TASK_BAR = 84,
    PAGE_ID_MINIMIZED_APP_VIEW = 85
};

extern const uint8_t assets[202033];
