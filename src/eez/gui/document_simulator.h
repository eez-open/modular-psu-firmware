enum DataEnum {
    ...
    DATA_ID_ETHERNET_AND_MQTT_STATUS = 156,
    ...
    DATA_ID_RAMP_AND_DELAY_LIST = 191,
    ...
    DATA_ID_CHANNEL_COUPLING_STATE = 207,
    DATA_ID_TRIGGER_SOURCE = 208,
    DATA_ID_TRIGGER_DELAY = 209,
    DATA_ID_TRIGGER_INITIATE_CONTINUOUSLY = 210,
    DATA_ID_TRIGGER_IS_INITIATED = 211,
    DATA_ID_TRIGGER_IS_MANUAL = 212,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 213,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 214,
    DATA_ID_CHANNEL_RANGES_MODE = 215,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 216,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 217,
    DATA_ID_TEXT_MESSAGE = 218,
    DATA_ID_SERIAL_STATUS = 219,
    DATA_ID_SERIAL_ENABLED = 220,
    DATA_ID_SERIAL_IS_CONNECTED = 221,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 222,
    DATA_ID_CHANNEL_RAMP_COUNTDOWN = 223,
    DATA_ID_IO_PINS = 224,
    DATA_ID_IO_PINS_INHIBIT_STATE = 225,
    DATA_ID_IO_PIN_NUMBER = 226,
    DATA_ID_IO_PIN_POLARITY = 227,
    DATA_ID_IO_PIN_FUNCTION_NAME = 228,
    DATA_ID_NTP_ENABLED = 229,
    DATA_ID_NTP_SERVER = 230,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 231,
    DATA_ID_PROGRESS = 232,
    DATA_ID_MAIN_APP_VIEW = 233,
    DATA_ID_TOUCH_CALIBRATION_POINT = 234,
    DATA_ID_SIMULATOR_LOAD_STATE = 235,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 236,
    DATA_ID_SIMULATOR_LOAD = 237,
    DATA_ID_SIMULATOR_LOAD2 = 238,
    DATA_ID_SELECTED_THEME = 239,
    DATA_ID_CHANNEL_TITLE = 240,
    DATA_ID_CHANNEL_SHORT_TITLE = 241,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 242,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 243,
    DATA_ID_CHANNEL_LONG_TITLE = 244,
    DATA_ID_ANIMATIONS_DURATION = 245,
    DATA_ID_SLOT1_INFO = 246,
    DATA_ID_SLOT2_INFO = 247,
    DATA_ID_SLOT3_INFO = 248,
    DATA_ID_SLOT1_TEST_RESULT = 249,
    DATA_ID_SLOT2_TEST_RESULT = 250,
    DATA_ID_SLOT3_TEST_RESULT = 251,
    DATA_ID_SLOT_DEFAULT1_VIEW = 252,
    DATA_ID_SLOT_DEFAULT2_VIEW = 253,
    DATA_ID_SLOT_DEFAULT3_VIEW = 254,
    DATA_ID_SLOT1_CHANNEL_INDEX = 255,
    DATA_ID_SLOT2_CHANNEL_INDEX = 256,
    DATA_ID_SLOT3_CHANNEL_INDEX = 257,
    DATA_ID_SLOT_DEF_2CH_VIEW = 258,
    DATA_ID_SLOT_MAX_2CH_VIEW = 259,
    DATA_ID_SLOT_MIN_2CH_VIEW = 260,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 261,
    DATA_ID_SLOT_2CH_CH1_INDEX = 262,
    DATA_ID_SLOT_2CH_CH2_INDEX = 263,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 264,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 265,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 266,
    DATA_ID_BATTERY = 267,
    ...
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 273,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 274,
    DATA_ID_SYS_FAN_MODE = 275,
    DATA_ID_SYS_FAN_SPEED = 276,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 277,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 278,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 279,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 280,
    DATA_ID_IS_TRACKING_ALLOWED = 281,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 282,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 283,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 284,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 285,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 286,
    DATA_ID_IS_COUPLED_OR_TRACKED = 287,
    DATA_ID_OVERLAY = 288,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 289,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 290,
    ...
    DATA_ID_RAMP_COUNTER_LABEL = 354,
    ...
    DATA_ID_DATE_TIME_FORMAT = 370,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 371,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 372,
    DATA_ID_DATE_TIME_AM_PM = 373,
    DATA_ID_IS_MULTI_TRACKING = 374,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 375,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 376,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 377,
    DATA_ID_CHANNEL_INFO_BRAND = 378,
    DATA_ID_CHANNEL_INFO_SERIAL = 379,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 380,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 381,
    DATA_ID_FILE_MANAGER_FILE_ICON = 382,
    DATA_ID_FILE_MANAGER_LAYOUT = 383,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 384,
    DATA_ID_TOUCH_RAW_X = 385,
    DATA_ID_TOUCH_RAW_Y = 386,
    DATA_ID_TOUCH_RAW_Z1 = 387,
    DATA_ID_TOUCH_RAW_PRESSED = 388,
    DATA_ID_TOUCH_CALIBRATED_X = 389,
    DATA_ID_TOUCH_CALIBRATED_Y = 390,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 391,
    DATA_ID_TOUCH_FILTERED_X = 392,
    DATA_ID_TOUCH_FILTERED_Y = 393,
    DATA_ID_TOUCH_FILTERED_PRESSED = 394,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 395,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 396,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 397,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 398,
    DATA_ID_ALERT_MESSAGE_IS_SET = 399,
    DATA_ID_ASYNC_PROGRESS = 400,
    DATA_ID_IO_PIN_FUNCTION = 401,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 402,
    DATA_ID_IO_PIN_PWM_DUTY = 403,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 404,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 405,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 406,
    DATA_ID_DEBUG_VARIABLES = 407,
    DATA_ID_DEBUG_VARIABLE_NAME = 408,
    DATA_ID_DEBUG_VARIABLE_VALUE = 409,
    DATA_ID_CHANNEL_RAMP_STATE = 410,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 411,
    DATA_ID_MQTT_IN_ERROR = 412
};
...
enum ActionsEnum {
    ...
    ACTION_ID_DLOG_VIEW_TOGGLE_LEGEND = 202,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 203,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 204,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 205,
    ACTION_ID_SHUTDOWN = 206,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 207,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 208,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 209,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 210,
    ACTION_ID_PROFILE_IMPORT = 211,
    ACTION_ID_PROFILE_EXPORT = 212,
    ACTION_ID_EVENT_QUEUE_FILTER = 213,
    ACTION_ID_EVENT_QUEUE_SELECT_EVENT = 214,
    ACTION_ID_DATE_TIME_SELECT_FORMAT = 215,
    ACTION_ID_DATE_TIME_TOGGLE_AM_PM = 216,
    ACTION_ID_EDIT_NO_FOCUS = 217,
    ACTION_ID_UNTRACK_ALL = 218,
    ACTION_ID_CH_SETTINGS_COPY = 219,
    ACTION_ID_SHOW_SYS_SETTINGS_ETHERNET_ERROR = 220,
    ACTION_ID_FILE_MANAGER_SELECT_LIST_VIEW = 221,
    ACTION_ID_SHOW_SYS_SETTINGS_RAMP_AND_DELAY = 222,
    ACTION_ID_CHANNEL_TOGGLE_RAMP_STATE = 223
};
...
enum StylesEnum {
    ...
    STYLE_ID_ERROR_ALERT = 21,
    STYLE_ID_ERROR_ALERT_BUTTON = 22,
    STYLE_ID_YT_GRAPH_U_DEFAULT = 23,
    STYLE_ID_YT_GRAPH_I_DEFAULT = 24,
    STYLE_ID_YT_GRAPH_P_DEFAULT = 25,
    STYLE_ID_YT_GRAPH_UNREGULATED = 26,
    STYLE_ID_YT_GRAPH_Y1 = 27,
    STYLE_ID_YT_GRAPH_Y2 = 28,
    STYLE_ID_YT_GRAPH_Y3 = 29,
    STYLE_ID_YT_GRAPH_Y4 = 30,
    STYLE_ID_YT_GRAPH_Y5 = 31,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_CONTAINER = 32,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_CONTAINER_S = 33,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_ITEM = 34,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_ITEM_S = 35,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_DISABLED_ITEM = 36,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_DISABLED_ITEM_S = 37,
    STYLE_ID_ENCODER_CURSOR_14_DISABLED = 38,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_DISABLED = 39,
    STYLE_ID_INFO_ALERT = 40,
    STYLE_ID_MENU_WITH_BUTTONS_MESSAGE = 41,
    STYLE_ID_MENU_WITH_BUTTONS_CONTAINER = 42,
    STYLE_ID_MENU_WITH_BUTTONS_BUTTON = 43,
    STYLE_ID_CHANNEL1 = 44,
    STYLE_ID_CHANNEL2 = 45,
    STYLE_ID_CHANNEL3 = 46,
    STYLE_ID_CHANNEL4 = 47,
    STYLE_ID_CHANNEL5 = 48,
    STYLE_ID_CHANNEL6 = 49,
    STYLE_ID_CHANNEL1_INVERSE = 50,
    STYLE_ID_CHANNEL2_INVERSE = 51,
    STYLE_ID_CHANNEL3_INVERSE = 52,
    STYLE_ID_CHANNEL4_INVERSE = 53,
    STYLE_ID_CHANNEL5_INVERSE = 54,
    STYLE_ID_CHANNEL6_INVERSE = 55,
    STYLE_ID_DEFAULT_M = 56,
    STYLE_ID_DEFAULT_M_WARNING = 57,
    STYLE_ID_VALUE_S = 58,
    ...
    STYLE_ID_DEFAULT_INVERSE = 113,
    STYLE_ID_SCROLLBAR_THUMB = 114,
    STYLE_ID_SCROLLBAR_BUTTON = 115,
    ...
    STYLE_ID_EDIT_VALUE_S_CENTERED = 122,
    ...
    STYLE_ID_VALUE_M_LEFT = 129,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 130,
    STYLE_ID_INLINE131 = 131,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 132,
    STYLE_ID_ENCODER_CURSOR_17_ENABLED = 133,
    STYLE_ID_INLINE134 = 134,
    STYLE_ID_YT_GRAPH = 135,
    STYLE_ID_LIST_GRAPH_CURSOR = 136,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 137,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 138,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 139,
    ...
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 193,
    STYLE_ID_BAR_GRAPH_TEXT = 194,
    STYLE_ID_INLINE195 = 195,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 196,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 197,
    STYLE_ID_INLINE198 = 198,
    STYLE_ID_INLINE199 = 199,
    STYLE_ID_TRIGGER_BUTTON_24 = 200,
    STYLE_ID_INLINE201 = 201,
    STYLE_ID_INLINE202 = 202,
    STYLE_ID_MON_VALUE_14_RIGHT = 203,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 204,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 205,
    STYLE_ID_TRIGGER_BUTTON_14 = 206,
    STYLE_ID_INLINE207 = 207,
    STYLE_ID_INLINE208 = 208,
    STYLE_ID_INLINE209 = 209,
    STYLE_ID_INLINE210 = 210,
    STYLE_ID_INLINE211 = 211,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 212,
    STYLE_ID_INST_SELECTED = 213,
    STYLE_ID_MON_VALUE_38_RIGHT = 214,
    STYLE_ID_INLINE215 = 215,
    STYLE_ID_CH_PROT_OFF = 216,
    STYLE_ID_CH_PROT_ON = 217,
    STYLE_ID_CH_PROT_TRIPPED = 218,
    STYLE_ID_INLINE219 = 219,
    STYLE_ID_MON_VALUE_24_RIGHT = 220,
    STYLE_ID_MON_VALUE_14_CENTER = 221,
    STYLE_ID_INLINE222 = 222,
    STYLE_ID_INLINE223 = 223,
    STYLE_ID_INLINE224 = 224,
    STYLE_ID_INLINE225 = 225,
    STYLE_ID_INLINE226 = 226,
    STYLE_ID_MON_VALUE_20_RIGHT = 227,
    STYLE_ID_MON_VALUE_14_LEFT = 228,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 229,
    ...
    STYLE_ID_BUTTON_S_DISABLED = 247,
...
enum PagesEnum {
    ...
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON = 82,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF = 83,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 84,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 85,
    PAGE_ID_SLOT_DEF_2CH_VERT = 86,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON = 87,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF = 88,
    PAGE_ID_SLOT_DEF_VERT_ERROR = 89,
    PAGE_ID_SLOT_DEF_VERT_NOT_INSTALLED = 90,
    PAGE_ID_SLOT_DEF_HORZ = 91,
    PAGE_ID_SLOT_DEF_HORZ_TITLE = 92,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON = 93,
    PAGE_ID_SLOT_DEF_1CH_YT_ON = 94,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF = 95,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 96,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 97,
    PAGE_ID_SLOT_DEF_2CH_HORZ = 98,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON = 99,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF = 100,
    PAGE_ID_SLOT_DEF_HORZ_ERROR = 101,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED = 102,
    PAGE_ID_SLOT_MAX_1CH_TITLE = 103,
    PAGE_ID_SLOT_MAX_1CH_NUM_ON = 104,
    PAGE_ID_SLOT_MAX_1CH_NUM_OFF = 105,
    PAGE_ID_SLOT_MAX_1CH_HBAR_ON = 106,
    PAGE_ID_SLOT_MAX_1CH_HBAR_OFF = 107,
    PAGE_ID_SLOT_MAX_1CH_YT_ON = 108,
    PAGE_ID_SLOT_MAX_1CH_YT_OFF = 109,
    PAGE_ID_SLOT_MAX_2CH = 110,
    PAGE_ID_SLOT_MAX_2CH_TITLE = 111,
    PAGE_ID_SLOT_MAX_2CH_NUM_ON = 112,
    PAGE_ID_SLOT_MAX_2CH_NUM_OFF = 113,
    PAGE_ID_SLOT_MAX_2CH_HBAR_ON = 114,
    PAGE_ID_SLOT_MAX_2CH_HBAR_OFF = 115,
    PAGE_ID_SLOT_MAX_2CH_YT_ON = 116,
    PAGE_ID_SLOT_MAX_2CH_YT_OFF = 117,
    PAGE_ID_SLOT_MAX_2CH_MIN_TITLE = 118,
    PAGE_ID_SLOT_MAX_2CH_MIN_ON = 119,
    PAGE_ID_SLOT_MAX_2CH_MIN_OFF = 120,
    PAGE_ID_SLOT_MAX_ERROR = 121,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 122,
    PAGE_ID_SLOT_MIN_1CH_TITLE = 123,
    PAGE_ID_SLOT_MIN_1CH_ON = 124,
    PAGE_ID_SLOT_MIN_1CH_OFF = 125,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_SERIES = 126,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_PARALLEL = 127,
    PAGE_ID_SLOT_MIN_2CH_TITLE = 128,
    PAGE_ID_SLOT_MIN_2CH = 129,
    PAGE_ID_SLOT_MIN_2CH_ON = 130,
    PAGE_ID_SLOT_MIN_2CH_OFF = 131,
    PAGE_ID_SLOT_MIN_ERROR = 132,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 133,
    PAGE_ID_SLOT_MICRO_1CH_TITLE = 134,
    PAGE_ID_SLOT_MICRO_1CH_ON = 135,
    PAGE_ID_SLOT_MICRO_1CH_OFF = 136,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_SERIES = 137,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_PARALLEL = 138,
    PAGE_ID_SLOT_MICRO_2CH = 139,
    PAGE_ID_SLOT_MICRO_2CH_TITLE = 140,
    PAGE_ID_SLOT_MICRO_2CH_ON = 141,
    PAGE_ID_SLOT_MICRO_2CH_OFF = 142,
    PAGE_ID_SLOT_MICRO_ERROR = 143,
    PAGE_ID_SLOT_MICRO_NOT_INSTALLED = 144,
    PAGE_ID_DLOG_VIEW = 145,
    PAGE_ID_IMAGE_VIEW = 146,
    PAGE_ID_DLOG_PARAMS = 147,
    PAGE_ID_DLOG_VIEW_OVERLAY_OPTIONS = 148,
    PAGE_ID_FILE_MANAGER = 149,
    PAGE_ID_FILE_BROWSER = 150,
    PAGE_ID_FILE_MENU = 151,
    PAGE_ID_FRONT_PANEL = 152,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 153,
    PAGE_ID_DCP405_FRONT_PANEL = 154,
...
extern const uint8_t assets[413659];
