enum DataEnum {
    ...
    DATA_ID_SLOTS = 243,
    DATA_ID_SIMULATOR_LOAD_STATE = 244,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 245,
    DATA_ID_SIMULATOR_LOAD = 246,
    DATA_ID_SIMULATOR_LOAD2 = 247,
    DATA_ID_SELECTED_THEME = 248,
    DATA_ID_PROFILE_DIRTY = 249,
    DATA_ID_CHANNEL_TITLE = 250,
    DATA_ID_CHANNEL_SHORT_TITLE = 251,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 252,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 253,
    DATA_ID_CHANNEL_LONG_TITLE = 254,
    DATA_ID_ANIMATIONS_DURATION = 255,
    DATA_ID_SLOT1_INFO = 256,
    DATA_ID_SLOT2_INFO = 257,
    DATA_ID_SLOT3_INFO = 258,
    DATA_ID_SLOT1_TEST_RESULT = 259,
    DATA_ID_SLOT2_TEST_RESULT = 260,
    DATA_ID_SLOT3_TEST_RESULT = 261,
    DATA_ID_SLOT_DEFAULT1_VIEW = 262,
    DATA_ID_SLOT_DEFAULT2_VIEW = 263,
    DATA_ID_SLOT_DEFAULT3_VIEW = 264,
    DATA_ID_SLOT1_CHANNEL_INDEX = 265,
    DATA_ID_SLOT2_CHANNEL_INDEX = 266,
    DATA_ID_SLOT3_CHANNEL_INDEX = 267,
    DATA_ID_SLOT_DEF_2CH_VIEW = 268,
    DATA_ID_SLOT_MAX_2CH_VIEW = 269,
    DATA_ID_SLOT_MIN_2CH_VIEW = 270,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 271,
    DATA_ID_SLOT_2CH_CH1_INDEX = 272,
    DATA_ID_SLOT_2CH_CH2_INDEX = 273,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 274,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 275,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 276,
    DATA_ID_BATTERY = 277,
    DATA_ID_IO_PIN_STATE = 278,
    DATA_ID_CHANNEL_DPROG = 279,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 280,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 281,
    DATA_ID_SYS_INFO_HAS_ERROR = 282,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 283,
    DATA_ID_SYS_FAN_MODE = 284,
    DATA_ID_SYS_FAN_SPEED = 285,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 286,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 287,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 288,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 289,
    DATA_ID_IS_TRACKING_ALLOWED = 290,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 291,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 292,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 293,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 294,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 295,
    DATA_ID_IS_COUPLED_OR_TRACKED = 296,
    DATA_ID_OVERLAY = 297,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 298,
    DATA_ID_DLOG_STATE = 299,
    DATA_ID_DLOG_TOGGLE_STATE = 300,
    DATA_ID_RECORDING = 301,
    DATA_ID_CHANNEL_HISTORY_VALUES = 302,
    DATA_ID_RECORDING_READY = 303,
    DATA_ID_NONDRAG_OVERLAY = 304,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 305,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 306,
    DATA_ID_DLOG_VISIBLE_VALUES = 307,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 308,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 309,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 310,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 311,
    DATA_ID_DLOG_ALL_VALUES = 312,
    DATA_ID_DLOG_VALUE_LABEL = 313,
    DATA_ID_DLOG_CURRENT_TIME = 314,
    DATA_ID_DLOG_FILE_LENGTH = 315,
    DATA_ID_DLOG_X_AXIS_OFFSET = 316,
    DATA_ID_DLOG_X_AXIS_DIV = 317,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 318,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 319,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 320,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 321,
    DATA_ID_DLOG_VIEW_STATE = 322,
    DATA_ID_DLOG_PERIOD = 323,
    DATA_ID_DLOG_DURATION = 324,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 325,
    DATA_ID_DLOG_CURRENT_ENABLED = 326,
    DATA_ID_DLOG_POWER_ENABLED = 327,
    DATA_ID_DLOG_START_ENABLED = 328,
    DATA_ID_DLOG_FILE_NAME = 329,
    DATA_ID_DLOG_VALUE_STATE = 330,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 331,
    DATA_ID_CHANNEL_OFF_LABEL = 332,
    DATA_ID_FILE_MANAGER_FILES = 333,
    DATA_ID_FILE_MANAGER_FILE_NAME = 334,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 335,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 336,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 337,
    DATA_ID_FILE_MANAGER_STATE = 338,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 339,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 340,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 341,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 342,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 343,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 344,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 345,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 346,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 347,
    DATA_ID_SCRIPT_INFO = 348,
    DATA_ID_SCRIPT_IS_STARTED = 349,
    DATA_ID_DEBUG_TRACE_LOG = 350,
    DATA_ID_DEBUG_TRACE_LOG_LINE = 351,
    DATA_ID_KEYPAD_OK_ENABLED = 352,
    DATA_ID_ETHERNET_HOST_NAME = 353,
    DATA_ID_MQTT_HOST = 354,
    DATA_ID_MQTT_PORT = 355,
    DATA_ID_MQTT_USERNAME = 356,
    DATA_ID_MQTT_PASSWORD = 357,
    DATA_ID_MQTT_PERIOD = 358,
    DATA_ID_DEBUG_TRACE_LOG_IS_STOPPED = 359,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 360,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 361,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 362,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 363,
    DATA_ID_LIST_COUNTER_LABEL = 364,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 365,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 366,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 367,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 368,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 369,
    DATA_ID_IS_RESET_BY_IWDG = 370,
    DATA_ID_DLOG_ENABLED = 371
};
...
enum PagesEnum {
    ...
    PAGE_ID_SYS_SETTINGS_CAL = 60,
    PAGE_ID_SYS_SETTINGS_CAL_CH = 61,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP = 62,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_FINISH = 63,
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[392582];
#else
extern const uint8_t assets[3864184];
#endif
