enum DataEnum {
    ...
    DATA_ID_IS_RESET_BY_IWDG = 318,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 319,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 320,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 321,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 322,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 323,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 324,
    DATA_ID_DATE_TIME_FORMAT = 325,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 326,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 327,
    DATA_ID_DATE_TIME_AM_PM = 328,
    DATA_ID_IS_MULTI_TRACKING = 329,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 330,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 331,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 332,
    DATA_ID_CHANNEL_INFO_BRAND = 333,
    DATA_ID_CHANNEL_INFO_SERIAL = 334,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 335,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 336,
    DATA_ID_FILE_MANAGER_FILE_ICON = 337,
    DATA_ID_FILE_MANAGER_LAYOUT = 338,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 339,
    DATA_ID_TOUCH_RAW_X = 340,
    DATA_ID_TOUCH_RAW_Y = 341,
    DATA_ID_TOUCH_RAW_Z1 = 342,
    DATA_ID_TOUCH_RAW_PRESSED = 343,
    DATA_ID_TOUCH_CALIBRATED_X = 344,
    DATA_ID_TOUCH_CALIBRATED_Y = 345,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 346,
    DATA_ID_TOUCH_FILTERED_X = 347,
    DATA_ID_TOUCH_FILTERED_Y = 348,
    DATA_ID_TOUCH_FILTERED_PRESSED = 349,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 350,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 351,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 352,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 353,
    DATA_ID_ALERT_MESSAGE_IS_SET = 354,
    DATA_ID_ASYNC_PROGRESS = 355,
    DATA_ID_IO_PIN_FUNCTION = 356,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 357,
    DATA_ID_IO_PIN_PWM_DUTY = 358,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 359,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 360,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 361,
    DATA_ID_CHANNEL_RAMP_STATE = 362,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 363,
    DATA_ID_MQTT_IN_ERROR = 364,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 365,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 366,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 367,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 368,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 369,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 370,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 371,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 372,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 373,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 374,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 375,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 376,
    DATA_ID_SLOTS = 377,
    DATA_ID_SLOT_INDEX = 378,
    DATA_ID_SLOT_TITLE_DEF = 379,
    DATA_ID_SLOT_TITLE_MAX = 380,
    DATA_ID_SLOT_TITLE_MIN = 381,
    DATA_ID_SLOT_TITLE_MICRO = 382,
    DATA_ID_SLOT_TITLE_SETTINGS = 383,
    DATA_ID_SLOT_ERROR_MESSAGE = 384,
    DATA_ID_USB_MODE = 385,
    DATA_ID_USB_CURRENT_MODE = 386,
    DATA_ID_USB_DEVICE_CLASS = 387,
    DATA_ID_USB_KEYBOARD_STATE = 388,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 389,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 390,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 391,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 392,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 393,
    DATA_ID_SLOT_SERIAL_INFO = 394,
    DATA_ID_SLOT_IS_ENABLED = 395,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 396,
    DATA_ID_USER_SWITCH_ACTION = 397,
    DATA_ID_NTP_REFRESH_FREQUENCY = 398,
    DATA_ID_CHANNEL_CALIBRATION_IS_POWER_CHANNEL = 399,
    DATA_ID_HAS_CUSTOM_BITMAP = 400,
    DATA_ID_CUSTOM_BITMAP = 401,
    DATA_ID_SLOT_INFO_WITH_FW_VER = 402,
    DATA_ID_MASTER_INFO_WITH_FW_VER = 403,
    DATA_ID_SLOT1_LABELS_AND_COLORS_VIEW = 404,
    DATA_ID_SLOT2_LABELS_AND_COLORS_VIEW = 405,
    DATA_ID_SLOT3_LABELS_AND_COLORS_VIEW = 406,
    DATA_ID_COLORS = 407,
    DATA_ID_KEYPAD_CAN_SET_DEFAULT = 408,
    DATA_ID_LABELS_AND_COLORS_PAGE_SLOT_TITLE = 409,
    DATA_ID_LABELS_AND_COLORS_PAGE_CHANNEL_TITLE = 410,
    DATA_ID_LABELS_AND_COLORS_IS_COLOR_MODIFIED = 411,
    DATA_ID_DLOG_ITEMS = 412,
    DATA_ID_DLOG_ITEM_IS_CHECKED = 413,
    DATA_ID_DLOG_ITEM_CHANNEL = 414,
    DATA_ID_DLOG_ITEM_LABEL = 415,
    DATA_ID_DLOG_ITEMS_SCROLLBAR_ENABLED = 416,
    DATA_ID_DLOG_ITEMS_NUM_SELECTED = 417,
    DATA_ID_DLOG_START_ENABLED = 418,
    DATA_ID_HAS_MULTIPLE_DISK_DRIVES = 419,
    DATA_ID_SELECTED_MASS_STORAGE_DEVICE = 420,
    DATA_ID_FILE_MANAGER_IS_SORT_FILES_OPTION_AVAILABLE = 421,
    DATA_ID_DLOG_PREVIEW_OVERLAY = 422,
    DATA_ID_DLOG_ITEM_IS_AVAILABLE = 423,
    DATA_ID_MODULE_IS_RESYNC_SUPPORTED = 424,
    DATA_ID_CHANNEL_IS_CALIBRATION_VALUE_SOURCE = 425,
    DATA_ID_CALIBRATION_POINT_CAN_EDIT_SET_VALUE = 426,
    DATA_ID_CALIBRATION_POINT_LIVE_MEASURED_VALUE = 427,
    DATA_ID_AC_MAINS = 428,
    DATA_ID_SELECTED_MCU_REVISION = 429,
    DATA_ID_IS_MCU_REVISION_SELECTED = 430,
    ...
    DATA_ID_DIB_MIO168_DIN_LABEL = 437,
    DATA_ID_DIB_MIO168_DIN_LABEL_LABEL = 438,
    DATA_ID_DIB_MIO168_DIN_SPEED = 439,
    DATA_ID_DIB_MIO168_DOUT_PINS = 440,
    DATA_ID_DIB_MIO168_DOUT_PINS_1_4 = 441,
    DATA_ID_DIB_MIO168_DOUT_PINS_5_8 = 442,
    DATA_ID_DIB_MIO168_DOUT_NO = 443,
    DATA_ID_DIB_MIO168_DOUT_STATE = 444,
    DATA_ID_DIB_MIO168_DOUT_LABEL = 445,
    DATA_ID_DIB_MIO168_DOUT_LABEL_LABEL = 446,
    DATA_ID_DIB_MIO168_AIN_CHANNELS = 447,
    DATA_ID_DIB_MIO168_AIN_LABEL = 448,
    DATA_ID_DIB_MIO168_AIN_LABEL_LABEL = 449,
    DATA_ID_DIB_MIO168_AIN_VALUE = 450,
    DATA_ID_DIB_MIO168_AIN_MODE = 451,
    DATA_ID_DIB_MIO168_AIN_RANGE = 452,
    DATA_ID_DIB_MIO168_AIN_RANGE_IS_AVAILABLE = 453,
    DATA_ID_DIB_MIO168_AIN_MODE_AND_RANGE = 454,
    DATA_ID_DIB_MIO168_AIN_RANGE_IS_MULTIPLE_SELECTION_AVAILABLE = 455,
    DATA_ID_DIB_MIO168_AIN_FAULT_STATUS = 456,
    DATA_ID_DIB_MIO168_AIN_NPLC = 457,
    DATA_ID_DIB_MIO168_AIN_APERTURE = 458,
    DATA_ID_DIB_MIO168_AOUT_CHANNELS = 459,
    DATA_ID_DIB_MIO168_AOUT_LABEL = 460,
    DATA_ID_DIB_MIO168_AOUT_LABEL_LABEL = 461,
    DATA_ID_DIB_MIO168_AOUT_VALUE = 462,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_ENABLED = 463,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_MODE = 464,
    DATA_ID_DIB_MIO168_AOUT_VOLTAGE_RANGE = 465,
    DATA_ID_DIB_MIO168_AOUT_CURRENT_RANGE = 466,
    DATA_ID_DIB_MIO168_AOUT_CHANNEL_HAS_SETTINGS = 467,
    DATA_ID_DIB_MIO168_AOUT_MODE_AND_RANGE = 468,
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 469,
    DATA_ID_DIB_MIO168_PWM_LABEL = 470,
    DATA_ID_DIB_MIO168_PWM_LABEL_LABEL = 471,
    DATA_ID_DIB_MIO168_PWM_FREQ = 472,
    DATA_ID_DIB_MIO168_PWM_DUTY = 473,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 474,
    DATA_ID_DIB_MIO168_AFE_VERSION = 475,
    DATA_ID_DIB_MIO168_PAGER_LIST = 476,
    DATA_ID_DIB_MIO168_PAGER_IS_SELECTED = 477,
    DATA_ID_DIB_MIO168_PAGER_SELECTED_PAGE = 478,
    DATA_ID_DIB_PREL6_RELAYS = 479,
    DATA_ID_DIB_PREL6_RELAY_IS_ON = 480,
    DATA_ID_DIB_PREL6_RELAY_LABEL = 481,
    DATA_ID_DIB_SMX46_ROUTES = 482,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 483,
    DATA_ID_DIB_SMX46_X_LABELS = 484,
    DATA_ID_DIB_SMX46_X_LABEL = 485,
    DATA_ID_DIB_SMX46_Y_LABELS = 486,
    DATA_ID_DIB_SMX46_Y_LABEL = 487,
    DATA_ID_DIB_SMX46_DAC1 = 488,
    DATA_ID_DIB_SMX46_DAC2 = 489,
    DATA_ID_DIB_SMX46_RELAY_ON = 490,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 491,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 492,
    DATA_ID_DIB_SMX46_ANALOG_OUTPUTS = 493,
    DATA_ID_DIB_SMX46_AO_LABEL = 494,
    DATA_ID_DIB_SMX46_AO1_LABEL = 495,
    DATA_ID_DIB_SMX46_AO2_LABEL = 496,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 497,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_VIEW = 498,
    DATA_ID_DIB_DCM220_SLOT_MIN_2CH_VIEW = 499,
    DATA_ID_DIB_DCM220_SLOT_MICRO_2CH_VIEW = 500,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 501,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 502,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_VIEW = 503,
    ...
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 512,
    DATA_ID_DIB_DCM224_PWM_DUTY = 513,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 514,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 515,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 516,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 517,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_VIEW = 518,
    DATA_ID_DIB_DCM224_SLOT_MIN_2CH_VIEW = 519,
    DATA_ID_DIB_DCM224_SLOT_MICRO_2CH_VIEW = 520,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 521,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 522,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_VIEW = 523
};
...
enum ActionsEnum {
    ...
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_DISPLAY_VALUE1 = 106,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_DISPLAY_VALUE2 = 107,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_SWAP_DISPLAY_VALUES = 108,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_YTVIEW_RATE = 109,
    ACTION_ID_SYS_SETTINGS_ENCODER_TOGGLE_CONFIRMATION_MODE = 110,
    ACTION_ID_TURN_DISPLAY_OFF = 111,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_TRIGGER_MODE = 112,
    ACTION_ID_CH_SETTINGS_LISTS_EDIT_LIST_COUNT = 113,
    ACTION_ID_CH_SETTINGS_LISTS_EDIT_ON_LIST_STOP = 114,
    ACTION_ID_CHANNEL_LISTS_PREVIOUS_PAGE = 115,
    ACTION_ID_CHANNEL_LISTS_NEXT_PAGE = 116,
    ACTION_ID_CHANNEL_LISTS_EDIT = 117,
    ACTION_ID_SHOW_CHANNEL_LISTS_INSERT_MENU = 118,
    ACTION_ID_SHOW_CHANNEL_LISTS_DELETE_MENU = 119,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_ABOVE = 120,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_BELOW = 121,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROW = 122,
    ACTION_ID_CHANNEL_LISTS_CLEAR_COLUMN = 123,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROWS = 124,
    ACTION_ID_CHANNEL_LISTS_DELETE_ALL = 125,
    ACTION_ID_TRIGGER_SELECT_SOURCE = 126,
    ACTION_ID_TRIGGER_EDIT_DELAY = 127,
    ACTION_ID_TRIGGER_TOGGLE_INITIATE_CONTINUOUSLY = 128,
    ACTION_ID_TRIGGER_GENERATE_MANUAL = 129,
    ACTION_ID_TRIGGER_SHOW_GENERAL_SETTINGS = 130,
    ACTION_ID_SHOW_STAND_BY_MENU = 131,
    ACTION_ID_RESET = 132,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_SELECT_MODE = 133,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_TOGGLE_AUTO_RANGING = 134,
    ACTION_ID_IO_PIN_TOGGLE_POLARITY = 135,
    ACTION_ID_IO_PIN_SELECT_FUNCTION = 136,
    ...
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 172,
    ...
    ACTION_ID_SET_FOCUS = 206,
    ACTION_ID_SELECT_CHANNEL_CALIBRATION_VALUE_TYPE = 207,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_NEXT = 208,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_PREVIOUS = 209,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_DELETE = 210,
    ACTION_ID_CHANNEL_CALIBRATION_POINT_SAVE = 211,
    ACTION_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 212,
    ACTION_ID_CH_SETTINGS_CALIBRATION_VIEW_POINTS = 213,
    ACTION_ID_SHOW_TOUCH_CALIBRATION_INTRO = 214,
    ACTION_ID_TOGGLE_SLOT_MAX_VIEW = 215,
    ACTION_ID_SHOW_SLOT_SETTINGS = 216,
    ACTION_ID_SELECT_USB_MODE = 217,
    ACTION_ID_SELECT_USB_DEVICE_CLASS = 218,
    ACTION_ID_TOGGLE_DISPLAY_TEST_COLOR_INDEX = 219,
    ACTION_ID_SHOW_DISPLAY_TEST_PAGE = 220,
    ACTION_ID_EDIT_NTP_REFRESH_FREQUENCY = 221,
    ACTION_ID_KEYPAD_OPTION3 = 222,
    ACTION_ID_SHOW_LABELS_AND_COLORS = 223,
    ACTION_ID_CHANGE_SLOT_LABEL = 224,
    ACTION_ID_CHANGE_CHANNEL_LABEL = 225,
    ACTION_ID_SHOW_CHANNEL_COLOR_PICKER = 226,
    ACTION_ID_PICK_COLOR = 227,
    ACTION_ID_KEYPAD_SET_DEFAULT = 228,
    ACTION_ID_SHOW_SLOT_COLOR_PICKER = 229,
    ACTION_ID_PICK_DEFAULT_COLOR = 230,
    ACTION_ID_DLOG_ITEM_TOGGLE = 231,
    ACTION_ID_DLOG_TRIGGER_SELECT_SOURCE = 232,
    ACTION_ID_SELECT_MASS_STORAGE_DEVICE = 233,
    ACTION_ID_MODULE_RESYNC = 234,
    ACTION_ID_SELECT_AC_MAINS = 235,
    ACTION_ID_SHOW_SELECT_MCU_REVISION_PAGE = 236,
    ACTION_ID_SELECT_R2B4_REVISION = 237,
    ACTION_ID_SELECT_R3B3_REVISION = 238,
    ACTION_ID_SELECT_MCU_REVISION = 239,
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 240,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 241,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 242,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 243,
    ACTION_ID_DIB_MIO168_AIN_SHOW_CONFIGURATION = 244,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE = 245,
    ACTION_ID_DIB_MIO168_AIN_SELECT_RANGE = 246,
    ACTION_ID_DIB_MIO168_AIN_CHANGE_LABEL = 247,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE_AND_RANGE = 248,
    ACTION_ID_DIB_MIO168_AOUT_TOGGLE_OUTPUT_ENABLED = 249,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_OUTPUT_MODE = 250,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_VOLTAGE_RANGE = 251,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_CURRENT_RANGE = 252,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_MODE_AND_RANGE = 253,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_CONFIGURATION = 254,
    ACTION_ID_DIB_MIO168_AOUT_CHANGE_LABEL = 255,
    ACTION_ID_DIB_MIO168_SHOW_INFO = 256,
    ACTION_ID_DIB_MIO168_SHOW_CALIBRATION = 257,
    ACTION_ID_DIB_MIO168_SHOW_CHANNEL_LABELS = 258,
    ACTION_ID_DIB_MIO168_SHOW_DIN_CHANNEL_LABELS = 259,
    ACTION_ID_DIB_MIO168_SHOW_DOUT_CHANNEL_LABELS = 260,
    ACTION_ID_DIB_MIO168_CHANGE_DIN_LABEL = 261,
    ACTION_ID_DIB_MIO168_CHANGE_DOUT_LABEL = 262,
    ACTION_ID_DIB_MIO168_PWM_CHANGE_LABEL = 263,
    ACTION_ID_DIB_MIO168_PAGER_SELECT_PAGE = 264,
    ACTION_ID_DIB_PREL6_TOGGLE_RELAY = 265,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 266,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 267,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 268,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 269,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 270,
    ACTION_ID_DIB_SMX46_SHOW_DAC1_CALIBRATION = 271,
    ACTION_ID_DIB_SMX46_SHOW_DAC2_CALIBRATION = 272,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 273,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 274,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 275,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 276,
    ACTION_ID_DIB_SMX46_CHANGE_SUBCHANNEL_LABEL = 277,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 278,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 279,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 280,
    ACTION_ID_SIMULATOR_LOAD = 281,
...
extern const uint8_t assets[545817];
