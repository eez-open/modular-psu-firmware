enum DataEnum {
    ...
    DATA_ID_TRIGGER_DELAY = 198,
    DATA_ID_TRIGGER_INITIATE_CONTINUOUSLY = 199,
    DATA_ID_TRIGGER_IS_INITIATED = 200,
    DATA_ID_TRIGGER_IS_MANUAL = 201,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 202,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 203,
    DATA_ID_CHANNEL_RANGES_MODE = 204,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 205,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 206,
    DATA_ID_TEXT_MESSAGE = 207,
    DATA_ID_SERIAL_STATUS = 208,
    ...
    DATA_ID_DLOG_ALL_VALUES = 274,
    DATA_ID_DLOG_CURRENT_TIME = 275,
    DATA_ID_DLOG_FILE_LENGTH = 276,
    DATA_ID_DLOG_X_AXIS_OFFSET = 277,
    DATA_ID_DLOG_X_AXIS_DIV = 278,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 279,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 280,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 281,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 282,
    DATA_ID_DLOG_VIEW_STATE = 283,
    DATA_ID_DLOG_PERIOD = 284,
    DATA_ID_DLOG_DURATION = 285,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 286,
    DATA_ID_DLOG_CURRENT_ENABLED = 287,
    DATA_ID_DLOG_POWER_ENABLED = 288,
    DATA_ID_DLOG_START_ENABLED = 289,
    DATA_ID_DLOG_FILE_NAME = 290,
    DATA_ID_DLOG_VALUE_STATE = 291,
    DATA_ID_CHANNEL_OFF_LABEL = 292,
    DATA_ID_FILE_MANAGER_FILES = 293,
    DATA_ID_FILE_MANAGER_FILE_NAME = 294,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 295,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 296,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 297,
    DATA_ID_FILE_MANAGER_STATE = 298,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 299,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 300,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 301,
    ...
    DATA_ID_CHANNEL_SETTINGS_PAGE = 325,
    DATA_ID_IS_RESET_BY_IWDG = 326,
    DATA_ID_DLOG_ENABLED = 327,
    ...
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 368,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 369,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 370,
    DATA_ID_DEBUG_VARIABLES = 371,
    DATA_ID_DEBUG_VARIABLE_NAME = 372,
    DATA_ID_DEBUG_VARIABLE_VALUE = 373,
    DATA_ID_CHANNEL_RAMP_STATE = 374,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 375,
    DATA_ID_MQTT_IN_ERROR = 376,
    DATA_ID_DEBUG_I_DAC = 377,
    DATA_ID_DEBUG_U_DAC = 378,
    DATA_ID_DEBUG_I_DAC_AMPER = 379,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 380,
    DATA_ID_DEBUG_I_ADC = 381,
    DATA_ID_DEBUG_U_ADC = 382,
    DATA_ID_DEBUG_I_ADC_AMPER = 383,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 384,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 385,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 386,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 387,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 388,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 389,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 390,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 391,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 392,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 393,
    DATA_ID_CHANNEL_CALIBRATION_CHART = 394,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 395,
    DATA_ID_CHANNEL_CALIBRATION_CHART_ZOOM = 396,
    DATA_ID_DUMMY = 397,
    DATA_ID_SLOTS = 398,
    DATA_ID_SLOT_INDEX = 399,
    DATA_ID_SLOT_TITLE_DEF = 400,
    DATA_ID_SLOT_TITLE_MAX = 401,
    DATA_ID_SLOT_TITLE_MIN = 402,
    DATA_ID_SLOT_TITLE_MICRO = 403,
    DATA_ID_SLOT_TITLE_SETTINGS = 404,
    DATA_ID_SLOT_ERROR_MESSAGE = 405,
    DATA_ID_USB_MODE = 406,
    DATA_ID_USB_CURRENT_MODE = 407,
    DATA_ID_USB_DEVICE_CLASS = 408,
    DATA_ID_USB_KEYBOARD_STATE = 409,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 410,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 411,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 412,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 413,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 414,
    DATA_ID_SLOT_SERIAL_INFO = 415,
    DATA_ID_SLOT_IS_ENABLED = 416,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 417,
    DATA_ID_USER_SWITCH_ACTION = 418,
    DATA_ID_NTP_REFRESH_FREQUENCY = 419,
    DATA_ID_CHANNEL_CALIBRATION_IS_POWER_CHANNEL = 420,
    DATA_ID_HAS_CUSTOM_BITMAP = 421,
    DATA_ID_CUSTOM_BITMAP = 422,
    DATA_ID_SLOT_INFO_WITH_FW_VER = 423,
    DATA_ID_MASTER_INFO_WITH_FW_VER = 424,
    DATA_ID_DIB_MIO168_DIN_PINS = 425,
    DATA_ID_DIB_MIO168_DIN_PINS_1_4 = 426,
    DATA_ID_DIB_MIO168_DIN_PINS_5_8 = 427,
    DATA_ID_DIB_MIO168_DIN_NO = 428,
    DATA_ID_DIB_MIO168_DIN_STATE = 429,
    DATA_ID_DIB_MIO168_DIN_RANGE = 430,
    DATA_ID_DIB_MIO168_DIN_SPEED = 431,
    DATA_ID_DIB_MIO168_DOUT_PINS = 432,
    DATA_ID_DIB_MIO168_DOUT_NO = 433,
    DATA_ID_DIB_MIO168_DOUT_STATE = 434,
    DATA_ID_DIB_MIO168_AIN_CHANNELS = 435,
    DATA_ID_DIB_MIO168_AIN_LABEL = 436,
    DATA_ID_DIB_MIO168_AIN_VALUE = 437,
    DATA_ID_DIB_MIO168_AIN_MODE = 438,
    DATA_ID_DIB_MIO168_AIN_RANGE = 439,
    DATA_ID_DIB_MIO168_AIN_HAS_TEMP_SENSOR_BIAS_FEATURE = 440,
    DATA_ID_DIB_MIO168_AIN_TEMP_SENSOR_BIAS = 441,
    DATA_ID_DIB_MIO168_AOUT_CHANNELS = 442,
    DATA_ID_DIB_MIO168_AOUT_LABEL = 443,
    DATA_ID_DIB_MIO168_AOUT_VALUE = 444,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_ENABLED = 445,
    DATA_ID_DIB_MIO168_AOUT_OUTPUT_MODE = 446,
    DATA_ID_DIB_MIO168_AOUT_VOLTAGE_RANGE = 447,
    DATA_ID_DIB_MIO168_AOUT_CURRENT_RANGE = 448,
    DATA_ID_DIB_MIO168_AOUT_CHANNEL_HAS_SETTINGS = 449,
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 450,
    DATA_ID_DIB_MIO168_PWM_LABEL = 451,
    DATA_ID_DIB_MIO168_PWM_FREQ = 452,
    DATA_ID_DIB_MIO168_PWM_DUTY = 453,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 454,
    DATA_ID_DIB_SMX46_ROUTES = 455,
    DATA_ID_DIB_SMX46_ROUTE_OPEN = 456,
    DATA_ID_DIB_SMX46_X_LABELS = 457,
    DATA_ID_DIB_SMX46_X_LABEL = 458,
    DATA_ID_DIB_SMX46_Y_LABELS = 459,
    DATA_ID_DIB_SMX46_Y_LABEL = 460,
    DATA_ID_DIB_SMX46_DAC1 = 461,
    DATA_ID_DIB_SMX46_DAC2 = 462,
    DATA_ID_DIB_SMX46_RELAY_ON = 463,
    DATA_ID_DIB_SMX46_SIGNAL_RELAY_CYCLES = 464,
    DATA_ID_DIB_SMX46_POWER_RELAY_CYCLES = 465,
    DATA_ID_DIB_DCM220_SLOT_DEF_2CH_VIEW = 466,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_VIEW = 467,
    DATA_ID_DIB_DCM220_SLOT_MIN_2CH_VIEW = 468,
    DATA_ID_DIB_DCM220_SLOT_MICRO_2CH_VIEW = 469,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH1_INDEX = 470,
    DATA_ID_DIB_DCM220_SLOT_2CH_CH2_INDEX = 471,
    DATA_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_VIEW = 472,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 473,
    DATA_ID_SIMULATOR_LOAD_STATE = 474,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 475,
    DATA_ID_SIMULATOR_LOAD = 476,
    DATA_ID_SIMULATOR_LOAD2 = 477,
    DATA_ID_MAIN_APP_VIEW = 478,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 479,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 480,
    DATA_ID_DIB_DCM224_PWM_FREQUENCY = 481,
    DATA_ID_DIB_DCM224_PWM_DUTY = 482,
    DATA_ID_DIB_DCM224_COUNTERPHASE_FREQUENCY = 483,
    DATA_ID_DIB_DCM224_COUNTERPHASE_DITHERING = 484,
    DATA_ID_DIB_DCM224_PWM_ENABLED = 485,
    DATA_ID_DIB_DCM224_SLOT_DEF_2CH_VIEW = 486,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_VIEW = 487,
    DATA_ID_DIB_DCM224_SLOT_MIN_2CH_VIEW = 488,
    DATA_ID_DIB_DCM224_SLOT_MICRO_2CH_VIEW = 489,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH1_INDEX = 490,
    DATA_ID_DIB_DCM224_SLOT_2CH_CH2_INDEX = 491,
    DATA_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_VIEW = 492
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_LABELS_AND_COLORS = 229,
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 230,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 231,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 232,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 233,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_TEMP_SENSOR_BIAS = 234,
    ACTION_ID_DIB_MIO168_AIN_SHOW_CONFIGURATION = 235,
    ACTION_ID_DIB_MIO168_AIN_SELECT_MODE = 236,
    ACTION_ID_DIB_MIO168_AIN_SELECT_RANGE = 237,
    ACTION_ID_DIB_MIO168_AOUT_TOGGLE_OUTPUT_ENABLED = 238,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_OUTPUT_MODE = 239,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_VOLTAGE_RANGE = 240,
    ACTION_ID_DIB_MIO168_AOUT_SELECT_CURRENT_RANGE = 241,
    ACTION_ID_DIB_MIO168_AOUT_SHOW_CONFIGURATION = 242,
    ACTION_ID_DIB_MIO168_SHOW_INFO = 243,
    ACTION_ID_DIB_MIO168_SHOW_CALIBRATION = 244,
    ACTION_ID_DIB_SMX46_TOGGLE_ROUTE = 245,
    ACTION_ID_DIB_SMX46_TOGGLE_RELAY = 246,
    ACTION_ID_DIB_SMX46_SHOW_CONFIGURE_ROUTES = 247,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_ROUTES = 248,
    ACTION_ID_DIB_SMX46_CLEAR_ALL_LABELS = 249,
    ACTION_ID_DIB_SMX46_SHOW_DAC1_CALIBRATION = 250,
    ACTION_ID_DIB_SMX46_SHOW_DAC2_CALIBRATION = 251,
    ACTION_ID_DIB_SMX46_SHOW_INFO = 252,
    ACTION_ID_DIB_SMX46_SHOW_RELAY_CYCLES = 253,
    ACTION_ID_DIB_SMX46_EDIT_Y_LABEL = 254,
    ACTION_ID_DIB_SMX46_EDIT_X_LABEL = 255,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT1 = 256,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT2 = 257,
    ACTION_ID_FRONT_PANEL_SELECT_SLOT3 = 258,
    ACTION_ID_SIMULATOR_LOAD = 259,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 260,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 261
};
...
enum StylesEnum {
    ...
    STYLE_ID_INLINE58 = 58,
    STYLE_ID_INLINE59 = 59,
    STYLE_ID_INLINE60 = 60,
    STYLE_ID_INLINE61 = 61,
    STYLE_ID_VALUE_S = 62,
    ...
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 138,
    STYLE_ID_INLINE139 = 139,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 140,
    STYLE_ID_ENCODER_CURSOR_17_ENABLED = 141,
    STYLE_ID_INLINE142 = 142,
    STYLE_ID_YT_GRAPH = 143,
    STYLE_ID_LIST_GRAPH_CURSOR = 144,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 145,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 146,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 147,
    STYLE_ID_INLINE148 = 148,
    STYLE_ID_INLINE149 = 149,
    STYLE_ID_INLINE150 = 150,
    STYLE_ID_EDIT_VALUE_M_CENTERED = 151,
    STYLE_ID_INLINE152 = 152,
    STYLE_ID_INLINE153 = 153,
    STYLE_ID_INLINE154 = 154,
    STYLE_ID_BUTTON_S_DISABLED = 155,
    STYLE_ID_INLINE156 = 156,
    STYLE_ID_INLINE157 = 157,
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 158,
    STYLE_ID_INLINE159 = 159,
    STYLE_ID_EVENT_ERROR = 160,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 161,
    STYLE_ID_INLINE162 = 162,
    STYLE_ID_ICON_AND_TEXT_S = 163,
    STYLE_ID_INLINE164 = 164,
    STYLE_ID_INLINE165 = 165,
    STYLE_ID_VALUE_M = 166,
    STYLE_ID_INLINE167 = 167,
    STYLE_ID_INLINE168 = 168,
    STYLE_ID_DEFAULT_DISABLED = 169,
    ...
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 228,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 229,
    STYLE_ID_SCROLLBAR_TRACK = 230,
    ...
    STYLE_ID_FRONT_PANEL_MODULE = 276,
    ...
    STYLE_ID_INST_SELECTED = 323,
    STYLE_ID_MON_VALUE_38_RIGHT = 324,
    STYLE_ID_INLINE325 = 325,
    STYLE_ID_CH_PROT_OFF = 326,
    STYLE_ID_CH_PROT_ON = 327,
    STYLE_ID_CH_PROT_TRIPPED = 328,
    STYLE_ID_INLINE329 = 329,
    STYLE_ID_MON_VALUE_20_RIGHT = 330,
    STYLE_ID_MON_VALUE_14_LEFT = 331,
    STYLE_ID_MON_VALUE_14_CENTER = 332,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 333,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 334,
    STYLE_ID_MON_VALUE_14_RIGHT = 335,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 336,
    STYLE_ID_MON_VALUE_24_RIGHT = 337,
...
enum PagesEnum {
    ...
    PAGE_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 117,
    ...
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 122,
    ...
    PAGE_ID_DIB_PREL6_SIMULATOR_FRONT_PANEL_MASK = 129,
    ...
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 135,
    ...
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 145,
    ...
    PAGE_ID_FRONT_PANEL = 217,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 218,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 219,
    PAGE_ID_DIB_DCM224_SIMULATOR_FRONT_PANEL_MASK = 220,
    PAGE_ID_DIB_DCM224_FRONT_PANEL_LED = 221,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ERROR = 222,
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ADV_OPTIONS = 223,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT = 224,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_2COL = 225,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON = 226,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_ON_2COL = 227,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF = 228,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_VERT_OFF_2COL = 229,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ = 230,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_2COL = 231,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON = 232,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_ON_2COL = 233,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF = 234,
    PAGE_ID_DIB_DCM224_SLOT_DEF_2CH_HORZ_OFF_2COL = 235,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH = 236,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_TITLE = 237,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_NUM_ON = 238,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_OFF = 239,
    ...
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_ON = 243,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_ON = 244,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_YT_OFF = 245,
    PAGE_ID_DIB_DCM224_SLOT_MAX_2CH_MIN_TITLE = 246,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_TITLE = 247,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH = 248,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_ON = 249,
    PAGE_ID_DIB_DCM224_SLOT_MIN_2CH_OFF = 250,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH = 251,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_TITLE = 252,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_ON = 253,
    PAGE_ID_DIB_DCM224_SLOT_MICRO_2CH_OFF = 254
};

extern const uint8_t assets[539815];
