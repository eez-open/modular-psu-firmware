enum DataEnum {
    ...
    DATA_ID_SLOT1_INFO = 234,
    DATA_ID_SLOT2_INFO = 235,
    DATA_ID_SLOT3_INFO = 236,
    DATA_ID_SLOT1_TEST_RESULT = 237,
    DATA_ID_SLOT2_TEST_RESULT = 238,
    DATA_ID_SLOT3_TEST_RESULT = 239,
    DATA_ID_SLOT1_DEFAULT_VIEW = 240,
    DATA_ID_SLOT2_DEFAULT_VIEW = 241,
    DATA_ID_SLOT3_DEFAULT_VIEW = 242,
    DATA_ID_SLOT1_CHANNEL_INDEX = 243,
    DATA_ID_SLOT2_CHANNEL_INDEX = 244,
    DATA_ID_SLOT3_CHANNEL_INDEX = 245,
    DATA_ID_SLOT_DEF_2CH_VIEW = 246,
    DATA_ID_SLOT_MAX_2CH_VIEW = 247,
    DATA_ID_SLOT_MIN_2CH_VIEW = 248,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 249,
    DATA_ID_SLOT_2CH_CH1_INDEX = 250,
    DATA_ID_SLOT_2CH_CH2_INDEX = 251,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 252,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 253,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 254,
    DATA_ID_BATTERY = 255,
    DATA_ID_IO_PIN_STATE = 256,
    DATA_ID_CHANNEL_DPROG = 257,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 258,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 259,
    DATA_ID_SYS_INFO_HAS_ERROR = 260,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 261,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 262,
    DATA_ID_SYS_FAN_MODE = 263,
    DATA_ID_SYS_FAN_SPEED = 264,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 265,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 266,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 267,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 268,
    DATA_ID_IS_TRACKING_ALLOWED = 269,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 270,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 271,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 272,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 273,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 274,
    DATA_ID_IS_COUPLED_OR_TRACKED = 275,
    DATA_ID_OVERLAY = 276,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 277,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 278,
    DATA_ID_DLOG_STATE = 279,
    DATA_ID_DLOG_TOGGLE_STATE = 280,
    DATA_ID_RECORDING = 281,
    DATA_ID_CHANNEL_HISTORY_VALUES = 282,
    DATA_ID_RECORDING_READY = 283,
    DATA_ID_NONDRAG_OVERLAY = 284,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 285,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 286,
    DATA_ID_DLOG_VISIBLE_VALUES = 287,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 288,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 289,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 290,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 291,
    DATA_ID_DLOG_ALL_VALUES = 292,
    DATA_ID_DLOG_CURRENT_TIME = 293,
    DATA_ID_DLOG_FILE_LENGTH = 294,
    DATA_ID_DLOG_X_AXIS_OFFSET = 295,
    DATA_ID_DLOG_X_AXIS_DIV = 296,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 297,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 298,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 299,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 300,
    DATA_ID_DLOG_VIEW_STATE = 301,
    DATA_ID_DLOG_PERIOD = 302,
    DATA_ID_DLOG_DURATION = 303,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 304,
    DATA_ID_DLOG_CURRENT_ENABLED = 305,
    DATA_ID_DLOG_POWER_ENABLED = 306,
    DATA_ID_DLOG_START_ENABLED = 307,
    DATA_ID_DLOG_FILE_NAME = 308,
    DATA_ID_DLOG_VALUE_STATE = 309,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 310,
    DATA_ID_CHANNEL_OFF_LABEL = 311,
    DATA_ID_FILE_MANAGER_FILES = 312,
    DATA_ID_FILE_MANAGER_FILE_NAME = 313,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 314,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 315,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 316,
    DATA_ID_FILE_MANAGER_STATE = 317,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 318,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 319,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 320,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 321,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 322,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 323,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 324,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 325,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 326,
    DATA_ID_SCRIPT_INFO = 327,
    DATA_ID_SCRIPT_IS_STARTED = 328,
    DATA_ID_KEYPAD_OK_ENABLED = 329,
    DATA_ID_ETHERNET_HOST_NAME = 330,
    DATA_ID_MQTT_HOST = 331,
    DATA_ID_MQTT_PORT = 332,
    DATA_ID_MQTT_USERNAME = 333,
    DATA_ID_MQTT_PASSWORD = 334,
    DATA_ID_MQTT_PERIOD = 335,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 336,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 337,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 338,
    DATA_ID_LIST_COUNTER_LABEL = 339,
    DATA_ID_RAMP_COUNTER_LABEL = 340,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 341,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 342,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 343,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 344,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 345,
    DATA_ID_IS_RESET_BY_IWDG = 346,
    DATA_ID_DLOG_ENABLED = 347,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 348,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 349,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 350,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 351,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 352,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 353,
    DATA_ID_DATE_TIME_FORMAT = 354,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 355,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 356,
    DATA_ID_DATE_TIME_AM_PM = 357,
    DATA_ID_IS_MULTI_TRACKING = 358,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 359,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 360,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 361,
    DATA_ID_CHANNEL_INFO_BRAND = 362,
    DATA_ID_CHANNEL_INFO_SERIAL = 363,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 364,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 365,
    DATA_ID_FILE_MANAGER_FILE_ICON = 366,
    DATA_ID_FILE_MANAGER_LAYOUT = 367,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 368,
    DATA_ID_TOUCH_RAW_X = 369,
    DATA_ID_TOUCH_RAW_Y = 370,
    DATA_ID_TOUCH_RAW_Z1 = 371,
    DATA_ID_TOUCH_RAW_PRESSED = 372,
    DATA_ID_TOUCH_CALIBRATED_X = 373,
    DATA_ID_TOUCH_CALIBRATED_Y = 374,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 375,
    DATA_ID_TOUCH_FILTERED_X = 376,
    DATA_ID_TOUCH_FILTERED_Y = 377,
    DATA_ID_TOUCH_FILTERED_PRESSED = 378,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 379,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 380,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 381,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 382,
    DATA_ID_ALERT_MESSAGE_IS_SET = 383,
    DATA_ID_ASYNC_PROGRESS = 384,
    DATA_ID_IO_PIN_FUNCTION = 385,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 386,
    DATA_ID_IO_PIN_PWM_DUTY = 387,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 388,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 389,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 390,
    DATA_ID_DEBUG_VARIABLES = 391,
    DATA_ID_DEBUG_VARIABLE_NAME = 392,
    DATA_ID_DEBUG_VARIABLE_VALUE = 393,
    DATA_ID_CHANNEL_RAMP_STATE = 394,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 395,
    DATA_ID_MQTT_IN_ERROR = 396,
    DATA_ID_DEBUG_I_DAC = 397,
    DATA_ID_DEBUG_U_DAC = 398,
    DATA_ID_DEBUG_I_DAC_AMPER = 399,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 400,
    DATA_ID_DEBUG_I_ADC = 401,
    DATA_ID_DEBUG_U_ADC = 402,
    DATA_ID_DEBUG_I_ADC_AMPER = 403,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 404,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 405,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 406,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 407,
...
enum PagesEnum {
    ...
    PAGE_ID_CH_SETTINGS_DCM220_SPECIFIC = 31,
    PAGE_ID_CH_SETTINGS_PROT_CLEAR = 32,
    PAGE_ID_CH_SETTINGS_PROT_OVP = 33,
    PAGE_ID_CH_SETTINGS_PROT_OCP = 34,
    PAGE_ID_CH_SETTINGS_PROT_OPP = 35,
    PAGE_ID_CH_SETTINGS_PROT_OTP = 36,
    PAGE_ID_CH_SETTINGS_TRIGGER = 37,
    PAGE_ID_CH_SETTINGS_LISTS = 38,
    PAGE_ID_CH_SETTINGS_LISTS_INSERT_MENU = 39,
    PAGE_ID_CH_SETTINGS_LISTS_FILE_MENU = 40,
    PAGE_ID_CH_SETTINGS_LISTS_DELETE_MENU = 41,
    PAGE_ID_CH_SETTINGS_CALIBRATION = 42,
    PAGE_ID_CH_SETTINGS_CALIBRATION_EDIT = 43,
    PAGE_ID_CH_SETTINGS_CALIBRATION_VIEW = 44,
    ...
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 81,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 82,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 83,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 84,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF = 85,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 86,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 87,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 88,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 89,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 90,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 91,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 92,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON = 93,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF = 94,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 95,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 96,
    PAGE_ID_SLOT_DEF_2CH_VERT = 97,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON = 98,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF = 99,
    PAGE_ID_SLOT_DEF_VERT_ERROR = 100,
    PAGE_ID_SLOT_DEF_VERT_NOT_INSTALLED = 101,
    PAGE_ID_SLOT_DEF_HORZ = 102,
    PAGE_ID_SLOT_DEF_HORZ_TITLE = 103,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON = 104,
    PAGE_ID_SLOT_DEF_1CH_YT_ON = 105,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF = 106,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 107,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 108,
    PAGE_ID_SLOT_DEF_2CH_HORZ = 109,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON = 110,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF = 111,
    PAGE_ID_SLOT_DEF_HORZ_ERROR = 112,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED = 113,
    PAGE_ID_SLOT_MAX_1CH_TITLE = 114,
    PAGE_ID_SLOT_MAX_1CH_NUM_ON = 115,
    PAGE_ID_SLOT_MAX_1CH_NUM_OFF = 116,
    PAGE_ID_SLOT_MAX_1CH_HBAR_ON = 117,
    PAGE_ID_SLOT_MAX_1CH_HBAR_OFF = 118,
    PAGE_ID_SLOT_MAX_1CH_YT_ON = 119,
    PAGE_ID_SLOT_MAX_1CH_YT_OFF = 120,
    PAGE_ID_SLOT_MAX_2CH = 121,
    PAGE_ID_SLOT_MAX_2CH_TITLE = 122,
    PAGE_ID_SLOT_MAX_2CH_NUM_ON = 123,
    PAGE_ID_SLOT_MAX_2CH_NUM_OFF = 124,
    PAGE_ID_SLOT_MAX_2CH_HBAR_ON = 125,
    PAGE_ID_SLOT_MAX_2CH_HBAR_OFF = 126,
    PAGE_ID_SLOT_MAX_2CH_YT_ON = 127,
    PAGE_ID_SLOT_MAX_2CH_YT_OFF = 128,
    PAGE_ID_SLOT_MAX_2CH_MIN_TITLE = 129,
    PAGE_ID_SLOT_MAX_2CH_MIN_ON = 130,
    PAGE_ID_SLOT_MAX_2CH_MIN_OFF = 131,
    PAGE_ID_SLOT_MAX_ERROR = 132,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 133,
    PAGE_ID_SLOT_MIN_1CH_TITLE = 134,
    PAGE_ID_SLOT_MIN_1CH_ON = 135,
    PAGE_ID_SLOT_MIN_1CH_OFF = 136,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_SERIES = 137,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_PARALLEL = 138,
    PAGE_ID_SLOT_MIN_2CH_TITLE = 139,
    PAGE_ID_SLOT_MIN_2CH = 140,
    PAGE_ID_SLOT_MIN_2CH_ON = 141,
    PAGE_ID_SLOT_MIN_2CH_OFF = 142,
    PAGE_ID_SLOT_MIN_ERROR = 143,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 144,
    PAGE_ID_SLOT_MICRO_1CH_TITLE = 145,
    PAGE_ID_SLOT_MICRO_1CH_ON = 146,
    PAGE_ID_SLOT_MICRO_1CH_OFF = 147,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_SERIES = 148,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_PARALLEL = 149,
    PAGE_ID_SLOT_MICRO_2CH = 150,
    PAGE_ID_SLOT_MICRO_2CH_TITLE = 151,
    PAGE_ID_SLOT_MICRO_2CH_ON = 152,
    PAGE_ID_SLOT_MICRO_2CH_OFF = 153,
    PAGE_ID_SLOT_MICRO_ERROR = 154,
    PAGE_ID_SLOT_MICRO_NOT_INSTALLED = 155,
    PAGE_ID_DLOG_VIEW = 156,
    PAGE_ID_IMAGE_VIEW = 157,
    PAGE_ID_DLOG_PARAMS = 158,
    PAGE_ID_DLOG_VIEW_OVERLAY_OPTIONS = 159,
    PAGE_ID_FILE_MANAGER = 160,
    PAGE_ID_FILE_BROWSER = 161,
    PAGE_ID_FILE_MENU = 162,
    PAGE_ID_FRONT_PANEL = 163,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 164,
    PAGE_ID_DCP405_FRONT_PANEL = 165,
