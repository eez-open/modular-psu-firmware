enum DataEnum {
    ...
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 496,
    DATA_ID_SIMULATOR_LOAD_STATE = 497,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 498,
    DATA_ID_SIMULATOR_LOAD = 499,
    DATA_ID_SIMULATOR_LOAD2 = 500,
    DATA_ID_MAIN_APP_VIEW = 501,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 502,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 503,
...
extern const uint8_t assets[541731];
