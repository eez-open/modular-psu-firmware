...
enum StylesEnum {
    ...
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 225,
    STYLE_ID_INST_SELECTED = 226,
    STYLE_ID_MON_VALUE_38_RIGHT = 227,
    STYLE_ID_INLINE228 = 228,
    STYLE_ID_CH_PROT_OFF = 229,
    STYLE_ID_CH_PROT_ON = 230,
    STYLE_ID_CH_PROT_TRIPPED = 231,
    STYLE_ID_INLINE232 = 232,
    STYLE_ID_MON_VALUE_24_RIGHT = 233,
    STYLE_ID_MON_VALUE_14_CENTER = 234,
    STYLE_ID_INLINE235 = 235,
    STYLE_ID_INLINE236 = 236,
    STYLE_ID_INLINE237 = 237,
    STYLE_ID_INLINE238 = 238,
    STYLE_ID_INLINE239 = 239,
    STYLE_ID_MON_VALUE_20_RIGHT = 240,
    STYLE_ID_MON_VALUE_14_LEFT = 241,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 242,
    STYLE_ID_INLINE243 = 243,
    STYLE_ID_INLINE244 = 244,
    STYLE_ID_INLINE245 = 245,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 246,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 247,
    STYLE_ID_SCROLLBAR_TRACK = 248,
