enum DataEnum {
    ...
    DATA_ID_APPLICATIONS = 232,
    DATA_ID_APPLICATION_TITLE = 233,
    DATA_ID_APPLICATION_ICON = 234,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 235,
    DATA_ID_FOREGROUND_APPLICATION = 236,
    DATA_ID_FOREGROUND_APPLICATION_TITLE = 237,
    DATA_ID_TOUCH_CALIBRATION_POINT = 238,
    DATA_ID_SLOTS = 239,
    DATA_ID_SLOT_MODULE_TYPE = 240,
    DATA_ID_SIMULATOR_LOAD_STATE = 241,
...
extern const uint8_t assets[268752];
