enum DataEnum {
    ...
    DATA_ID_DIB_MIO168_INPUTS = 417,
    DATA_ID_DIB_MIO168_INPUT_NO = 418,
    DATA_ID_DIB_MIO168_INPUT_STATE = 419,
    DATA_ID_DIB_MIO168_OUTPUTS = 420,
    DATA_ID_DIB_MIO168_OUTPUT_NO = 421,
    DATA_ID_DIB_MIO168_OUTPUT_STATE = 422,
    DATA_ID_DIB_MIO168_ANALOG_INPUTS = 423,
    DATA_ID_DIB_MIO168_ANALOG_INPUT_VALUE = 424,
    DATA_ID_DIB_SMX46_OUTPUTS = 425,
    DATA_ID_FRONT_PANEL_SLOT1_VIEW = 426,
    DATA_ID_SIMULATOR_LOAD_STATE = 427,
    DATA_ID_SIMULATOR_LOAD_STATE2 = 428,
    DATA_ID_SIMULATOR_LOAD = 429,
    DATA_ID_SIMULATOR_LOAD2 = 430,
    DATA_ID_MAIN_APP_VIEW = 431,
    DATA_ID_FRONT_PANEL_SLOT2_VIEW = 432,
    DATA_ID_FRONT_PANEL_SLOT3_VIEW = 433
};
...
enum StylesEnum {
    ...
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 216,
    STYLE_ID_INST_SELECTED = 217,
    STYLE_ID_MON_VALUE_38_RIGHT = 218,
    STYLE_ID_INLINE219 = 219,
    STYLE_ID_CH_PROT_OFF = 220,
    STYLE_ID_CH_PROT_ON = 221,
    STYLE_ID_CH_PROT_TRIPPED = 222,
    STYLE_ID_INLINE223 = 223,
    STYLE_ID_MON_VALUE_24_RIGHT = 224,
    STYLE_ID_MON_VALUE_14_CENTER = 225,
...
enum PagesEnum {
    ...
    PAGE_ID_SLOT_DEF_1CH_NUM_ON = 79,
    PAGE_ID_SLOT_DEF_1CH_NUM_ON_2COL = 80,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON = 81,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON_2COL = 82,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF = 83,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF_2COL = 84,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 85,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES_2COL = 86,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 87,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL_2COL = 88,
    PAGE_ID_SLOT_DEF_2CH_VERT = 89,
    PAGE_ID_SLOT_DEF_2CH_VERT_2COL = 90,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON = 91,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON_2COL = 92,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF = 93,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF_2COL = 94,
    PAGE_ID_SLOT_DEF_VERT_ERROR = 95,
    PAGE_ID_SLOT_DEF_VERT_ERROR_2COL = 96,
    PAGE_ID_SLOT_DEF_VERT_NOT_INSTALLED = 97,
    PAGE_ID_SLOT_DEF_VERT_NOT_INSTALLED_2COL = 98,
    PAGE_ID_SLOT_DEF_HORZ = 99,
    PAGE_ID_SLOT_DEF_HORZ_TITLE = 100,
    PAGE_ID_SLOT_DEF_HORZ_TITLE_2COL = 101,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON = 102,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON_2COL = 103,
    PAGE_ID_SLOT_DEF_1CH_YT_ON = 104,
    PAGE_ID_SLOT_DEF_1CH_YT_ON_2COL = 105,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF = 106,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF_2COL = 107,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 108,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES_2COL = 109,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 110,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL_2COL = 111,
    PAGE_ID_SLOT_DEF_2CH_HORZ = 112,
    PAGE_ID_SLOT_DEF_2CH_HORZ_2COL = 113,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON = 114,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON_2COL = 115,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF = 116,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF_2COL = 117,
    PAGE_ID_SLOT_DEF_HORZ_ERROR = 118,
    PAGE_ID_SLOT_DEF_HORZ_ERROR_2COL = 119,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED = 120,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED_2COL = 121,
    PAGE_ID_SLOT_MAX_1CH_TITLE = 122,
    PAGE_ID_SLOT_MAX_1CH_NUM_ON = 123,
    PAGE_ID_SLOT_MAX_1CH_NUM_OFF = 124,
    PAGE_ID_SLOT_MAX_1CH_HBAR_ON = 125,
    PAGE_ID_SLOT_MAX_1CH_HBAR_OFF = 126,
    PAGE_ID_SLOT_MAX_1CH_YT_ON = 127,
    PAGE_ID_SLOT_MAX_1CH_YT_OFF = 128,
    PAGE_ID_SLOT_MAX_2CH = 129,
    PAGE_ID_SLOT_MAX_2CH_TITLE = 130,
    PAGE_ID_SLOT_MAX_2CH_NUM_ON = 131,
    PAGE_ID_SLOT_MAX_2CH_NUM_OFF = 132,
    PAGE_ID_SLOT_MAX_2CH_HBAR_ON = 133,
    PAGE_ID_SLOT_MAX_2CH_HBAR_OFF = 134,
    PAGE_ID_SLOT_MAX_2CH_YT_ON = 135,
    PAGE_ID_SLOT_MAX_2CH_YT_OFF = 136,
    PAGE_ID_SLOT_MAX_2CH_MIN_TITLE = 137,
    PAGE_ID_SLOT_MAX_2CH_MIN_ON = 138,
    PAGE_ID_SLOT_MAX_2CH_MIN_OFF = 139,
    PAGE_ID_SLOT_MAX_ERROR = 140,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 141,
    PAGE_ID_SLOT_MIN_1CH_TITLE = 142,
    PAGE_ID_SLOT_MIN_1CH_ON = 143,
    PAGE_ID_SLOT_MIN_1CH_OFF = 144,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_SERIES = 145,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_PARALLEL = 146,
    PAGE_ID_SLOT_MIN_2CH_TITLE = 147,
    PAGE_ID_SLOT_MIN_2CH = 148,
    PAGE_ID_SLOT_MIN_2CH_ON = 149,
    PAGE_ID_SLOT_MIN_2CH_OFF = 150,
    PAGE_ID_SLOT_MIN_ERROR = 151,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 152,
    PAGE_ID_SLOT_MICRO_1CH_TITLE = 153,
    PAGE_ID_SLOT_MICRO_1CH_ON = 154,
    PAGE_ID_SLOT_MICRO_1CH_OFF = 155,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_SERIES = 156,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_PARALLEL = 157,
    PAGE_ID_SLOT_MICRO_2CH = 158,
    PAGE_ID_SLOT_MICRO_2CH_TITLE = 159,
    PAGE_ID_SLOT_MICRO_2CH_ON = 160,
    PAGE_ID_SLOT_MICRO_2CH_OFF = 161,
    PAGE_ID_SLOT_MICRO_ERROR = 162,
    PAGE_ID_SLOT_MICRO_NOT_INSTALLED = 163,
    PAGE_ID_DLOG_VIEW = 164,
    PAGE_ID_IMAGE_VIEW = 165,
    PAGE_ID_DLOG_PARAMS = 166,
    PAGE_ID_DLOG_VIEW_OVERLAY_OPTIONS = 167,
    PAGE_ID_FILE_MANAGER = 168,
    PAGE_ID_FILE_BROWSER = 169,
    PAGE_ID_FILE_MENU = 170,
    ...
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF_2COL = 181,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 182,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 183,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 184,
    PAGE_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 185,
    PAGE_ID_DIB_PREL6_SIMULATOR_FRONT_PANEL_MASK = 186,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF = 187,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_2COL = 188,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 189,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 190,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 191,
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 192,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 193,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL = 194,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 195,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 196,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 197,
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 198,
    PAGE_ID_DIB_DCP405_CH_SETTINGS_SPECIFIC = 199,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM220 = 200,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM224 = 201,
    PAGE_ID_DIB_DCM220_DCM220_FRONT_PANEL_LED = 202,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_ERROR = 203,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_SPECIFIC = 204,
    PAGE_ID_FRONT_PANEL = 205,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 206,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 207
};

extern const uint8_t assets[521928];
