...
enum PagesEnum {
    ...
    PAGE_ID_DIB_MIO168_SIMULATOR_FRONT_PANEL_MASK = 173,
    PAGE_ID_DIB_PREL6_SIMULATOR_FRONT_PANEL_MASK = 174,
    PAGE_ID_DIB_SMX46_SIMULATOR_FRONT_PANEL_MASK = 175,
    PAGE_ID_DIB_DCP405_SIMULATOR_FRONT_PANEL_MASK = 176,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM220 = 177,
    PAGE_ID_DIB_DCM220_SIMULATOR_FRONT_PANEL_MASK_DCM224 = 178,
    PAGE_ID_DIB_DCM220_DCM220_FRONT_PANEL_LED = 179,
    PAGE_ID_FRONT_PANEL = 180,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 181,
    PAGE_ID_FRONT_PANEL_NUMERIC_KEYPAD = 182
};

extern const uint8_t assets[517521];
