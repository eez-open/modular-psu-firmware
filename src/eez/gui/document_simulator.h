enum DataEnum {
    ...
    DATA_ID_CAL_CH_U_MIN = 72,
    DATA_ID_CAL_CH_U_MID = 73,
    DATA_ID_CAL_CH_U_MAX = 74,
    DATA_ID_CAL_CH_I0_MIN = 75,
    DATA_ID_CAL_CH_I0_MID = 76,
    DATA_ID_CAL_CH_I0_MAX = 77,
    DATA_ID_CAL_CH_I1_MIN = 78,
    DATA_ID_CAL_CH_I1_MID = 79,
    DATA_ID_CAL_CH_I1_MAX = 80,
    DATA_ID_CHANNEL_PROTECTION_STATUS = 81,
    DATA_ID_CHANNEL_PROTECTION_OVP_STATE = 82,
    DATA_ID_CHANNEL_PROTECTION_OVP_TYPE = 83,
    DATA_ID_CHANNEL_PROTECTION_OVP_LEVEL = 84,
    DATA_ID_CHANNEL_PROTECTION_OVP_DELAY = 85,
    DATA_ID_CHANNEL_PROTECTION_OVP_LIMIT = 86,
    DATA_ID_CHANNEL_PROTECTION_OCP_STATE = 87,
    DATA_ID_CHANNEL_PROTECTION_OCP_DELAY = 88,
    DATA_ID_CHANNEL_PROTECTION_OCP_LIMIT = 89,
    DATA_ID_CHANNEL_PROTECTION_OCP_MAX_CURRENT_LIMIT_CAUSE = 90,
    DATA_ID_CHANNEL_PROTECTION_OPP_STATE = 91,
    DATA_ID_CHANNEL_PROTECTION_OPP_LEVEL = 92,
    DATA_ID_CHANNEL_PROTECTION_OPP_DELAY = 93,
    DATA_ID_CHANNEL_PROTECTION_OPP_LIMIT = 94,
    DATA_ID_CHANNEL_PROTECTION_OTP_INSTALLED = 95,
    DATA_ID_CHANNEL_PROTECTION_OTP_STATE = 96,
    DATA_ID_CHANNEL_PROTECTION_OTP_LEVEL = 97,
    DATA_ID_CHANNEL_PROTECTION_OTP_DELAY = 98,
    DATA_ID_EVENT_QUEUE_LAST_EVENT_TYPE = 99,
    DATA_ID_EVENT_QUEUE_EVENTS = 100,
    DATA_ID_EVENT_QUEUE_EVENT_TYPE = 101,
    DATA_ID_EVENT_QUEUE_EVENT_MESSAGE = 102,
    DATA_ID_EVENT_QUEUE_SELECTED_EVENT_MESSAGE = 103,
    DATA_ID_CHANNEL_RSENSE_STATUS = 104,
    DATA_ID_CHANNEL_RPROG_INSTALLED = 105,
    DATA_ID_CHANNEL_RPROG_STATUS = 106,
    DATA_ID_CHANNEL_TRACKING_IS_ENABLED = 107,
    DATA_ID_CHANNEL_TRACKING_IS_ALLOWED = 108,
    DATA_ID_CHANNEL_IS_PAR_SER_COUPLED_OR_TRACKED = 109,
    DATA_ID_COUPLING_TYPE = 110,
    DATA_ID_CHANNEL_COUPLING_IS_SERIES = 111,
    DATA_ID_SYS_ON_TIME_TOTAL = 112,
    DATA_ID_SYS_ON_TIME_LAST = 113,
    DATA_ID_SYS_TEMP_AUX_STATUS = 114,
    DATA_ID_SYS_TEMP_AUX_OTP_STATE = 115,
    DATA_ID_SYS_TEMP_AUX_OTP_LEVEL = 116,
    DATA_ID_SYS_TEMP_AUX_OTP_DELAY = 117,
    DATA_ID_SYS_TEMP_AUX_OTP_IS_TRIPPED = 118,
    DATA_ID_SYS_TEMP_AUX = 119,
    DATA_ID_SYS_INFO_FIRMWARE_VER = 120,
    DATA_ID_SYS_INFO_SERIAL_NO = 121,
    DATA_ID_SYS_INFO_SCPI_VER = 122,
    DATA_ID_SYS_INFO_CPU = 123,
    ...
    DATA_ID_PROFILES_LIST = 139,
    DATA_ID_PROFILES_AUTO_RECALL_STATUS = 140,
    DATA_ID_PROFILES_AUTO_RECALL_LOCATION = 141,
    DATA_ID_PROFILE_STATUS = 142,
    DATA_ID_PROFILE_LABEL = 143,
    DATA_ID_PROFILE_REMARK = 144,
    DATA_ID_PROFILE_IS_AUTO_RECALL_LOCATION = 145,
    DATA_ID_PROFILE_CHANNEL_U_SET = 146,
    DATA_ID_PROFILE_CHANNEL_I_SET = 147,
    DATA_ID_PROFILE_CHANNEL_OUTPUT_STATE = 148,
    DATA_ID_ETHERNET_INSTALLED = 149,
    DATA_ID_ETHERNET_ENABLED = 150,
    DATA_ID_MQTT_ENABLED = 151,
    DATA_ID_ETHERNET_STATUS = 152,
    DATA_ID_ETHERNET_AND_MQTT_STATUS = 153,
    DATA_ID_MQTT_CONNECTION_STATE = 154,
    DATA_ID_ETHERNET_IP_ADDRESS = 155,
    DATA_ID_ETHERNET_DNS = 156,
    DATA_ID_ETHERNET_GATEWAY = 157,
    DATA_ID_ETHERNET_SUBNET_MASK = 158,
    DATA_ID_ETHERNET_SCPI_PORT = 159,
    DATA_ID_ETHERNET_IS_CONNECTED = 160,
    DATA_ID_ETHERNET_DHCP = 161,
    DATA_ID_ETHERNET_MAC = 162,
    DATA_ID_CHANNEL_IS_VOLTAGE_BALANCED = 163,
    DATA_ID_CHANNEL_IS_CURRENT_BALANCED = 164,
    DATA_ID_SYS_OUTPUT_PROTECTION_COUPLED = 165,
    DATA_ID_SYS_SHUTDOWN_WHEN_PROTECTION_TRIPPED = 166,
    DATA_ID_SYS_FORCE_DISABLING_ALL_OUTPUTS_ON_POWER_UP = 167,
    DATA_ID_SYS_PASSWORD_IS_SET = 168,
    DATA_ID_SYS_RL_STATE = 169,
    DATA_ID_SYS_SOUND_IS_ENABLED = 170,
    DATA_ID_SYS_SOUND_IS_CLICK_ENABLED = 171,
    DATA_ID_SYS_SOUND_ENABLED = 172,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE1 = 173,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE2 = 174,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_YT_VIEW_RATE = 175,
    DATA_ID_SYS_ENCODER_CONFIRMATION_MODE = 176,
    DATA_ID_SYS_ENCODER_MOVING_UP_SPEED = 177,
    DATA_ID_SYS_ENCODER_MOVING_DOWN_SPEED = 178,
    DATA_ID_SYS_ENCODER_INSTALLED = 179,
    DATA_ID_SYS_DISPLAY_STATE = 180,
    DATA_ID_SYS_DISPLAY_BRIGHTNESS = 181,
    DATA_ID_CHANNEL_TRIGGER_MODE = 182,
    DATA_ID_CHANNEL_TRIGGER_ON_LIST_STOP = 183,
    DATA_ID_CHANNEL_U_TRIGGER_VALUE = 184,
    DATA_ID_CHANNEL_I_TRIGGER_VALUE = 185,
    DATA_ID_CHANNEL_LIST_COUNT = 186,
    DATA_ID_CHANNEL_LISTS = 187,
    DATA_ID_RAMP_AND_DELAY_LIST = 188,
    DATA_ID_CHANNEL_LIST_INDEX = 189,
    DATA_ID_CHANNEL_LIST_DWELL = 190,
    DATA_ID_CHANNEL_LIST_DWELL_ENABLED = 191,
    DATA_ID_CHANNEL_LIST_VOLTAGE = 192,
    DATA_ID_CHANNEL_LIST_VOLTAGE_ENABLED = 193,
    DATA_ID_CHANNEL_LIST_CURRENT = 194,
    DATA_ID_CHANNEL_LIST_CURRENT_ENABLED = 195,
    DATA_ID_CHANNEL_LISTS_PREVIOUS_PAGE_ENABLED = 196,
    DATA_ID_CHANNEL_LISTS_NEXT_PAGE_ENABLED = 197,
    DATA_ID_CHANNEL_LISTS_CURSOR = 198,
    DATA_ID_CHANNEL_LISTS_INSERT_MENU_ENABLED = 199,
    DATA_ID_CHANNEL_LISTS_DELETE_MENU_ENABLED = 200,
    DATA_ID_CHANNEL_LISTS_DELETE_ROW_ENABLED = 201,
    DATA_ID_CHANNEL_LISTS_CLEAR_COLUMN_ENABLED = 202,
    DATA_ID_CHANNEL_LISTS_DELETE_ROWS_ENABLED = 203,
    DATA_ID_CHANNEL_COUPLING_STATE = 204,
    DATA_ID_TRIGGER_SOURCE = 205,
    DATA_ID_TRIGGER_DELAY = 206,
    DATA_ID_TRIGGER_INITIATE_CONTINUOUSLY = 207,
    DATA_ID_TRIGGER_IS_INITIATED = 208,
    DATA_ID_TRIGGER_IS_MANUAL = 209,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 210,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 211,
    DATA_ID_CHANNEL_RANGES_MODE = 212,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 213,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 214,
    DATA_ID_TEXT_MESSAGE = 215,
    DATA_ID_SERIAL_STATUS = 216,
    DATA_ID_SERIAL_ENABLED = 217,
    DATA_ID_SERIAL_IS_CONNECTED = 218,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 219,
    DATA_ID_CHANNEL_RAMP_COUNTDOWN = 220,
    DATA_ID_IO_PINS = 221,
    ...
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 270,
    ...
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 287,
    ...
    DATA_ID_RAMP_COUNTER_LABEL = 349,
    ...
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 358,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 359,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 360,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 361,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 362,
    DATA_ID_DATE_TIME_FORMAT = 363,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 364,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 365,
    DATA_ID_DATE_TIME_AM_PM = 366,
    DATA_ID_IS_MULTI_TRACKING = 367,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 368,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 369,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 370,
    DATA_ID_CHANNEL_INFO_BRAND = 371,
    DATA_ID_CHANNEL_INFO_SERIAL = 372,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 373,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 374,
    DATA_ID_FILE_MANAGER_FILE_ICON = 375,
    DATA_ID_FILE_MANAGER_LAYOUT = 376,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 377,
    DATA_ID_TOUCH_RAW_X = 378,
    DATA_ID_TOUCH_RAW_Y = 379,
    DATA_ID_TOUCH_RAW_Z1 = 380,
    DATA_ID_TOUCH_RAW_PRESSED = 381,
    DATA_ID_TOUCH_CALIBRATED_X = 382,
    DATA_ID_TOUCH_CALIBRATED_Y = 383,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 384,
    DATA_ID_TOUCH_FILTERED_X = 385,
    DATA_ID_TOUCH_FILTERED_Y = 386,
    DATA_ID_TOUCH_FILTERED_PRESSED = 387,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 388,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 389,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 390,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 391,
    DATA_ID_ALERT_MESSAGE_IS_SET = 392,
    DATA_ID_ASYNC_PROGRESS = 393,
    DATA_ID_IO_PIN_FUNCTION = 394,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 395,
    DATA_ID_IO_PIN_PWM_DUTY = 396,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 397,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 398,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 399,
    DATA_ID_DEBUG_VARIABLES = 400,
    DATA_ID_DEBUG_VARIABLE_NAME = 401,
    DATA_ID_DEBUG_VARIABLE_VALUE = 402,
    DATA_ID_CHANNEL_RAMP_STATE = 403,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 404,
    DATA_ID_MQTT_IN_ERROR = 405,
    DATA_ID_DEBUG_I_DAC = 406,
    DATA_ID_DEBUG_U_DAC = 407,
    DATA_ID_DEBUG_I_DAC_AMPER = 408,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 409,
    DATA_ID_DEBUG_I_ADC = 410,
    DATA_ID_DEBUG_U_ADC = 411,
    DATA_ID_DEBUG_I_ADC_AMPER = 412,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 413,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 414,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 415,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 416,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 417,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 418,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 419,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 420,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 421,
    DATA_ID_CHANNEL_CALIBRATION_POINTS = 422,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_SAVE = 423
};
...
enum StylesEnum {
    ...
    STYLE_ID_CALIBRATION_POINTS_X_AXIS_LABEL_RIGHT = 57,
    STYLE_ID_CALIBRATION_POINTS_X_AXIS_MARKER = 58,
    STYLE_ID_CALIBRATION_POINTS_X_AXIS_MARKER_SELECTED = 59,
    ...
    STYLE_ID_VALUE_M_LEFT = 133,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 134,
    STYLE_ID_INLINE135 = 135,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 136,
    STYLE_ID_ENCODER_CURSOR_17_ENABLED = 137,
    STYLE_ID_INLINE138 = 138,
    STYLE_ID_YT_GRAPH = 139,
    STYLE_ID_LIST_GRAPH_CURSOR = 140,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 141,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 142,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 143,
    STYLE_ID_INLINE144 = 144,
    STYLE_ID_INLINE145 = 145,
    STYLE_ID_INLINE146 = 146,
    STYLE_ID_MON_VALUE_14_CENTER = 147,
    ...
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 199,
    STYLE_ID_BAR_GRAPH_TEXT = 200,
    STYLE_ID_BAR_GRAPH_SET_LINE = 201,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 202,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 203,
    STYLE_ID_INLINE204 = 204,
    STYLE_ID_INLINE205 = 205,
    STYLE_ID_TRIGGER_BUTTON_24 = 206,
    STYLE_ID_INLINE207 = 207,
    STYLE_ID_INLINE208 = 208,
    STYLE_ID_MON_VALUE_14_RIGHT = 209,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 210,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 211,
    STYLE_ID_TRIGGER_BUTTON_14 = 212,
    ...
    STYLE_ID_MON_VALUE_20_RIGHT = 231,
    STYLE_ID_MON_VALUE_14_LEFT = 232,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 233,
    STYLE_ID_INLINE234 = 234,
    STYLE_ID_INLINE235 = 235,
    STYLE_ID_INLINE236 = 236,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 237,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 238,
    STYLE_ID_SCROLLBAR_TRACK = 239,
...
enum PagesEnum {
    ...
    PAGE_ID_CH_SETTINGS_CALIBRATION_POINTS = 44,
    PAGE_ID_CH_SETTINGS_ADV_OPTIONS = 45,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 46,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 47,
    PAGE_ID_CH_SETTINGS_INFO = 48,
    PAGE_ID_SYS_SETTINGS = 49,
    PAGE_ID_SYS_SETTINGS_TEMPERATURE = 50,
    PAGE_ID_SYS_SETTINGS_PROTECTIONS = 51,
    PAGE_ID_SYS_SETTINGS_TRIGGER = 52,
    PAGE_ID_SYS_SETTINGS_IO = 53,
    PAGE_ID_SYS_SETTINGS_DATE_TIME = 54,
    PAGE_ID_SYS_SETTINGS_ENCODER = 55,
    PAGE_ID_SYS_SETTINGS_SERIAL = 56,
    PAGE_ID_SYS_SETTINGS_ETHERNET = 57,
    PAGE_ID_SYS_SETTINGS_MQTT = 58,
    PAGE_ID_SYS_SETTINGS_ETHERNET_STATIC = 59,
    PAGE_ID_SYS_SETTINGS_SCREEN_CALIBRATION = 60,
    PAGE_ID_SYS_SETTINGS_DISPLAY = 61,
    ...
    PAGE_ID_SLOT_DEF_1CH_NUM_ON = 80,
    PAGE_ID_SLOT_DEF_MIO168 = 81,
    PAGE_ID_SLOT_DEF_SMX46 = 82,
    PAGE_ID_SLOT_DEF_1CH_VBAR_ON = 83,
    PAGE_ID_SLOT_DEF_1CH_VERT_OFF = 84,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_SERIES = 85,
    PAGE_ID_SLOT_DEF_1CH_VERT_COUPLED_PARALLEL = 86,
    PAGE_ID_SLOT_DEF_2CH_VERT = 87,
    PAGE_ID_SLOT_DEF_2CH_VERT_ON = 88,
    PAGE_ID_SLOT_DEF_2CH_VERT_OFF = 89,
    PAGE_ID_SLOT_DEF_VERT_ERROR = 90,
    PAGE_ID_SLOT_DEF_VERT_NOT_INSTALLED = 91,
    PAGE_ID_SLOT_DEF_HORZ = 92,
    PAGE_ID_SLOT_DEF_HORZ_TITLE = 93,
    PAGE_ID_SLOT_DEF_1CH_HBAR_ON = 94,
    PAGE_ID_SLOT_DEF_1CH_YT_ON = 95,
    PAGE_ID_SLOT_DEF_1CH_HORZ_OFF = 96,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_SERIES = 97,
    PAGE_ID_SLOT_DEF_1CH_HORZ_COUPLED_PARALLEL = 98,
    PAGE_ID_SLOT_DEF_2CH_HORZ = 99,
    PAGE_ID_SLOT_DEF_2CH_HORZ_ON = 100,
    PAGE_ID_SLOT_DEF_2CH_HORZ_OFF = 101,
    PAGE_ID_SLOT_DEF_HORZ_ERROR = 102,
    PAGE_ID_SLOT_DEF_HORZ_NOT_INSTALLED = 103,
    PAGE_ID_SLOT_MAX_1CH_TITLE = 104,
    PAGE_ID_SLOT_MAX_1CH_NUM_ON = 105,
    PAGE_ID_SLOT_MAX_1CH_NUM_OFF = 106,
    PAGE_ID_SLOT_MAX_1CH_HBAR_ON = 107,
    PAGE_ID_SLOT_MAX_1CH_HBAR_OFF = 108,
    PAGE_ID_SLOT_MAX_1CH_YT_ON = 109,
    PAGE_ID_SLOT_MAX_1CH_YT_OFF = 110,
    PAGE_ID_SLOT_MAX_2CH = 111,
    PAGE_ID_SLOT_MAX_2CH_TITLE = 112,
    PAGE_ID_SLOT_MAX_2CH_NUM_ON = 113,
    PAGE_ID_SLOT_MAX_2CH_NUM_OFF = 114,
    PAGE_ID_SLOT_MAX_2CH_HBAR_ON = 115,
    PAGE_ID_SLOT_MAX_2CH_HBAR_OFF = 116,
    PAGE_ID_SLOT_MAX_2CH_YT_ON = 117,
    PAGE_ID_SLOT_MAX_2CH_YT_OFF = 118,
    PAGE_ID_SLOT_MAX_2CH_MIN_TITLE = 119,
    PAGE_ID_SLOT_MAX_2CH_MIN_ON = 120,
    PAGE_ID_SLOT_MAX_2CH_MIN_OFF = 121,
    PAGE_ID_SLOT_MAX_ERROR = 122,
    PAGE_ID_SLOT_MAX_NOT_INSTALLED = 123,
    PAGE_ID_SLOT_MIN_1CH_TITLE = 124,
    PAGE_ID_SLOT_MIN_1CH_ON = 125,
    PAGE_ID_SLOT_MIN_1CH_OFF = 126,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_SERIES = 127,
    PAGE_ID_SLOT_MIN_1CH_COUPLED_PARALLEL = 128,
    PAGE_ID_SLOT_MIN_2CH_TITLE = 129,
    PAGE_ID_SLOT_MIN_2CH = 130,
    PAGE_ID_SLOT_MIN_2CH_ON = 131,
    PAGE_ID_SLOT_MIN_2CH_OFF = 132,
    PAGE_ID_SLOT_MIN_ERROR = 133,
    PAGE_ID_SLOT_MIN_NOT_INSTALLED = 134,
    PAGE_ID_SLOT_MICRO_1CH_TITLE = 135,
    PAGE_ID_SLOT_MICRO_1CH_ON = 136,
    PAGE_ID_SLOT_MICRO_1CH_OFF = 137,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_SERIES = 138,
    PAGE_ID_SLOT_MICRO_1CH_COUPLED_PARALLEL = 139,
    PAGE_ID_SLOT_MICRO_2CH = 140,
    PAGE_ID_SLOT_MICRO_2CH_TITLE = 141,
    PAGE_ID_SLOT_MICRO_2CH_ON = 142,
    PAGE_ID_SLOT_MICRO_2CH_OFF = 143,
    PAGE_ID_SLOT_MICRO_ERROR = 144,
    PAGE_ID_SLOT_MICRO_NOT_INSTALLED = 145,
    PAGE_ID_DLOG_VIEW = 146,
    PAGE_ID_IMAGE_VIEW = 147,
    PAGE_ID_DLOG_PARAMS = 148,
    PAGE_ID_DLOG_VIEW_OVERLAY_OPTIONS = 149,
    PAGE_ID_FILE_MANAGER = 150,
    PAGE_ID_FILE_BROWSER = 151,
    PAGE_ID_FILE_MENU = 152,
    PAGE_ID_FRONT_PANEL = 153,
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 154,
    PAGE_ID_DCP405_FRONT_PANEL = 155,
    PAGE_ID_DCP405B_FRONT_PANEL = 156,
    PAGE_ID_DCM220_FRONT_PANEL = 157,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 158,
    PAGE_ID_DCM224_FRONT_PANEL = 159,
    ...
    PAGE_ID_DEBUG_POWER_CHANNELS = 169
};

extern const uint8_t assets[444308];
