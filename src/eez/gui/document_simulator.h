enum DataEnum {
    ...
    DATA_ID_MAIN_APP_VIEW = 238,
    DATA_ID_APPLICATIONS = 239,
    DATA_ID_APPLICATION_TITLE = 240,
    DATA_ID_APPLICATION_ICON = 241,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 242,
    DATA_ID_FOREGROUND_APPLICATION = 243,
    DATA_ID_FOREGROUND_APPLICATION_TITLE = 244,
    DATA_ID_TOUCH_CALIBRATION_POINT = 245,
    DATA_ID_SLOTS = 246,
    DATA_ID_SLOT_MODULE_TYPE = 247,
    DATA_ID_SIMULATOR_LOAD_STATE = 248,
    DATA_ID_SIMULATOR_LOAD = 249,
    DATA_ID_SELECTED_THEME = 250,
    DATA_ID_PROFILE_DIRTY = 251,
    DATA_ID_CHANNEL_TITLE = 252,
    DATA_ID_CHANNEL_SHORT_TITLE = 253,
    DATA_ID_CHANNEL_LONG_TITLE = 254
};
...
enum PagesEnum {
    ...
    PAGE_ID_OTP = 82,
    PAGE_ID_OPP = 83,
    PAGE_ID_FRONT_PANEL = 84,
    PAGE_ID_NUMERIC_KEYPAD2 = 85,
    PAGE_ID_MINIMIZED_APP_VIEW = 86,
    PAGE_ID_GUI_TMPL_ONE_MAX_STATUS_LINE_BOTTOM = 87,
    PAGE_ID_GUI_TMPL_SYSTEM_SETTINGS_STATUS_LINE_BOTTOM = 88,
    PAGE_ID_GUI_TMPL_DEFAULT_VERTICAL_NUMERIC_ETC = 89,
    PAGE_ID_GUI_TMPL_HORIZONTAL_GRAPH_BAR = 90,
...
extern const uint8_t assets[274430];
