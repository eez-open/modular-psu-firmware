enum DataEnum {
    ...
    DATA_ID_TOUCH_CALIBRATION_POINT = 230,
    DATA_ID_SELECTED_THEME = 231,
    DATA_ID_CHANNEL_TITLE = 232,
    DATA_ID_CHANNEL_SHORT_TITLE = 233,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 234,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 235,
    DATA_ID_CHANNEL_LONG_TITLE = 236,
    DATA_ID_ANIMATIONS_DURATION = 237,
    DATA_ID_SLOT1_INFO = 238,
    DATA_ID_SLOT2_INFO = 239,
    DATA_ID_SLOT3_INFO = 240,
    DATA_ID_SLOT1_TEST_RESULT = 241,
    DATA_ID_SLOT2_TEST_RESULT = 242,
    DATA_ID_SLOT3_TEST_RESULT = 243,
    DATA_ID_SLOT_DEFAULT1_VIEW = 244,
    DATA_ID_SLOT_DEFAULT2_VIEW = 245,
    DATA_ID_SLOT_DEFAULT3_VIEW = 246,
    DATA_ID_SLOT1_CHANNEL_INDEX = 247,
    DATA_ID_SLOT2_CHANNEL_INDEX = 248,
    DATA_ID_SLOT3_CHANNEL_INDEX = 249,
    DATA_ID_SLOT_DEF_2CH_VIEW = 250,
    DATA_ID_SLOT_MAX_2CH_VIEW = 251,
    DATA_ID_SLOT_MIN_2CH_VIEW = 252,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 253,
    DATA_ID_SLOT_2CH_CH1_INDEX = 254,
    DATA_ID_SLOT_2CH_CH2_INDEX = 255,
    DATA_ID_BATTERY = 256,
    DATA_ID_IO_PIN_STATE = 257,
    DATA_ID_CHANNEL_DPROG = 258,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 259,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 260,
    DATA_ID_SYS_INFO_HAS_ERROR = 261,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 262,
    ...
    DATA_ID_DLOG_CURRENT_TIME = 294,
    DATA_ID_DLOG_FILE_LENGTH = 295,
    DATA_ID_DLOG_X_AXIS_OFFSET = 296,
    DATA_ID_DLOG_X_AXIS_DIV = 297,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 298,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 299,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 300,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 301,
    DATA_ID_DLOG_VIEW_STATE = 302,
    DATA_ID_DLOG_PERIOD = 303,
    DATA_ID_DLOG_DURATION = 304,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 305,
    DATA_ID_DLOG_CURRENT_ENABLED = 306,
    DATA_ID_DLOG_POWER_ENABLED = 307,
    DATA_ID_DLOG_START_ENABLED = 308,
    DATA_ID_DLOG_FILE_NAME = 309,
    DATA_ID_DLOG_VALUE_STATE = 310,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 311,
    DATA_ID_CHANNEL_OFF_LABEL = 312,
    DATA_ID_FILE_MANAGER_FILES = 313,
    DATA_ID_FILE_MANAGER_FILE_NAME = 314,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 315,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 316,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 317,
    DATA_ID_FILE_MANAGER_STATE = 318,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 319,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 320,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 321,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 322,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 323,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 324,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 325,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 326,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 327,
    DATA_ID_SCRIPT_INFO = 328,
    DATA_ID_SCRIPT_IS_STARTED = 329,
    DATA_ID_KEYPAD_OK_ENABLED = 330,
    DATA_ID_ETHERNET_HOST_NAME = 331,
    DATA_ID_MQTT_HOST = 332,
    DATA_ID_MQTT_PORT = 333,
    DATA_ID_MQTT_USERNAME = 334,
    DATA_ID_MQTT_PASSWORD = 335,
    DATA_ID_MQTT_PERIOD = 336,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 337,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 338,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 339,
    DATA_ID_LIST_COUNTER_LABEL = 340,
    DATA_ID_RAMP_COUNTER_LABEL = 341,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 342,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 343,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 344,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 345,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 346,
    DATA_ID_IS_RESET_BY_IWDG = 347,
    DATA_ID_DLOG_ENABLED = 348,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 349,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 350,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 351,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 352,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 353,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 354,
    DATA_ID_DATE_TIME_FORMAT = 355,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 356,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 357,
    DATA_ID_DATE_TIME_AM_PM = 358,
    DATA_ID_IS_MULTI_TRACKING = 359,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 360,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 361,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 362,
    DATA_ID_CHANNEL_INFO_BRAND = 363,
    DATA_ID_CHANNEL_INFO_SERIAL = 364,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 365,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 366,
    DATA_ID_FILE_MANAGER_FILE_ICON = 367,
    DATA_ID_FILE_MANAGER_LAYOUT = 368,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 369,
    DATA_ID_TOUCH_RAW_X = 370,
    DATA_ID_TOUCH_RAW_Y = 371,
    DATA_ID_TOUCH_RAW_Z1 = 372,
    DATA_ID_TOUCH_RAW_PRESSED = 373,
    DATA_ID_TOUCH_CALIBRATED_X = 374,
    DATA_ID_TOUCH_CALIBRATED_Y = 375,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 376,
    DATA_ID_TOUCH_FILTERED_X = 377,
    DATA_ID_TOUCH_FILTERED_Y = 378,
    DATA_ID_TOUCH_FILTERED_PRESSED = 379,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 380,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 381,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 382,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 383,
    DATA_ID_ALERT_MESSAGE_IS_SET = 384,
    DATA_ID_ASYNC_PROGRESS = 385,
    DATA_ID_IO_PIN_FUNCTION = 386,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 387,
    DATA_ID_IO_PIN_PWM_DUTY = 388,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 389,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 390,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 391,
    DATA_ID_DEBUG_VARIABLES = 392,
    DATA_ID_DEBUG_VARIABLE_NAME = 393,
    DATA_ID_DEBUG_VARIABLE_VALUE = 394,
    DATA_ID_CHANNEL_RAMP_STATE = 395,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 396,
    DATA_ID_MQTT_IN_ERROR = 397,
    DATA_ID_DEBUG_I_DAC = 398,
    DATA_ID_DEBUG_U_DAC = 399,
    DATA_ID_DEBUG_I_DAC_AMPER = 400,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 401,
    DATA_ID_DEBUG_I_ADC = 402,
    DATA_ID_DEBUG_U_ADC = 403,
    DATA_ID_DEBUG_I_ADC_AMPER = 404,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 405,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 406,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 407,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 408,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 409,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 410,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 411,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 412,
    DATA_ID_CHANNEL_CALIBRATION_POINT_INFO = 413,
    DATA_ID_CHANNEL_CALIBRATION_POINTS = 414,
...
enum PagesEnum {
    ...
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 153,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 154,
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 155,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 156,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 157,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 158,
    PAGE_ID_TOUCH_TEST = 159,
    PAGE_ID_DEBUG_VARIABLES = 160,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 161,
    PAGE_ID_OVP_TYPE = 162,
    PAGE_ID_DEBUG_POWER_CHANNELS = 163
};

extern const uint8_t assets[308996];
