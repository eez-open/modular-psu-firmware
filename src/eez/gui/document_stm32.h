enum DataEnum {
    ...
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 293,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 294,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 295,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 296,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 297,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 298,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 299,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 300,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 301,
    DATA_ID_SCRIPT_INFO = 302,
    DATA_ID_SCRIPT_IS_STARTED = 303,
    DATA_ID_KEYPAD_OK_ENABLED = 304,
    DATA_ID_ETHERNET_HOST_NAME = 305,
    DATA_ID_MQTT_HOST = 306,
    DATA_ID_MQTT_PORT = 307,
    DATA_ID_MQTT_USERNAME = 308,
    DATA_ID_MQTT_PASSWORD = 309,
    DATA_ID_MQTT_PERIOD = 310,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 311,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 312,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 313,
    DATA_ID_LIST_COUNTER_LABEL = 314,
    DATA_ID_RAMP_COUNTER_LABEL = 315,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 316,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 317,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 318,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 319,
    ...
    DATA_ID_DEBUG_VARIABLES = 364,
    DATA_ID_DEBUG_VARIABLE_NAME = 365,
    DATA_ID_DEBUG_VARIABLE_VALUE = 366,
    DATA_ID_CHANNEL_RAMP_STATE = 367,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 368,
    DATA_ID_MQTT_IN_ERROR = 369,
    DATA_ID_DEBUG_I_DAC = 370,
    DATA_ID_DEBUG_U_DAC = 371,
    DATA_ID_DEBUG_I_DAC_AMPER = 372,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 373,
    DATA_ID_DEBUG_I_ADC = 374,
    DATA_ID_DEBUG_U_ADC = 375,
    DATA_ID_DEBUG_I_ADC_AMPER = 376,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 377,
    ...
    DATA_ID_DUMMY = 390,
    DATA_ID_SLOTS = 391,
    DATA_ID_SLOT_INDEX = 392,
    DATA_ID_SLOT_TITLE_DEF = 393,
    DATA_ID_SLOT_TITLE_MAX = 394,
    DATA_ID_SLOT_TITLE_MIN = 395,
    DATA_ID_SLOT_TITLE_MICRO = 396,
    DATA_ID_SLOT_TITLE_SETTINGS = 397,
    DATA_ID_SLOT_ERROR_MESSAGE = 398,
    DATA_ID_USB_MODE = 399,
    DATA_ID_USB_CURRENT_MODE = 400,
    DATA_ID_USB_DEVICE_CLASS = 401,
    DATA_ID_USB_KEYBOARD_STATE = 402,
    DATA_ID_CHANNELS_IS_2COL_VIEW = 403,
    DATA_ID_DISPLAY_TEST_COLOR_INDEX = 404,
    DATA_ID_CHANNEL_HAS_ADVANCED_OPTIONS = 405,
    DATA_ID_CHANNEL_HAS_FIRMWARE_UPDATE = 406,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE_IS_SELECTABLE = 407,
    DATA_ID_SLOT_SERIAL_INFO = 408,
    DATA_ID_SLOT_IS_ENABLED = 409,
    DATA_ID_SLOT_IS_DCPSUPPLY_MODULE = 410,
    DATA_ID_USER_SWITCH_ACTION = 411,
    DATA_ID_NTP_REFRESH_FREQUENCY = 412,
    DATA_ID_CHANNEL_CALIBRATION_IS_POWER_CHANNEL = 413,
    DATA_ID_HAS_CUSTOM_BITMAP = 414,
    DATA_ID_CUSTOM_BITMAP = 415,
    DATA_ID_SLOT_INFO_WITH_FW_VER = 416,
    DATA_ID_MASTER_INFO_WITH_FW_VER = 417,
    DATA_ID_SLOT1_LABELS_AND_COLORS_VIEW = 418,
    DATA_ID_SLOT2_LABELS_AND_COLORS_VIEW = 419,
    DATA_ID_SLOT3_LABELS_AND_COLORS_VIEW = 420,
    DATA_ID_COLORS = 421,
    DATA_ID_KEYPAD_CAN_SET_DEFAULT = 422,
    DATA_ID_LABELS_AND_COLORS_PAGE_SLOT_TITLE = 423,
    DATA_ID_LABELS_AND_COLORS_PAGE_CHANNEL_TITLE = 424,
    DATA_ID_LABELS_AND_COLORS_IS_COLOR_MODIFIED = 425,
    DATA_ID_DLOG_ITEMS = 426,
    DATA_ID_DLOG_ITEM_STATUS = 427,
    DATA_ID_DLOG_ITEM_CHANNEL = 428,
    DATA_ID_DLOG_ITEM_LABEL = 429,
    DATA_ID_DLOG_ITEMS_SCROLLBAR_ENABLED = 430,
    DATA_ID_DLOG_ITEMS_NUM_SELECTED = 431,
    DATA_ID_DLOG_START_ENABLED = 432,
    ...
    DATA_ID_DIB_MIO168_AIN_HAS_TEMP_SENSOR_BIAS_FEATURE = 455,
    DATA_ID_DIB_MIO168_AIN_TEMP_SENSOR_BIAS = 456,
    ...
    DATA_ID_DIB_MIO168_PWM_CHANNELS = 466,
    DATA_ID_DIB_MIO168_PWM_LABEL = 467,
    DATA_ID_DIB_MIO168_PWM_LABEL_LABEL = 468,
    DATA_ID_DIB_MIO168_PWM_FREQ = 469,
    DATA_ID_DIB_MIO168_PWM_DUTY = 470,
    DATA_ID_DIB_MIO168_DIN_HAS_SPEED = 471,
...
enum ActionsEnum {
    ...
    ACTION_ID_DIB_MIO168_DIN_SHOW_CONFIGURATION = 234,
    ACTION_ID_DIB_MIO168_DIN_SELECT_RANGE = 235,
    ACTION_ID_DIB_MIO168_DIN_SELECT_SPEED = 236,
    ACTION_ID_DIB_MIO168_DOUT_TOGGLE_STATE = 237,
    ACTION_ID_DIB_MIO168_AIN_TOGGLE_TEMP_SENSOR_BIAS = 238,
...
enum StylesEnum {
    ...
    STYLE_ID_LABELS_AND_COLORS_SLOT = 259,
...
enum PagesEnum {
    ...
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 123,
    ...
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 138,
    ...
    PAGE_ID_DIB_DCM220_CH_SETTINGS_ERROR = 187,
    ...
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT_OFF = 192,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_VERT_OFF_2COL = 193,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ = 194,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_2COL = 195,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_ON = 196,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_ON_2COL = 197,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_OFF = 198,
    PAGE_ID_DIB_DCM220_SLOT_DEF_2CH_HORZ_OFF_2COL = 199,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH = 200,
    ...
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_YT_ON = 208,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_YT_OFF = 209,
    PAGE_ID_DIB_DCM220_SLOT_MAX_2CH_MIN_TITLE = 210,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH_TITLE = 211,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH = 212,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH_ON = 213,
    PAGE_ID_DIB_DCM220_SLOT_MIN_2CH_OFF = 214,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH = 215,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_TITLE = 216,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_ON = 217,
    PAGE_ID_DIB_DCM220_SLOT_MICRO_2CH_OFF = 218,
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS = 219,
    PAGE_ID_DIB_DCM220_LABELS_AND_COLORS_CH = 220,
    ...
    PAGE_ID_DIB_DCM224_LABELS_AND_COLORS = 254,
