enum DataEnum {
    ...
    DATA_ID_CHANNELS_IS_MAX_VIEW = 20,
    DATA_ID_CHANNELS_VIEW_MODE = 21,
    DATA_ID_CHANNELS_VIEW_MODE_IN_DEFAULT = 22,
    DATA_ID_CHANNELS_VIEW_MODE_IN_MAX = 23,
    DATA_ID_CHANNEL_MAX = 24,
    DATA_ID_CHANNEL_SMALL1 = 25,
    DATA_ID_CHANNEL_SMALL2 = 26,
    DATA_ID_CHANNEL_DISPLAY_VALUE1 = 27,
    DATA_ID_CHANNEL_DISPLAY_VALUE2 = 28,
    DATA_ID_OVP = 29,
    DATA_ID_OCP = 30,
    DATA_ID_OPP = 31,
    DATA_ID_OTP_CH = 32,
    DATA_ID_OTP_AUX = 33,
    DATA_ID_ALERT_MESSAGE = 34,
    DATA_ID_ALERT_MESSAGE_2 = 35,
    DATA_ID_ALERT_MESSAGE_3 = 36,
    DATA_ID_EDIT_VALUE = 37,
    DATA_ID_EDIT_UNIT = 38,
    DATA_ID_EDIT_INFO = 39,
    DATA_ID_EDIT_INFO1 = 40,
    DATA_ID_EDIT_INFO2 = 41,
    DATA_ID_EDIT_MODE_INTERACTIVE_MODE_SELECTOR = 42,
    DATA_ID_EDIT_STEPS = 43,
    DATA_ID_MODEL_INFO = 44,
    DATA_ID_FIRMWARE_INFO = 45,
    DATA_ID_SELF_TEST_RESULT = 46,
    DATA_ID_KEYPAD_TEXT = 47,
    DATA_ID_KEYPAD_CAPS = 48,
    ...
    DATA_ID_KEYPAD_SIGN_ENABLED = 53,
    DATA_ID_KEYPAD_DOT_ENABLED = 54,
    DATA_ID_KEYPAD_UNIT_ENABLED = 55,
    DATA_ID_CHANNEL_LABEL = 56,
    DATA_ID_CHANNEL_SHORT_LABEL = 57,
    DATA_ID_CHANNEL_TEMP_STATUS = 58,
    DATA_ID_CHANNEL_TEMP = 59,
    DATA_ID_CHANNEL_ON_TIME_TOTAL = 60,
    DATA_ID_CHANNEL_ON_TIME_LAST = 61,
    DATA_ID_CHANNEL_CALIBRATION_STATUS = 62,
    DATA_ID_CHANNEL_CALIBRATION_STATE = 63,
    DATA_ID_CHANNEL_CALIBRATION_DATE = 64,
    DATA_ID_CHANNEL_CALIBRATION_REMARK = 65,
    DATA_ID_CHANNEL_CALIBRATION_STEP_IS_SET_REMARK_STEP = 66,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NUM = 67,
    DATA_ID_CHANNEL_CALIBRATION_STEP_STATUS = 68,
    DATA_ID_CHANNEL_CALIBRATION_STEP_LEVEL_VALUE = 69,
    DATA_ID_CHANNEL_CALIBRATION_STEP_VALUE = 70,
    DATA_ID_CHANNEL_CALIBRATION_STEP_PREV_ENABLED = 71,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NEXT_ENABLED = 72,
    DATA_ID_CAL_CH_U_MIN = 73,
    DATA_ID_CAL_CH_U_MID = 74,
    DATA_ID_CAL_CH_U_MAX = 75,
    DATA_ID_CAL_CH_I0_MIN = 76,
    DATA_ID_CAL_CH_I0_MID = 77,
    DATA_ID_CAL_CH_I0_MAX = 78,
    DATA_ID_CAL_CH_I1_MIN = 79,
    DATA_ID_CAL_CH_I1_MID = 80,
    DATA_ID_CAL_CH_I1_MAX = 81,
    DATA_ID_CHANNEL_PROTECTION_STATUS = 82,
    DATA_ID_CHANNEL_PROTECTION_OVP_STATE = 83,
    ...
    DATA_ID_EVENT_QUEUE_LAST_EVENT_MESSAGE = 100,
    DATA_ID_EVENT_QUEUE_EVENTS = 101,
    DATA_ID_EVENT_QUEUE_EVENTS_TYPE = 102,
    DATA_ID_EVENT_QUEUE_EVENTS_MESSAGE = 103,
    DATA_ID_EVENT_QUEUE_MULTIPLE_PAGES = 104,
    DATA_ID_EVENT_QUEUE_PREVIOUS_PAGE_ENABLED = 105,
    DATA_ID_EVENT_QUEUE_NEXT_PAGE_ENABLED = 106,
    DATA_ID_EVENT_QUEUE_PAGE_INFO = 107,
    DATA_ID_CHANNEL_RSENSE_STATUS = 108,
    DATA_ID_CHANNEL_RPROG_INSTALLED = 109,
    DATA_ID_CHANNEL_RPROG_STATUS = 110,
    DATA_ID_CHANNEL_IS_COUPLED = 111,
    DATA_ID_CHANNEL_IS_TRACKED = 112,
    DATA_ID_CHANNEL_IS_COUPLED_OR_TRACKED = 113,
    DATA_ID_CHANNEL_COUPLING_IS_ALLOWED = 114,
    DATA_ID_CHANNEL_COUPLING_MODE = 115,
    DATA_ID_CHANNEL_COUPLING_SELECTED_MODE = 116,
    DATA_ID_CHANNEL_COUPLING_IS_SERIES = 117,
    DATA_ID_SYS_ON_TIME_TOTAL = 118,
    DATA_ID_SYS_ON_TIME_LAST = 119,
    DATA_ID_SYS_TEMP_AUX_STATUS = 120,
    DATA_ID_SYS_TEMP_AUX_OTP_STATE = 121,
    DATA_ID_SYS_TEMP_AUX_OTP_LEVEL = 122,
    DATA_ID_SYS_TEMP_AUX_OTP_DELAY = 123,
    DATA_ID_SYS_TEMP_AUX_OTP_IS_TRIPPED = 124,
    DATA_ID_SYS_TEMP_AUX = 125,
    DATA_ID_SYS_INFO_FIRMWARE_VER = 126,
    DATA_ID_SYS_INFO_SERIAL_NO = 127,
    DATA_ID_SYS_INFO_SCPI_VER = 128,
    DATA_ID_SYS_INFO_CPU = 129,
    DATA_ID_SYS_INFO_ETHERNET = 130,
    ...
    DATA_ID_PROFILES_LIST1 = 146,
    DATA_ID_PROFILES_LIST2 = 147,
    DATA_ID_PROFILES_AUTO_RECALL_STATUS = 148,
    DATA_ID_PROFILES_AUTO_RECALL_LOCATION = 149,
    DATA_ID_PROFILE_STATUS = 150,
    DATA_ID_PROFILE_LABEL = 151,
    DATA_ID_PROFILE_REMARK = 152,
    DATA_ID_PROFILE_IS_AUTO_RECALL_LOCATION = 153,
    DATA_ID_PROFILE_CHANNEL_U_SET = 154,
    DATA_ID_PROFILE_CHANNEL_I_SET = 155,
    DATA_ID_PROFILE_CHANNEL_OUTPUT_STATE = 156,
    DATA_ID_ETHERNET_INSTALLED = 157,
    DATA_ID_ETHERNET_ENABLED = 158,
    DATA_ID_ETHERNET_STATUS = 159,
    DATA_ID_ETHERNET_IP_ADDRESS = 160,
    DATA_ID_ETHERNET_DNS = 161,
    DATA_ID_ETHERNET_GATEWAY = 162,
    DATA_ID_ETHERNET_SUBNET_MASK = 163,
    DATA_ID_ETHERNET_SCPI_PORT = 164,
    DATA_ID_ETHERNET_IS_CONNECTED = 165,
    DATA_ID_ETHERNET_DHCP = 166,
    DATA_ID_ETHERNET_MAC = 167,
    DATA_ID_CHANNEL_IS_VOLTAGE_BALANCED = 168,
    DATA_ID_CHANNEL_IS_CURRENT_BALANCED = 169,
    DATA_ID_SYS_OUTPUT_PROTECTION_COUPLED = 170,
    DATA_ID_SYS_SHUTDOWN_WHEN_PROTECTION_TRIPPED = 171,
    DATA_ID_SYS_FORCE_DISABLING_ALL_OUTPUTS_ON_POWER_UP = 172,
    DATA_ID_SYS_PASSWORD_IS_SET = 173,
    DATA_ID_SYS_RL_STATE = 174,
    DATA_ID_SYS_SOUND_IS_ENABLED = 175,
    DATA_ID_SYS_SOUND_IS_CLICK_ENABLED = 176,
    DATA_ID_SYS_SOUND_ENABLED = 177,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE1 = 178,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE2 = 179,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_YT_VIEW_RATE = 180,
    DATA_ID_SYS_ENCODER_CONFIRMATION_MODE = 181,
    DATA_ID_SYS_ENCODER_MOVING_UP_SPEED = 182,
    DATA_ID_SYS_ENCODER_MOVING_DOWN_SPEED = 183,
    DATA_ID_SYS_ENCODER_INSTALLED = 184,
    DATA_ID_SYS_DISPLAY_STATE = 185,
    DATA_ID_SYS_DISPLAY_BRIGHTNESS = 186,
    DATA_ID_CHANNEL_TRIGGER_MODE = 187,
    DATA_ID_CHANNEL_TRIGGER_OUTPUT_STATE = 188,
    DATA_ID_CHANNEL_TRIGGER_ON_LIST_STOP = 189,
    DATA_ID_CHANNEL_U_TRIGGER_VALUE = 190,
    DATA_ID_CHANNEL_I_TRIGGER_VALUE = 191,
    DATA_ID_CHANNEL_LIST_COUNT = 192,
    DATA_ID_CHANNEL_LISTS = 193,
    DATA_ID_CHANNEL_LIST_INDEX = 194,
    DATA_ID_CHANNEL_LIST_DWELL = 195,
    DATA_ID_CHANNEL_LIST_DWELL_ENABLED = 196,
    DATA_ID_CHANNEL_LIST_VOLTAGE = 197,
    DATA_ID_CHANNEL_LIST_VOLTAGE_ENABLED = 198,
    DATA_ID_CHANNEL_LIST_CURRENT = 199,
    DATA_ID_CHANNEL_LIST_CURRENT_ENABLED = 200,
    DATA_ID_CHANNEL_LISTS_PREVIOUS_PAGE_ENABLED = 201,
    DATA_ID_CHANNEL_LISTS_NEXT_PAGE_ENABLED = 202,
    DATA_ID_CHANNEL_LISTS_CURSOR = 203,
    DATA_ID_CHANNEL_LISTS_INSERT_MENU_ENABLED = 204,
    DATA_ID_CHANNEL_LISTS_DELETE_MENU_ENABLED = 205,
    DATA_ID_CHANNEL_LISTS_DELETE_ROW_ENABLED = 206,
    DATA_ID_CHANNEL_LISTS_CLEAR_COLUMN_ENABLED = 207,
    DATA_ID_CHANNEL_LISTS_DELETE_ROWS_ENABLED = 208,
    DATA_ID_TRIGGER_SOURCE = 209,
    DATA_ID_TRIGGER_DELAY = 210,
    DATA_ID_TRIGGER_INITIATE_CONTINUOUSLY = 211,
    DATA_ID_TRIGGER_IS_INITIATED = 212,
    DATA_ID_TRIGGER_IS_MANUAL = 213,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 214,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 215,
    DATA_ID_CHANNEL_RANGES_MODE = 216,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 217,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 218,
    DATA_ID_TEXT_MESSAGE = 219,
    DATA_ID_SERIAL_STATUS = 220,
    DATA_ID_SERIAL_ENABLED = 221,
    DATA_ID_SERIAL_IS_CONNECTED = 222,
    DATA_ID_SERIAL_BAUD = 223,
    DATA_ID_SERIAL_PARITY = 224,
    ...
    DATA_ID_VIEW_STATUS = 236,
    DATA_ID_DLOG_STATUS = 237,
    DATA_ID_APPLICATIONS = 238,
    DATA_ID_APPLICATION_TITLE = 239,
    DATA_ID_APPLICATION_ICON = 240,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 241,
    DATA_ID_FOREGROUND_APPLICATION = 242,
    DATA_ID_FOREGROUND_APPLICATION_TITLE = 243,
    DATA_ID_TOUCH_CALIBRATION_POINT = 244,
    DATA_ID_SELECTED_THEME = 245,
    DATA_ID_PROFILE_DIRTY = 246,
    DATA_ID_CHANNEL_TITLE = 247,
    DATA_ID_CHANNEL_SHORT_TITLE = 248,
    DATA_ID_CHANNEL_LONG_TITLE = 249
};
...
void data_channel_max(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_small1(DataOperationEnum operation, Cursor &cursor, Value &value);
void data_channel_small2(DataOperationEnum operation, Cursor &cursor, Value &value);
...
enum ActionsEnum {
    ...
    ACTION_ID_SYS_SETTINGS_ENCODER_TOGGLE_CONFIRMATION_MODE = 133,
    ACTION_ID_TURN_DISPLAY_OFF = 134,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_TRIGGER_MODE = 135,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_VOLTAGE_TRIGGER_VALUE = 136,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_CURRENT_TRIGGER_VALUE = 137,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_LIST_COUNT = 138,
    ACTION_ID_CH_SETTINGS_TRIGGER_TOGGLE_OUTPUT_STATE = 139,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_ON_LIST_STOP = 140,
    ACTION_ID_CHANNEL_LISTS_PREVIOUS_PAGE = 141,
    ACTION_ID_CHANNEL_LISTS_NEXT_PAGE = 142,
    ACTION_ID_CHANNEL_LISTS_EDIT = 143,
    ACTION_ID_SHOW_CHANNEL_LISTS_INSERT_MENU = 144,
    ACTION_ID_SHOW_CHANNEL_LISTS_DELETE_MENU = 145,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_ABOVE = 146,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_BELOW = 147,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROW = 148,
    ACTION_ID_CHANNEL_LISTS_CLEAR_COLUMN = 149,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROWS = 150,
    ACTION_ID_CHANNEL_LISTS_DELETE_ALL = 151,
    ACTION_ID_CHANNEL_INITIATE_TRIGGER = 152,
    ACTION_ID_CHANNEL_SET_TO_FIXED = 153,
    ACTION_ID_CHANNEL_ENABLE_OUTPUT = 154,
    ACTION_ID_TRIGGER_SELECT_SOURCE = 155,
    ACTION_ID_TRIGGER_EDIT_DELAY = 156,
    ACTION_ID_TRIGGER_TOGGLE_INITIATE_CONTINUOUSLY = 157,
    ACTION_ID_TRIGGER_GENERATE_MANUAL = 158,
    ACTION_ID_TRIGGER_SHOW_GENERAL_SETTINGS = 159,
    ACTION_ID_SHOW_STAND_BY_MENU = 160,
    ACTION_ID_RESET = 161,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_SELECT_MODE = 162,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_TOGGLE_AUTO_RANGING = 163,
    ACTION_ID_IO_PIN_TOGGLE_POLARITY = 164,
    ACTION_ID_IO_PIN_SELECT_FUNCTION = 165,
    ACTION_ID_SERIAL_TOGGLE = 166,
    ACTION_ID_SERIAL_SELECT_PARITY = 167,
    ACTION_ID_NTP_TOGGLE = 168,
    ACTION_ID_NTP_EDIT_SERVER = 169,
    ACTION_ID_OPEN_APPLICATION = 170,
    ACTION_ID_SHOW_HOME = 171,
    ACTION_ID_SELECT_THEME = 172,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 173
};
...
enum StylesEnum {
    ...
    STYLE_ID_TOUCH_CALIBRATION = 10,
    STYLE_ID_TOUCH_CALIBRATION_ACTIVE = 11,
    STYLE_ID_EDIT_INFO_S = 12,
    STYLE_ID_BOTTOM_BUTTON_BACKGROUND = 13,
    STYLE_ID_BOTTOM_BUTTON = 14,
    STYLE_ID_HOME = 15,
    STYLE_ID_HOME_ICON = 16,
    STYLE_ID_HOME_ICON_ACTIVE = 17,
    STYLE_ID_DEFAULT_GUI_TMPL = 18,
    STYLE_ID_STATUS_BGND = 19,
    STYLE_ID_DEFAULT_INVERSE = 20,
    STYLE_ID_CHANNEL_OFF = 21,
    STYLE_ID_MON_VALUE_L_RIGHT = 22,
    STYLE_ID_MON_VALUE_UR_L_RIGHT = 23,
    STYLE_ID_MON_VALUE_FOCUS = 24,
    STYLE_ID_MON_VALUE = 25,
    STYLE_ID_MON_DAC = 26,
    STYLE_ID_EDIT_S = 27,
    STYLE_ID_CHANNEL_ERROR = 28,
    STYLE_ID_BAR_GRAPH_U_DEFUALT = 29,
    STYLE_ID_BAR_GRAPH_TEXT = 30,
    STYLE_ID_BAR_GRAPH_SET_LINE = 31,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 32,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 33,
    STYLE_ID_BAR_GRAPH_UNREGULATED = 34,
    STYLE_ID_EDIT_VALUE_S_RIGHT = 35,
    STYLE_ID_EDIT_VALUE_FOCUS_S_RIGHT = 36,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_RIGHT = 37,
    STYLE_ID_MON_DAC_S = 38,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_CENTER = 39,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 40,
    STYLE_ID_BAR_GRAPH_TEXT_VERTICAL = 41,
    STYLE_ID_EDIT_S_FOCUS = 42,
    STYLE_ID_YT_GRAPH = 43,
    STYLE_ID_YT_GRAPH_U_DEFUALT = 44,
    STYLE_ID_YT_GRAPH_I_DEFAULT = 45,
    STYLE_ID_YT_GRAPH_UNREGULATED = 46,
    STYLE_ID_COUPLED_INFO_S = 47,
    STYLE_ID_EDIT_VALUE = 48,
    STYLE_ID_EVENT_INFO_ICON = 49,
    STYLE_ID_EVENT_WARNING_ICON = 50,
    STYLE_ID_EVENT_ERROR_ICON = 51,
    STYLE_ID_PROT_INDICATOR_INVALID_S = 52,
    STYLE_ID_PROT_INDICATOR_S = 53,
    STYLE_ID_PROT_INDICATOR_SET_S = 54,
    STYLE_ID_PROT_INDICATOR_TRIP_S = 55,
    STYLE_ID_BUTTON_INDICATOR_ON = 56,
    STYLE_ID_BUTTON_INDICATOR_ERROR = 57,
    STYLE_ID_BUTTON_INDICATOR_OFF = 58,
    STYLE_ID_PROT_INDICATOR_BLINK_S = 59,
    STYLE_ID_DEFAULT_S_LEFT = 60,
    STYLE_ID_BOTTOM_BUTTON_DISABLED = 61,
    STYLE_ID_EDIT_VALUE_S_LEFT = 62,
    STYLE_ID_KEY = 63,
    STYLE_ID_KEY_ICONS = 64,
    STYLE_ID_KEY_DISABLED = 65,
    STYLE_ID_TAB_PAGE_SELECTED = 66,
    STYLE_ID_TAB_PAGE = 67,
    STYLE_ID_EDIT_VALUE_L = 68,
    STYLE_ID_VALUE = 69,
    STYLE_ID_VALUE_S = 70,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 71,
    STYLE_ID_YELLOW_1 = 72,
    STYLE_ID_YELLOW_2 = 73,
    STYLE_ID_YELLOW_3 = 74,
    STYLE_ID_YELLOW_4 = 75,
    STYLE_ID_YELLOW_5 = 76,
    STYLE_ID_YELLOW_6 = 77,
    STYLE_ID_YES_NO = 78,
    STYLE_ID_YES_NO_BACKGROUND = 79,
    STYLE_ID_YES_NO_MESSAGE = 80,
    STYLE_ID_YES_NO_BUTTON = 81,
    STYLE_ID_TEXT_MESSAGE = 82,
    STYLE_ID_ASYNC_OPERATION = 83,
    STYLE_ID_EVENT_INFO = 84,
    STYLE_ID_EVENT_WARNING = 85,
    STYLE_ID_EVENT_ERROR = 86,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 87,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_LEFT = 88,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 89,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 90,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 91,
    STYLE_ID_LIST_GRAPH_CURSOR = 92,
    STYLE_ID_YT_GRAPH_U_DEFUALT_LABEL = 93,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 94,
    STYLE_ID_EDIT_VALUE_FOCUS_S_CENTER = 95,
    STYLE_ID_EDIT_VALUE_LEFT = 96,
    STYLE_ID_EDIT_VALUE_ACTIVE_LEFT = 97,
    STYLE_ID_EDIT_VALUE_ACTIVE = 98,
    STYLE_ID_DEFAULT_DISABLED = 99,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S = 100,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_DISABLED = 101,
    STYLE_ID_DISPLAY_OFF = 102,
    STYLE_ID_DISPLAY_OFF_S = 103,
    STYLE_ID_SET_VALUE_S_RIGHT_BALANCED = 104,
    STYLE_ID_SET_VALUE_BALANCED = 105,
    STYLE_ID_SET_VALUE_FOCUS_BALANCED = 106,
    STYLE_ID_DEFAULT_3 = 107,
    STYLE_ID_ENCODER_CURSOR = 108
};
...
enum PagesEnum {
    ...
    PAGE_ID_MAIN = 8,
    PAGE_ID_OLD_MAIN = 9,
    PAGE_ID_OLD_STATUS_BAR = 10,
    PAGE_ID_OLD_TASK_BAR = 11,
    PAGE_ID_MAIN_HELP = 12,
    PAGE_ID_EDIT_MODE_KEYPAD = 13,
    PAGE_ID_EDIT_MODE_STEP = 14,
    PAGE_ID_EDIT_MODE_STEP_HELP = 15,
    PAGE_ID_EDIT_MODE_SLIDER = 16,
    PAGE_ID_EDIT_MODE_SLIDER_HELP = 17,
    PAGE_ID_YES_NO = 18,
    PAGE_ID_ARE_YOU_SURE_WITH_MESSAGE = 19,
    PAGE_ID_YES_NO_LATER = 20,
    ...
    PAGE_ID_CH_SETTINGS_LISTS_DELETE_MENU = 36,
    PAGE_ID_CH_START_LIST = 37,
    PAGE_ID_CH_SETTINGS_ADV = 38,
    PAGE_ID_CH_SETTINGS_ADV_REMOTE = 39,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 40,
    PAGE_ID_CH_SETTINGS_ADV_TRACKING = 41,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING = 42,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING_INFO = 43,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 44,
    PAGE_ID_CH_SETTINGS_INFO = 45,
    PAGE_ID_SYS_SETTINGS = 46,
    PAGE_ID_SYS_SETTINGS_AUX_OTP = 47,
    ...
    PAGE_ID_SYS_SETTINGS_SERIAL = 53,
    PAGE_ID_SYS_SETTINGS_ETHERNET = 54,
    PAGE_ID_SYS_SETTINGS_ETHERNET_STATIC = 55,
    PAGE_ID_SYS_SETTINGS_CAL = 56,
    PAGE_ID_SYS_SETTINGS_CAL_CH = 57,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP = 58,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_FINISH = 59,
    PAGE_ID_SYS_SETTINGS_SCREEN_CALIBRATION = 60,
    PAGE_ID_SYS_SETTINGS_DISPLAY = 61,
    PAGE_ID_SYS_SETTINGS_SOUND = 62,
    PAGE_ID_USER_PROFILES = 63,
    PAGE_ID_USER_PROFILES2 = 64,
    PAGE_ID_USER_PROFILE_SETTINGS = 65,
    PAGE_ID_USER_PROFILE_0_SETTINGS = 66,
    PAGE_ID_SYS_INFO = 67,
    PAGE_ID_SYS_INFO2 = 68,
    PAGE_ID_STAND_BY_MENU = 69,
    PAGE_ID_ENTERING_STANDBY = 70,
    PAGE_ID_STANDBY = 71,
    PAGE_ID_DISPLAY_OFF = 72,
    PAGE_ID_CHANNELS = 73,
    PAGE_ID_PROFILE = 74,
    PAGE_ID_PROFILE_BASIC_INFO = 75,
    PAGE_ID_COUPLED_CHANNELS_DEFAULT_VIEW = 76,
    PAGE_ID_COUPLED_CHANNELS_HORIZONTAL_BAR_VIEW = 77,
    PAGE_ID_COUPLED_CHANNELS_VERTICAL_BAR_VIEW = 78,
    PAGE_ID_COUPLED_CHANNELS_YTBAR_VIEW = 79,
    PAGE_ID_OCP = 80,
    PAGE_ID_OVP = 81,
    PAGE_ID_OTP = 82,
    PAGE_ID_OPP = 83,
    PAGE_ID_MINIMIZED_APP_VIEW = 84,
    PAGE_ID_GUI_TMPL_ONE_MAX_STATUS_LINE_BOTTOM = 85,
    PAGE_ID_GUI_TMPL_SYSTEM_SETTINGS_STATUS_LINE_BOTTOM = 86,
    PAGE_ID_GUI_TMPL_DEFAULT_VERTICAL_NUMERIC_ETC = 87,
    PAGE_ID_GUI_TMPL_HORIZONTAL_GRAPH_BAR = 88,
    PAGE_ID_GUI_TMPL_OUTPUT_COUPLINGS = 89,
    PAGE_ID_DCP405_DEFAULT_NUMERIC = 90,
    PAGE_ID_DCP405_DEFAULT_VERT_BAR = 91,
    PAGE_ID_DCP405_DEFAULT_HORZ_BAR = 92,
    PAGE_ID_DCP405_DEFAULT_VERT_OFF = 93,
    PAGE_ID_DCP405_DEFAULT_HORZ_OFF = 94,
    PAGE_ID_CHANNELS_DEFAULT_NUMERIC = 95,
    PAGE_ID_CHANNELS_DEFAULT_VERT_BAR = 96,
    PAGE_ID_CHANNELS_DEFAULT_HORZ_BAR = 97,
    PAGE_ID_DCP405_MAX = 98,
    PAGE_ID_DCP405_SMALL = 99
};

extern const uint8_t assets[210626];
