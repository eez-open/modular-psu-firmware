enum DataEnum {
    ...
    DATA_ID_EDIT_MODE_INTERACTIVE_MODE_SELECTOR = 40,
    DATA_ID_EDIT_STEPS = 41,
    DATA_ID_MODEL_INFO = 42,
    DATA_ID_FIRMWARE_INFO = 43,
    DATA_ID_SELF_TEST_RESULT = 44,
    DATA_ID_KEYPAD_TEXT = 45,
    DATA_ID_KEYPAD_CAPS = 46,
    DATA_ID_KEYPAD_OPTION1_TEXT = 47,
    DATA_ID_KEYPAD_OPTION1_ENABLED = 48,
    DATA_ID_KEYPAD_OPTION2_TEXT = 49,
    DATA_ID_KEYPAD_OPTION2_ENABLED = 50,
    DATA_ID_KEYPAD_SIGN_ENABLED = 51,
    DATA_ID_KEYPAD_DOT_ENABLED = 52,
    DATA_ID_KEYPAD_UNIT_ENABLED = 53,
    DATA_ID_CHANNEL_LABEL = 54,
    DATA_ID_CHANNEL_SHORT_LABEL = 55,
    DATA_ID_CHANNEL_TEMP_STATUS = 56,
    DATA_ID_CHANNEL_TEMP = 57,
    DATA_ID_CHANNEL_ON_TIME_TOTAL = 58,
    DATA_ID_CHANNEL_ON_TIME_LAST = 59,
    DATA_ID_CHANNEL_CALIBRATION_STATUS = 60,
    DATA_ID_CHANNEL_CALIBRATION_STATE = 61,
    DATA_ID_CHANNEL_CALIBRATION_DATE = 62,
    DATA_ID_CHANNEL_CALIBRATION_REMARK = 63,
    DATA_ID_CHANNEL_CALIBRATION_STEP_IS_SET_REMARK_STEP = 64,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NUM = 65,
    DATA_ID_CHANNEL_CALIBRATION_STEP_STATUS = 66,
    DATA_ID_CHANNEL_CALIBRATION_STEP_LEVEL_VALUE = 67,
    DATA_ID_CHANNEL_CALIBRATION_STEP_VALUE = 68,
    DATA_ID_CHANNEL_CALIBRATION_STEP_PREV_ENABLED = 69,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NEXT_ENABLED = 70,
    DATA_ID_CAL_CH_U_MIN = 71,
    DATA_ID_CAL_CH_U_MID = 72,
    DATA_ID_CAL_CH_U_MAX = 73,
    DATA_ID_CAL_CH_I0_MIN = 74,
    DATA_ID_CAL_CH_I0_MID = 75,
    DATA_ID_CAL_CH_I0_MAX = 76,
    DATA_ID_CAL_CH_I1_MIN = 77,
    DATA_ID_CAL_CH_I1_MID = 78,
    DATA_ID_CAL_CH_I1_MAX = 79,
    DATA_ID_CHANNEL_PROTECTION_STATUS = 80,
    DATA_ID_CHANNEL_PROTECTION_OVP_STATE = 81,
    DATA_ID_CHANNEL_PROTECTION_OVP_LEVEL = 82,
    DATA_ID_CHANNEL_PROTECTION_OVP_DELAY = 83,
    DATA_ID_CHANNEL_PROTECTION_OVP_LIMIT = 84,
    DATA_ID_CHANNEL_PROTECTION_OCP_STATE = 85,
    DATA_ID_CHANNEL_PROTECTION_OCP_DELAY = 86,
    DATA_ID_CHANNEL_PROTECTION_OCP_LIMIT = 87,
    DATA_ID_CHANNEL_PROTECTION_OCP_MAX_CURRENT_LIMIT_CAUSE = 88,
    DATA_ID_CHANNEL_PROTECTION_OPP_STATE = 89,
    DATA_ID_CHANNEL_PROTECTION_OPP_LEVEL = 90,
    DATA_ID_CHANNEL_PROTECTION_OPP_DELAY = 91,
    DATA_ID_CHANNEL_PROTECTION_OPP_LIMIT = 92,
    DATA_ID_CHANNEL_PROTECTION_OTP_INSTALLED = 93,
    DATA_ID_CHANNEL_PROTECTION_OTP_STATE = 94,
    DATA_ID_CHANNEL_PROTECTION_OTP_LEVEL = 95,
    DATA_ID_CHANNEL_PROTECTION_OTP_DELAY = 96,
    DATA_ID_EVENT_QUEUE_LAST_EVENT_TYPE = 97,
    DATA_ID_EVENT_QUEUE_LAST_EVENT_MESSAGE = 98,
    DATA_ID_EVENT_QUEUE_EVENTS = 99,
    DATA_ID_EVENT_QUEUE_EVENTS_TYPE = 100,
    DATA_ID_EVENT_QUEUE_EVENTS_MESSAGE = 101,
    DATA_ID_EVENT_QUEUE_MULTIPLE_PAGES = 102,
    DATA_ID_EVENT_QUEUE_PREVIOUS_PAGE_ENABLED = 103,
    DATA_ID_EVENT_QUEUE_NEXT_PAGE_ENABLED = 104,
    DATA_ID_EVENT_QUEUE_PAGE_INFO = 105,
    ...
    DATA_ID_CHANNEL_TRIGGER_OUTPUT_STATE = 186,
    ...
    DATA_ID_SERIAL_BAUD = 221,
    DATA_ID_SERIAL_PARITY = 222,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 223,
    DATA_ID_IO_PINS = 224,
    DATA_ID_IO_PINS_INHIBIT_STATE = 225,
    DATA_ID_IO_PIN_NUMBER = 226,
    DATA_ID_IO_PIN_POLARITY = 227,
    DATA_ID_IO_PIN_FUNCTION = 228,
    DATA_ID_NTP_ENABLED = 229,
    DATA_ID_NTP_SERVER = 230,
    DATA_ID_ASYNC_OPERATION_THROBBER = 231,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 232,
    DATA_ID_PROGRESS = 233,
    DATA_ID_VIEW_STATUS = 234,
    DATA_ID_DLOG_STATUS = 235,
    DATA_ID_APPLICATIONS = 236,
    DATA_ID_APPLICATION_TITLE = 237,
    DATA_ID_APPLICATION_ICON = 238,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 239,
    DATA_ID_FOREGROUND_APPLICATION = 240,
    DATA_ID_FOREGROUND_APPLICATION_TITLE = 241,
    DATA_ID_TOUCH_CALIBRATION_POINT = 242,
    DATA_ID_SELECTED_THEME = 243,
    DATA_ID_PROFILE_DIRTY = 244,
    DATA_ID_CHANNEL_TITLE = 245,
    DATA_ID_CHANNEL_SHORT_TITLE = 246,
    DATA_ID_CHANNEL_LONG_TITLE = 247,
    DATA_ID_SCRIPTS = 248,
    DATA_ID_SCRIPT_NAME = 249,
    DATA_ID_SCRIPTS_PAGE_MODE = 250,
    DATA_ID_SCRIPTS_MULTIPLE_PAGES = 251,
    DATA_ID_SCRIPTS_PREVIOUS_PAGE_ENABLED = 252,
    DATA_ID_SCRIPTS_NEXT_PAGE_ENABLED = 253,
    DATA_ID_SCRIPTS_PAGE_INFO = 254
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_SCRIPTS = 174,
    ACTION_ID_START_SCRIPT = 175,
    ACTION_ID_SET_SCRIPTS_PAGE_MODE_SCRIPTS = 176,
    ACTION_ID_SET_SCRIPTS_PAGE_MODE_SHELL = 177,
    ACTION_ID_SCRIPTS_PREVIOUS_PAGE = 178,
    ACTION_ID_SCRIPTS_NEXT_PAGE = 179
};
...
enum StylesEnum {
    ...
    STYLE_ID_EDIT_VALUE_ACTIVE_S_LEFT = 63,
    STYLE_ID_KEY = 64,
    STYLE_ID_KEY_ICONS = 65,
    STYLE_ID_KEY_DISABLED = 66,
    STYLE_ID_TAB_PAGE_SELECTED = 67,
    STYLE_ID_TAB_PAGE = 68,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 69,
    STYLE_ID_SLIDER_SHADE_1 = 70,
    STYLE_ID_SLIDER_SHADE_2 = 71,
    STYLE_ID_SLIDER_SHADE_3 = 72,
    STYLE_ID_SLIDER_SHADE_4 = 73,
    STYLE_ID_SLIDER_SHADE_5 = 74,
    STYLE_ID_SLIDER_SHADE_6 = 75,
    STYLE_ID_YES_NO = 76,
    STYLE_ID_YES_NO_BACKGROUND = 77,
    STYLE_ID_YES_NO_MESSAGE = 78,
    STYLE_ID_YES_NO_BUTTON = 79,
    STYLE_ID_TEXT_MESSAGE = 80,
    STYLE_ID_ASYNC_OPERATION = 81,
    STYLE_ID_EVENT_INFO = 82,
    STYLE_ID_EVENT_WARNING = 83,
    STYLE_ID_EVENT_ERROR = 84,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 85,
    STYLE_ID_KEY_SPEC_ICONS = 86,
    STYLE_ID_VALUE_S = 87,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 88,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 89,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 90,
    STYLE_ID_LIST_GRAPH_CURSOR = 91,
    STYLE_ID_YT_GRAPH_U_DEFUALT_LABEL = 92,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 93,
    STYLE_ID_EDIT_VALUE_FOCUS_S_CENTER = 94,
    STYLE_ID_EDIT_VALUE_LEFT = 95,
    STYLE_ID_EDIT_VALUE_ACTIVE_LEFT = 96,
    STYLE_ID_EDIT_VALUE_L = 97,
    STYLE_ID_EDIT_VALUE_ACTIVE = 98,
    STYLE_ID_DEFAULT_DISABLED = 99,
    STYLE_ID_VALUE = 100,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S = 101,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_DISABLED = 102,
    STYLE_ID_DISPLAY_OFF = 103,
    STYLE_ID_DISPLAY_OFF_S = 104,
    STYLE_ID_SET_VALUE_S_RIGHT_BALANCED = 105,
    STYLE_ID_SET_VALUE_BALANCED = 106,
...
enum PagesEnum {
    ...
    PAGE_ID_DCP405_DEFAULT_VERT_OFF = 92,
    PAGE_ID_DCP405_DEFAULT_HORZ_BAR = 93,
    PAGE_ID_DCP405_DEFAULT_YT = 94,
    PAGE_ID_DCP405_DEFAULT_HORZ_OFF = 95,
    PAGE_ID_CHANNELS_DEFAULT_NUMERIC = 96,
    PAGE_ID_CHANNELS_DEFAULT_VERT_BAR = 97,
    PAGE_ID_CHANNELS_DEFAULT_HORZ_BAR = 98,
    PAGE_ID_CHANNELS_DEFAULT_YT = 99,
