enum DataEnum {
    ...
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 343,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 344,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 345,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 346,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 347,
    DATA_ID_IS_RESET_BY_IWDG = 348,
    DATA_ID_DLOG_ENABLED = 349,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 350,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 351,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 352,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 353,
    ...
    DATA_ID_IS_MULTI_TRACKING = 362,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 363,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 364,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 365,
    DATA_ID_CHANNEL_INFO_BRAND = 366,
    DATA_ID_CHANNEL_INFO_SERIAL = 367,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 368,
...
enum StylesEnum {
    ...
    STYLE_ID_SCROLLBAR_THUMB = 153,
    STYLE_ID_SCROLLBAR_BUTTON = 154,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 155,
    STYLE_ID_KEY_SPEC_ICONS = 157,
    STYLE_ID_KEY_SPEC_ICONS_DISABLED = 159,
    STYLE_ID_KEY_DISABLED = 160,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 161,
    STYLE_ID_VALUE_M = 169,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 172,
    STYLE_ID_YT_GRAPH = 174,
    STYLE_ID_LIST_GRAPH_CURSOR = 175,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 176,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 177,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 178,
    STYLE_ID_VALUE = 182,
    STYLE_ID_DEFAULT_M = 186,
    STYLE_ID_NON_INTERACTIVE_BUTTON_M = 187,
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 188,
    STYLE_ID_EVENT_ERROR = 189,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 190,
    STYLE_ID_ICON_AND_TEXT_S = 192,
    STYLE_ID_ICON_AND_TEXT_S_DISABLED = 193,
    STYLE_ID_DEFAULT_DISABLED = 200,
    STYLE_ID_EDIT_VALUE_M_CENTERED = 203,
    STYLE_ID_EDIT_S = 204,
    STYLE_ID_EVENT_WARNING = 223,
    STYLE_ID_DISPLAY_OFF = 224,
    STYLE_ID_DISPLAY_OFF_S = 225,
    STYLE_ID_MON_VALUE_48_RIGHT = 228,
    STYLE_ID_MON_VALUE_20_LEFT = 230,
    STYLE_ID_ENCODER_CURSOR_14_DISABLED = 231,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 232,
    STYLE_ID_BAR_GRAPH_TEXT = 233,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 235,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 236,
    STYLE_ID_TRIGGER_BUTTON_24 = 238,
    STYLE_ID_MON_VALUE_14_RIGHT = 240,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_DISABLED = 241,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 242,
    STYLE_ID_ENCODER_CURSOR_14_LEFT_DISABLED = 243,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 244,
    STYLE_ID_TRIGGER_BUTTON_14 = 245,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 251,
    STYLE_ID_INST_SELECTED = 252,
    STYLE_ID_MON_VALUE_38_RIGHT = 253,
    STYLE_ID_CH_PROT_OFF = 255,
    STYLE_ID_CH_PROT_ON = 256,
    STYLE_ID_CH_PROT_TRIPPED = 257,
    STYLE_ID_BUTTON_BGND = 258,
    STYLE_ID_MON_VALUE_24_RIGHT = 260,
    STYLE_ID_MON_VALUE_14_CENTER = 261,
    STYLE_ID_MON_VALUE_20_RIGHT = 267,
    STYLE_ID_MON_VALUE_14_LEFT = 268,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 269,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 273,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 274,
    STYLE_ID_SCROLLBAR_TRACK = 275,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 286
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[310887];
#else
extern const uint8_t assets[1366128];
#endif
