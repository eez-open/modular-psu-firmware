...
enum PagesEnum {
    ...
    PAGE_ID_DCM220_FRONT_PANEL_LED = 163,
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 164,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 165,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 166,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 167,
    PAGE_ID_TOUCH_TEST = 168,
    PAGE_ID_DEBUG_VARIABLES = 169,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 170,
    PAGE_ID_OVP_TYPE = 171,
    PAGE_ID_DEBUG_POWER_CHANNELS = 172,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 173,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 174,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 175,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 176
};

extern const uint8_t assets[316416];
