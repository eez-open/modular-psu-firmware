enum DataEnum {
    ...
    DATA_ID_BATTERY = 268,
    DATA_ID_IO_PIN_STATE = 269,
    DATA_ID_CHANNEL_DPROG = 270,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 271,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 272,
    DATA_ID_SYS_INFO_HAS_ERROR = 273,
    ...
    DATA_ID_DLOG_STATE = 290,
    DATA_ID_DLOG_TOGGLE_STATE = 291,
    DATA_ID_RECORDING = 292,
    DATA_ID_CHANNEL_HISTORY_VALUES = 293,
    DATA_ID_RECORDING_READY = 294,
    DATA_ID_NONDRAG_OVERLAY = 295,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 296,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 297,
    DATA_ID_DLOG_VISIBLE_VALUES = 298,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 299,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 300,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 301,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 302,
    DATA_ID_DLOG_ALL_VALUES = 303,
    DATA_ID_DLOG_VALUE_LABEL = 304,
    DATA_ID_DLOG_CURRENT_TIME = 305,
    DATA_ID_DLOG_FILE_LENGTH = 306,
    DATA_ID_DLOG_X_AXIS_OFFSET = 307,
    DATA_ID_DLOG_X_AXIS_DIV = 308,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 309,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 310,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 311,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 312,
    DATA_ID_DLOG_VIEW_STATE = 313,
    DATA_ID_DLOG_PERIOD = 314,
    DATA_ID_DLOG_DURATION = 315,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 316,
    DATA_ID_DLOG_CURRENT_ENABLED = 317,
    DATA_ID_DLOG_POWER_ENABLED = 318,
    DATA_ID_DLOG_START_ENABLED = 319,
    DATA_ID_DLOG_FILE_NAME = 320,
    DATA_ID_DLOG_VALUE_STATE = 321,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 322,
    DATA_ID_CHANNEL_OFF_LABEL = 323,
    DATA_ID_FILE_MANAGER_FILES = 324,
    DATA_ID_FILE_MANAGER_FILE_NAME = 325,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 326,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 327,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 328,
    DATA_ID_FILE_MANAGER_STATE = 329,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 330,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 331,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 332,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 333,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 334,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 335,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 336,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 337,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 338,
    DATA_ID_SCRIPT_INFO = 339,
    DATA_ID_SCRIPT_IS_STARTED = 340,
    DATA_ID_DEBUG_TRACE_LOG = 341,
    DATA_ID_DEBUG_TRACE_LOG_LINE = 342,
    ...
    DATA_ID_DEBUG_TRACE_LOG_IS_STOPPED = 350,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 351,
    ...
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 356,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 357,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 358,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 359,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 360,
    DATA_ID_IS_RESET_BY_IWDG = 361,
    DATA_ID_DLOG_ENABLED = 362
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[300181];
#else
extern const uint8_t assets[1313732];
#endif
