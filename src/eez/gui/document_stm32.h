enum DataEnum {
    ...
    DATA_ID_SELECTED_THEME = 234,
    DATA_ID_CHANNEL_TITLE = 235,
    DATA_ID_CHANNEL_SHORT_TITLE = 236,
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 237,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 238,
    DATA_ID_CHANNEL_LONG_TITLE = 239,
    DATA_ID_ANIMATIONS_DURATION = 240,
    DATA_ID_SLOT1_INFO = 241,
    DATA_ID_SLOT2_INFO = 242,
    DATA_ID_SLOT3_INFO = 243,
    DATA_ID_SLOT1_TEST_RESULT = 244,
    DATA_ID_SLOT2_TEST_RESULT = 245,
    DATA_ID_SLOT3_TEST_RESULT = 246,
    DATA_ID_SLOT_DEFAULT1_VIEW = 247,
    DATA_ID_SLOT_DEFAULT2_VIEW = 248,
    DATA_ID_SLOT_DEFAULT3_VIEW = 249,
    DATA_ID_SLOT1_CHANNEL_INDEX = 250,
    DATA_ID_SLOT2_CHANNEL_INDEX = 251,
    DATA_ID_SLOT3_CHANNEL_INDEX = 252,
    DATA_ID_SLOT_DEF_2CH_VIEW = 253,
    DATA_ID_SLOT_MAX_2CH_VIEW = 254,
    DATA_ID_SLOT_MIN_2CH_VIEW = 255,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 256,
    DATA_ID_SLOT_2CH_CH1_INDEX = 257,
    DATA_ID_SLOT_2CH_CH2_INDEX = 258,
    DATA_ID_BATTERY = 259,
    DATA_ID_IO_PIN_STATE = 260,
    DATA_ID_CHANNEL_DPROG = 261,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 262,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 263,
    DATA_ID_SYS_INFO_HAS_ERROR = 264,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 265,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 266,
    DATA_ID_SYS_FAN_MODE = 267,
    DATA_ID_SYS_FAN_SPEED = 268,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 269,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 270,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 271,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 272,
    DATA_ID_IS_TRACKING_ALLOWED = 273,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 274,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 275,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 276,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 277,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 278,
    DATA_ID_IS_COUPLED_OR_TRACKED = 279,
    DATA_ID_OVERLAY = 280,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 281,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 282,
    DATA_ID_DLOG_STATE = 283,
    DATA_ID_DLOG_TOGGLE_STATE = 284,
    DATA_ID_RECORDING = 285,
    DATA_ID_CHANNEL_HISTORY_VALUES = 286,
    DATA_ID_RECORDING_READY = 287,
    DATA_ID_NONDRAG_OVERLAY = 288,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 289,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 290,
    DATA_ID_DLOG_VISIBLE_VALUES = 291,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 292,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 293,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 294,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 295,
    DATA_ID_DLOG_ALL_VALUES = 296,
    DATA_ID_DLOG_VALUE_LABEL = 297,
    DATA_ID_DLOG_CURRENT_TIME = 298,
    DATA_ID_DLOG_FILE_LENGTH = 299,
    DATA_ID_DLOG_X_AXIS_OFFSET = 300,
    DATA_ID_DLOG_X_AXIS_DIV = 301,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 302,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 303,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 304,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 305,
    DATA_ID_DLOG_VIEW_STATE = 306,
    DATA_ID_DLOG_PERIOD = 307,
    DATA_ID_DLOG_DURATION = 308,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 309,
    DATA_ID_DLOG_CURRENT_ENABLED = 310,
    DATA_ID_DLOG_POWER_ENABLED = 311,
    DATA_ID_DLOG_START_ENABLED = 312,
    DATA_ID_DLOG_FILE_NAME = 313,
    DATA_ID_DLOG_VALUE_STATE = 314,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 315,
    DATA_ID_CHANNEL_OFF_LABEL = 316,
    DATA_ID_FILE_MANAGER_FILES = 317,
    DATA_ID_FILE_MANAGER_FILE_NAME = 318,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 319,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 320,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 321,
    DATA_ID_FILE_MANAGER_STATE = 322,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 323,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 324,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 325,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 326,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 327,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 328,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 329,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 330,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 331,
    DATA_ID_SCRIPT_INFO = 332,
    DATA_ID_SCRIPT_IS_STARTED = 333,
    DATA_ID_KEYPAD_OK_ENABLED = 334,
    DATA_ID_ETHERNET_HOST_NAME = 335,
    DATA_ID_MQTT_HOST = 336,
    DATA_ID_MQTT_PORT = 337,
    DATA_ID_MQTT_USERNAME = 338,
    DATA_ID_MQTT_PASSWORD = 339,
    DATA_ID_MQTT_PERIOD = 340,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 341,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 342,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 343,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 344,
    DATA_ID_LIST_COUNTER_LABEL = 345,
    DATA_ID_RAMP_COUNTER_LABEL = 346,
    ...
    DATA_ID_DATE_TIME_FORMAT = 362,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 363,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 364,
    DATA_ID_DATE_TIME_AM_PM = 365,
    DATA_ID_IS_MULTI_TRACKING = 366,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 367,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 368,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 369,
    DATA_ID_CHANNEL_INFO_BRAND = 370,
    DATA_ID_CHANNEL_INFO_SERIAL = 371,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 372,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 373,
    DATA_ID_FILE_MANAGER_FILE_ICON = 374,
    DATA_ID_FILE_MANAGER_LAYOUT = 375,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 376,
    DATA_ID_TOUCH_RAW_X = 377,
    DATA_ID_TOUCH_RAW_Y = 378,
    DATA_ID_TOUCH_RAW_Z1 = 379,
    DATA_ID_TOUCH_RAW_PRESSED = 380,
    DATA_ID_TOUCH_CALIBRATED_X = 381,
    DATA_ID_TOUCH_CALIBRATED_Y = 382,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 383,
    DATA_ID_TOUCH_FILTERED_X = 384,
    DATA_ID_TOUCH_FILTERED_Y = 385,
    DATA_ID_TOUCH_FILTERED_PRESSED = 386,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 387,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 388,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 389,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 390,
    DATA_ID_ALERT_MESSAGE_IS_SET = 391,
    DATA_ID_ASYNC_PROGRESS = 392,
    DATA_ID_IO_PIN_FUNCTION = 393,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 394,
    DATA_ID_IO_PIN_PWM_DUTY = 395,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 396,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 397,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 398,
    DATA_ID_DEBUG_VARIABLES = 399,
    DATA_ID_DEBUG_VARIABLE_NAME = 400,
    DATA_ID_DEBUG_VARIABLE_VALUE = 401,
    DATA_ID_CHANNEL_RAMP_STATE = 402,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 403,
    DATA_ID_MQTT_IN_ERROR = 404
};
...
enum PagesEnum {
    ...
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 152,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 153,
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 154,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 155,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 156,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 157,
    PAGE_ID_TOUCH_TEST = 158,
    PAGE_ID_DEBUG_VARIABLES = 159,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 160,
    PAGE_ID_OVP_TYPE = 161
};

extern const uint8_t assets[299943];
