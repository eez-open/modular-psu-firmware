enum DataEnum {
    ...
    DATA_ID_CHANNEL_PROTECTION_OVP_LEVEL = 83,
    DATA_ID_CHANNEL_PROTECTION_OVP_DELAY = 84,
    DATA_ID_CHANNEL_PROTECTION_OVP_LIMIT = 85,
    DATA_ID_CHANNEL_PROTECTION_OCP_STATE = 86,
    DATA_ID_CHANNEL_PROTECTION_OCP_DELAY = 87,
    DATA_ID_CHANNEL_PROTECTION_OCP_LIMIT = 88,
    DATA_ID_CHANNEL_PROTECTION_OCP_MAX_CURRENT_LIMIT_CAUSE = 89,
    DATA_ID_CHANNEL_PROTECTION_OPP_STATE = 90,
    DATA_ID_CHANNEL_PROTECTION_OPP_LEVEL = 91,
    DATA_ID_CHANNEL_PROTECTION_OPP_DELAY = 92,
    DATA_ID_CHANNEL_PROTECTION_OPP_LIMIT = 93,
    DATA_ID_CHANNEL_PROTECTION_OTP_INSTALLED = 94,
    DATA_ID_CHANNEL_PROTECTION_OTP_STATE = 95,
    DATA_ID_CHANNEL_PROTECTION_OTP_LEVEL = 96,
    DATA_ID_CHANNEL_PROTECTION_OTP_DELAY = 97,
    DATA_ID_EVENT_QUEUE_LAST_EVENT_TYPE = 98,
    DATA_ID_EVENT_QUEUE_LAST_EVENT_MESSAGE = 99,
    DATA_ID_EVENT_QUEUE_EVENTS = 100,
    DATA_ID_EVENT_QUEUE_EVENTS_TYPE = 101,
    DATA_ID_EVENT_QUEUE_EVENTS_MESSAGE = 102,
    DATA_ID_EVENT_QUEUE_MULTIPLE_PAGES = 103,
    DATA_ID_EVENT_QUEUE_PREVIOUS_PAGE_ENABLED = 104,
    DATA_ID_EVENT_QUEUE_NEXT_PAGE_ENABLED = 105,
    DATA_ID_EVENT_QUEUE_PAGE_INFO = 106,
    DATA_ID_CHANNEL_RSENSE_STATUS = 107,
    DATA_ID_CHANNEL_RPROG_INSTALLED = 108,
    DATA_ID_CHANNEL_RPROG_STATUS = 109,
    DATA_ID_CHANNEL_IS_COUPLED = 110,
    DATA_ID_CHANNEL_IS_TRACKED = 111,
    DATA_ID_CHANNEL_IS_COUPLED_OR_TRACKED = 112,
    DATA_ID_CHANNEL_COUPLING_IS_ALLOWED = 113,
    DATA_ID_CHANNEL_COUPLING_MODE = 114,
    DATA_ID_CHANNEL_COUPLING_SELECTED_MODE = 115,
    ...
    DATA_ID_SYS_INFO_ETHERNET = 129,
    DATA_ID_SYS_INFO_FAN_STATUS = 130,
    DATA_ID_SYS_INFO_FAN_SPEED = 131,
    DATA_ID_CHANNEL_BOARD_INFO_LABEL = 132,
    DATA_ID_CHANNEL_BOARD_INFO_REVISION = 133,
    DATA_ID_DATE_TIME_DATE = 134,
    DATA_ID_DATE_TIME_YEAR = 135,
    DATA_ID_DATE_TIME_MONTH = 136,
    DATA_ID_DATE_TIME_DAY = 137,
    DATA_ID_DATE_TIME_TIME = 138,
    DATA_ID_DATE_TIME_HOUR = 139,
    DATA_ID_DATE_TIME_MINUTE = 140,
    DATA_ID_DATE_TIME_SECOND = 141,
    DATA_ID_DATE_TIME_TIME_ZONE = 142,
    DATA_ID_DATE_TIME_DST = 143,
    DATA_ID_SET_PAGE_DIRTY = 144,
    DATA_ID_PROFILES_LIST1 = 145,
    DATA_ID_PROFILES_LIST2 = 146,
    ...
    DATA_ID_CHANNEL_TRIGGER_OUTPUT_STATE = 187,
    DATA_ID_CHANNEL_TRIGGER_ON_LIST_STOP = 188,
    DATA_ID_CHANNEL_U_TRIGGER_VALUE = 189,
    DATA_ID_CHANNEL_I_TRIGGER_VALUE = 190,
    DATA_ID_CHANNEL_LIST_COUNT = 191,
    DATA_ID_CHANNEL_LISTS = 192,
    DATA_ID_CHANNEL_LIST_INDEX = 193,
    DATA_ID_CHANNEL_LIST_DWELL = 194,
    DATA_ID_CHANNEL_LIST_DWELL_ENABLED = 195,
    DATA_ID_CHANNEL_LIST_VOLTAGE = 196,
    DATA_ID_CHANNEL_LIST_VOLTAGE_ENABLED = 197,
    DATA_ID_CHANNEL_LIST_CURRENT = 198,
    DATA_ID_CHANNEL_LIST_CURRENT_ENABLED = 199,
    DATA_ID_CHANNEL_LISTS_PREVIOUS_PAGE_ENABLED = 200,
    DATA_ID_CHANNEL_LISTS_NEXT_PAGE_ENABLED = 201,
    DATA_ID_CHANNEL_LISTS_CURSOR = 202,
    DATA_ID_CHANNEL_LISTS_INSERT_MENU_ENABLED = 203,
    DATA_ID_CHANNEL_LISTS_DELETE_MENU_ENABLED = 204,
    DATA_ID_CHANNEL_LISTS_DELETE_ROW_ENABLED = 205,
    DATA_ID_CHANNEL_LISTS_CLEAR_COLUMN_ENABLED = 206,
    DATA_ID_CHANNEL_LISTS_DELETE_ROWS_ENABLED = 207,
    ...
    DATA_ID_SERIAL_BAUD = 222,
    DATA_ID_SERIAL_PARITY = 223,
    ...
    DATA_ID_VIEW_STATUS = 235,
    DATA_ID_DLOG_STATUS = 236,
    DATA_ID_APPLICATIONS = 237,
    DATA_ID_APPLICATION_TITLE = 238,
    DATA_ID_APPLICATION_ICON = 239,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 240,
    DATA_ID_FOREGROUND_APPLICATION = 241,
    DATA_ID_FOREGROUND_APPLICATION_TITLE = 242,
    DATA_ID_TOUCH_CALIBRATION_POINT = 243,
    DATA_ID_SELECTED_THEME = 244,
    DATA_ID_PROFILE_DIRTY = 245,
    DATA_ID_CHANNEL_TITLE = 246,
    DATA_ID_CHANNEL_SHORT_TITLE = 247,
...
enum StylesEnum {
    ...
    STYLE_ID_DEFAULT_GUI_TMPL = 19,
    STYLE_ID_STATUS_BGND = 20,
    STYLE_ID_DEFAULT_INVERSE = 21,
    STYLE_ID_CHANNEL_OFF = 22,
    STYLE_ID_MON_VALUE_L_RIGHT = 23,
    STYLE_ID_MON_VALUE_UR_L_RIGHT = 24,
    STYLE_ID_MON_VALUE_FOCUS = 25,
    STYLE_ID_MON_VALUE = 26,
    STYLE_ID_MON_DAC = 27,
    STYLE_ID_EDIT_S = 28,
    STYLE_ID_CHANNEL_ERROR = 29,
    STYLE_ID_BAR_GRAPH_U_DEFUALT = 30,
    STYLE_ID_BAR_GRAPH_TEXT = 31,
    STYLE_ID_BAR_GRAPH_SET_LINE = 32,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 33,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 34,
    STYLE_ID_BAR_GRAPH_UNREGULATED = 35,
    STYLE_ID_EDIT_VALUE_S_RIGHT = 36,
    STYLE_ID_EDIT_VALUE_FOCUS_S_RIGHT = 37,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_RIGHT = 38,
    STYLE_ID_MON_DAC_S = 39,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_CENTER = 40,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 41,
    STYLE_ID_BAR_GRAPH_TEXT_VERTICAL = 42,
    STYLE_ID_EDIT_S_FOCUS = 43,
    STYLE_ID_YT_GRAPH = 44,
    STYLE_ID_YT_GRAPH_U_DEFUALT = 45,
    STYLE_ID_YT_GRAPH_I_DEFAULT = 46,
    STYLE_ID_YT_GRAPH_UNREGULATED = 47,
    STYLE_ID_COUPLED_INFO_S = 48,
    STYLE_ID_EDIT_VALUE = 49,
    STYLE_ID_EVENT_INFO_ICON = 50,
    STYLE_ID_EVENT_WARNING_ICON = 51,
    STYLE_ID_EVENT_ERROR_ICON = 52,
    STYLE_ID_PROT_INDICATOR_INVALID_S = 53,
    STYLE_ID_PROT_INDICATOR_S = 54,
    STYLE_ID_PROT_INDICATOR_SET_S = 55,
    STYLE_ID_PROT_INDICATOR_TRIP_S = 56,
    STYLE_ID_BUTTON_INDICATOR_ON = 57,
    STYLE_ID_BUTTON_INDICATOR_ERROR = 58,
    STYLE_ID_BUTTON_INDICATOR_OFF = 59,
    STYLE_ID_PROT_INDICATOR_BLINK_S = 60,
    STYLE_ID_DEFAULT_S_LEFT = 61,
    STYLE_ID_BOTTOM_BUTTON_DISABLED = 62,
    STYLE_ID_EDIT_VALUE_S_LEFT = 63,
    STYLE_ID_KEY = 64,
    STYLE_ID_KEY_ICONS = 65,
    STYLE_ID_KEY_DISABLED = 66,
    STYLE_ID_TAB_PAGE_SELECTED = 67,
    STYLE_ID_TAB_PAGE = 68,
    STYLE_ID_EDIT_VALUE_L = 69,
    STYLE_ID_VALUE = 70,
    STYLE_ID_VALUE_S = 71,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 72,
    STYLE_ID_YELLOW_1 = 73,
    STYLE_ID_YELLOW_2 = 74,
    STYLE_ID_YELLOW_3 = 75,
    STYLE_ID_YELLOW_4 = 76,
    STYLE_ID_YELLOW_5 = 77,
    STYLE_ID_YELLOW_6 = 78,
    STYLE_ID_YES_NO = 79,
    STYLE_ID_YES_NO_BUTTON = 80,
    STYLE_ID_YES_NO_BACKGROUND = 81,
    STYLE_ID_YES_NO_MESSAGE = 82,
    STYLE_ID_TEXT_MESSAGE = 83,
    STYLE_ID_ASYNC_OPERATION = 84,
    STYLE_ID_ASYNC_OPERATION_ACTION = 85,
    STYLE_ID_EVENT_INFO = 86,
    STYLE_ID_EVENT_WARNING = 87,
    STYLE_ID_EVENT_ERROR = 88,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 89,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_LEFT = 90,
    STYLE_ID_KEY_SPEC_ICONS = 91,
    STYLE_ID_KEY_SPEC = 92,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 93,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 94,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 95,
    STYLE_ID_LIST_GRAPH_CURSOR = 96,
    STYLE_ID_YT_GRAPH_U_DEFUALT_LABEL = 97,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 98,
    STYLE_ID_EDIT_VALUE_FOCUS_S_CENTER = 99,
    STYLE_ID_EDIT_VALUE_LEFT = 100,
    STYLE_ID_EDIT_VALUE_ACTIVE_LEFT = 101,
    STYLE_ID_EDIT_VALUE_ACTIVE = 102,
    STYLE_ID_DEFAULT_DISABLED = 103,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S = 104,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_DISABLED = 105,
    STYLE_ID_DARK_LINE = 106,
    STYLE_ID_DISPLAY_OFF = 107,
    STYLE_ID_DISPLAY_OFF_S = 108,
    STYLE_ID_SET_VALUE_S_RIGHT_BALANCED = 109,
