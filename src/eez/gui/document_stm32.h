...
enum PagesEnum {
    ...
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 166,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 167,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 168,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 169,
    PAGE_ID_TOUCH_TEST = 170,
    PAGE_ID_DEBUG_VARIABLES = 171,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 172,
    PAGE_ID_OVP_TYPE = 173,
