...
enum ActionsEnum {
    ...
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_COUNTERPHASE_DITHERING = 263,
    ACTION_ID_DIB_DCM224_CH_SETTINGS_ADV_TOGGLE_PWM_ENABLED = 264
};
...
enum PagesEnum {
    ...
    PAGE_ID_DIB_DCM224_CH_SETTINGS_ERROR = 215,
...
extern const uint8_t assets[332300];
