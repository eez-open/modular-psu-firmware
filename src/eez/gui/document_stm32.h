enum DataEnum {
    ...
    DATA_ID_DEBUG_TRACE_LOG = 337,
    DATA_ID_DEBUG_TRACE_LOG_LINE = 338,
    ...
    DATA_ID_DEBUG_TRACE_LOG_IS_STOPPED = 346,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 347,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 348,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 349,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 350,
    DATA_ID_LIST_COUNTER_LABEL = 351,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 352,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 353,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 354,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 355,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 356,
    DATA_ID_IS_RESET_BY_IWDG = 357,
    DATA_ID_DLOG_ENABLED = 358,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 359,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 360,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 361,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 362,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 363
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[300998];
#else
extern const uint8_t assets[1314036];
#endif
