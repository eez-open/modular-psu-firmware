...
enum StylesEnum {
    ...
    STYLE_ID_ERROR_ALERT = 12,
    STYLE_ID_ERROR_ALERT_BUTTON = 13,
    STYLE_ID_YT_GRAPH_U_DEFAULT = 14,
    STYLE_ID_YT_GRAPH_I_DEFAULT = 15,
    STYLE_ID_YT_GRAPH_P_DEFAULT = 16,
    STYLE_ID_YT_GRAPH_UNREGULATED = 17,
    STYLE_ID_YT_GRAPH_Y1 = 18,
    STYLE_ID_YT_GRAPH_Y2 = 19,
    STYLE_ID_YT_GRAPH_Y3 = 20,
    STYLE_ID_YT_GRAPH_Y4 = 21,
    STYLE_ID_YT_GRAPH_Y5 = 22,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_CONTAINER = 23,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_CONTAINER_S = 24,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_ITEM = 25,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_ITEM_S = 26,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_DISABLED_ITEM = 27,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_DISABLED_ITEM_S = 28,
    STYLE_ID_INFO_ALERT = 29,
    STYLE_ID_MENU_WITH_BUTTONS_MESSAGE = 30,
    STYLE_ID_MENU_WITH_BUTTONS_CONTAINER = 31,
    STYLE_ID_MENU_WITH_BUTTONS_BUTTON = 32,
    STYLE_ID_CHANNEL1 = 33,
    STYLE_ID_CHANNEL2 = 34,
    STYLE_ID_CHANNEL3 = 35,
    STYLE_ID_CHANNEL4 = 36,
    STYLE_ID_CHANNEL5 = 37,
    STYLE_ID_CHANNEL6 = 38,
    STYLE_ID_CHANNEL1_INVERSE = 39,
    STYLE_ID_CHANNEL2_INVERSE = 40,
    STYLE_ID_CHANNEL3_INVERSE = 41,
    STYLE_ID_CHANNEL4_INVERSE = 42,
    STYLE_ID_CHANNEL5_INVERSE = 43,
    STYLE_ID_CHANNEL6_INVERSE = 44,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ERROR = 78,
    STYLE_ID_TOUCH_CALIBRATION = 97,
    STYLE_ID_BOTTOM_BUTTON_BACKGROUND = 102,
    STYLE_ID_BOTTOM_BUTTON = 103,
    ...
    STYLE_ID_VALUE_S = 115,
    STYLE_ID_EDIT_VALUE_M_LEFT = 116,
    STYLE_ID_KEY_ICONS = 117,
    STYLE_ID_KEY = 118,
    STYLE_ID_TAB_PAGE_SELECTED = 121,
    STYLE_ID_TAB_PAGE = 122,
    STYLE_ID_DEFAULT_INVERSE = 129,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 130,
    STYLE_ID_SLIDER_SHADE_1 = 131,
    STYLE_ID_SLIDER_SHADE_2 = 132,
    STYLE_ID_SLIDER_SHADE_3 = 133,
    STYLE_ID_SLIDER_SHADE_4 = 134,
    STYLE_ID_SLIDER_SHADE_5 = 135,
    STYLE_ID_YES_NO = 136,
    STYLE_ID_YES_NO_BUTTON = 137,
    STYLE_ID_YES_NO_MESSAGE = 138,
    STYLE_ID_TEXT_MESSAGE = 140,
    STYLE_ID_ASYNC_OPERATION = 143,
    STYLE_ID_PROGRESS = 144,
    STYLE_ID_SCROLLBAR_THUMB = 154,
    STYLE_ID_SCROLLBAR_BUTTON = 155,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 156,
    STYLE_ID_KEY_SPEC_ICONS = 158,
    STYLE_ID_KEY_SPEC_ICONS_DISABLED = 160,
    STYLE_ID_KEY_DISABLED = 161,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 162,
    STYLE_ID_VALUE_M = 170,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 173,
    STYLE_ID_YT_GRAPH = 175,
    STYLE_ID_LIST_GRAPH_CURSOR = 176,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 177,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 178,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 179,
    STYLE_ID_VALUE = 183,
    STYLE_ID_DEFAULT_M = 187,
    STYLE_ID_NON_INTERACTIVE_BUTTON_M = 188,
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 189,
    STYLE_ID_EVENT_ERROR = 190,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 191,
    STYLE_ID_ICON_AND_TEXT_S = 193,
    STYLE_ID_ICON_AND_TEXT_S_DISABLED = 194,
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[311112];
#else
