...
enum StylesEnum {
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 290,
    STYLE_ID_INLINE291 = 291,
    STYLE_ID_MON_VALUE_20_LEFT = 292,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 293,
    STYLE_ID_BAR_GRAPH_TEXT = 294,
    STYLE_ID_BAR_GRAPH_SET_LINE = 295,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 296,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 297,
...
extern const uint8_t assets[329246];
