...
enum StylesEnum {
    ...
    STYLE_ID_DEFAULT_GUI_TMPL = 234,
    STYLE_ID_MON_VALUE_48_RIGHT = 235,
    STYLE_ID_MON_VALUE_20_LEFT = 237,
    STYLE_ID_ENCODER_CURSOR_14_DISABLED = 238,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 239,
    STYLE_ID_ENCODER_CURSOR_14_FOCUSED = 240,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 241,
    STYLE_ID_BAR_GRAPH_TEXT = 242,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 244,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 245,
    STYLE_ID_TRIGGER_BUTTON_24 = 247,
    STYLE_ID_MON_VALUE_14_RIGHT = 249,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_DISABLED = 250,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 251,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_FOCUSED = 252,
    STYLE_ID_ENCODER_CURSOR_14_LEFT_DISABLED = 253,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 254,
    STYLE_ID_TRIGGER_BUTTON_14 = 255,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 263,
    STYLE_ID_INST_SELECTED = 264,
    STYLE_ID_MON_VALUE_38_RIGHT = 265,
    STYLE_ID_CH_PROT_OFF = 268,
    STYLE_ID_CH_PROT_ON = 269,
    STYLE_ID_CH_PROT_TRIPPED = 270,
    STYLE_ID_BUTTON_BGND = 271,
    STYLE_ID_MON_VALUE_24_RIGHT = 275,
    STYLE_ID_MON_VALUE_14_CENTER = 276,
    STYLE_ID_MON_VALUE_20_RIGHT = 283,
    STYLE_ID_MON_VALUE_14_LEFT = 284,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 285,
    STYLE_ID_SCROLLBAR_TRACK = 293,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 306
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[311554];
#else
extern const uint8_t assets[1365484];
#endif
