...
enum StylesEnum {
    ...
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 70,
    STYLE_ID_YELLOW_1 = 71,
    STYLE_ID_YELLOW_2 = 72,
    STYLE_ID_YELLOW_3 = 73,
    STYLE_ID_YELLOW_4 = 74,
    STYLE_ID_YELLOW_5 = 75,
    STYLE_ID_YELLOW_6 = 76,
    STYLE_ID_YES_NO = 77,
    STYLE_ID_YES_NO_BACKGROUND = 78,
    STYLE_ID_YES_NO_MESSAGE = 79,
    STYLE_ID_YES_NO_BUTTON = 80,
    STYLE_ID_TEXT_MESSAGE = 81,
    STYLE_ID_ASYNC_OPERATION = 82,
    STYLE_ID_EVENT_INFO = 83,
    STYLE_ID_EVENT_WARNING = 84,
    STYLE_ID_EVENT_ERROR = 85,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 86,
    STYLE_ID_VALUE_S = 87,
    ...
    STYLE_ID_EDIT_VALUE_ACTIVE = 97,
    STYLE_ID_DEFAULT_DISABLED = 98,
    STYLE_ID_VALUE = 99,
...
extern const uint8_t assets[210416];
