...
enum ActionsEnum {
    ...
    ACTION_ID_SELECT_THEME = 157,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 158,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 159,
    ACTION_ID_RESTART = 160,
    ACTION_ID_USER_SWITCH_CLICKED = 161,
    ...
    ACTION_ID_SHOW_DEBUG_TRACE_LOG = 198,
    ACTION_ID_DLOG_UPLOAD = 199,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 200,
    ACTION_ID_MQTT_EDIT_HOST = 201,
    ACTION_ID_MQTT_EDIT_PORT = 202,
    ACTION_ID_MQTT_EDIT_USERNAME = 203,
    ACTION_ID_MQTT_EDIT_PASSWORD = 204,
    ACTION_ID_MQTT_EDIT_PERIOD = 205,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 206,
    ACTION_ID_DEBUG_TRACE_LOG_TOGGLE = 207,
...
enum PagesEnum {
    ...
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 157,
    PAGE_ID_DCM220_FRONT_PANEL_LED = 158
};

#ifdef OPTION_SDRAM
extern const uint8_t assets[300605];
#else
extern const uint8_t assets[1313508];
#endif
