enum DataEnum {
    ...
    DATA_ID_CHANNEL_COUPLING_STATE = 206,
    ...
    DATA_ID_CHANNEL_SHORT_TITLE_WITH_COLON = 236,
    DATA_ID_CHANNEL_SHORT_TITLE_WITHOUT_TRACKING_ICON = 237,
    DATA_ID_CHANNEL_LONG_TITLE = 238,
    DATA_ID_ANIMATIONS_DURATION = 239,
    DATA_ID_SLOT1_INFO = 240,
    DATA_ID_SLOT2_INFO = 241,
    DATA_ID_SLOT3_INFO = 242,
    DATA_ID_SLOT1_TEST_RESULT = 243,
    DATA_ID_SLOT2_TEST_RESULT = 244,
    DATA_ID_SLOT3_TEST_RESULT = 245,
    DATA_ID_SLOT_DEFAULT1_VIEW = 246,
    DATA_ID_SLOT_DEFAULT2_VIEW = 247,
    DATA_ID_SLOT_DEFAULT3_VIEW = 248,
    DATA_ID_SLOT1_CHANNEL_INDEX = 249,
    DATA_ID_SLOT2_CHANNEL_INDEX = 250,
    DATA_ID_SLOT3_CHANNEL_INDEX = 251,
    DATA_ID_SLOT_DEF_2CH_VIEW = 252,
    DATA_ID_SLOT_MAX_2CH_VIEW = 253,
    DATA_ID_SLOT_MIN_2CH_VIEW = 254,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 255,
    DATA_ID_SLOT_2CH_CH1_INDEX = 256,
    DATA_ID_SLOT_2CH_CH2_INDEX = 257,
    DATA_ID_BATTERY = 258,
    DATA_ID_IO_PIN_STATE = 259,
    DATA_ID_CHANNEL_DPROG = 260,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 261,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 262,
    DATA_ID_SYS_INFO_HAS_ERROR = 263,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 264,
    DATA_ID_SYS_FAN_MODE = 265,
    DATA_ID_SYS_FAN_SPEED = 266,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 267,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 268,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 269,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 270,
    DATA_ID_IS_TRACKING_ALLOWED = 271,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 272,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 273,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 274,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 275,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 276,
    DATA_ID_IS_COUPLED_OR_TRACKED = 277,
    DATA_ID_OVERLAY = 278,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 279,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 280,
    DATA_ID_DLOG_STATE = 281,
    DATA_ID_DLOG_TOGGLE_STATE = 282,
    DATA_ID_RECORDING = 283,
    DATA_ID_CHANNEL_HISTORY_VALUES = 284,
    DATA_ID_RECORDING_READY = 285,
    DATA_ID_NONDRAG_OVERLAY = 286,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 287,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 288,
    DATA_ID_DLOG_VISIBLE_VALUES = 289,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 290,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 291,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 292,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 293,
    DATA_ID_DLOG_ALL_VALUES = 294,
    DATA_ID_DLOG_VALUE_LABEL = 295,
    DATA_ID_DLOG_CURRENT_TIME = 296,
    DATA_ID_DLOG_FILE_LENGTH = 297,
    DATA_ID_DLOG_X_AXIS_OFFSET = 298,
    DATA_ID_DLOG_X_AXIS_DIV = 299,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 300,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 301,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 302,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 303,
    DATA_ID_DLOG_VIEW_STATE = 304,
    DATA_ID_DLOG_PERIOD = 305,
    DATA_ID_DLOG_DURATION = 306,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 307,
    DATA_ID_DLOG_CURRENT_ENABLED = 308,
    DATA_ID_DLOG_POWER_ENABLED = 309,
    DATA_ID_DLOG_START_ENABLED = 310,
    DATA_ID_DLOG_FILE_NAME = 311,
    DATA_ID_DLOG_VALUE_STATE = 312,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 313,
    DATA_ID_CHANNEL_OFF_LABEL = 314,
    DATA_ID_FILE_MANAGER_FILES = 315,
    DATA_ID_FILE_MANAGER_FILE_NAME = 316,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 317,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 318,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 319,
    DATA_ID_FILE_MANAGER_STATE = 320,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 321,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 322,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 323,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 324,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 325,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 326,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 327,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 328,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 329,
    DATA_ID_SCRIPT_INFO = 330,
    DATA_ID_SCRIPT_IS_STARTED = 331,
    DATA_ID_KEYPAD_OK_ENABLED = 332,
    DATA_ID_ETHERNET_HOST_NAME = 333,
    DATA_ID_MQTT_HOST = 334,
    DATA_ID_MQTT_PORT = 335,
    DATA_ID_MQTT_USERNAME = 336,
    DATA_ID_MQTT_PASSWORD = 337,
    DATA_ID_MQTT_PERIOD = 338,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 339,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 340,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 341,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 342,
    DATA_ID_LIST_COUNTER_LABEL = 343,
    DATA_ID_RAMP_COUNTER_LABEL = 344,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 345,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 346,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 347,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 348,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 349,
    DATA_ID_IS_RESET_BY_IWDG = 350,
    DATA_ID_DLOG_ENABLED = 351,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 352,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 353,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 354,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 355,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 356,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 357,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 358,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 359,
    DATA_ID_DATE_TIME_FORMAT = 360,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 361,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 362,
    DATA_ID_DATE_TIME_AM_PM = 363,
    DATA_ID_IS_MULTI_TRACKING = 364,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 365,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 366,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 367,
    DATA_ID_CHANNEL_INFO_BRAND = 368,
    DATA_ID_CHANNEL_INFO_SERIAL = 369,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 370,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 371,
    DATA_ID_FILE_MANAGER_FILE_ICON = 372,
    DATA_ID_FILE_MANAGER_LAYOUT = 373,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 374,
    DATA_ID_TOUCH_RAW_X = 375,
    DATA_ID_TOUCH_RAW_Y = 376,
    DATA_ID_TOUCH_RAW_Z1 = 377,
    DATA_ID_TOUCH_RAW_PRESSED = 378,
    DATA_ID_TOUCH_CALIBRATED_X = 379,
    DATA_ID_TOUCH_CALIBRATED_Y = 380,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 381,
    DATA_ID_TOUCH_FILTERED_X = 382,
    DATA_ID_TOUCH_FILTERED_Y = 383,
    DATA_ID_TOUCH_FILTERED_PRESSED = 384,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 385,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 386,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 387,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 388,
    DATA_ID_ALERT_MESSAGE_IS_SET = 389,
    DATA_ID_ASYNC_PROGRESS = 390,
    DATA_ID_IO_PIN_FUNCTION = 391,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 392,
    DATA_ID_IO_PIN_PWM_DUTY = 393,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 394,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 395,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 396,
    DATA_ID_DEBUG_VARIABLES = 397,
    DATA_ID_DEBUG_VARIABLE_NAME = 398,
    DATA_ID_DEBUG_VARIABLE_VALUE = 399,
    DATA_ID_CHANNEL_RAMP_STATE = 400,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 401
};
...
enum StylesEnum {
    ...
    STYLE_ID_ICON_AND_TEXT_S_DISABLED = 158,
...
extern const uint8_t assets[299507];
