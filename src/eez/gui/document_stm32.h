enum DataEnum {
    ...
    DATA_ID_APPLICATIONS = 230,
    DATA_ID_APPLICATION_TITLE = 231,
    DATA_ID_APPLICATION_ICON = 232,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 233,
...
enum PagesEnum {
    ...
    PAGE_ID_OTP = 88,
    PAGE_ID_OPP = 89,
    PAGE_ID_SYS_SETTINGS = 90
};

extern const uint8_t assets[123490];
