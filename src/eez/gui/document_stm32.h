enum DataEnum {
    ...
    DATA_ID_DEBUG_I_DAC = 409,
    DATA_ID_DEBUG_U_DAC = 410,
    DATA_ID_DEBUG_I_DAC_AMPER = 411,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 412,
    DATA_ID_DEBUG_I_ADC = 413,
    DATA_ID_DEBUG_U_ADC = 414,
    DATA_ID_DEBUG_I_ADC_AMPER = 415,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 416
};
...
extern const uint8_t assets[301222];
