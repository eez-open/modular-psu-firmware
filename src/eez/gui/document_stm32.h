...
enum StylesEnum {
    ...
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_CONTAINER = 3,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_ITEM = 4,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_DISABLED_ITEM = 5,
    STYLE_ID_DEFAULT = 6,
    STYLE_ID_DEFAULT_S = 7,
    STYLE_ID_EDIT_INFO_S = 8,
    STYLE_ID_TOUCH_CALIBRATION = 9,
    STYLE_ID_TOUCH_CALIBRATION_ACTIVE = 10,
    STYLE_ID_MENU_S = 11,
    STYLE_ID_BOTTOM_BUTTON_BACKGROUND = 12,
    STYLE_ID_BOTTOM_BUTTON = 13,
    STYLE_ID_HOME = 14,
    STYLE_ID_HOME_ICON = 15,
    STYLE_ID_HOME_ICON_ACTIVE = 16,
    STYLE_ID_DEFAULT_INVERSE = 17,
    STYLE_ID_CHANNEL_OFF = 18,
    STYLE_ID_MON_VALUE_L_RIGHT = 19,
    STYLE_ID_MON_VALUE_UR_L_RIGHT = 20,
    STYLE_ID_MON_VALUE_FOCUS = 21,
    STYLE_ID_MON_VALUE = 22,
    STYLE_ID_MON_DAC = 23,
    STYLE_ID_EDIT_S = 24,
    STYLE_ID_CHANNEL_ERROR = 25,
    STYLE_ID_BAR_GRAPH_U_DEFUALT = 26,
    STYLE_ID_BAR_GRAPH_TEXT = 27,
    STYLE_ID_BAR_GRAPH_SET_LINE = 28,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 29,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 30,
    STYLE_ID_BAR_GRAPH_UNREGULATED = 31,
    STYLE_ID_EDIT_VALUE_S_RIGHT = 32,
    STYLE_ID_EDIT_VALUE_FOCUS_S_RIGHT = 33,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_RIGHT = 34,
    STYLE_ID_MON_DAC_S = 35,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_CENTER = 36,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 37,
    STYLE_ID_BAR_GRAPH_TEXT_VERTICAL = 38,
    STYLE_ID_EDIT_S_FOCUS = 39,
    STYLE_ID_YT_GRAPH = 40,
    STYLE_ID_YT_GRAPH_U_DEFUALT = 41,
    STYLE_ID_YT_GRAPH_I_DEFAULT = 42,
    STYLE_ID_YT_GRAPH_UNREGULATED = 43,
    STYLE_ID_COUPLED_INFO_S = 44,
    STYLE_ID_EDIT_VALUE = 45,
    STYLE_ID_EDIT_VALUE_S_LEFT = 46,
    STYLE_ID_KEY = 47,
    STYLE_ID_KEY_ICONS = 48,
    STYLE_ID_KEY_DISABLED = 49,
    STYLE_ID_TAB_PAGE_SELECTED = 50,
    STYLE_ID_TAB_PAGE = 51,
    STYLE_ID_EDIT_VALUE_L = 52,
    STYLE_ID_VALUE = 53,
    STYLE_ID_VALUE_S = 54,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 55,
    STYLE_ID_YELLOW_1 = 56,
    STYLE_ID_YELLOW_2 = 57,
    STYLE_ID_YELLOW_3 = 58,
    STYLE_ID_YELLOW_4 = 59,
    STYLE_ID_YELLOW_5 = 60,
    STYLE_ID_YELLOW_6 = 61,
    STYLE_ID_TOAST_ALERT = 62,
    STYLE_ID_ERROR_ALERT = 63,
...
enum PagesEnum {
    ...
    PAGE_ID_TOAST3_ALERT = 15,
    PAGE_ID_ERROR_ALERT = 16,
    PAGE_ID_ERROR_LONG_ALERT = 17,
    PAGE_ID_ERROR_ALERT_WITH_ACTION = 18,
    PAGE_ID_ERROR_TOAST_ALERT = 19,
    PAGE_ID_YES_NO = 20,
    PAGE_ID_ARE_YOU_SURE_WITH_MESSAGE = 21,
    PAGE_ID_YES_NO_LATER = 22,
    PAGE_ID_TEXT_MESSAGE = 23,
    PAGE_ID_ASYNC_OPERATION_IN_PROGRESS = 24,
    PAGE_ID_PROGRESS = 25,
    PAGE_ID_EVENT_QUEUE = 26,
    PAGE_ID_KEYPAD = 27,
    PAGE_ID_NUMERIC_KEYPAD = 28,
    PAGE_ID_CH_SETTINGS_PROT = 29,
    ...
    PAGE_ID_CH_START_LIST = 39,
    PAGE_ID_CH_SETTINGS_ADV = 40,
    PAGE_ID_CH_SETTINGS_ADV_REMOTE = 41,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 42,
    PAGE_ID_CH_SETTINGS_ADV_TRACKING = 43,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING = 44,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING_INFO = 45,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 46,
    PAGE_ID_CH_SETTINGS_INFO = 47,
    PAGE_ID_SYS_SETTINGS = 48,
    PAGE_ID_SYS_SETTINGS_AUX_OTP = 49,
    ...
    PAGE_ID_SYS_SETTINGS_SERIAL = 55,
    PAGE_ID_SYS_SETTINGS_ETHERNET = 56,
    PAGE_ID_SYS_SETTINGS_ETHERNET_STATIC = 57,
    PAGE_ID_SYS_SETTINGS_CAL = 58,
    PAGE_ID_SYS_SETTINGS_CAL_CH = 59,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP = 60,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_FINISH = 61,
    ...
    PAGE_ID_CHANNELS = 75,
    PAGE_ID_PROFILE = 76,
    PAGE_ID_PROFILE_BASIC_INFO = 77,
    PAGE_ID_COUPLED_CHANNELS_DEFAULT_VIEW = 78,
    PAGE_ID_COUPLED_CHANNELS_HORIZONTAL_BAR_VIEW = 79,
    PAGE_ID_COUPLED_CHANNELS_VERTICAL_BAR_VIEW = 80,
    PAGE_ID_COUPLED_CHANNELS_YTBAR_VIEW = 81,
    PAGE_ID_OCP = 82,
    PAGE_ID_OVP = 83,
    PAGE_ID_OTP = 84,
    PAGE_ID_OPP = 85,
    PAGE_ID_OLD_STATUS_BAR = 86,
    PAGE_ID_OLD_TASK_BAR = 87,
    PAGE_ID_MINIMIZED_APP_VIEW = 88
};

extern const uint8_t assets[137094];
