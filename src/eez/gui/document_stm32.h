enum DataEnum {
    ...
    DATA_ID_SYS_SOUND_ENABLED = 170,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE1 = 171,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE2 = 172,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_YT_VIEW_RATE = 173,
    DATA_ID_SYS_ENCODER_CONFIRMATION_MODE = 174,
    DATA_ID_SYS_ENCODER_MOVING_UP_SPEED = 175,
    DATA_ID_SYS_ENCODER_MOVING_DOWN_SPEED = 176,
    DATA_ID_SYS_ENCODER_INSTALLED = 177,
    DATA_ID_SYS_DISPLAY_STATE = 178,
    DATA_ID_SYS_DISPLAY_BRIGHTNESS = 179,
    DATA_ID_CHANNEL_TRIGGER_MODE = 180,
    DATA_ID_CHANNEL_TRIGGER_OUTPUT_STATE = 181,
    DATA_ID_CHANNEL_TRIGGER_ON_LIST_STOP = 182,
    DATA_ID_CHANNEL_U_TRIGGER_VALUE = 183,
    DATA_ID_CHANNEL_I_TRIGGER_VALUE = 184,
    DATA_ID_CHANNEL_LIST_COUNT = 185,
    DATA_ID_CHANNEL_LISTS = 186,
    DATA_ID_CHANNEL_LIST_INDEX = 187,
    DATA_ID_CHANNEL_LIST_DWELL = 188,
    DATA_ID_CHANNEL_LIST_DWELL_ENABLED = 189,
    DATA_ID_CHANNEL_LIST_VOLTAGE = 190,
    DATA_ID_CHANNEL_LIST_VOLTAGE_ENABLED = 191,
    DATA_ID_CHANNEL_LIST_CURRENT = 192,
    DATA_ID_CHANNEL_LIST_CURRENT_ENABLED = 193,
    DATA_ID_CHANNEL_LISTS_PREVIOUS_PAGE_ENABLED = 194,
    DATA_ID_CHANNEL_LISTS_NEXT_PAGE_ENABLED = 195,
    DATA_ID_CHANNEL_LISTS_CURSOR = 196,
    DATA_ID_CHANNEL_LISTS_INSERT_MENU_ENABLED = 197,
    DATA_ID_CHANNEL_LISTS_DELETE_MENU_ENABLED = 198,
    DATA_ID_CHANNEL_LISTS_DELETE_ROW_ENABLED = 199,
    DATA_ID_CHANNEL_LISTS_CLEAR_COLUMN_ENABLED = 200,
    DATA_ID_CHANNEL_LISTS_DELETE_ROWS_ENABLED = 201,
    ...
    DATA_ID_SERIAL_ENABLED = 214,
    DATA_ID_SERIAL_IS_CONNECTED = 215,
    DATA_ID_SERIAL_BAUD = 216,
    DATA_ID_SERIAL_PARITY = 217,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 218,
    DATA_ID_IO_PINS = 219,
    DATA_ID_IO_PINS_INHIBIT_STATE = 220,
    DATA_ID_IO_PIN_NUMBER = 221,
    DATA_ID_IO_PIN_POLARITY = 222,
    DATA_ID_IO_PIN_FUNCTION = 223,
    DATA_ID_NTP_ENABLED = 224,
    DATA_ID_NTP_SERVER = 225,
    DATA_ID_ASYNC_OPERATION_THROBBER = 226,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 227,
    DATA_ID_PROGRESS = 228,
    DATA_ID_VIEW_STATUS = 229,
    DATA_ID_DLOG_STATUS = 230,
...
enum StylesEnum {
    ...
    STYLE_ID_BAR_GRAPH_TEXT_VERTICAL = 20,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 21,
    STYLE_ID_DEFAULT_INVERSE = 22,
    STYLE_ID_CHANNEL_OFF = 23,
    STYLE_ID_MON_VALUE_L_RIGHT = 24,
    STYLE_ID_MON_VALUE_UR_L_RIGHT = 25,
    STYLE_ID_MON_VALUE_FOCUS = 26,
    STYLE_ID_MON_VALUE = 27,
    STYLE_ID_MON_DAC = 28,
    STYLE_ID_EDIT_S = 29,
    STYLE_ID_CHANNEL_ERROR = 30,
    STYLE_ID_BAR_GRAPH_U_DEFUALT = 31,
    STYLE_ID_BAR_GRAPH_TEXT = 32,
    STYLE_ID_BAR_GRAPH_SET_LINE = 33,
    ...
    STYLE_ID_EDIT_VALUE_S_LEFT = 49,
    STYLE_ID_KEY = 50,
    STYLE_ID_KEY_ICONS = 51,
    STYLE_ID_KEY_DISABLED = 52,
    STYLE_ID_TAB_PAGE_SELECTED = 53,
    STYLE_ID_TAB_PAGE = 54,
    STYLE_ID_EDIT_VALUE_L = 55,
    STYLE_ID_VALUE = 56,
    STYLE_ID_VALUE_S = 57,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 58,
    STYLE_ID_YELLOW_1 = 59,
    STYLE_ID_YELLOW_2 = 60,
    STYLE_ID_YELLOW_3 = 61,
    STYLE_ID_YELLOW_4 = 62,
    STYLE_ID_YELLOW_5 = 63,
    STYLE_ID_YELLOW_6 = 64,
    STYLE_ID_YES_NO = 65,
...
enum PagesEnum {
    ...
    PAGE_ID_OTP = 80,
    PAGE_ID_OPP = 81,
    PAGE_ID_OLD_STATUS_BAR = 82,
    PAGE_ID_OLD_TASK_BAR = 83,
...
extern const uint8_t assets[204724];
