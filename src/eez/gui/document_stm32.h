...
enum PagesEnum {
    ...
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF = 186,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_DEF_2COL = 187,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MAX = 188,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MIN = 189,
    PAGE_ID_DIB_PREL6_SLOT_VIEW_MICRO = 190,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF = 191,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_DEF_2COL = 192,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MAX = 193,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MIN = 194,
    PAGE_ID_DIB_SMX46_SLOT_VIEW_MICRO = 195,
    PAGE_ID_DIB_DCP405_CH_SETTINGS_SPECIFIC = 196,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_ERROR = 197,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_SPECIFIC = 198
};

extern const uint8_t assets[314413];
