...
enum PagesEnum {
    ...
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 163,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 164,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 165,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 166,
    PAGE_ID_TOUCH_TEST = 167,
    PAGE_ID_DEBUG_VARIABLES = 168,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 169,
    PAGE_ID_OVP_TYPE = 170,
    PAGE_ID_DEBUG_POWER_CHANNELS = 171,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 172,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 173,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 174,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 175
};

extern const uint8_t assets[316021];
