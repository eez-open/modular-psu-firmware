...
enum StylesEnum {
    ...
    STYLE_ID_YES_NO = 64,
    STYLE_ID_YES_NO_BUTTON = 65,
    STYLE_ID_YES_NO_BACKGROUND = 66,
    STYLE_ID_YES_NO_MESSAGE = 67,
    STYLE_ID_TEXT_MESSAGE = 68,
    STYLE_ID_ASYNC_OPERATION = 69,
    STYLE_ID_ASYNC_OPERATION_ACTION = 70,
    STYLE_ID_EVENT_INFO = 71,
    STYLE_ID_EVENT_WARNING = 72,
    STYLE_ID_EVENT_ERROR = 73,
    STYLE_ID_BOTTOM_BUTTON_DISABLED = 74,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 75,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_LEFT = 76,
    STYLE_ID_KEY_SPEC_ICONS = 77,
    STYLE_ID_KEY_SPEC = 78,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 79,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 80,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 81,
    STYLE_ID_LIST_GRAPH_CURSOR = 82,
    STYLE_ID_YT_GRAPH_U_DEFUALT_LABEL = 83,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 84,
    STYLE_ID_EDIT_VALUE_FOCUS_S_CENTER = 85,
    STYLE_ID_EDIT_VALUE_LEFT = 86,
    STYLE_ID_EDIT_VALUE_ACTIVE_LEFT = 87,
    STYLE_ID_STATUS_BGND = 88,
    STYLE_ID_EDIT_VALUE_ACTIVE = 89,
    STYLE_ID_DEFAULT_DISABLED = 90,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S = 91,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_DISABLED = 92,
    STYLE_ID_DARK_LINE = 93,
    STYLE_ID_DISPLAY_OFF = 94,
    STYLE_ID_DISPLAY_OFF_S = 95,
    STYLE_ID_SET_VALUE_S_RIGHT_BALANCED = 96,
    STYLE_ID_SET_VALUE_BALANCED = 97,
    STYLE_ID_SET_VALUE_FOCUS_BALANCED = 98,
    STYLE_ID_PROT_INDICATOR_S = 99,
    STYLE_ID_PROT_INDICATOR_SET_S = 100,
    STYLE_ID_PROT_INDICATOR_TRIP_S = 101,
    STYLE_ID_EVENT_INFO_ICON = 102,
    STYLE_ID_EVENT_WARNING_ICON = 103,
    STYLE_ID_EVENT_ERROR_ICON = 104,
    STYLE_ID_PROT_INDICATOR_INVALID_S = 105,
    STYLE_ID_BUTTON_INDICATOR_ON = 106,
    STYLE_ID_BUTTON_INDICATOR_ERROR = 107,
    STYLE_ID_BUTTON_INDICATOR_OFF = 108,
    STYLE_ID_PROT_INDICATOR_BLINK_S = 109,
    STYLE_ID_DEFAULT_S_LEFT = 110,
    STYLE_ID_DEFAULT_3 = 111
};
...
enum PagesEnum {
    ...
    PAGE_ID_TEXT_MESSAGE = 18,
    PAGE_ID_ASYNC_OPERATION_IN_PROGRESS = 19,
    PAGE_ID_PROGRESS = 20,
    PAGE_ID_EVENT_QUEUE = 21,
    PAGE_ID_KEYPAD = 22,
    PAGE_ID_NUMERIC_KEYPAD = 23,
    PAGE_ID_CH_SETTINGS_PROT = 24,
    PAGE_ID_CH_SETTINGS_PROT_CLEAR = 25,
    PAGE_ID_CH_SETTINGS_PROT_OVP = 26,
    PAGE_ID_CH_SETTINGS_PROT_OCP = 27,
    PAGE_ID_CH_SETTINGS_PROT_OPP = 28,
    PAGE_ID_CH_SETTINGS_PROT_OTP = 29,
    PAGE_ID_CH_SETTINGS_TRIGGER = 30,
    PAGE_ID_CH_SETTINGS_LISTS = 31,
    PAGE_ID_CH_SETTINGS_LISTS_INSERT_MENU = 32,
    PAGE_ID_CH_SETTINGS_LISTS_DELETE_MENU = 33,
    PAGE_ID_CH_START_LIST = 34,
    PAGE_ID_CH_SETTINGS_ADV = 35,
    PAGE_ID_CH_SETTINGS_ADV_REMOTE = 36,
    PAGE_ID_CH_SETTINGS_ADV_RANGES = 37,
    PAGE_ID_CH_SETTINGS_ADV_TRACKING = 38,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING = 39,
    PAGE_ID_CH_SETTINGS_ADV_COUPLING_INFO = 40,
    PAGE_ID_CH_SETTINGS_ADV_VIEW = 41,
    PAGE_ID_CH_SETTINGS_INFO = 42,
    PAGE_ID_SYS_SETTINGS = 43,
    PAGE_ID_SYS_SETTINGS_AUX_OTP = 44,
    PAGE_ID_SYS_SETTINGS_PROTECTIONS = 45,
    PAGE_ID_SYS_SETTINGS_TRIGGER = 46,
    PAGE_ID_SYS_SETTINGS_IO = 47,
    PAGE_ID_SYS_SETTINGS_DATE_TIME = 48,
    PAGE_ID_SYS_SETTINGS_ENCODER = 49,
    PAGE_ID_SYS_SETTINGS_SERIAL = 50,
    PAGE_ID_SYS_SETTINGS_ETHERNET = 51,
    PAGE_ID_SYS_SETTINGS_ETHERNET_STATIC = 52,
    PAGE_ID_SYS_SETTINGS_CAL = 53,
    PAGE_ID_SYS_SETTINGS_CAL_CH = 54,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_STEP = 55,
    PAGE_ID_SYS_SETTINGS_CAL_CH_WIZ_FINISH = 56,
    PAGE_ID_SYS_SETTINGS_SCREEN_CALIBRATION = 57,
    PAGE_ID_SYS_SETTINGS_DISPLAY = 58,
    PAGE_ID_SYS_SETTINGS_SOUND = 59,
    PAGE_ID_USER_PROFILES = 60,
    PAGE_ID_USER_PROFILES2 = 61,
    PAGE_ID_USER_PROFILE_SETTINGS = 62,
    PAGE_ID_USER_PROFILE_0_SETTINGS = 63,
    PAGE_ID_SYS_INFO = 64,
    PAGE_ID_SYS_INFO2 = 65,
    PAGE_ID_STAND_BY_MENU = 66,
    PAGE_ID_ENTERING_STANDBY = 67,
    PAGE_ID_STANDBY = 68,
    PAGE_ID_DISPLAY_OFF = 69,
    PAGE_ID_CHANNELS = 70,
    PAGE_ID_PROFILE = 71,
    PAGE_ID_PROFILE_BASIC_INFO = 72,
    PAGE_ID_COUPLED_CHANNELS_DEFAULT_VIEW = 73,
    PAGE_ID_COUPLED_CHANNELS_HORIZONTAL_BAR_VIEW = 74,
    PAGE_ID_COUPLED_CHANNELS_VERTICAL_BAR_VIEW = 75,
    PAGE_ID_COUPLED_CHANNELS_YTBAR_VIEW = 76,
    PAGE_ID_OCP = 77,
    PAGE_ID_OVP = 78,
    PAGE_ID_OTP = 79,
    PAGE_ID_OPP = 80,
    PAGE_ID_OLD_STATUS_BAR = 81,
    PAGE_ID_OLD_TASK_BAR = 82,
    PAGE_ID_MINIMIZED_APP_VIEW = 83
};

extern const uint8_t assets[137900];
