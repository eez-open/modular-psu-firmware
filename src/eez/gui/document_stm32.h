enum DataEnum {
    ...
    DATA_ID_CALIBRATION_POINTS = 407,
    DATA_ID_CALIBRATION_POINT_IS_SET = 408,
    DATA_ID_CALIBRATION_POINT_DAC = 409,
    DATA_ID_CALIBRATION_POINT_VALUE = 410,
    DATA_ID_CALIBRATION_POINT_ADC = 411,
    DATA_ID_CHANNEL_CALIBRATION_VALUE = 412,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 413,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_OTHER = 414
};
...
void data_calibration_points(DataOperationEnum operation, Cursor cursor, Value &value);
void data_calibration_point_is_set(DataOperationEnum operation, Cursor cursor, Value &value);
void data_calibration_point_dac(DataOperationEnum operation, Cursor cursor, Value &value);
void data_calibration_point_value(DataOperationEnum operation, Cursor cursor, Value &value);
void data_calibration_point_adc(DataOperationEnum operation, Cursor cursor, Value &value);
void data_channel_calibration_value(DataOperationEnum operation, Cursor cursor, Value &value);
void data_channel_calibration_value_is_voltage(DataOperationEnum operation, Cursor cursor, Value &value);
void data_channel_calibration_value_other(DataOperationEnum operation, Cursor cursor, Value &value);
...
enum ActionsEnum {
    ...
    ACTION_ID_SELECT_CHANNEL_CALIBRATION_VALUE = 214,
    ACTION_ID_DELETE_CALIBRATION_POINT = 215
};
...
void action_select_channel_calibration_value();
void action_delete_calibration_point();
...
enum StylesEnum {
    ...
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 145,
    STYLE_ID_INLINE146 = 146,
    STYLE_ID_EVENT_ERROR = 147,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 148,
    STYLE_ID_INLINE149 = 149,
    STYLE_ID_ICON_AND_TEXT_S = 150,
    STYLE_ID_INLINE151 = 151,
    STYLE_ID_INLINE152 = 152,
    STYLE_ID_VALUE_M = 153,
    STYLE_ID_INLINE154 = 154,
    STYLE_ID_INLINE155 = 155,
    STYLE_ID_DEFAULT_DISABLED = 156,
    ...
    STYLE_ID_EVENT_WARNING = 183,
    STYLE_ID_DISPLAY_OFF = 184,
    STYLE_ID_DISPLAY_OFF_S = 185,
    STYLE_ID_INLINE186 = 186,
    STYLE_ID_INLINE187 = 187,
    STYLE_ID_MON_VALUE_48_RIGHT = 188,
    STYLE_ID_INLINE189 = 189,
    STYLE_ID_MON_VALUE_20_LEFT = 190,
    ...
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 213,
    STYLE_ID_INST_SELECTED = 214,
    STYLE_ID_MON_VALUE_38_RIGHT = 215,
    STYLE_ID_INLINE216 = 216,
    STYLE_ID_CH_PROT_OFF = 217,
    STYLE_ID_CH_PROT_ON = 218,
    STYLE_ID_CH_PROT_TRIPPED = 219,
    STYLE_ID_INLINE220 = 220,
    STYLE_ID_MON_VALUE_24_RIGHT = 221,
    STYLE_ID_MON_VALUE_14_CENTER = 222,
    STYLE_ID_INLINE223 = 223,
    STYLE_ID_INLINE224 = 224,
    STYLE_ID_INLINE225 = 225,
    STYLE_ID_INLINE226 = 226,
    STYLE_ID_INLINE227 = 227,
    STYLE_ID_MON_VALUE_20_RIGHT = 228,
    STYLE_ID_MON_VALUE_14_LEFT = 229,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 230,
    STYLE_ID_INLINE231 = 231,
    STYLE_ID_INLINE232 = 232,
    STYLE_ID_INLINE233 = 233,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 234,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 235,
    STYLE_ID_SCROLLBAR_TRACK = 236,
...
extern const uint8_t assets[308261];
