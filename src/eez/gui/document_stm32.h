...
enum PagesEnum {
    ...
    PAGE_ID_FRONT_PANEL_EMPTY_SLOT = 160,
    ...
    PAGE_ID_DIB_MIO168_SLOT_VIEW_DEF = 171,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MAX = 172,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MIN = 173,
    PAGE_ID_DIB_MIO168_SLOT_VIEW_MICRO = 174
};

extern const uint8_t assets[310056];
