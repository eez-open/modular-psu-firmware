enum DataEnum {
    ...
    DATA_ID_BATTERY = 263,
    DATA_ID_IO_PIN_STATE = 264,
    DATA_ID_CHANNEL_DPROG = 265,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 266,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 267,
    DATA_ID_SYS_INFO_HAS_ERROR = 268,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 269,
    ...
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 286,
    ...
    DATA_ID_RAMP_COUNTER_LABEL = 350,
    ...
    DATA_ID_TOUCH_RAW_X = 381,
    DATA_ID_TOUCH_RAW_Y = 382,
    DATA_ID_TOUCH_RAW_Z1 = 383,
    DATA_ID_TOUCH_RAW_PRESSED = 384,
    DATA_ID_TOUCH_CALIBRATED_X = 385,
    DATA_ID_TOUCH_CALIBRATED_Y = 386,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 387,
    DATA_ID_TOUCH_FILTERED_X = 388,
    DATA_ID_TOUCH_FILTERED_Y = 389,
    DATA_ID_TOUCH_FILTERED_PRESSED = 390,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 391,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 392,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 393,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 394,
    DATA_ID_ALERT_MESSAGE_IS_SET = 395,
    DATA_ID_ASYNC_PROGRESS = 396,
    DATA_ID_IO_PIN_FUNCTION = 397,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 398,
    DATA_ID_IO_PIN_PWM_DUTY = 399,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 400,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 401,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 402,
    DATA_ID_DEBUG_VARIABLES = 403,
    DATA_ID_DEBUG_VARIABLE_NAME = 404,
    DATA_ID_DEBUG_VARIABLE_VALUE = 405,
    DATA_ID_CHANNEL_RAMP_STATE = 406,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 407,
    DATA_ID_MQTT_IN_ERROR = 408
};
