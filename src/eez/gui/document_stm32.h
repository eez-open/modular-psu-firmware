enum DataEnum {
    ...
    DATA_ID_APPLICATIONS = 243,
    DATA_ID_APPLICATION_TITLE = 244,
    DATA_ID_APPLICATION_ICON = 245,
    DATA_ID_IS_HOME_APPLICATION_IN_FOREGROUND = 246,
    DATA_ID_FOREGROUND_APPLICATION = 247,
    DATA_ID_FOREGROUND_APPLICATION_TITLE = 248,
    DATA_ID_TOUCH_CALIBRATION_POINT = 249,
...
enum StylesEnum {
    ...
    STYLE_ID_EVENT_INFO_ICON = 103,
    STYLE_ID_EVENT_WARNING_ICON = 104,
    STYLE_ID_EVENT_ERROR_ICON = 105,
    STYLE_ID_PROT_INDICATOR_INVALID_S = 106,
    STYLE_ID_BUTTON_INDICATOR_ON = 107,
    STYLE_ID_BUTTON_INDICATOR_ERROR = 108,
    STYLE_ID_BUTTON_INDICATOR_OFF = 109,
    STYLE_ID_PROT_INDICATOR_BLINK_S = 110,
    STYLE_ID_DEFAULT_S_LEFT = 111,
    STYLE_ID_DEFAULT_3 = 112,
    STYLE_ID_BUTTON_BGND = 113
};
...
enum PagesEnum {
    ...
    PAGE_ID_OTP = 83,
    PAGE_ID_OPP = 84,
    PAGE_ID_OLD_STATUS_BAR = 85,
    PAGE_ID_OLD_TASK_BAR = 86,
    PAGE_ID_MINIMIZED_APP_VIEW = 87,
    PAGE_ID_GUI_TMPL_ONE_MAX_STATUS_LINE_BOTTOM = 88,
    PAGE_ID_GUI_TMPL_SYSTEM_SETTINGS_STATUS_LINE_BOTTOM = 89,
    PAGE_ID_GUI_TMPL_DEFAULT_VERTICAL_NUMERIC_ETC = 90,
    PAGE_ID_GUI_TMPL_HORIZONTAL_GRAPH_BAR = 91,
    PAGE_ID_GUI_TMPL_OUTPUT_COUPLINGS = 92,
    PAGE_ID_DCP405_DEFAULT_NUMERIC = 93,
    PAGE_ID_DCP405_DEFAULT_VERT_BAR = 94,
    PAGE_ID_DCP405_DEFAULT_HORZ_BAR = 95,
    PAGE_ID_DCP405_DEFAULT_VERT_OFF = 96,
...
extern const uint8_t assets[207477];
