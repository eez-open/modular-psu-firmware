enum DataEnum {
    ...
    DATA_ID_EVENT_QUEUE_MULTIPLE_PAGES = 109,
    DATA_ID_EVENT_QUEUE_PREVIOUS_PAGE_ENABLED = 110,
    DATA_ID_EVENT_QUEUE_NEXT_PAGE_ENABLED = 111,
    DATA_ID_EVENT_QUEUE_PAGE_INFO = 112,
    DATA_ID_CHANNEL_RSENSE_STATUS = 113,
    DATA_ID_CHANNEL_RPROG_INSTALLED = 114,
    DATA_ID_CHANNEL_RPROG_STATUS = 115,
    DATA_ID_CHANNEL_TRACKING_IS_ENABLED = 116,
    DATA_ID_CHANNEL_TRACKING_IS_ALLOWED = 117,
    DATA_ID_CHANNEL_IS_PAR_SER_COUPLED_OR_TRACKED = 118,
    DATA_ID_COUPLING_TYPE = 119,
    DATA_ID_CHANNEL_COUPLING_IS_SERIES = 120,
    DATA_ID_SYS_ON_TIME_TOTAL = 121,
    DATA_ID_SYS_ON_TIME_LAST = 122,
    DATA_ID_SYS_TEMP_AUX_STATUS = 123,
    DATA_ID_SYS_TEMP_AUX_OTP_STATE = 124,
    DATA_ID_SYS_TEMP_AUX_OTP_LEVEL = 125,
    DATA_ID_SYS_TEMP_AUX_OTP_DELAY = 126,
    DATA_ID_SYS_TEMP_AUX_OTP_IS_TRIPPED = 127,
    DATA_ID_SYS_TEMP_AUX = 128,
    DATA_ID_SYS_INFO_FIRMWARE_VER = 129,
    DATA_ID_SYS_INFO_SERIAL_NO = 130,
    DATA_ID_SYS_INFO_SCPI_VER = 131,
    DATA_ID_SYS_INFO_CPU = 132,
    DATA_ID_SYS_INFO_FAN_STATUS = 133,
    DATA_ID_SYS_INFO_FAN_SPEED = 134,
    DATA_ID_CHANNEL_BOARD_INFO_LABEL = 135,
    DATA_ID_CHANNEL_BOARD_INFO_REVISION = 136,
    DATA_ID_DATE_TIME_DATE = 137,
    DATA_ID_DATE_TIME_YEAR = 138,
    DATA_ID_DATE_TIME_MONTH = 139,
    DATA_ID_DATE_TIME_DAY = 140,
    DATA_ID_DATE_TIME_TIME = 141,
    DATA_ID_DATE_TIME_HOUR = 142,
    DATA_ID_DATE_TIME_MINUTE = 143,
    DATA_ID_DATE_TIME_SECOND = 144,
    DATA_ID_DATE_TIME_TIME_ZONE = 145,
    DATA_ID_DATE_TIME_DST = 146,
    DATA_ID_SET_PAGE_DIRTY = 147,
    DATA_ID_PROFILES_LIST = 148,
    DATA_ID_PROFILES_AUTO_RECALL_STATUS = 149,
    DATA_ID_PROFILES_AUTO_RECALL_LOCATION = 150,
    DATA_ID_PROFILE_STATUS = 151,
    DATA_ID_PROFILE_LABEL = 152,
    DATA_ID_PROFILE_REMARK = 153,
    DATA_ID_PROFILE_IS_AUTO_RECALL_LOCATION = 154,
    DATA_ID_PROFILE_CHANNEL_U_SET = 155,
    DATA_ID_PROFILE_CHANNEL_I_SET = 156,
    DATA_ID_PROFILE_CHANNEL_OUTPUT_STATE = 157,
    DATA_ID_ETHERNET_INSTALLED = 158,
    DATA_ID_ETHERNET_ENABLED = 159,
    DATA_ID_MQTT_ENABLED = 160,
    DATA_ID_ETHERNET_STATUS = 161,
    DATA_ID_MQTT_CONNECTION_STATE = 162,
    DATA_ID_ETHERNET_IP_ADDRESS = 163,
    DATA_ID_ETHERNET_DNS = 164,
    DATA_ID_ETHERNET_GATEWAY = 165,
    DATA_ID_ETHERNET_SUBNET_MASK = 166,
    DATA_ID_ETHERNET_SCPI_PORT = 167,
    DATA_ID_ETHERNET_IS_CONNECTED = 168,
    DATA_ID_ETHERNET_DHCP = 169,
    DATA_ID_ETHERNET_MAC = 170,
    DATA_ID_CHANNEL_IS_VOLTAGE_BALANCED = 171,
    DATA_ID_CHANNEL_IS_CURRENT_BALANCED = 172,
    DATA_ID_SYS_OUTPUT_PROTECTION_COUPLED = 173,
    DATA_ID_SYS_SHUTDOWN_WHEN_PROTECTION_TRIPPED = 174,
    DATA_ID_SYS_FORCE_DISABLING_ALL_OUTPUTS_ON_POWER_UP = 175,
    DATA_ID_SYS_PASSWORD_IS_SET = 176,
    DATA_ID_SYS_RL_STATE = 177,
    DATA_ID_SYS_SOUND_IS_ENABLED = 178,
    DATA_ID_SYS_SOUND_IS_CLICK_ENABLED = 179,
    DATA_ID_SYS_SOUND_ENABLED = 180,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE1 = 181,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_DISPLAY_VALUE2 = 182,
    DATA_ID_CHANNEL_DISPLAY_VIEW_SETTINGS_YT_VIEW_RATE = 183,
    DATA_ID_SYS_ENCODER_CONFIRMATION_MODE = 184,
    DATA_ID_SYS_ENCODER_MOVING_UP_SPEED = 185,
    DATA_ID_SYS_ENCODER_MOVING_DOWN_SPEED = 186,
    DATA_ID_SYS_ENCODER_INSTALLED = 187,
    DATA_ID_SYS_DISPLAY_STATE = 188,
    DATA_ID_SYS_DISPLAY_BRIGHTNESS = 189,
    DATA_ID_CHANNEL_TRIGGER_MODE = 190,
    DATA_ID_CHANNEL_TRIGGER_ON_LIST_STOP = 191,
    DATA_ID_CHANNEL_U_TRIGGER_VALUE = 192,
    DATA_ID_CHANNEL_I_TRIGGER_VALUE = 193,
    DATA_ID_CHANNEL_LIST_COUNT = 194,
    DATA_ID_CHANNEL_LISTS = 195,
    ...
    DATA_ID_TRIGGER_SOURCE = 211,
    DATA_ID_TRIGGER_DELAY = 212,
    DATA_ID_TRIGGER_INITIATE_CONTINUOUSLY = 213,
    DATA_ID_TRIGGER_IS_INITIATED = 214,
    DATA_ID_TRIGGER_IS_MANUAL = 215,
    DATA_ID_CHANNEL_HAS_SUPPORT_FOR_CURRENT_DUAL_RANGE = 216,
    DATA_ID_CHANNEL_RANGES_SUPPORTED = 217,
    DATA_ID_CHANNEL_RANGES_MODE = 218,
    DATA_ID_CHANNEL_RANGES_AUTO_RANGING = 219,
    DATA_ID_CHANNEL_RANGES_CURRENTLY_SELECTED = 220,
    DATA_ID_TEXT_MESSAGE = 221,
    DATA_ID_SERIAL_STATUS = 222,
    DATA_ID_SERIAL_ENABLED = 223,
    DATA_ID_SERIAL_IS_CONNECTED = 224,
    DATA_ID_CHANNEL_LIST_COUNTDOWN = 225,
    DATA_ID_IO_PINS = 226,
    DATA_ID_IO_PINS_INHIBIT_STATE = 227,
    DATA_ID_IO_PIN_NUMBER = 228,
    DATA_ID_IO_PIN_POLARITY = 229,
    DATA_ID_IO_PIN_FUNCTION = 230,
    DATA_ID_NTP_ENABLED = 231,
    DATA_ID_NTP_SERVER = 232,
    DATA_ID_ASYNC_OPERATION_THROBBER = 233,
    DATA_ID_SYS_DISPLAY_BACKGROUND_LUMINOSITY_STEP = 234,
    DATA_ID_PROGRESS = 235,
    ...
    DATA_ID_BATTERY = 262,
    DATA_ID_IO_PIN_STATE = 263,
    DATA_ID_CHANNEL_DPROG = 264,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 265,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 266,
    DATA_ID_SYS_INFO_HAS_ERROR = 267,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 268,
    DATA_ID_SYS_FAN_MODE = 269,
    DATA_ID_SYS_FAN_SPEED = 270,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 271,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 272,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 273,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 274,
    DATA_ID_IS_TRACKING_ALLOWED = 275,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 276,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 277,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 278,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 279,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 280,
    DATA_ID_IS_COUPLED_OR_TRACKED = 281,
    DATA_ID_OVERLAY = 282,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 283,
    DATA_ID_DLOG_STATE = 284,
    DATA_ID_DLOG_TOGGLE_STATE = 285,
    DATA_ID_RECORDING = 286,
    DATA_ID_CHANNEL_HISTORY_VALUES = 287,
    DATA_ID_RECORDING_READY = 288,
    DATA_ID_NONDRAG_OVERLAY = 289,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 290,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 291,
    DATA_ID_DLOG_VISIBLE_VALUES = 292,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 293,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 294,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 295,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 296,
    DATA_ID_DLOG_ALL_VALUES = 297,
    DATA_ID_DLOG_VALUE_LABEL = 298,
    DATA_ID_DLOG_CURRENT_TIME = 299,
    DATA_ID_DLOG_FILE_LENGTH = 300,
    DATA_ID_DLOG_X_AXIS_OFFSET = 301,
    DATA_ID_DLOG_X_AXIS_DIV = 302,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE = 303,
    DATA_ID_DLOG_X_AXIS_MAX_VALUE_LABEL = 304,
    DATA_ID_IS_SINGLE_PAGE_ON_STACK = 305,
    DATA_ID_IS_SHOW_LIVE_RECORDING = 306,
    DATA_ID_DLOG_VIEW_STATE = 307,
    DATA_ID_DLOG_PERIOD = 308,
    DATA_ID_DLOG_DURATION = 309,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 310,
    DATA_ID_DLOG_CURRENT_ENABLED = 311,
    DATA_ID_DLOG_POWER_ENABLED = 312,
    DATA_ID_DLOG_START_ENABLED = 313,
    DATA_ID_DLOG_FILE_NAME = 314,
    DATA_ID_DLOG_VALUE_STATE = 315,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 316,
    DATA_ID_CHANNEL_OFF_LABEL = 317,
    DATA_ID_FILE_MANAGER_FILES = 318,
    DATA_ID_FILE_MANAGER_FILE_NAME = 319,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 320,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 321,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 322,
    DATA_ID_FILE_MANAGER_STATE = 323,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 324,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 325,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 326,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 327,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 328,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 329,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 330,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 331,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 332,
    DATA_ID_SCRIPT_INFO = 333,
    DATA_ID_SCRIPT_IS_STARTED = 334,
    DATA_ID_KEYPAD_OK_ENABLED = 335,
    DATA_ID_ETHERNET_HOST_NAME = 336,
    DATA_ID_MQTT_HOST = 337,
    DATA_ID_MQTT_PORT = 338,
    DATA_ID_MQTT_USERNAME = 339,
    DATA_ID_MQTT_PASSWORD = 340,
    DATA_ID_MQTT_PERIOD = 341,
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 342,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 343,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 344,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 345,
    DATA_ID_LIST_COUNTER_LABEL = 346,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 347,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 348,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 349,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 350,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 351,
    DATA_ID_IS_RESET_BY_IWDG = 352,
    DATA_ID_DLOG_ENABLED = 353,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 354,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 355,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 356,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 357,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 358,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 359,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 360,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 361
};
...
enum ActionsEnum {
    ...
    ACTION_ID_EVENT_QUEUE_PREVIOUS_PAGE = 80,
    ACTION_ID_EVENT_QUEUE_NEXT_PAGE = 81,
    ACTION_ID_CH_SETTINGS_ADV_REMOTE_TOGGLE_SENSE = 82,
    ACTION_ID_CH_SETTINGS_ADV_REMOTE_TOGGLE_PROGRAMMING = 83,
    ACTION_ID_DATE_TIME_SELECT_DST_RULE = 84,
    ACTION_ID_SHOW_USER_PROFILES = 85,
    ACTION_ID_SHOW_USER_PROFILE_SETTINGS = 86,
    ACTION_ID_PROFILES_TOGGLE_AUTO_RECALL = 87,
    ACTION_ID_PROFILE_TOGGLE_IS_AUTO_RECALL_LOCATION = 88,
    ACTION_ID_PROFILE_RECALL = 89,
    ACTION_ID_PROFILE_SAVE = 90,
    ACTION_ID_PROFILE_DELETE = 91,
    ACTION_ID_PROFILE_EDIT_REMARK = 92,
    ACTION_ID_TOGGLE_CHANNELS_VIEW_MODE = 93,
    ACTION_ID_ETHERNET_TOGGLE = 94,
    ACTION_ID_MQTT_TOGGLE = 95,
    ACTION_ID_ETHERNET_TOGGLE_DHCP = 96,
    ACTION_ID_ETHERNET_EDIT_MAC_ADDRESS = 97,
    ACTION_ID_ETHERNET_EDIT_STATIC_ADDRESS = 98,
    ACTION_ID_ETHERNET_EDIT_IP_ADDRESS = 99,
    ACTION_ID_ETHERNET_EDIT_DNS = 100,
    ACTION_ID_ETHERNET_EDIT_GATEWAY = 101,
    ACTION_ID_ETHERNET_EDIT_SUBNET_MASK = 102,
    ACTION_ID_ETHERNET_EDIT_SCPI_PORT = 103,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_OUTPUT_PROTECTION_COUPLE = 104,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_SHUTDOWN_WHEN_PROTECTION_TRIPPED = 105,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_TOGGLE_FORCE_DISABLING_ALL_OUTPUTS_ON_POWER_UP = 106,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_TOGGLE_STATE = 107,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_EDIT_LEVEL = 108,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_EDIT_DELAY = 109,
    ACTION_ID_SYS_SETTINGS_PROTECTIONS_AUX_OTP_CLEAR = 110,
    ACTION_ID_EDIT_SYSTEM_PASSWORD = 111,
    ACTION_ID_SYS_FRONT_PANEL_LOCK = 112,
    ACTION_ID_SYS_FRONT_PANEL_UNLOCK = 113,
    ACTION_ID_SYS_SETTINGS_SOUND_TOGGLE = 114,
    ACTION_ID_SYS_SETTINGS_SOUND_TOGGLE_CLICK = 115,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_DISPLAY_VALUE1 = 116,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_DISPLAY_VALUE2 = 117,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_SWAP_DISPLAY_VALUES = 118,
    ACTION_ID_CH_SETTINGS_ADV_VIEW_EDIT_YTVIEW_RATE = 119,
    ACTION_ID_SYS_SETTINGS_ENCODER_TOGGLE_CONFIRMATION_MODE = 120,
    ACTION_ID_TURN_DISPLAY_OFF = 121,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_TRIGGER_MODE = 122,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_VOLTAGE_TRIGGER_VALUE = 123,
    ACTION_ID_CH_SETTINGS_TRIGGER_EDIT_CURRENT_TRIGGER_VALUE = 124,
    ACTION_ID_CH_SETTINGS_LISTS_EDIT_LIST_COUNT = 125,
    ACTION_ID_CH_SETTINGS_LISTS_EDIT_ON_LIST_STOP = 126,
    ACTION_ID_CHANNEL_LISTS_PREVIOUS_PAGE = 127,
    ACTION_ID_CHANNEL_LISTS_NEXT_PAGE = 128,
    ACTION_ID_CHANNEL_LISTS_EDIT = 129,
    ACTION_ID_SHOW_CHANNEL_LISTS_INSERT_MENU = 130,
    ACTION_ID_SHOW_CHANNEL_LISTS_DELETE_MENU = 131,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_ABOVE = 132,
    ACTION_ID_CHANNEL_LISTS_INSERT_ROW_BELOW = 133,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROW = 134,
    ACTION_ID_CHANNEL_LISTS_CLEAR_COLUMN = 135,
    ACTION_ID_CHANNEL_LISTS_DELETE_ROWS = 136,
    ACTION_ID_CHANNEL_LISTS_DELETE_ALL = 137,
    ACTION_ID_CHANNEL_INITIATE_TRIGGER = 138,
    ACTION_ID_CHANNEL_SET_TO_FIXED = 139,
    ACTION_ID_CHANNEL_ENABLE_OUTPUT = 140,
    ACTION_ID_TRIGGER_SELECT_SOURCE = 141,
    ACTION_ID_TRIGGER_EDIT_DELAY = 142,
    ACTION_ID_TRIGGER_TOGGLE_INITIATE_CONTINUOUSLY = 143,
    ACTION_ID_TRIGGER_GENERATE_MANUAL = 144,
    ACTION_ID_TRIGGER_SHOW_GENERAL_SETTINGS = 145,
    ACTION_ID_SHOW_STAND_BY_MENU = 146,
    ACTION_ID_RESET = 147,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_SELECT_MODE = 148,
    ACTION_ID_CH_SETTINGS_ADV_RANGES_TOGGLE_AUTO_RANGING = 149,
    ACTION_ID_IO_PIN_TOGGLE_POLARITY = 150,
    ACTION_ID_IO_PIN_SELECT_FUNCTION = 151,
    ACTION_ID_SERIAL_TOGGLE = 152,
    ACTION_ID_NTP_TOGGLE = 153,
    ACTION_ID_NTP_EDIT_SERVER = 154,
    ACTION_ID_SELECT_THEME = 155,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 156,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 157,
    ACTION_ID_RESTART = 158,
    ACTION_ID_USER_SWITCH_CLICKED = 159,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 160,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 161,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 162,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 163,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 164,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 165,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 166,
    ACTION_ID_SET_COUPLING_PARALLEL = 167,
    ACTION_ID_SET_COUPLING_SERIES = 168,
    ACTION_ID_SET_COUPLING_COMMON_GND = 169,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 170,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 171,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 172,
    ACTION_ID_DRAG_OVERLAY = 173,
    ACTION_ID_DLOG_TOGGLE = 174,
    ACTION_ID_SHOW_DLOG_VIEW = 175,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 176,
    ACTION_ID_SHOW_FILE_MANAGER = 177,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 178,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT_DIRECTORY = 179,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 180,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 181,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 182,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 183,
    ACTION_ID_SHOW_DLOG_PARAMS = 184,
    ACTION_ID_DLOG_VOLTAGE_TOGGLE = 185,
    ACTION_ID_DLOG_CURRENT_TOGGLE = 186,
    ACTION_ID_DLOG_POWER_TOGGLE = 187,
    ACTION_ID_DLOG_VALUE_TOGGLE = 188,
    ACTION_ID_DLOG_EDIT_PERIOD = 189,
    ACTION_ID_DLOG_EDIT_DURATION = 190,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 191,
    ACTION_ID_DLOG_START_RECORDING = 192,
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 193,
    ACTION_ID_FILE_MANAGER_SORT_BY = 194,
    ACTION_ID_DLOG_AUTO_SCALE = 195,
    ACTION_ID_DLOG_UPLOAD = 196,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 197,
    ACTION_ID_MQTT_EDIT_HOST = 198,
    ACTION_ID_MQTT_EDIT_PORT = 199,
    ACTION_ID_MQTT_EDIT_USERNAME = 200,
    ACTION_ID_MQTT_EDIT_PASSWORD = 201,
    ACTION_ID_MQTT_EDIT_PERIOD = 202,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 203,
    ACTION_ID_DLOG_SCALE_TO_FIT = 204,
    ACTION_ID_DLOG_VIEW_TOGGLE_LEGEND = 205,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 206,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 207,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 208,
    ACTION_ID_SHUTDOWN = 209,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 210,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 211,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 212,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 213,
    ACTION_ID_PROFILE_IMPORT = 214,
    ACTION_ID_PROFILE_EXPORT = 215,
    ACTION_ID_EVENT_QUEUE_FILTER = 216,
    ACTION_ID_EVENT_QUEUE_SELECT_EVENT = 217
};
...
enum StylesEnum {
    ...
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 66,
    STYLE_ID_BOTTOM_BUTTON_DISABLED = 67,
    STYLE_ID_KEY_SPEC_ICONS = 68,
    STYLE_ID_KEY_SPEC_ICONS_DISABLED = 69,
    STYLE_ID_KEY_DISABLED = 70,
    STYLE_ID_EDIT_VALUE_S_CENTERED = 71,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_CENTER = 72,
    STYLE_ID_EDIT_VALUE_ACTIVE_M_CENTER = 73,
    STYLE_ID_VALUE_M = 74,
    STYLE_ID_DEFAULT_DISABLED_M_LEFT = 75,
    STYLE_ID_YT_GRAPH = 76,
    STYLE_ID_LIST_GRAPH_CURSOR = 77,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 78,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 79,
    STYLE_ID_EDIT_VALUE_FOCUS_S_CENTER = 80,
    STYLE_ID_VALUE = 81,
    STYLE_ID_DEFAULT_M = 82,
    STYLE_ID_NON_INTERACTIVE_BUTTON_M = 83,
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 84,
    STYLE_ID_DEFAULT_M_LEFT = 85,
    STYLE_ID_EVENT_ERROR = 86,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 87,
    STYLE_ID_ICON_AND_TEXT_S = 88,
    STYLE_ID_ICON_AND_TEXT_S_DISABLED = 89,
    STYLE_ID_DEFAULT_DISABLED = 90,
    STYLE_ID_EDIT_VALUE_M_CENTERED = 91,
    STYLE_ID_EDIT_S = 92,
    STYLE_ID_EDIT_VALUE_ACTIVE_S_LEFT = 93,
    STYLE_ID_EVENT_WARNING = 94,
    STYLE_ID_DISPLAY_OFF = 95,
    STYLE_ID_DISPLAY_OFF_S = 96,
    STYLE_ID_DEFAULT_GUI_TMPL = 97,
    STYLE_ID_MON_VALUE_48_RIGHT = 98,
    STYLE_ID_MON_VALUE_20_LEFT = 99,
    STYLE_ID_ENCODER_CURSOR_14_DISABLED = 100,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 101,
    STYLE_ID_ENCODER_CURSOR_14_FOCUSED = 102,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 103,
    STYLE_ID_BAR_GRAPH_TEXT = 104,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 105,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 106,
    STYLE_ID_TRIGGER_BUTTON_24 = 107,
    STYLE_ID_MON_VALUE_14_RIGHT = 108,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_DISABLED = 109,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 110,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_FOCUSED = 111,
    STYLE_ID_ENCODER_CURSOR_14_LEFT_DISABLED = 112,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 113,
    STYLE_ID_TRIGGER_BUTTON_14 = 114,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 115,
    STYLE_ID_INST_SELECTED = 116,
    STYLE_ID_MON_VALUE_38_RIGHT = 117,
    STYLE_ID_CH_PROT_OFF = 118,
    STYLE_ID_CH_PROT_ON = 119,
    STYLE_ID_CH_PROT_TRIPPED = 120,
    STYLE_ID_BUTTON_BGND = 121,
    STYLE_ID_MON_VALUE_24_RIGHT = 122,
    STYLE_ID_MON_VALUE_14_CENTER = 123,
    STYLE_ID_MON_VALUE_20_RIGHT = 124,
    STYLE_ID_MON_VALUE_14_LEFT = 125,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 126,
    STYLE_ID_SCROLLBAR_TRACK = 127,
    STYLE_ID_SCROLLBAR_THUMB = 128,
    STYLE_ID_SCROLLBAR_BUTTON = 129,
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[301252];
#else
extern const uint8_t assets[1313772];
#endif
