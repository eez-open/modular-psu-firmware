enum DataEnum {
    ...
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 337,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 338,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 339,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 340,
    DATA_ID_LIST_COUNTER_LABEL = 341,
    ...
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 350,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 351,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 352,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 353,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 354,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 355,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 356,
    DATA_ID_DATE_TIME_FORMAT = 357,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 358,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 359,
    DATA_ID_DATE_TIME_AM_PM = 360,
    DATA_ID_IS_MULTI_TRACKING = 361,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 362,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 363,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 364,
    DATA_ID_CHANNEL_INFO_BRAND = 365,
    DATA_ID_CHANNEL_INFO_SERIAL = 366,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 367,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 368,
    DATA_ID_FILE_MANAGER_FILE_ICON = 369,
    DATA_ID_FILE_MANAGER_LAYOUT = 370,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 371,
    DATA_ID_TOUCH_RAW_X = 372,
    DATA_ID_TOUCH_RAW_Y = 373,
    DATA_ID_TOUCH_RAW_Z1 = 374,
    DATA_ID_TOUCH_RAW_PRESSED = 375,
    DATA_ID_TOUCH_CALIBRATED_X = 376,
    DATA_ID_TOUCH_CALIBRATED_Y = 377,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 378,
    DATA_ID_TOUCH_FILTERED_X = 379,
    DATA_ID_TOUCH_FILTERED_Y = 380,
    DATA_ID_TOUCH_FILTERED_PRESSED = 381,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 382,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 383,
    ...
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 391,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 392,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 393,
    DATA_ID_DEBUG_VARIABLES = 394,
    DATA_ID_DEBUG_VARIABLE_NAME = 395,
    DATA_ID_DEBUG_VARIABLE_VALUE = 396
};
...
enum StylesEnum {
    ...
    STYLE_ID_YT_GRAPH = 179,
    STYLE_ID_LIST_GRAPH_CURSOR = 180,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 181,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 182,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 183,
    STYLE_ID_VALUE = 187,
    STYLE_ID_DEFAULT_M = 191,
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 192,
    STYLE_ID_EVENT_ERROR = 193,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 194,
    STYLE_ID_ICON_AND_TEXT_S = 196,
    STYLE_ID_ICON_AND_TEXT_S_DISABLED = 197,
    STYLE_ID_DEFAULT_DISABLED = 203,
    STYLE_ID_EDIT_VALUE_M_CENTERED = 206,
    STYLE_ID_EDIT_S = 207,
    STYLE_ID_EVENT_WARNING = 227,
    STYLE_ID_DISPLAY_OFF = 228,
    STYLE_ID_DISPLAY_OFF_S = 229,
    STYLE_ID_MON_VALUE_48_RIGHT = 232,
    STYLE_ID_MON_VALUE_20_LEFT = 234,
    STYLE_ID_ENCODER_CURSOR_14_DISABLED = 235,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 236,
    STYLE_ID_BAR_GRAPH_TEXT = 237,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 239,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 240,
    STYLE_ID_TRIGGER_BUTTON_24 = 242,
    STYLE_ID_MON_VALUE_14_RIGHT = 244,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_DISABLED = 245,
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 246,
    STYLE_ID_ENCODER_CURSOR_14_LEFT_DISABLED = 247,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 248,
    STYLE_ID_TRIGGER_BUTTON_14 = 249,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 255,
    STYLE_ID_INST_SELECTED = 256,
    STYLE_ID_MON_VALUE_38_RIGHT = 257,
    STYLE_ID_CH_PROT_OFF = 259,
    STYLE_ID_CH_PROT_ON = 260,
    STYLE_ID_CH_PROT_TRIPPED = 261,
    STYLE_ID_BUTTON_BGND = 262,
    STYLE_ID_MON_VALUE_24_RIGHT = 264,
    STYLE_ID_MON_VALUE_14_CENTER = 265,
    STYLE_ID_MON_VALUE_20_RIGHT = 271,
    STYLE_ID_MON_VALUE_14_LEFT = 272,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 273,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 277,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 278,
    STYLE_ID_SCROLLBAR_TRACK = 279,
    STYLE_ID_BUTTON_S_DISABLED = 292
};
...
extern const uint8_t assets[311799];
