enum DataEnum {
    ...
    DATA_ID_TOUCH_CALIBRATION_POINT = 235,
    ...
    DATA_ID_BATTERY = 261,
    DATA_ID_IO_PIN_STATE = 262,
    DATA_ID_CHANNEL_DPROG = 263,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 264,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 265,
    DATA_ID_SYS_INFO_HAS_ERROR = 266,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 267,
    DATA_ID_SYS_FAN_MODE = 268,
    DATA_ID_SYS_FAN_SPEED = 269,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 270,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 271,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 272,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 273,
    DATA_ID_IS_TRACKING_ALLOWED = 274,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 275,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 276,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 277,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 278,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 279,
    DATA_ID_IS_COUPLED_OR_TRACKED = 280,
    DATA_ID_OVERLAY = 281,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 282,
    ...
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 346,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 347,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 348,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 349,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 350,
    DATA_ID_IS_RESET_BY_IWDG = 351,
    DATA_ID_DLOG_ENABLED = 352,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 353,
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 354,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 355,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 356,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 357
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[300321];
#else
extern const uint8_t assets[1312244];
#endif
