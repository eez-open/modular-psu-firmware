enum DataEnum {
    ...
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 344,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 345,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 346,
    DATA_ID_LIST_COUNTER_LABEL = 347,
    DATA_ID_RAMP_COUNTER_LABEL = 348,
    ...
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 398,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 399,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 400,
    DATA_ID_DEBUG_VARIABLES = 401,
    DATA_ID_DEBUG_VARIABLE_NAME = 402,
    DATA_ID_DEBUG_VARIABLE_VALUE = 403,
    DATA_ID_CHANNEL_RAMP_STATE = 404,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 405,
    DATA_ID_MQTT_IN_ERROR = 406,
    DATA_ID_DEBUG_I_DAC = 407,
    DATA_ID_DEBUG_U_DAC = 408,
    DATA_ID_DEBUG_I_DAC_AMPER = 409,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 410,
    DATA_ID_DEBUG_I_ADC = 411,
    DATA_ID_DEBUG_U_ADC = 412,
    DATA_ID_DEBUG_I_ADC_AMPER = 413,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 414,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 415
};
...
enum ActionsEnum {
    ...
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 198,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 199,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 200,
    ACTION_ID_SHUTDOWN = 201,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 202,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 203,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 204,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 205,
    ACTION_ID_PROFILE_IMPORT = 206,
    ACTION_ID_PROFILE_EXPORT = 207,
    ACTION_ID_EVENT_QUEUE_FILTER = 208,
    ACTION_ID_EVENT_QUEUE_SELECT_EVENT = 209,
    ACTION_ID_DATE_TIME_SELECT_FORMAT = 210,
    ACTION_ID_DATE_TIME_TOGGLE_AM_PM = 211,
    ACTION_ID_EDIT_NO_FOCUS = 212,
    ACTION_ID_UNTRACK_ALL = 213,
    ACTION_ID_CH_SETTINGS_COPY = 214,
    ACTION_ID_SHOW_SYS_SETTINGS_ETHERNET_ERROR = 215,
