...
enum StylesEnum {
    ...
    STYLE_ID_TAB_PAGE_SELECTED = 64,
    STYLE_ID_TAB_PAGE = 65,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 66,
    STYLE_ID_YELLOW_1 = 67,
    STYLE_ID_YELLOW_2 = 68,
    STYLE_ID_YELLOW_3 = 69,
    STYLE_ID_YELLOW_4 = 70,
    STYLE_ID_YELLOW_5 = 71,
    STYLE_ID_YELLOW_6 = 72,
    STYLE_ID_YES_NO = 73,
    STYLE_ID_YES_NO_BACKGROUND = 74,
    STYLE_ID_YES_NO_MESSAGE = 75,
    STYLE_ID_YES_NO_BUTTON = 76,
    STYLE_ID_TEXT_MESSAGE = 77,
    STYLE_ID_ASYNC_OPERATION = 78,
    STYLE_ID_EVENT_INFO = 79,
    STYLE_ID_EVENT_WARNING = 80,
    STYLE_ID_EVENT_ERROR = 81,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_LEFT = 82,
    STYLE_ID_KEY_DISABLED = 83,
    STYLE_ID_VALUE_S = 84,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 85,
    STYLE_ID_MAX_CURRENT_LIMIT_CAUSE = 86,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 87,
    STYLE_ID_LIST_GRAPH_CURSOR = 88,
    STYLE_ID_YT_GRAPH_U_DEFUALT_LABEL = 89,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 90,
    STYLE_ID_EDIT_VALUE_FOCUS_S_CENTER = 91,
    STYLE_ID_EDIT_VALUE_LEFT = 92,
    STYLE_ID_EDIT_VALUE_ACTIVE_LEFT = 93,
    STYLE_ID_EDIT_VALUE_L = 94,
    STYLE_ID_EDIT_VALUE_ACTIVE = 95,
    STYLE_ID_DEFAULT_DISABLED = 96,
    STYLE_ID_VALUE = 97,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S = 98,
    STYLE_ID_BOTTOM_BUTTON_TEXTUAL_S_DISABLED = 99,
    STYLE_ID_DISPLAY_OFF = 100,
    STYLE_ID_DISPLAY_OFF_S = 101,
    STYLE_ID_SET_VALUE_S_RIGHT_BALANCED = 102,
    STYLE_ID_SET_VALUE_BALANCED = 103,
    STYLE_ID_SET_VALUE_FOCUS_BALANCED = 104,
    STYLE_ID_DEFAULT_3 = 105,
    STYLE_ID_ENCODER_CURSOR = 106
};
...
extern const uint8_t assets[210022];
