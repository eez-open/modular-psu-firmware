enum DataEnum {
    ...
    DATA_ID_SLOT1_INFO = 229,
    DATA_ID_SLOT2_INFO = 230,
    DATA_ID_SLOT3_INFO = 231,
    ...
    DATA_ID_SLOT_DEF_2CH_VIEW = 241,
    DATA_ID_SLOT_MAX_2CH_VIEW = 242,
    DATA_ID_SLOT_MIN_2CH_VIEW = 243,
    DATA_ID_SLOT_MICRO_2CH_VIEW = 244,
    DATA_ID_SLOT_2CH_CH1_INDEX = 245,
    DATA_ID_SLOT_2CH_CH2_INDEX = 246,
    DATA_ID_BATTERY = 247,
    DATA_ID_IO_PIN_STATE = 248,
    DATA_ID_CHANNEL_DPROG = 249,
    DATA_ID_CHANNEL_DPROG_INSTALLED = 250,
    DATA_ID_SYS_INFO_SDCARD_STATUS = 251,
    DATA_ID_SYS_INFO_HAS_ERROR = 252,
    DATA_ID_SYS_SETTINGS_HAS_ERROR = 253,
    DATA_ID_SYS_INFO_BATTERY_STATUS = 254,
    DATA_ID_SYS_FAN_MODE = 255,
    DATA_ID_SYS_FAN_SPEED = 256,
    DATA_ID_IS_COUPLING_TYPE_UNCOUPLED = 257,
    DATA_ID_IS_COUPLING_TYPE_PARALLEL = 258,
    DATA_ID_IS_COUPLING_TYPE_COMMON_GND = 259,
    DATA_ID_IS_COUPLING_TYPE_SPLIT_RAILS = 260,
    DATA_ID_IS_TRACKING_ALLOWED = 261,
    DATA_ID_IS_COUPLING_PARALLEL_ALLOWED = 262,
    DATA_ID_IS_COUPLING_SERIES_ALLOWED = 263,
    DATA_ID_CHANNEL_COUPLING_ENABLE_TRACKING_MODE = 264,
    DATA_ID_CHANNEL_ACTIVE_COUPLED_LED = 265,
    DATA_ID_IS_COUPLING_TYPE_SERIES = 266,
    DATA_ID_IS_COUPLED_OR_TRACKED = 267,
    DATA_ID_OVERLAY = 268,
    DATA_ID_CHANNELS_WITH_LIST_COUNTER_VISIBLE = 269,
    DATA_ID_CHANNELS_WITH_RAMP_COUNTER_VISIBLE = 270,
    DATA_ID_DLOG_STATE = 271,
    DATA_ID_DLOG_TOGGLE_STATE = 272,
    DATA_ID_RECORDING = 273,
    DATA_ID_CHANNEL_HISTORY_VALUES = 274,
    DATA_ID_RECORDING_READY = 275,
    DATA_ID_NONDRAG_OVERLAY = 276,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 277,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 278,
    DATA_ID_DLOG_VISIBLE_VALUES = 279,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 280,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 281,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 282,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 283,
    DATA_ID_DLOG_ALL_VALUES = 284,
    ...
    DATA_ID_DLOG_DURATION = 295,
    DATA_ID_DLOG_VOLTAGE_ENABLED = 296,
    DATA_ID_DLOG_CURRENT_ENABLED = 297,
    DATA_ID_DLOG_POWER_ENABLED = 298,
    DATA_ID_DLOG_START_ENABLED = 299,
    DATA_ID_DLOG_FILE_NAME = 300,
    DATA_ID_DLOG_VALUE_STATE = 301,
    DATA_ID_SLOT_MAX_2CH_MIN_VIEW = 302,
    DATA_ID_CHANNEL_OFF_LABEL = 303,
    DATA_ID_FILE_MANAGER_FILES = 304,
    DATA_ID_FILE_MANAGER_FILE_NAME = 305,
    DATA_ID_FILE_MANAGER_FILE_DATE_TIME = 306,
    DATA_ID_FILE_MANAGER_FILE_SIZE = 307,
    DATA_ID_FILE_MANAGER_FILE_SELECTED = 308,
    DATA_ID_FILE_MANAGER_STATE = 309,
    DATA_ID_FILE_MANAGER_IS_ROOT_DIRECTORY = 310,
    DATA_ID_FILE_MANAGER_CURRENT_DIRECTORY = 311,
    DATA_ID_FILE_MANAGER_IS_DIRECTORY = 312,
    DATA_ID_FILE_MANAGER_FILE_TYPE = 313,
    DATA_ID_FILE_MANAGER_OPEN_FILE_ENABLED = 314,
    DATA_ID_FILE_MANAGER_UPLOAD_FILE_ENABLED = 315,
    DATA_ID_FILE_MANAGER_RENAME_FILE_ENABLED = 316,
    DATA_ID_FILE_MANAGER_DELETE_FILE_ENABLED = 317,
    DATA_ID_FILE_MANAGER_OPENED_IMAGE = 318,
    DATA_ID_SCRIPT_INFO = 319,
    DATA_ID_SCRIPT_IS_STARTED = 320,
    DATA_ID_KEYPAD_OK_ENABLED = 321,
    DATA_ID_ETHERNET_HOST_NAME = 322,
    DATA_ID_MQTT_HOST = 323,
    DATA_ID_MQTT_PORT = 324,
    DATA_ID_MQTT_USERNAME = 325,
    DATA_ID_MQTT_PASSWORD = 326,
    DATA_ID_MQTT_PERIOD = 327,
    DATA_ID_DLOG_VIEW_SHOW_LABELS = 328,
    DATA_ID_IS_ANY_COUPLING_ALLOWED = 329,
    DATA_ID_IS_COUPLING_SPLIT_RAILS_ALLOWED = 330,
    DATA_ID_LIST_COUNTER_LABEL = 331,
    DATA_ID_RAMP_COUNTER_LABEL = 332,
    DATA_ID_MODULE_SPECIFIC_CH_SETTINGS = 333,
    DATA_ID_CHANNEL_FIRMWARE_VERSION = 334,
    DATA_ID_FILE_MANAGER_BROWSER_TITLE = 335,
    DATA_ID_CHANNEL_HAS_ERROR_SETTINGS = 336,
    DATA_ID_CHANNEL_SETTINGS_PAGE = 337,
    DATA_ID_IS_RESET_BY_IWDG = 338,
    DATA_ID_DLOG_ENABLED = 339,
    DATA_ID_FILE_MANAGER_BROWSER_IS_SAVE_DIALOG = 340,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 341,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 342,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 343,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 344,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 345,
    DATA_ID_DATE_TIME_FORMAT = 346,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 347,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 348,
    DATA_ID_DATE_TIME_AM_PM = 349,
    DATA_ID_IS_MULTI_TRACKING = 350,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 351,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 352,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 353,
    DATA_ID_CHANNEL_INFO_BRAND = 354,
    DATA_ID_CHANNEL_INFO_SERIAL = 355,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 356,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 357,
    DATA_ID_FILE_MANAGER_FILE_ICON = 358,
    DATA_ID_FILE_MANAGER_LAYOUT = 359,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 360,
    DATA_ID_TOUCH_RAW_X = 361,
    DATA_ID_TOUCH_RAW_Y = 362,
    DATA_ID_TOUCH_RAW_Z1 = 363,
    DATA_ID_TOUCH_RAW_PRESSED = 364,
    DATA_ID_TOUCH_CALIBRATED_X = 365,
    DATA_ID_TOUCH_CALIBRATED_Y = 366,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 367,
    DATA_ID_TOUCH_FILTERED_X = 368,
    DATA_ID_TOUCH_FILTERED_Y = 369,
    DATA_ID_TOUCH_FILTERED_PRESSED = 370,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 371,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 372,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 373,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 374,
    DATA_ID_ALERT_MESSAGE_IS_SET = 375,
    DATA_ID_ASYNC_PROGRESS = 376,
    DATA_ID_IO_PIN_FUNCTION = 377,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 378,
    DATA_ID_IO_PIN_PWM_DUTY = 379,
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 380,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 381,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 382,
    DATA_ID_DEBUG_VARIABLES = 383,
    DATA_ID_DEBUG_VARIABLE_NAME = 384,
    DATA_ID_DEBUG_VARIABLE_VALUE = 385,
    DATA_ID_CHANNEL_RAMP_STATE = 386,
    DATA_ID_RAMP_AND_DELAY_LIST_SCROLLBAR_ENABLED = 387,
    DATA_ID_MQTT_IN_ERROR = 388,
    DATA_ID_DEBUG_I_DAC = 389,
    DATA_ID_DEBUG_U_DAC = 390,
    DATA_ID_DEBUG_I_DAC_AMPER = 391,
    DATA_ID_DEBUG_U_DAC_VOLTAGE = 392,
    DATA_ID_DEBUG_I_ADC = 393,
    DATA_ID_DEBUG_U_ADC = 394,
    DATA_ID_DEBUG_I_ADC_AMPER = 395,
    DATA_ID_DEBUG_U_ADC_VOLTAGE = 396,
    DATA_ID_DLOG_VIEW_LEGEND_VIEW_OPTION = 397,
    DATA_ID_CALIBRATION_POINT_MEASURED_VALUE = 398,
    DATA_ID_CALIBRATION_POINT_SET_VALUE = 399,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_TYPE = 400,
    DATA_ID_CHANNEL_CALIBRATION_VALUE_IS_VOLTAGE = 401,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_PREVIOUS = 402,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_MOVE_TO_NEXT = 403,
    DATA_ID_CHANNEL_CALIBRATION_POINT_CAN_DELETE = 404,
...
enum PagesEnum {
    ...
    PAGE_ID_DCM220_FRONT_PANEL_LED = 164,
    PAGE_ID_FILE_MANAGER_DETAILS_VIEW = 165,
    PAGE_ID_FILE_MANAGER_SCRIPTS_VIEW = 166,
    PAGE_ID_FILE_MANAGER_SCRIPTS_ALTER_VIEW = 167,
    PAGE_ID_FILE_MANAGER_LARGE_ICONS_VIEW = 168,
    PAGE_ID_TOUCH_TEST = 169,
    PAGE_ID_DEBUG_VARIABLES = 170,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 171,
    PAGE_ID_OVP_TYPE = 172,
