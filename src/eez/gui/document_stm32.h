enum DataEnum {
    ...
    DATA_ID_CHANNEL_VOLTAGE_RAMP_DURATION = 390,
    DATA_ID_CHANNEL_CURRENT_RAMP_DURATION = 391,
    DATA_ID_CHANNEL_OUTPUT_DELAY = 392,
    DATA_ID_DEBUG_VARIABLES = 393,
    DATA_ID_DEBUG_VARIABLE_NAME = 394,
    DATA_ID_DEBUG_VARIABLE_VALUE = 395
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_SYS_SETTINGS_RAMP_AND_DELAY = 223
};
...
enum StylesEnum {
    ...
    STYLE_ID_YT_GRAPH = 181,
    STYLE_ID_LIST_GRAPH_CURSOR = 182,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 183,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 184,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 185,
    STYLE_ID_VALUE = 189,
    STYLE_ID_DEFAULT_M = 193,
    STYLE_ID_OPTION_TOGGLE_L_CENTER = 194,
    STYLE_ID_EVENT_ERROR = 195,
    STYLE_ID_DEFAULT_DISABLED_S_LEFT = 196,
    STYLE_ID_ICON_AND_TEXT_S = 198,
    STYLE_ID_ICON_AND_TEXT_S_DISABLED = 199,
    STYLE_ID_DEFAULT_DISABLED = 205,
    STYLE_ID_EDIT_VALUE_M_CENTERED = 208,
    STYLE_ID_EDIT_S = 209,
    STYLE_ID_EVENT_WARNING = 229,
    STYLE_ID_DISPLAY_OFF = 230,
    STYLE_ID_DISPLAY_OFF_S = 231,
    STYLE_ID_MON_VALUE_48_RIGHT = 234,
    STYLE_ID_MON_VALUE_20_LEFT = 236,
    ...
    STYLE_ID_ENCODER_CURSOR_14_RIGHT_ENABLED = 246,
    STYLE_ID_CHANNEL_OFF_BUTTON_20 = 247,
    STYLE_ID_TRIGGER_BUTTON_14 = 248,
    STYLE_ID_CHANNEL_OFF_BUTTON_38 = 254,
    STYLE_ID_INST_SELECTED = 255,
    STYLE_ID_MON_VALUE_38_RIGHT = 256,
    STYLE_ID_CH_PROT_OFF = 258,
    STYLE_ID_CH_PROT_ON = 259,
    STYLE_ID_CH_PROT_TRIPPED = 260,
    STYLE_ID_BUTTON_BGND = 261,
    STYLE_ID_MON_VALUE_24_RIGHT = 263,
    STYLE_ID_MON_VALUE_14_CENTER = 264,
    STYLE_ID_MON_VALUE_20_RIGHT = 270,
    STYLE_ID_MON_VALUE_14_LEFT = 271,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 272,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 276,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 277,
    STYLE_ID_SCROLLBAR_TRACK = 278,
    STYLE_ID_BUTTON_S_DISABLED = 291
};
...
enum PagesEnum {
    ...
    PAGE_ID_SYS_SETTINGS_RAMP_AND_DELAY = 69,
    ...
    PAGE_ID_DEBUG_VARIABLES = 162,
    PAGE_ID_FOCUS_VALUE_OVERLAY = 163
};

extern const uint8_t assets[308635];
