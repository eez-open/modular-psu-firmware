...
enum PagesEnum {
    ...
    PAGE_ID_DIB_DCP405_CH_SETTINGS_SPECIFIC = 198,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_ERROR = 199,
    PAGE_ID_DIB_DCM220_CH_SETTINGS_SPECIFIC = 200
};

extern const uint8_t assets[314564];
