enum DataEnum {
    ...
    DATA_ID_DLOG_STATE = 278,
    DATA_ID_DLOG_TOGGLE_STATE = 279,
    DATA_ID_RECORDING = 280,
    DATA_ID_CHANNEL_HISTORY_VALUES = 281,
    DATA_ID_RECORDING_READY = 282,
    DATA_ID_NONDRAG_OVERLAY = 283,
    DATA_ID_DLOG_SINGLE_VALUE_OVERLAY = 284,
    DATA_ID_DLOG_MULTIPLE_VALUES_OVERLAY = 285,
    DATA_ID_DLOG_VISIBLE_VALUES = 286,
    DATA_ID_DLOG_VISIBLE_VALUE_LABEL = 287,
    DATA_ID_DLOG_VISIBLE_VALUE_DIV = 288,
    DATA_ID_DLOG_VISIBLE_VALUE_OFFSET = 289,
    DATA_ID_DLOG_VISIBLE_VALUE_CURSOR = 290,
    DATA_ID_DLOG_ALL_VALUES = 291,
    DATA_ID_DLOG_VALUE_LABEL = 292,
    ...
    DATA_ID_DLOG_VIEW_SHOW_LEGEND = 336,
    ...
    DATA_ID_CHANNEL_CALIBRATION_STEP_NOTE = 349,
    DATA_ID_CHANNEL_CALIBRATION_HAS_STEP_NOTE = 350,
    DATA_ID_FILE_MANAGER_STORAGE_INFO = 351,
    DATA_ID_FILE_MANAGER_STORAGE_ALARM = 352,
    DATA_ID_EVENT_QUEUE_IS_LONG_MESSAGE_TEXT = 353,
    DATA_ID_EVENT_QUEUE_EVENT_LONG_MESSAGE_OVERLAY = 354,
    DATA_ID_EVENT_QUEUE_EVENT_IS_SELECTED = 355,
    DATA_ID_DATE_TIME_FORMAT = 356,
    DATA_ID_DATE_TIME_FORMAT_IS_DMY = 357,
    DATA_ID_DATE_TIME_FORMAT_IS_24H = 358,
    DATA_ID_DATE_TIME_AM_PM = 359,
    DATA_ID_IS_MULTI_TRACKING = 360,
    DATA_ID_CHANNEL_COPY_AVAILABLE = 361,
    DATA_ID_CHANNEL_RSENSE_INSTALLED = 362,
    DATA_ID_FILE_MANAGER_SORT_FILES_OPTION = 363,
    DATA_ID_CHANNEL_INFO_BRAND = 364,
    DATA_ID_CHANNEL_INFO_SERIAL = 365,
    DATA_ID_FILE_MANAGER_LIST_VIEW = 366,
    DATA_ID_FILE_MANAGER_IS_LIST_VIEW_OPTION_AVAILABLE = 367,
    DATA_ID_FILE_MANAGER_FILE_ICON = 368,
    DATA_ID_FILE_MANAGER_LAYOUT = 369,
    DATA_ID_FILE_MANAGER_FILE_DESCRIPTION = 370,
    DATA_ID_TOUCH_RAW_X = 371,
    DATA_ID_TOUCH_RAW_Y = 372,
    DATA_ID_TOUCH_RAW_Z1 = 373,
    DATA_ID_TOUCH_RAW_PRESSED = 374,
    DATA_ID_TOUCH_CALIBRATED_X = 375,
    DATA_ID_TOUCH_CALIBRATED_Y = 376,
    DATA_ID_TOUCH_CALIBRATED_PRESSED = 377,
    DATA_ID_TOUCH_FILTERED_X = 378,
    DATA_ID_TOUCH_FILTERED_Y = 379,
    DATA_ID_TOUCH_FILTERED_PRESSED = 380,
    DATA_ID_CAN_SHOW_PREVIOUS_PAGE = 381,
    DATA_ID_FILE_MANAGER_FILE_HAS_DESCRIPTION = 382,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_STATE = 383,
    DATA_ID_FILE_MANAGER_IMAGE_OPEN_PROGRESS = 384,
    DATA_ID_ALERT_MESSAGE_IS_SET = 385,
    DATA_ID_ASYNC_PROGRESS = 386,
    DATA_ID_IO_PIN_FUNCTION = 387,
    DATA_ID_IO_PIN_PWM_FREQUENCY = 388,
    DATA_ID_IO_PIN_PWM_DUTY = 389
};
...
enum ActionsEnum {
    ...
    ACTION_ID_SELECT_THEME = 153,
    ACTION_ID_TOGGLE_CHANNELS_MAX_VIEW = 154,
    ACTION_ID_EDIT_ANIMATIONS_DURATION = 155,
    ACTION_ID_RESTART = 156,
    ACTION_ID_USER_SWITCH_CLICKED = 157,
    ACTION_ID_IO_PIN_TOGGLE_STATE = 158,
    ACTION_ID_CH_SETTINGS_ADV_TOGGLE_DPROG = 159,
    ACTION_ID_SYS_SETTINGS_FAN_TOGGLE_MODE = 160,
    ACTION_ID_SYS_SETTINGS_FAN_EDIT_SPEED = 161,
    ACTION_ID_SHOW_SYS_SETTINGS_TRACKING = 162,
    ACTION_ID_SHOW_SYS_SETTINGS_COUPLING = 163,
    ACTION_ID_SET_COUPLING_UNCOUPLED = 164,
    ACTION_ID_SET_COUPLING_PARALLEL = 165,
    ACTION_ID_SET_COUPLING_SERIES = 166,
    ACTION_ID_SET_COUPLING_COMMON_GND = 167,
    ACTION_ID_SET_COUPLING_SPLIT_RAILS = 168,
    ACTION_ID_TOGGLE_CHANNEL_TRACKING = 169,
    ACTION_ID_TOGGLE_ENABLE_TRACKING_MODE_IN_COUPLING = 170,
    ACTION_ID_DRAG_OVERLAY = 171,
    ACTION_ID_DLOG_TOGGLE = 172,
    ACTION_ID_SHOW_DLOG_VIEW = 173,
    ACTION_ID_SELECT_USER_SWITCH_ACTION = 174,
    ACTION_ID_SHOW_FILE_MANAGER = 175,
    ACTION_ID_FILE_MANAGER_SELECT_FILE = 176,
    ACTION_ID_FILE_MANAGER_GO_TO_PARENT_DIRECTORY = 177,
    ACTION_ID_FILE_MANAGER_OPEN_FILE = 178,
    ACTION_ID_FILE_MANAGER_UPLOAD_FILE = 179,
    ACTION_ID_FILE_MANAGER_RENAME_FILE = 180,
    ACTION_ID_FILE_MANAGER_DELETE_FILE = 181,
    ACTION_ID_SHOW_DLOG_PARAMS = 182,
    ACTION_ID_DLOG_VOLTAGE_TOGGLE = 183,
    ACTION_ID_DLOG_CURRENT_TOGGLE = 184,
    ACTION_ID_DLOG_POWER_TOGGLE = 185,
    ACTION_ID_DLOG_VALUE_TOGGLE = 186,
    ACTION_ID_DLOG_EDIT_PERIOD = 187,
    ACTION_ID_DLOG_EDIT_DURATION = 188,
    ACTION_ID_DLOG_EDIT_FILE_NAME = 189,
    ACTION_ID_DLOG_START_RECORDING = 190,
    ACTION_ID_DLOG_VIEW_SHOW_OVERLAY_OPTIONS = 191,
    ACTION_ID_FILE_MANAGER_SORT_BY = 192,
    ACTION_ID_DLOG_AUTO_SCALE = 193,
    ACTION_ID_DLOG_UPLOAD = 194,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 195,
    ACTION_ID_MQTT_EDIT_HOST = 196,
    ACTION_ID_MQTT_EDIT_PORT = 197,
    ACTION_ID_MQTT_EDIT_USERNAME = 198,
    ACTION_ID_MQTT_EDIT_PASSWORD = 199,
    ACTION_ID_MQTT_EDIT_PERIOD = 200,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 201,
    ACTION_ID_DLOG_SCALE_TO_FIT = 202,
    ACTION_ID_DLOG_VIEW_TOGGLE_LEGEND = 203,
    ACTION_ID_DLOG_VIEW_TOGGLE_LABELS = 204,
    ACTION_ID_DLOG_VIEW_SELECT_VISIBLE_VALUE = 205,
    ACTION_ID_CHANNEL_UPDATE_FIRMWARE = 206,
    ACTION_ID_SHUTDOWN = 207,
    ACTION_ID_SHOW_CHANNEL_LISTS_FILE_MENU = 208,
    ACTION_ID_CHANNEL_LISTS_FILE_IMPORT = 209,
    ACTION_ID_CHANNEL_LISTS_FILE_EXPORT = 210,
    ACTION_ID_FILE_MANAGER_NEW_FILE = 211,
    ...
    ACTION_ID_FILE_MANAGER_SELECT_LIST_VIEW = 222
};
...
enum StylesEnum {
    ...
    STYLE_ID_INFO_ALERT = 31,
    STYLE_ID_MENU_WITH_BUTTONS_MESSAGE = 32,
    STYLE_ID_MENU_WITH_BUTTONS_CONTAINER = 33,
    STYLE_ID_MENU_WITH_BUTTONS_BUTTON = 34,
    STYLE_ID_CHANNEL1 = 35,
    STYLE_ID_CHANNEL2 = 36,
    STYLE_ID_CHANNEL3 = 37,
    STYLE_ID_CHANNEL4 = 38,
    STYLE_ID_CHANNEL5 = 39,
    STYLE_ID_CHANNEL6 = 40,
    STYLE_ID_CHANNEL1_INVERSE = 41,
    STYLE_ID_CHANNEL2_INVERSE = 42,
    STYLE_ID_CHANNEL3_INVERSE = 43,
    STYLE_ID_CHANNEL4_INVERSE = 44,
    STYLE_ID_CHANNEL5_INVERSE = 45,
    STYLE_ID_CHANNEL6_INVERSE = 46,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ERROR = 80,
    STYLE_ID_TOUCH_CALIBRATION = 99,
    STYLE_ID_STATUS_ICON_ENABLED_WITH_NEED_ATTENTION = 104,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ACTIVE = 106,
    STYLE_ID_STATUS_ICON_ENABLED_BLINK = 108,
    STYLE_ID_STATUS_ICON_DISABLED = 109,
    ...
    STYLE_ID_KEY = 120,
    STYLE_ID_TAB_PAGE_SELECTED = 123,
    STYLE_ID_TAB_PAGE = 124,
    STYLE_ID_DEFAULT_INVERSE = 131,
    STYLE_ID_BUTTON_S = 132,
    STYLE_ID_SLIDER_SHADE_1 = 133,
    STYLE_ID_SLIDER_SHADE_2 = 134,
    STYLE_ID_SLIDER_SHADE_3 = 135,
    STYLE_ID_SLIDER_SHADE_4 = 136,
    STYLE_ID_SLIDER_SHADE_5 = 137,
    STYLE_ID_YES_NO = 138,
    STYLE_ID_YES_NO_BUTTON = 139,
    STYLE_ID_YES_NO_MESSAGE = 140,
    STYLE_ID_TEXT_MESSAGE = 142,
    STYLE_ID_ASYNC_OPERATION = 145,
    STYLE_ID_PROGRESS = 146,
...
enum ColorsEnum {
    ...
    COLOR_ID_DATA_LOGGING_BACKGROUND = 32,
...
extern const uint8_t assets[310810];
