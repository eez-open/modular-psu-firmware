enum DataEnum {
    ...
    DATA_ID_DEBUG_TRACE_LOG = 335,
    DATA_ID_DEBUG_TRACE_LOG_LINE = 336,
    ...
    DATA_ID_DEBUG_TRACE_LOG_IS_STOPPED = 344,
...
enum ActionsEnum {
    ...
    ACTION_ID_SHOW_DEBUG_TRACE_LOG = 196,
    ACTION_ID_DLOG_UPLOAD = 197,
    ACTION_ID_ETHERNET_EDIT_HOST_NAME = 198,
    ACTION_ID_MQTT_EDIT_HOST = 199,
    ACTION_ID_MQTT_EDIT_PORT = 200,
    ACTION_ID_MQTT_EDIT_USERNAME = 201,
    ACTION_ID_MQTT_EDIT_PASSWORD = 202,
    ACTION_ID_MQTT_EDIT_PERIOD = 203,
    ACTION_ID_SHOW_SYS_SETTINGS_MQTT = 204,
    ACTION_ID_DEBUG_TRACE_LOG_TOGGLE = 205,
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[300140];
#else
extern const uint8_t assets[1312324];
#endif
