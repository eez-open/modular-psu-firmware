...
enum StylesEnum {
    ...
    STYLE_ID_MON_VALUE_48_RIGHT = 291,
    STYLE_ID_INLINE292 = 292,
    STYLE_ID_MON_VALUE_20_LEFT = 293,
    STYLE_ID_BAR_GRAPH_U_DEFAULT = 294,
    STYLE_ID_BAR_GRAPH_TEXT = 295,
    STYLE_ID_BAR_GRAPH_SET_LINE = 296,
    STYLE_ID_BAR_GRAPH_LIMIT_LINE = 297,
    STYLE_ID_BAR_GRAPH_I_DEFAULT = 298,
...
extern const uint8_t assets[329270];
