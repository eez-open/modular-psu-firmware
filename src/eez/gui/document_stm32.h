...
enum StylesEnum {
    ...
    STYLE_ID_STATUS_BGND = 53,
    STYLE_ID_STATUS_ICON_ENABLED_AND_ERROR = 79,
    STYLE_ID_STATUS_ICON_ENABLED = 80,
    ...
    STYLE_ID_NON_INTERACTIVE_BUTTON_S = 132,
    ...
    STYLE_ID_YT_GRAPH = 176,
    STYLE_ID_LIST_GRAPH_CURSOR = 177,
    STYLE_ID_YT_GRAPH_U_DEFAULT_LABEL = 178,
    STYLE_ID_YT_GRAPH_I_DEFAULT_LABEL = 179,
    STYLE_ID_ENCODER_CURSOR_14_ENABLED = 180,
    STYLE_ID_VALUE = 184,
    STYLE_ID_DEFAULT_M = 188,
    STYLE_ID_NON_INTERACTIVE_BUTTON_M = 189,
    ...
    STYLE_ID_CH_PROT_OFF = 260,
    STYLE_ID_CH_PROT_ON = 261,
    STYLE_ID_CH_PROT_TRIPPED = 262,
    STYLE_ID_BUTTON_BGND = 263,
    STYLE_ID_MON_VALUE_24_RIGHT = 267,
    STYLE_ID_MON_VALUE_14_CENTER = 268,
    STYLE_ID_MON_VALUE_20_RIGHT = 275,
    STYLE_ID_MON_VALUE_14_LEFT = 276,
    STYLE_ID_CHANNEL_OFF_BUTTON_14 = 277,
    STYLE_ID_STATUS_LINE_SMALL_TITLE = 282,
    STYLE_ID_EDIT_VALUE_S_CENTERED_STATUS_LINE = 283,
    STYLE_ID_SCROLLBAR_TRACK = 284,
    STYLE_ID_NON_INTERACTIVE_BUTTON_S_DISABLED = 295
};
...
#ifdef OPTION_SDRAM
extern const uint8_t assets[311213];
#else
extern const uint8_t assets[1366480];
#endif
