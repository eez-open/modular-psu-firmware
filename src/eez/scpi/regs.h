...
//
#define QUES_ISUM_N(N) (1 << (N)) /* INSTrument N QUEStionable Event Summary */

//
// OPERation INSTrument register bits
//
#define OPER_ISUM_N(N) (1 << (N)) /* INSTrument N OPERation Event Summary */
...
enum scpi_psu_reg_name_t {
    ...
    SCPI_PSU_CH_REG_QUES_INST_ISUM_EVENT1 = SCPI_PSU_CH_REG_QUES_INST_ISUM_COND1 + NUM_REG_INSTRUMENTS,
    SCPI_PSU_CH_REG_QUES_INST_ISUM_ENABLE1 = SCPI_PSU_CH_REG_QUES_INST_ISUM_EVENT1 + NUM_REG_INSTRUMENTS,

    SCPI_PSU_CH_REG_OPER_INST_ISUM_COND1 = SCPI_PSU_CH_REG_QUES_INST_ISUM_ENABLE1 + NUM_REG_INSTRUMENTS,
    SCPI_PSU_CH_REG_OPER_INST_ISUM_EVENT1 = SCPI_PSU_CH_REG_OPER_INST_ISUM_COND1 + NUM_REG_INSTRUMENTS,
    SCPI_PSU_CH_REG_OPER_INST_ISUM_ENABLE1 = SCPI_PSU_CH_REG_OPER_INST_ISUM_EVENT1 + NUM_REG_INSTRUMENTS,
