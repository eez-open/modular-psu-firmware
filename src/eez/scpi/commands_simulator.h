#define SCPI_COMMANDS \
    ...
    SCPI_COMMAND("[SOURce#]:VOLTage:FUNCtion:PHASeshift?", scpi_cmd_sourceVoltageFunctionPhaseshiftQ) \
    SCPI_COMMAND("[SOURce#]:VOLTage:FUNCtion:AMPLitude", scpi_cmd_sourceVoltageFunctionAmplitude) \
    SCPI_COMMAND("[SOURce#]:VOLTage:FUNCtion:AMPLitude?", scpi_cmd_sourceVoltageFunctionAmplitudeQ) \
    SCPI_COMMAND("[SOURce#]:VOLTage:FUNCtion:OFFSet", scpi_cmd_sourceVoltageFunctionOffset) \
